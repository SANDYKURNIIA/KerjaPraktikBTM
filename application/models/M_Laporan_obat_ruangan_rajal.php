...
class M_Laporan_obat_ruangan_rajal extends CI_Model
{ 
    ...
    public function selectLaporanObatRuanganRajal()
    {
        ...
        FROM stok_apotik s, list_logistik l, detail_request d,staff f, staff a
    ...
    public function selectLaporanObatRuanganRajalRange($mulai, $akhir)
    {
        date_default_timezone_set('Asia/Jakarta');
        $hasil = $this->db->query("SELECT s.tgl tanggal, l.id_logistik kode_obat,l.nama nama_obat, (s.frek *-1) jumlah,  ROUND(l.harga_cost*1.11) hna_ppn, ROUND(l.harga_cost) hna, f.nama staff_req, f.ruangan, f.tipe unit, a.nama staff_acc
        FROM stok_apotik s, list_logistik l, detail_request d,staff f, staff a
