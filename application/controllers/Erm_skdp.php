...
class Erm_skdp extends CI_Controller {
	...
	public function form($id_pel, $id_his)
	{
		...
		$page_data['page_content'] = 'erm_form/view_skdp';
	...
	{
		$data['page_title']="SKDP (SURAT KETERANGAN DALAM PERAWATAN)";
		$this->load->view('erm_print/skdp', $data);
	}
}
=======
<?php
