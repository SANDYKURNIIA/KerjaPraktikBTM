...
class Retur_obat_logistik extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $max = $this->M_Perencanaan->selectNoDokumenRetur();
        $i = 0;
        $page_data = array('max' =>  $max[$i]->max + 1,);
        $page_data['vendor'] = $this->db->get('produsen')->result_array();
        $page_data['obat'] = $this->M_Perencanaan->selectObatRetur();
        $page_data['page_content'] = 'page_content/Retur_obat_logistik';
    ...
    public function tampil_list_faktur()
    {
        ...
        $page_data = $this->M_Perencanaan->getListRetur($idFaktur);
    ...
    public function insertFaktur()
    {
        ...
        $this->M_Perencanaan->insertObat($data, 'faktur_retur_obat');
        $out['status'] = "success";
    ...
    public function insertObatFaktur()
    {
        ...
        $this->M_Perencanaan->insertObat($data, 'detail_retur_obat');
    ...
    function hapus_list_faktur()
    {
        ...
        $this->M_Perencanaan->delete($id_detail, 'detail_retur_obat', 'id_detail');
    ...
    {
        $page_data = $this->M_Perencanaan->selectDataRetur();
        $out = null;
        for ($i = 0; $i < count($page_data); $i++) {
            $label =     "<a class='btn btn-danger btn-icon-anim btn-square' href='".base_url()."Retur_obat_logistik/print_out/" . $page_data[$i]->id_faktur . "' ><i class='icon-printer'></i></a>";
    ...
    public function tampil_range()
    {
        ...
        $page_data = $this->M_Perencanaan->selectRangeRetur($mulai, $akhir);
        $out = null;
        for ($i = 0; $i < count($page_data); $i++) {
            $label =     "<a class='btn btn-danger btn-icon-anim btn-square' href='".base_url()."Retur_obat_logistik/print_out/" . $page_data[$i]->id_faktur . "' ><i class='icon-printer'></i></a>";
            $edit =  "<a class='btn btn-warning btn-icon-anim btn-square' data-toggle='modal' onclick='edit_faktur(\"" . $page_data[$i]->id_faktur . "\",\"" . $page_data[$i]->no_dokumen . "\")'><i class='icon-pencil'></i></a>";
    ...
    function hapus_faktur_po()
    {
        ...
        $this->M_Perencanaan->delete($id_faktur, 'faktur_retur_obat','id_faktur');
        $out['status'] = "success";
        echo json_encode($out);
    }
    ...
    {
        $data['data'] = $this->M_Perencanaan->getRetur($id_faktur);
        $data['list'] = $this->M_Perencanaan->getListRetur($id_faktur);
    ...
    public function Tampil_laporan()
    {
        ...
        $akhir = $this->input->post('akhir');
        if ($mulai != '' && $akhir != '') {
            $page_data = $this->M_Perencanaan->selectLaporanRetur($mulai, $akhir);
        } else {
            $page_data = $this->M_Perencanaan->selectLaporanRetur('', '');
        }
