...
class Erm_ranap extends CI_Controller
{
	...
	public function form($id_pel, $id_his , $icuOnly = false)
	{
		...
		$asses_per_ranap_exists = $this->M_Erm_ranap->checkAsesmenPerawatRanap($id_pelayanan, $id_histori);
	...
	public function checkData()
	{
		...
		$asses_ulang_nyeri = $this->M_Erm_ranap->checkData(['no_rm' => $id_histori], 'form_asesmen_ulang_nyeri');
