...
class Erm_penolakan_tindakan_kedokteran extends CI_Controller
{
	...
	public function form($id_pelayanan, $id_history)
	{
		...
		$page_data['page_content'] = 'erm_form/penolakan_tindakan_dokter_igd';
	...
	public function edit_penolakan_tindakan()
	{
		$data = $this->session->userdata('data_auth');
		...
		$where = array('id_form_penolakan_tindakan_dokter' => $this->input->post('id'));

		$this->M_Erm->update($data, $where, 'form_penolakan_tindakan_dokter');
		$out['status'] = "success";
