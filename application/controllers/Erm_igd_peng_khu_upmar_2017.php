...
class Erm_igd_peng_khu_upmar_2017 extends CI_Controller
{
	...
	public function insert_peng_khusus()
	{
		...
		if ($this->form_validation->run()) {
			...
			$this->M_Erm->insert($data, 'form_peng_khusus');
			$out['status'] = "success";
		} else {
			$out = array(
				'error'   => true,
	...
	public function edit_peng_khusus()
	{
		...
		$this->M_Erm->update($data, $where, 'form_peng_khusus');
		$out['status'] = "success";
		echo json_encode($out);
	}
	...
	function hapus_tindakan_pengawasan()
	{
		...
		$this->M_Erm->delete($where, 'form_peng_khusus');
		$out['status'] = "success";
		echo json_encode($out);
	}
}
