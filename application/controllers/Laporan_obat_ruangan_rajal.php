...
class Laporan_obat_ruangan_rajal extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('M_Laporan_obat_ruangan_rajal');
    }

    public function index()
    {
        $this->load->view('assets/_header');
        $page_data['page_content'] = 'page_content/Laporan_obat_ruangan_rajal';
        $this->load->view('Main', $page_data);
        $this->load->view('assets/_footer');
    }

    public function tampil_data_laporan_obat_ruangan_rajal()
    {
        ...
        if ($first_date != '' && $second_date != '') {
            $page_data = $this->M_Laporan_obat_ruangan_rajal->selectLaporanObatRuanganRajalRange($first_date, $second_date);
        } else {
            $page_data = $this->M_Laporan_obat_ruangan_rajal->selectLaporanObatRuanganRajal($tanggal);
        }
