...
class Erm_penundaan_pelayanan_pengobatan extends CI_Controller {
	...
	public function insert_penundaan_pelayanan()
	{
		...
		if ($this->form_validation->run()) {
			...
			$this->M_Erm_poli->insert($data, 'form_penundaan_pelayanan_obat');
			$out['status'] = "success";
		} else {
			$out = array(
				'error'   => true,
	...
	public function edit_penundaan_pelayanan()
	{
		...
		$this->M_Erm_poli->update($data,$where, 'form_penundaan_pelayanan_obat');
		$out['status'] = "success";
