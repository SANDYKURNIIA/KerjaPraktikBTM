...
<div class="panel panel-success card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-light">PENCARIAN SEP INTERNAL</h6>
        </div>
    ...
    <div class="row">
        ...
        <div class="row mt-30">
            ...
            <div class="col-md-9">
                    <label class="mt-0 txt-dark">Masukkan Nomor SEP : </label>
                    <input class="form-control" placeholder="NOMOR SEP" tabindex="1" name="inNosep" id="inNosep"></input>
...
<script type="text/javascript">
    function tampilRangePermit() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Vclaim_bpjs1/getSEPInternal'); ?>',
                "type": 'POST',
                "data": {
                    sep: nosep,
                },
    ...
    function delete_ranap(noSurat,nosep,tglrujukinternal,tujuanrujuk) {
        // nama = $("#NamaPasien").val();
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Vclaim_bpjs1/hapus_sep_internal",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        noSurat: noSurat,
