...
<div class="panel panel-success card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h1 class="panel-title txt-dark"><span class="label label-success font-weight-1000">LIST PENGAJUAN APPROVAL SEP</span>
            </h1>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Vclaim_bpjs/listPengajuanAproval'); ?>',
                "type": 'POST',
                "data": {
                    bulan: '<?= date('Y-m-d') ?>',
                },
    ...
    function tampilHariIni() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Vclaim_bpjs/listPengajuanAproval'); ?>',
                "type": 'POST',
                "data": {
                    bulan: '<?= date('Y-m-d') ?>',
                },
