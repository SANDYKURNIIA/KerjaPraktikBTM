    ...
    <div class="panel-wrapper collapse in">
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group col-md-9 has-success">
                            <input type="text" autocomplete="off" class="form-control" placeholder="" name="inTglSEP" id="inNoKartu" value="<?= $kartu ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label col-md-3">Spesialis / Sub Spesialis</label>
                        <div class="input-group col-md-9 has-success">
