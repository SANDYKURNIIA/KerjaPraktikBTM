...
<div class="panel panel-success card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-light">MONITORING KLAIM</h6>
        </div>
    ...
    <div class="row">
        ...
        <div class="row mt-30">
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    <label class="mt-0 txt-dark">Status Klaim : </label>
                    <select class="form-control select2" placeholder="Choose a Category" tabindex="1" name="inStatus" id="inStatus">
                        <option value="-">-</option>
...
<script type="text/javascript">
    function tampilRangePermit() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Vclaim_bpjs/getMonitoringKlaim'); ?>',
                "type": 'POST',
                "data": {
                    jenis: jenis,
                    tgl: tgl,
