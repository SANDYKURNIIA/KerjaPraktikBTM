                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group col-md-9 has-success">
                            ...
                            <!-- <span class="input-group-btn" style="width:0px;"></span> -->
                            <input type="text" autocomplete="off" class="form-control" name="inPoli" id="inPoli" placeholder="Maksimal 3 karakter" value="<?= ($jenis_pelayanan == "UGD" || $jenis_pelayanan == "UGD PONEK") ? "IGD | INSTALASI GAWAT DARURAT" : ""; ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 has-success">
                                <input type="text" class="form-control " placeholder="No LP" name="inNoLP" id="inNoLP">

                                <span class="danger-block" id="err_inNoLP"></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.metaData['code'] == 200) {
                        $('#inSKDP').val(data.data['noSuratKontrol']);
                        if (data.data['namaJnsKontrol'] == "Kontrol") {

                            $('#inPoli').val(data.data['poliTujuan'] + ' | ' + data.data['namaPoliTujuan']);
                            $('#inDiagnosa').val(data.data['sep']['diagnosa']);
                            $('#inAsal').val(data.data['sep']['provPerujuk']['asalRujukan']).change();
                            $('#inPPKAsal').val(data.data['sep']['provPerujuk']['kdProviderPerujuk'] + ' | ' + data.data['sep']['provPerujuk']['nmProviderPerujuk']);
                            $('#inTglRujuk').val(data.data['sep']['provPerujuk']['tglRujukan']).change();
                            getNoRujukan(data.data['sep']['noSep']);
                        }
                    } else {
                        swal({
                            title: "Gagal!",
        ...
        function getNoRujukan(no_sep) {
            if (no_sep != "") {
                $.ajax({
                    ...
                    success: function(data) {
                        $('#inNoRujuk').val(data.data['noRujukan']);
                    }
                });
            }
        }
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status == 'success') {
                    $('#inHakKelas').val(data.data['hakKelas']['kode']);
                    if (data.data['mr']['noTelepon'] == null) {
                        $('#inNoHp').val('12345678910');
                    } else {
