            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" action="<?php echo base_url('Kasir_poli/print_kasir_rajal') ?>" method="post" enctype="multipart/form-data" role="form" target="_blank">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row" style="margin-top: 20px;">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <button title="Cetak Selisih" class="btn btn-warning btn-anim btn-rounded mr-10" type="submit" name="action" value="cetak_selisih"><i class="icon-printer"></i><span class="btn-text">CETAK SELISIH</span></button>
                                        <br>
                                        <br>
...
<script type="text/javascript">
        ...
        var table = $('#tb_riwayat').DataTable({
            ...
            "ajax": {
                ...
                "data": function(data) {
                    ...
                    data.url = "Kasir_intan/print_riwayat_dp";
    ...
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Kasir/tampil_pasien_pulang_poli'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Kasir/Tampil_Range_pasienPulang_poli'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
