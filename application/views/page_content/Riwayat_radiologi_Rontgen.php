...
<div class="panel panel-default card-view">
	<div class="panel-heading">
		<div class="pull-left">
			<h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">RIWAYAT RADIOLOGI RONTGEN</span>
			</h6>
		</div>
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					$('#datable').DataTable({
						...
						"ajax": '<?php echo base_url('Radiologi/tampil_data_rontgen'); ?>',
						"deferRender": true,
						"processing": true,
						"order": [],
						"columnDefs": [{
				...
				// console.log(postData);
					$.ajax({
						type: 'POST',
						url: 'http://36.92.141.3/re-sibatik/Radiologi/postPindahData',
