...
<div class="panel panel-default card-view">
	<div class="panel-heading">
		<div class="pull-left">
			<h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">RIWAYAT RADIOLOGI USG</span>
			</h6>
		</div>
				...
				<div class="modal-body">
					...
					<div class="collapse" id="detailTindakan">
						...
						<div class="col-xs-7 text-center data-wrap-right" id="outRadiologi" style="display: none">
							...
							<strong>
								<font color="000000" size="5%" style="margin-left:10px"> EXPERTISE RIWAYAT RADIOLOGI</font>
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					$('#datable').DataTable({
						...
						"ajax": '<?php echo base_url('Radiologi/tampil_data_usg'); ?>',
						"deferRender": true,
						"processing": true,
						"order": [],
						"columnDefs": [{
				...
				// console.log(postData);
					$.ajax({
						type: 'POST',
						url: 'https://36.92.141.5/re-sibatik/Radiologi/postPindahData',
