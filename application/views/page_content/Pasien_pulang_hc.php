...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">PASIEN PULANG HOME CARE</span></h6>
        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" action="<?php echo base_url('Kasir/print_kasir_Hc') ?>" method="post" target="_blank" enctype="multipart/form-data" role="form">
...
<script type="text/javascript">
    function tampilTindakanFarmasi(id_mcu) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('Kasir/getDpDiscHc') ?>",
            dataType: "JSON",
            data: {
                id_mcu: id_mcu,
            },
    ...
    function kembali(id_pelayanan) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Kasir/update_pasien_balik_Hc",
                    method: "POST",
                    dataType: 'json',
                    data: {
    ...
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Kasir/tampil_pasien_pulang_Hc'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Kasir/tampil_pasien_pulang_Hc'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
