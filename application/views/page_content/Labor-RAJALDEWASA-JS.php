                ...
                success:function(data){
					...
					//DEWASA 
						if(data.nama == " Darah Rutin "){
							...
							$('#isiGGTDEWASA').collapse('hide');
							$('#isiFESESDEWASA').collapse('hide');
							$('#isiALBUMINDEWASA').collapse('hide');
							$('#isiBILIRUBINDEWASA').collapse('hide');
							...
							}else if(data.nama == "UREUM CREATININ"){
								// UREUM
							...
							}else if(data.nama == " GGT DGN ALAT "){
							// GGT DGN ALAT
								$("#inNamaGGTDEWASA").val(data.nama);
								$('#isiGGTDEWASA').collapse('toggle');
								$('#isiDENGUEDEWASA').collapse('hide');
								$('#isiPTAPTTDEWASA').collapse('hide');
								$('#isiPTDEWASA').collapse('hide');
								$('#isiCRPDEWASA').collapse('hide');
								...
								$('#isiDARAHDEWASA').collapse('hide');
								$('#isiALPDEWASA').collapse('hide');
								$("#id_tindakan_laborGGTDEWASA").val(data.id_tindakan_labor);
								$('#id_pelayanan_ggt_dewasa').val(data.id_pelayanan);
								$('#id_list_tindakan_ggt_dewasa').val(data.id_list_tindakan);
							}else if(data.nama == "ALP DGN ALAT"){
							// ALP
								$("#inNamaALPDEWASA").val(data.nama);
								$('#isiALPDEWASA').collapse('toggle');
								$('#isiGGTDEWASA').collapse('hide');
								$('#isiDENGUEDEWASA').collapse('hide');
								$('#isiPTAPTTDEWASA').collapse('hide');
								$('#isiPTDEWASA').collapse('hide');
								...
								$('#isiGOL-DARAHDEWASA').collapse('hide');
								$('#isiDARAHDEWASA').collapse('hide');
								$("#id_tindakan_laborALPDEWASA").val(data.id_tindakan_labor);
								$('#id_pelayanan_alp_dewasa').val(data.id_pelayanan);
								$('#id_list_tindakan_alp_dewasa').val(data.id_list_tindakan);
							}else if(data.nama == "BILIRUBIN DGN ALAT"){
							// BILIRUBIN
								$("#inNamaBILIRUBINDEWASA").val(data.nama);
								$('#isiBILIRUBINDEWASA').collapse('toggle');
								$('#isiALPDEWASA').collapse('hide');
								$('#isiGGTDEWASA').collapse('hide');
								$('#isiDENGUEDEWASA').collapse('hide');
								$('#isiPTAPTTDEWASA').collapse('hide');
								...
								$('#isiGOL-DARAHDEWASA').collapse('hide');
								$('#isiDARAHDEWASA').collapse('hide');
								$("#id_tindakan_laborBILIRUBINDEWASA").val(data.id_tindakan_labor);
								$('#id_pelayanan_bilirubin_dewasa').val(data.id_pelayanan);
								$('#id_list_tindakan_bilirubin_dewasa').val(data.id_list_tindakan);
						}else{
							swal({   
...
<!-- SUM GLOBULIN -->
	 ...
	 <script type="text/javascript">
		function	insert_bil_darah() {
		    ...
		    inJenisPasienDEWASA = $('#inMasukDEWASA').val();
			hb=$('#inHBDEWASA').val();
	...
	function insert_bil_b20() {
		...
		function insert_bil_ggt() {
		    Nama_tindakan = $('#inNamaGGTDEWASA').val();
		    id_tindakan_labor = $('#id_tindakan_laborGGTDEWASA').val();
			ggt=$('#inGGTDEWASA').val();
			inJenisPasienDEWASA = $('#inMasukDEWASA').val();
			swal({   
				title: "Apakah kamu yakin ingin !",
				...
				$().ready(function(){                                        
					$.ajax({  
						url : "<?php echo base_url() ?>Labor/insert_ggt_dewasa",
						method: "POST",
						dataType: 'json',
						data : {
						id_tindakan_labor:id_tindakan_labor,
		...
		function insert_bil_alp() {
		    Nama_tindakan = $('#inNamaALPDEWASA').val();
		    id_tindakan_labor = $('#id_tindakan_laborALPDEWASA').val();
			alp=$('#inALPDEWASA').val();
			inJenisPasienDEWASA = $('#inMasukDEWASA').val();
			swal({   
				title: "Apakah kamu yakin ingin !",
				...
				$().ready(function(){                                        
					$.ajax({  
						url : "<?php echo base_url() ?>Labor/insert_alp_dewasa",
						method: "POST",
						dataType: 'json',
						data : {
						id_tindakan_labor:id_tindakan_labor,
		...
		function insert_bil_bilirubin() {
		    Nama_tindakan = $('#inNamaBILIRUBINDEWASA').val();
		    id_tindakan_labor = $('#id_tindakan_laborBILIRUBINDEWASA').val();
			bilirubin560=$('#inBILIRUBIN560DEWASA').val();
			bilirubin6090=$('#inBILIRUBIN6090DEWASA').val();
			inJenisPasienDEWASA = $('#inMasukDEWASA').val();
			swal({   
				title: "Apakah kamu yakin ingin !",
				text: "Menyimpan Data " + Nama_tindakan + " ini?",
				...
				$().ready(function(){                                        
					$.ajax({  
						url : "<?php echo base_url() ?>Labor/insert_bilirubin_dewasa",
						method: "POST",
						dataType: 'json',
						data : {
						id_tindakan_labor:id_tindakan_labor,
						bilirubin560:bilirubin560,
						bilirubin6090:bilirubin6090,
						inJenisPasienDEWASA:inJenisPasienDEWASA,
						},
						success: function(data){
						if(data.status=="success"){
