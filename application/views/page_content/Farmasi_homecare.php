...
<div class="panel panel-default card-view mt-20 ">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">PASIEN HOMECARE</span></h6>
        </div>
...
<script type="text/javascript">
    ...
    function cetakSigna1() {
        id_resep = $('#inResObat').val();
        id_his = $('#inHisResep').val();
        window.open('<?= base_url('Homecare/') ?>' + 'cetak_signa/' + id_resep + '/' + id_his);
    }
    ...
    function cetak() {
        id_resep = $('#inResObat').val();
        id_his = $('#inHisResep').val();
        window.open('<?= base_url('Homecare/') ?>' + 'print_struk_obat/' + id_resep + '/' + id_his);
    ...
    function cetak_resep() {
        id_resep = $('#inResObat').val();
        id_his = $('#inHisResep').val();
        window.open('<?= base_url('Homecare/') ?>' + 'print_resep/' + id_resep + '/' + id_his);
    }

    function copy_resep() {
        id_resep = $('#inResObat').val();
        id_his = $('#inHisResep').val();
        window.open('<?= base_url('Homecare/') ?>' + 'print_copy_resep/' + id_resep + '/' + id_his);
    }

    function cetak_resep_kronis() {
        id_resep = $('#inResObat').val();
        id_his = $('#inHisResep').val();
        window.open('<?= base_url('Homecare/') ?>' + 'print_resep_kronis/' + id_resep + '/' + id_his);
    }

    function cetak_Layout() {
        id_resep = $('#inResObat').val();
        id_his = $('#inHisResep').val();
        window.open('<?= base_url('Homecare/') ?>' + 'print_layout/' + id_resep + '/' + id_his);
    }
    ...
    function reload_data_resep(id_pelayanan, id_history) {
        ...
        $('#tableresep').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Homecare/tampil_resep_farmasi'); ?>',
                "type": 'POST',
                "data": {
                    id_pelayanan: id_pelayanan,
                    id_history: id_history
    ...
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Apotik_poli/tampil_homecare'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Apotik_poli/tampil_homecare'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
