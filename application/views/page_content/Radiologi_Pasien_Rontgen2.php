...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">PASIEN RONTGEN</span>
            </h6>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-9 has-error">
                                                <input type="text" class="form-control" name="inNama" disabled
                                                    id="inNama">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-9 has-error">
                                                <input type="text" class="form-control" name="inJumlah" id="inJumlah"
                                                    disabled>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-9 has-error">
                                                <input type="text" class="form-control" name="inBiaya" disabled
                                                    id="inBiaya">
                                                <input type="hidden" class="form-control" disabled id="idPelayanan"
                                                    name="idPelayanan">
                                                <input type="hidden" class="form-control" disabled
                                                    id="id_tindakan_radiologi" name="id_tindakan_radiologi">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-9 has-success">
                                                <select class="form-control filled-input select2" name="inDPJP"
                                                    placeholder="PILIH NAMA DOKTER"
                                                    style="border: 1px solid lightgreen;" tabindex="1" id="inDPJP">
                                                    <option value="-">-</option>
                                                    <?php
                                        ...
                                        <div class="panel-body" style="margin-left:-1em;">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control"
                                                                placeholder=" NO SEP ... ." disabled id="no_sep">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6" id="myColElement">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" disabled id="kesimpulan"
                                                            value="-">
                                                        <span class="help-block"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="panel panel-default card-view">
                                                            ...
                                                            <div class="panel-wrapper collapse in">
                                                                <div class="panel-body">
                                                                    <div> <textarea class="textarea"
                                                                            id="hasil_pemeriksaan"
                                                                            style="width: 100%; height: 300px; color: black;"> </textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-md-8" style="margin-top:0em;">
                                                <div class="form-group pull-right" style="margin-right:20px;">
                                                    <button type="button" data-dismiss="modal"
                                                        onclick="insert_radiologi2()"
                                                        class="btn btn-success btn-anim  btn-sm ml-20 mt-5"><i
                                                            class="icon-rocket"></i><span
                                                            class="btn-text">SIMPAN</span></button>
                                                    <button onclick="reset_form()"
                                                        class="btn btn-default btn-anim  btn-sm ml-20 mt-5"><i
                                                            class="icon-trash"></i><span class="btn-text">CLEAR
                                                            FORM</span></button>
                                                </div>
                                            </div>
                        ...
                        <div class="form-wrap">
                            ...
                            <div class="form-body mt-10">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-9 has-success" onchange="pilihTindakanRadiologi()">
                                                <select class="form-control filled-input select2"
                                                    style="border: 1px solid lightgreen;" tabindex="1"
                                                    name="inTindakanRadiologi" id="inTindakanRadiologi">
                                                    <option value="-">-</option>
                                                    <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label class="control-label col-md-3">JUMLAH TINDAKAN</label>
                                            <div class="col-md-9 has-error">
                                                <input type="text" class="form-control " id="outJumlahRadiologi"
                                                    disabled placeholder="jumlah">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 has-success">
                                                <textarea class="form-control" id="outKet" name="outKet" rows="13"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <button onclick="update_radiologi()"
                                                class="btn btn-success btn-anim  btn-sm ml-20 mt-5"><i
                                                    class="icon-rocket"></i><span class="btn-text">SIMPAN
                                                    PERUBAHAN</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xs-7 text-center data-wrap-right" id="outRadiologi" style="display: none">
                            ...
                            <table class="table table-hover display pb-60">
                                <tr>
                                    <td style="border-top: none !important;"><img
                                            src="<?php base_url(); ?>../assets/logo-rsbt.png"></td>
                            ...
                            <table class="table pb-0" style="margin-top:10px">
                                <tbody style="color: black;">
                                    ...
                                    <tr>
                                        <td style="font-size:12px; width:10%; padding:10px; border:0px">NAMA PEMERIKSAAN
                                        </td>
                                        <td style="font-size:12px; padding:10px; border:0px">: &nbsp;
                                            <font id="namaa" />
                                        </td>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td style="border-top: none; "><img
                                            style="margin-left:40px; margin-top:-2em; margin-bottom:-4em;"
                                            src="<?php base_url(); ?>../assets/ttd-rad.png"></td>
                                </tr>
                                <tr>
                                    <td style="width: 55%; border-top: none"></td>
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    $('#datable').DataTable({
                        ...
                        "ajax": '<?php echo base_url('Radiologi/tampil_data_rontgen2'); ?>',
                        "deferRender": true,
                        "processing": true,
                        "order": [],
                        "columnDefs": [{
                ...
                //                 const formattedDate = tglLahir.toLocaleDateString('id-ID', options);
