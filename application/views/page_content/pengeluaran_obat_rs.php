<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="span span-success">PENGELUARAN OBAT RUMAH SAKIT</span></h6>
        </div>
...
<script type="text/javascript">
    function insertFaktur() {
        ...
        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Pengeluaran_obat_rs/insertFaktur",
                method: "POST",
                dataType: 'json',
                data: dataString,
                success: function(data) {
    ...
    function hapus_faktur(id_faktur) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Pengeluaran_obat_rs/hapus_faktur_po",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_faktur: id_faktur,
    ...
    function insertObatFaktur() {
        ...
        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Pengeluaran_obat_rs/insertObatFaktur",
                method: "POST",
                dataType: 'json',
                data: dataString,
                success: function(data) {
    ...
    function reload_isi_list_faktur(idFaktur) {
        ...
        $('#isiFaktur1').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Pengeluaran_obat_rs/tampil_list_faktur'); ?>',
                "type": 'POST',
                "data": {
                    idFaktur: idFaktur
                },
    ...
    function hapus_list_faktur(id_detail) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Pengeluaran_obat_rs/hapus_list_faktur",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_detail: id_detail,
    ...
    function reload_list_faktur(idFaktur) {
        ...
        $('#isiFaktur').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Pengeluaran_obat_rs/tampil_obat'); ?>',
                "type": 'POST',
                "data": {
                    idFaktur: idFaktur
                },
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Pengeluaran_obat_rs/tampil_data'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePo(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Pengeluaran_obat_rs/tampil_range'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
