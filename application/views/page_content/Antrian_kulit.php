                ...
                <div class="row ">
                    <div class="col-sm-13">
                        <div class="panel panel-default card-view pb-0">
                            <div class="btn btn-success btn-icon-anim btn-circle" onClick="window.location.reload();"><i class="icon-refresh"></i></div>
                            <div class="col-md-1">
                                ...
                                <input type="hidden" id="no_antrian" value="<?php $in = 'k';
                                                                            $no = $antrian_data['no_antri'];
                                                                            echo ($in . $no); ?>" disabled>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tabledata').DataTable({
            ...
            "ajax": '<?php echo base_url('Poli_kulit/tampilAntrian'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function skip_data(id_antrian) {
        $.ajax({
            url: "<?= base_url() ?>Poli_kulit/updateskip",
            method: 'POST',
            dataType: 'json',
            data: {
    ...
    function nextAntrian() {
        ...
        $.ajax({
            url: "<?= base_url() ?>Poli_kulit/updatenext",
            method: "POST",
            dataType: 'json',
            data: {
                id_antrian: id_antrian,
    ...
    function playSuara(no_antri, nama) {
        $nomor = "k" + no_antri;
        $.ajax({
            url: "<?= base_url() ?>Poli_kulit/playSuara",
            method: "POST",
            dataType: 'json',
            data: {
                nomor: $nomor,
