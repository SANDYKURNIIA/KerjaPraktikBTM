<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="span span-success">LIST OBAT PR</span></h6>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-body mt-20">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label col-md-3">Tanggal PR</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label col-md-3">PILIH PE- RENCANAAN</label>
                                    <div class="col-md-9 has-success">
                                        <select class="form-control filled-input select2" style="border: 1px solid lightgreen;" tabindex="1" name="inPR" id="inPR">
...
<div class="panel-wrapper collapse in">
    <div class="panel-body">
        <!-- sample modal content -->
        <div class="modal fade " id="modalTambahObatFaktur" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;padding-right: 16px;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
...
<script type="text/javascript">
    function insertFaktur() {
        ...
        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Permintaan_pembelian/insertFaktur",
                method: "POST",
                dataType: 'json',
                data: dataString,
    ...
    function hapus_faktur(id_faktur) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Permintaan_pembelian/hapus_faktur",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_faktur: id_faktur,
    ...
    function reload_total_harga(id_faktur) {
        ...
        $('#outTotalHarga').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Permintaan_pembelian/tampil_total_harga'); ?>',
                "type": 'POST',
                "data": {
                    idFaktur: id_faktur
                },
    ...
    function insertObatFaktur() {
        ...
        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Permintaan_pembelian/insertObatFaktur",
                method: "POST",
                dataType: 'json',
                data: dataString,
                success: function(data) {
    ...
    function hapus_list_faktur(id_detail) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Permintaan_pembelian/hapus_list_faktur",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_detail: id_detail,
    ...
    function pilih_list_faktur(id_detail, id_struk) {
        $.ajax({
            url: "<?= base_url() . 'Permintaan_pembelian/getDataListFaktur' ?>",
            data: {
                id_detail: id_detail,
            },
            type: 'POST',
    ...
    function insertObatFaktur1() {
        ...
        if (tglExp == "") {
            ...
            $.ajax({
                type: "POST",
                url: "Permintaan_pembelian/insertObatFaktur1",
                dataType: 'json',
                data: {
                    idFaktur: id_faktur,
                    id_detail: id_detail,
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Permintaan_pembelian/tampil_data'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePo(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Permintaan_pembelian/tampil_rangePo'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
...
<script type="text/javascript">
    function myFunction() {
        ...
        if (no_faktur != '') {
            $.ajax({
                url: "<?php echo base_url(); ?>Permintaan_pembelian/check_noFaktur",
                method: "POST",
                data: {
                    no_faktur: no_faktur
                },
