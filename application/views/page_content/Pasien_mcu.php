                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-wrap">
                                                        <div class="form-body">
                                                            <div class="modal-body">
                                                                <form class="form-horizontal" action="<?php echo base_url('Kasir/print_kasir_mcu') ?>" method="post" target="_blank" enctype="multipart/form-data" role="form">
                                                                        ...
                                                                        <div class="row">
                                                                            <div>
                                                                                <center> <button class="btn btn-info btn-rounded mr-10" type="submit" name="action" value="cetakdanpulang"></i><span class="btn-text">CETAK DAN PULANG</span></button>
                                                                                    <button title="Simpan Total Bayar" onclick="simpanDetailKasir()" class="btn btn-primary btn-anim btn-rounded mr-10" type="button"><i class="icon-cloud-download"></i><span class="btn-text">SIMPAN</span></button>
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status_dt == 'found') {
                    ...
                    $('#totalkeseluruhan1').val(convertToRupiah(data.total-data.diskon));
                    $('#totalkeseluruhan').val(data.total-data.diskon);
                    $('#totalbayar').val(data.total-data.diskon);
                } else {
                    $('#inDiskon').val(0);
                    $('#inDp').val(0);
                ...
                if (data.cara_bayar != 42) {
                    $('#opsi_bayar').val('asuransi').change();
                    $("#opsi_bayar").prop("disabled", true);
                } else {
    ...
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Kasir/tampil_pasien_mcu'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
...
<script type="text/javascript">
    function simpanDetailKasir() {
        ...
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Kasir/insert_pembayaran_mcu",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_pelayanan: id_mcu,
