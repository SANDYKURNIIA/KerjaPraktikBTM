...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">PASIEN RAWAT JALAN POLI </span></h6>
        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12 mt-10">
                                                                                <div class="form-group pull-right pr-15">
                                                                                    ...
                                                                                    <button class="btn btn-success btn-anim  btn-sm btn-rounded" type="submit" name="action" value="pulang"><i class="icon-rocket"></i><span class="btn-text">CETAK DAN PULANG</span></button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status_dt == 'found') {
                    ...
                    $('#inDp').val(data.dp);
                    $('#inTglKeluar').val(data.tanggal_keluar).change();
                } else {
                    $("#modal_edit_kasir").modal('show');
                    $('#btnbayar').hide();
    ...
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Kasir/tampil_pasien_rajal'); ?>',
                "type": 'POST',
