    ...
    <div class="col-sm-12">
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                <div class="pull-left">
                    <h6 class="panel-title txt-dark">STOK OBAT APOTIK</h6>
                </div>
                <div align="right">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label class="control-label col-md-3">NAMA OBAT</label>
                                            <div class="col-md-9 has-success">
                                                <select class="form-control filled-input select2" id="inLogistik1" onchange="tampilStok(this) ">
                                                    <option value="-">-</option>
                                                    <?php
...
<script type="text/javascript">
    ...
    function tambah_stok() {
        ...
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: "<?php echo base_url('Apotik/tambah_stok_apotik'); ?>",
            data: {
...
<script type="text/javascript">
    function detail_stok(id_logistik) {
        ...
        $('#datablestok').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Apotik/tampil_detail_stok'); ?>',
                "type": 'POST',
                "data": {
                    id_logistik: id_logistik
                },
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#inLogistik1').change(function() {
            ...
            if (obat != '') {
                $.ajax({
                    url: "<?php echo base_url(); ?>Apotik/getExpStokApotik",
                    method: "POST",
                    data: {
                        obat: obat
                    },
        ...
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Apotik/tampil_stok_obat_apotik'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
