		...
		<div class="modal fade" id="modal_edit_kasir" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" action="<?php echo base_url('Kasir/print_kasir_ranap') ?>" method="post" novalidate enctype="multipart/form-data" role="form" target="_blank">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group ">
											...
											<div class="col-md-9">
												<input type="number" class="form-control rounded-input" autocomplete="off" placeholder="jumlah" id="inDp" name="inDp" readonly>
												<span class="help-block"></span>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group ">
											...
											<div class="col-md-9">
												<input type="number" class="form-control rounded-input" autocomplete="off" placeholder="jumlah" id="inSelisih" name="inSelisih" value="0" oninput="tampilHarga()">
												<span class="help-block"></span>
											</div>
										</div>
									</div>
							...
							<div class="row">
								<center>
									<button class="btn btn-danger btn-anim  btn-rounded mr-10" id="checkout" style="display: block;" type="submit" name="action" value="pulang"><i class="icon-logout"></i><span class="btn-text">CHECKOUT</span></button>
									<button class="btn btn-danger btn-anim  btn-rounded mr-10" id="checkout_1" style="display: none;" onclick="error()" type="button"><i class="icon-logout"></i><span class="btn-text">CHECKOUT!</span></button>

									<button class="btn btn-warning btn-anim btn-rounded mr-10" type="submit" name="action" value="cetak_penata"><i class="icon-printer"></i><span class="btn-text">CETAK</span></button>
									<button class="btn btn-info btn-anim btn-rounded mr-10" type="submit" name="action" value="cetak_selisih"><i class="icon-printer"></i><span class="btn-text">CETAK SELISIH</span></button>
								</center>
...
<script type="text/javascript">
	function tampilHarga() {
		...
		totalakhir = totalawal - selisih - diskon_konsul - diskon_tindakan - diskon_labor - diskon_radio;
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#datable').DataTable({
			...
			"ajax": '<?php echo base_url('Apelkes/tampil_data_apelkes'); ?>',
			"deferRender": true,
			"processing": true,
			"order": [],
			"columnDefs": [{
