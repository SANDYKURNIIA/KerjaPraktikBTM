                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 has-error">
                                                    <input type="number" class="form-control " disabled="" id="outStok">
                                                    <span class="help-block"> </span>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    function inputJumlah() {
        ...
        jml_req = parseFloat($("#inJumlahPermintaan").val());
    ...
    function terima() {
        ...
        $.ajax({
            method: "POST",
            dataType: 'json',
            url: "<?php echo base_url() ?>Logistik_farmasi/updateTerimaStokLogistik",
            data: {
    ...
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Logistik_farmasi/Tampil_riwayat_permintaan'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Logistik_farmasi/Tampil_riwayat_permintaan'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
    ...
    function reload_data_tindakan(id_req) {
        ...
        $('#tabletindakan').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Logistik_farmasi/Tampil_list_riwayat_permintaan_obat'); ?>',
                "type": 'POST',
                "data": {
                    id_req: id_req
                },
