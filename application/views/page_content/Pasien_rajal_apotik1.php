                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <label class="control-label col-md-3">NAMA OBAT</label>
                                        <div class="col-md-9 has-success">
                                            <input type="text" class="form-control " id="inObat2" disabled="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-md-9 has-success">
                                            <input type="number" class="form-control " id="inStok" placeholder="jumlah" disabled>
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function edit_obat(id, id_resep) {
        $.ajax({
    ...
    function edit_obat1(id, id_resep, stok) {
        $.ajax({
            url: "<?= base_url() . 'Apotik/getDataObatKronis' ?>",
            method: "POST",
            dataType: 'json',
            data: {
                id_tindakan: id
            ...
            success: function(data) {
                if (data.status_dt == "found") {
                    ...
                    $('#inObat2').val(data.nama);
                    $('#inSigna2').val(data.id_signa).change();
                    $('#inTglExp2').val(data.kadaluarsa);
                    $("#inJumlahObat2").val(data.frek);
                    harga = Number(data.total) / Number(data.frek);
                    $("#outTotalObat2").val(data.total);
                    $("#hargaCost1").val(harga);
                    $("#idTindakan1").val(id);
