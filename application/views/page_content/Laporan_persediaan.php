            ...
            <div class="row mt-30">
                <div class="col-md-12">
                    ...
                    <div class="col-md-3 mt-20">
                        <button class="btn btn-info btn-anim btn-sm1" onclick="kunci_so();"><i class="icon-rocket"></i><span class="btn-text">STOK OPNAME</span>
...
<script type="text/javascript">
    ...
    function kunci_so() {
        ...
        periode = $('#inBulan').val();
        swal({
            title: "Apakah kamu yakin ingin simpan Stok Opname?",
            text: "",
            type: "warning",
            ...
            if (isConfirm) {
                $.ajax({
                    url: "<?php echo base_url() ?>Laporan_farmasi/kunci_so",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        periode: periode,
                    ...
                    success: function(data) {
                        if (data.status == "success") {
                            ...
                            swal({
                                title: "good job!",
                                type: "success",
                                text: "Laporan Stok Opname Berhasil Disimpan",
                                confirmButtonColor: "#3cb878",
                            });
