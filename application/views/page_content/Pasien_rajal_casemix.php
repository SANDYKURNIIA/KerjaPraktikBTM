...
<div class="panel panel-default card-view">
    ...
    <?php $this->load->view('page_content/Modal_rajal_casemix') ?>
    ...
    <script type="text/javascript">
        ...
        function tampilTindakanFarmasi(id_pelayanan, id_history) {
            $.ajax({
                url: "<?= base_url() . 'Casemix/getDataPasienRajal' ?>",
                data: {
                ...
                success: function(data) {
                    if (data.status_dt == "found") {
                        $("#inJenisPel").val(data.rajal['jenis_pelayanan']);
                        $("#inPoli").val(data.rajal['poli']);
                        $("#inCaraPulang").val(data.rajal['cara_keluar']);
                        $("#inNoBpjs").val(data.rajal['no_bpjs']);
                        $("#inDPJP").val(data.rajal['nama_dokter']);
                        $("#inTglMasuk").val(data.rajal['tgl_masuk']);
                        $("#inTglKeluar").val(data.rajal['tgl_keluar']);
                        $("#inTglLahir").val(data.rajal['tgl_lahir']);
                        $("#inNoRm").val(data.rajal['no_rm']);
                        $("#inNama").val(data.rajal['nama']);
                        $("#inSEP").val(data.rajal['no_sep']);
                        $("#inCaraBayar").val(data.rajal['cara_bayar']);
                        $("#inGender").val(data.rajal['jenis_kelamin']);
        ...
        $(document).ready(function() {
            $('#datable').DataTable({
                ...
                "ajax": '<?php echo base_url('Casemix/Tampil_pasien_rajal'); ?>',
                "deferRender": true,
                "processing": true,
                "order": [],
                "columnDefs": [{
