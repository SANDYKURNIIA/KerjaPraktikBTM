<div class="panel panel-default card-view">
	<div class="panel-heading">
		<div class="pull-left">
			<h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">RIWAYAT ERM RANAP</span></h6>
		</div>
		...
		<div class="row mt-30">
			<div class="col-md-12">
				...
				<div class="col-md-2">
					<label class="mt-0 txt-dark">TIPE MASUK :</label>
					<select class="form-control select2" placeholder="Choose a Category" name="tipe" id="tipe">
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#datable').DataTable({
			...
			"ajax": {
				"url": '<?= base_url('Erm_ranap/tampil_erm_ranap'); ?>',
				"type": 'POST',
				"data": {
					tipe: 'today',
				},
