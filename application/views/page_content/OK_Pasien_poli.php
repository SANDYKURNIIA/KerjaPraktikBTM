                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-9 has-success">
                                        <select class="form-control filled-input select2" id="inObat" onchange="setHarga()">
                                            ...
                                            ?>
                                                <option value="<?php echo $row["id_logistik"] . '|' . $harga . '|' . $row["margin"] . '|' . $row["kadaluarsa"] . '|' . $stok; ?>"><?php echo $row["nama"]; ?></option>
                                            <?php
                                            }
                                            ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('OK_Pasien/tampil_pasien_poli'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
