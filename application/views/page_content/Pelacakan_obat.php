...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">PELACAKAN OBAT</span></h6>
        </div>
                    ...
                    <table id="datable" class="table table-hover display pb-30" width="100%">
                        <thead>
                            <tr class="bg-success">
                                ...
                                <th>TGL. USULAN</th>
                                <th>STATUS PR</th>
                                <th>TGL. ACC PR KA INSTALASI</th>
                                <th>TGL. ACC PR DIREKTUR</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Pelacakan_obat/Tampil_Rangepelacakan'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Pelacakan_obat/Tampil_Rangepelacakan'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
