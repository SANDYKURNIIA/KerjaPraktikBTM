...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN PENUNJANG </span></h6>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2 has-success">
                        <select class="form-control select2" placeholder="Choose a Category" name="jenis_pelayanan" id="jenis_pelayanan">
                            <option value="-">-</option>
                            <option value="LABRANAP">LABOR RANAP</option>
                            <option value="LABRAJAL">LABOR RAJAL</option>
                            <option value="RADRANAP">RADIOLOGI RANAP</option>
                            <option value="RADRAJAL">RADIOLOGI RAJAL</option>
                            <option value="HEMO">HEMODIALISA</option>
                            <option value="FISIORAJAL">FISIO RAJAL</option>
                            <option value="FISIORANAP">FISIO RANAP</option>
                            <option value="OKRANAP">OK RANAP</option>
                            <option value="OKRAJAL">OK RAJAL</option>
                            <!-- <option value="RESEPFRI">RESEP FRI</option>
                            <option value="RESEPFRJ">RESEP FRJ</option> -->
                        </select>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    //             },
    //         },
    //         "ajax": '<?php echo base_url('Laporan/Tampil_Range_penunjangOp'); ?>',
    //         "deferRender": true,
    //         "processing": true,
    //         "order": [],
    //         "columnDefs": [{
    ...
    function tampilRangePermit() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Laporan/Tampil_Range_penunjangOp'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir,
