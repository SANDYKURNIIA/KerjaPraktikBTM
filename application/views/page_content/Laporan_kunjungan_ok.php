...
<div class="panel panel-default card-view">
	<div class="panel-heading">
		<div class="pull-left">
			<h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN KUNJUNGAN OK</span></h6>
		</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#datable').DataTable({
			...
			"ajax": {
				"url": '<?= base_url('OK_laporan_dokter/tampil_kunjungan'); ?>',
				"type": 'POST',
				"data": {
					tipe: 'today',
				},
