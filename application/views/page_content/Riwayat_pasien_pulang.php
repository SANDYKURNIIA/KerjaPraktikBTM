...
<script type="text/javascript">
    ...
    function tampilTindakanFarmasi(id_pelayanan, id_history, id_resep, jenis_pel) {
    ...
    function reload_data_tindakan(id_pelayanan) {
        ...
        $('#tabletindakan').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Apotik/tampil_tindakan_riwayat_pulang'); ?>',
                "type": 'POST',
                "data": {
                    id_pelayanan: id_pelayanan
                },
    ...
    //     id_pelayanan=$("#inPel").val();
    //     id_history=$("#inHis").val();
    //     window.open ('<?= base_url('Apotik/') ?>'+ 'print_riwayat_pulang/' + id_pelayanan +'/'+id_history);
    // }
    // function cetak_resep() {
    //     id_pelayanan=$("#inPel").val();
    //     id_history=$("#inHis").val();

    //     window.open ('<?= base_url('Apotik/') ?>'+ 'print_resep_riwayat_pulang/'+ id_pelayanan +'/'+id_history);
    // }
    function cetak() {
        id_resep = $('#inResObat').val();
        id_his = $('#inHis').val();
    ...
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Apotik/Tampil_riwayat_pasien_pulang'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Apotik/Tampil_riwayat_pasien_pulang'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
