...
<div class="panel panel-default card-view">
	<div class="panel-heading">
		<div class="pull-left">
			<h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN TINDAKAN RADIOLOGI</span></h6>
		</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#datable').DataTable({
			...
			"ajax": '<?php echo base_url('Radiologi/tampil_laporan_tindakan'); ?>',
			"deferRender": true,
			"processing": true,
			"order": [],
			"columnDefs": [{
	...
	function tampilRange() {
		...
		$('#datable').DataTable({
			...
			"ajax": {
				"url": '<?= base_url('Radiologi/tampil_range_tindakan_laporan'); ?>',
				"type": 'POST',
				"data": {
					mulai: mulai,
					akhir: akhir
