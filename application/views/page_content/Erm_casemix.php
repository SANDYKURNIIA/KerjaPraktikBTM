...
<div class="panel panel-default card-view">
	<div class="panel-heading">
		<div class="pull-left">
			<h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">ERM</span></h6>
		</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#datable').DataTable({
			...
			"ajax": {
				"url": '<?= base_url('Casemix/tampil_erm'); ?>',
				"type": 'POST',
				"data": {
					tipe: 'today',
				},
	...
	// window.location.href = "<?php echo base_url('Erm_igd_edit/print_resume_medis/') ?>" + id ;
	// }
	// End
</script>