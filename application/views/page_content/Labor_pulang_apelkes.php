...
<div class="panel panel-default card-view">
	<div class="panel-heading">
		<div class="pull-left">
			<h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">PASIEN PULANG LABOR</span></h6>
		</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#datable').DataTable({
			...
			"ajax": {
				"url": '<?= base_url('apelkes/tampil_dataranap_pulang'); ?>',
				"type": 'POST',
				"data": {
					tipe: 'today',
	...
	function tampilHariIni() {
		...
		$('#datable').DataTable({
			...
			"ajax": '<?php echo base_url('apelkes/tampil_dataranap_pulang'); ?>',
			"deferRender": true,
			"processing": true,
			"order": [],
			"columnDefs": [{
