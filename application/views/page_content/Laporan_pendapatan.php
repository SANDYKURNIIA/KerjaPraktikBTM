...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN PENDAPATAN</span></h6>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Laporan_pendapatan/Tampil_laporan_pasien'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir, jenis_pelayanan) {
        $('#datable').DataTable().destroy();
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Laporan_pendapatan/Tampil_Rangelaporan_pasien'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir,
