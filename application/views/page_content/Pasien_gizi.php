			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="pull-left">
							<h6 class="panel-title txt-dark">DATA PASIEN GIZI</h6>
						</div>
						<div class="clearfix"></div>
						<h5 class="modal-title mt-10" id="myLargeModalLabel"><i class="ti-layout-media-right-alt mr-10"></i> FORM DIET
						</h5>
					</div>
					<div class="modal-body">
						<div class="form-body">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" readonly class="form-control" placeholder="NOMOR RM" name="no_rm" id="no_rm">
										</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" readonly class="form-control" placeholder="NAMA" name="nama" id="nama">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label mb-10 text-left">TANGGAL LAHIR</label>
											<input type="text" readonly class="form-control" placeholder="TANGGAL LAHIR" name="tgl_lahir" id="tgl_lahir">
										</div>

									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label mb-10 text-left">RUANGAN</label>
											<input type="text" readonly class="form-control" placeholder="JENIS TINDAKAN" name="poli" id="poli">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label mb-10 text-left">DIET</label>
											<input type="text" class="form-control" placeholder="DIET" name="diet" id="diet">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label mb-10 text-left">WAKTU</label>
											<input type="time" class="form-control" name="waktu" id="waktu" value="12:00">
										</div>
									</div>

								<div class="form-group">
									<input type="hidden" class="form-control" id="inPelAntri">
									<div type="submit" class="btn btn-success mr-10" onclick="insert_data()">SIMPAN
									</div>
								</div>
							...
							<form id="formAntrian">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label mb-10 text-left">Waktu</label>
											<input type="time" class="form-control" name="waktu" id="up_waktu"value="12:00">
										</div>
									</div>
								<div class="form-group">
									<input type="hidden" class="form-control" id="inPelAntri">
...
<script type="text/javascript">
	...
	function reload_data_diet(id_pelayanan) {
		...
		$('#tabletindakan').DataTable({
			...
			"ajax": {
				"url": '<?php echo base_url('Rawatinap/tampil_data_diet'); ?>',
				"type": 'POST',
				"data": {
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$('#datable').DataTable({
			...
			"ajax": '<?php echo base_url('Rawatinap/tampil_data_gizi'); ?>',
			"deferRender": true,
			"processing": true,
			"order": [],
			"columnDefs": [{
