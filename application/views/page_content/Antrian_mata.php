                    ...
                    <div class="col-sm-13">
                        <div class="panel panel-default card-view pb-0">
                            ...
                            <div class="col-md-1">
                                ...
                                <input type="hidden" id="no_antrian" value="<?php $in = 'm';
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tabledata').DataTable({
            ...
            "ajax": '<?php echo base_url('Poli_mata/tampilAntrian'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function skip_data(id_antrian) {
        $.ajax({
            url: "<?= base_url() ?>Poli_mata/updateskip",
            method: 'POST',
            dataType: 'json',
            data: {
    ...
    function nextAntrian() {
        ...
        $.ajax({
            url: "<?= base_url() ?>Poli_mata/updatenext",
            method: "POST",
            dataType: 'json',
            data: {
                id_antrian: id_antrian,
    ...
    function playSuara(no_antri, nama) {
        $nomor = "m" + no_antri;
        $.ajax({
            url: "<?= base_url() ?>Poli_mata/playSuara",
            method: "POST",
            dataType: 'json',
            data: {
                nomor: $nomor,
