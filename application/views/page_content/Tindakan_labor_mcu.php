...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="span span-success">TINDAKAN LABOR MCU</span></h6>
        </div>
...
<div class="panel-wrapper collapse in">
    ...
    <div class="modal fade bs-example-modal-lg" id="modal_edit_labor_mcu" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
...
<script type="text/javascript">
    function up_tindakan_mcu() {
		...
		$.ajax({
			url: "<?= base_url() . 'mcu/insert_tindakan_labor_mcu' ?>",
			method: "POST",
			dataType: 'json',
			cache: true,
			data: {
    ...
    function edit_labor_mcu(id_daftar_tindakan){
            $.ajax({
                url: "<?php echo base_url() ?>mcu/getDataLaborMcu",
                data: {
                ...
                success: function(data) {
                    if (data.status_dt == "found") {
                        ...
                        $("#modal_edit_labor_mcu").modal('show');
                    } else {
        ...
        function updateTindakan(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>mcu/edit_labor_mcu",
                dataType: 'json',
                data: {
                    id: id,
                    nama: nama,
                ...
                success: function(data) {
                    if (data.status == "success") {
                        ...
                        $("#modal_edit_labor_mcu").modal('hide');
                        $('#datable').DataTable().ajax.reload();
                    } else {
                        swal({
                            title: "Gagal!",
    ...
    $(document).ready(function () {
                ...
                $('#datable').DataTable({
                        ...
                        "sLast":     "Terakhir"
                            ...
                            "ajax": '<?php echo base_url('mcu/tampil_Tindakan_labor_mcu'); ?>',    
                            "deferRender": true,
                            "processing": true,
                            "order": [], 
                            "columnDefs": [
