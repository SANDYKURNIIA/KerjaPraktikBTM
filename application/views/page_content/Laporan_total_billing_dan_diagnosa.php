...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN TOTAL BILLING DAN DIAGNOSA</span></h6>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('laporan_total_billing_dan_diagnosa/tampil_data_laporan_total_billing_dan_diagnosa'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('laporan_total_billing_dan_diagnosa/tampil_data_laporan_total_billing_dan_diagnosa'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
