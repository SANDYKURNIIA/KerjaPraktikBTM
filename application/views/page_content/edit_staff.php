	...
	<div class="panel panel-default card-view mt-20">
	    <div class="panel-heading">
	        <div class="pull-left">
	            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">DATA STAFF</span>
	            </h6>
	            ...
	            <div class="modal-dialog modal-lg">
	                <div class="modal-content">
	                    <div class="modal-header">
	                        ...
	                        <h5 class="modal-title mt-10" id="myLargeModalLabel"><i class="icon-user mr-10"></i> AKUN STAFF</h5>
	                    </div>
	                    <div class="modal-body">
	                        ...
	                        <div class="form-body mt-20">
	                            <div class="row">
	                                ...
	                                <div class="col-md-6">
	                                    <div class="form-group">
	                                        ...
	                                        <div class="col-md-9 has-success">
	                                            <input type="text" autocomplete="off" class="form-control" id="password" placeholder="PASSWORD" required>
	                                            <span class="help-block"> </span>
	                            ...
	                            <div class="row mb-30">
	                                ...
	                                <div class="col-md-6">
	                                    <div class="form-group">
	                                        <label class="control-label col-md-3">IZIN AKSES</label>
	                                        <div class="col-md-9 has-success">
	                                            <input type="number" class="form-control" id="izin_akses" placeholder="IZIN AKSES" required>
	                                            <span id="izin_akses_error" class="text-danger"></span>
	                                        </div>
	                                    </div>
	                                </div>
                                    <div class="col-md-6">
	                                    <div class="form-group">
	                                        ...
	                                        <div class="col-md-9 has-success">
	                                            <input type="number" class="form-control" id="tipe" placeholder="TIPE" required>
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-6">
	                                    <div class="form-group">
	                                        <label class="control-label col-md-3">USERNAME</label>
	                                        <div class="col-md-9 has-success">
	                                            <input type="text" class="form-control filled-input" placeholder="USERNAME" name="username" id="username" readonly>
	                            ...
	                            <div class="row">
	                                <div class="col-md-6">
	                                    <div class="form-group">
	                                        <label class="control-label col-md-3">IZIN AKSES</label>
	                                        <div class="col-md-9 has-success">
	                                            <input type="text" class="form-control filled-input " placeholder="IZIN AKSES" id="izin_akses" name="izin_akses" readonly>
	                                ...
	                                <div class="col-md-6">
	                                    <div class="form-group">
	                                        <label class="control-label col-md-3">TIPE</label>
	                                        <div class="col-md-9 has-success">
	                                            <input type="text" class="form-control filled-input " placeholder="TIPE" name="tipe" id="tipe" readonly>
	...
	<script type="text/javascript">
	    $(document).ready(function() {
	        ...
	        $('#datable').DataTable({
	            ...
	            "ajax": '<?php echo base_url('Erm_edit_staff/tampil_dataakun'); ?>',
	            "deferRender": true,
	            "processing": true,
	            "order": [],
	            "columnDefs": [{
	    ...
	    function insertAkun() {
	        ...
	        nama = $('#nama').val();
	        izin_akses = $('#izin_akses').val();
	        tipe = $('#tipe').val();
	        $().ready(function() {
	            $.ajax({
	                url: "<?php echo base_url() ?>Erm_edit_staff/insertAkun",
	                method: "POST",
	                dataType: 'json',
	                data: {
	                    email: email,
	                ...
	                success: function(data) {
	                    if (data.status == "success") {
							...
							if (data.izin_akses_error != '') {
	                            $('#izin_akses_error').html(data.izin_akses_error);
	                        } else {
	                            $('#izin_akses_error').html('');
	                        }
							if (data.tipe_error != '') {
	                            $('#tipe_error').html(data.tipe_error);
	                        } else {
	                            $('#tipe_error').html('');
	                        }
	...
	<script type="text/javascript">
	    ...
	    function edit_buka(username) {
	        swal({
	            ...
	            $().ready(function() {
	                $.ajax({
	                    url: "<?php echo base_url() ?>Erm_edit_staff/buka_staff",
	                    method: "POST",
	                    dataType: 'json',
	                    data: {
	                        username: username,
	    ...
	    function edit_tutup(username) {
	        swal({
	            ...
	            $().ready(function() {
	                $.ajax({
	                    url: "<?php echo base_url() ?>Erm_edit_staff/tutup_staff",
	                    method: "POST",
	                    dataType: 'json',
	                    data: {
	                        username: username,
	    ...
	    function edit_data_pendaftaran(username) {
	        $.ajax({
	            url: "<?= base_url() . 'Erm_edit_staff/getdata_staff' ?>",
	            data: {
	                username: username,
	            },
	            type: 'POST',
	    ...
	    $('#username').keyup(function() {
	        ...
	        if (uname != '') {
	            $.ajax({
	                url: "<?php echo base_url(); ?>Erm_edit_staff/check_username",
	                method: "POST",
	                data: {
	                    username: uname
	                },
