...
<div class="panel panel-default card-view">
	<div class="panel-heading">
		<div class="pull-left">
			<h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN OBAT SLOWMOVING</span></h6>
		</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		datable = $('#datable').DataTable({
			...
			"ajax": {
				"url": "<?php echo base_url('Apotik/Tampil_laporan_slowmoving'); ?>",
				"type": "POST",
				"data": function(data) {
