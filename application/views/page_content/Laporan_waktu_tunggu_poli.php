...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN WAKTU TUNGGU POLI</span></h6>
        </div>
                    ...
                    <table id="datable" class="table table-hover display pb-30" width="100%">
                        <thead>
                            <tr class="bg-success">
                                ...
                                <th>POLI</th>
                                <th>DOKTER</th>
                                <th>WAKTU CETAK SEP</th>
                                <th>WAKTU ISI ASKEP</th>
                                <th>WAKTU ISI ASDOK</th>
                            </tr>
                        </thead>
                        <tfoot>
                            <tr class="bg-success">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('LaporanKunjunganPoli/tampil_waktu_tunggu_poli'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('LaporanKunjunganPoli/tampil_waktu_tunggu_poli'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
