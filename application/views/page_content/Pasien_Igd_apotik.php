...
<div class="panel panel-default card-view mt-20 ">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">PASIEN UGD</span></h6>
        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div id="cetakFarmasi" onclick="cetak()" class="btn btn-sm btn-success mr-10">CETAK</div>
                                                ...
                                                <div id="cetakFarmasi" onclick="cetakSigna1()" class="btn btn-sm btn-success mr-10">SIGNA</div>
        ...
        if (id_logistik != '') {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    harga = Number(data.margin) * Number(data.harga_cost) * (1 + Number(data.ppn) / 100);
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status_dt == "found") {
                    ...
                    $("#hargaCost").val(Math.round(harga));
                    $("#idTindakan").val(id);
    ...
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Apotik/tampil_pasien_Igd'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
