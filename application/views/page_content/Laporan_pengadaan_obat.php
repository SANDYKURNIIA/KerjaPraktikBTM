...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">OBAT FORNAS</span></h6>
        </div>
                    ...
                    <table id="datable" class="table table-hover display pb-30" width="100%">
                        <thead>
                            <tr class="bg-success">
                                ...
                                <th>JUMLAH ITEM OBAT FORMULARIUM YANG TERSEDIA DI RS</th>
                            </tr>
                        </thead>
                        <tfoot>
                            <tr class="bg-success">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Laporan/Tampil_laporan_pengadaan_obat'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Laporan/Tampil_laporan_pengadaan_obat'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
