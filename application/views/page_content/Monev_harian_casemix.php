...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">MONEV HARIAN</span></h6>
        </div>
...
<?php $this->load->view('page_content/Modal_monev_harian') ?>
...
function convertToRupiah(angka) {
    ...
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Casemix/tampil_monev_harian'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
