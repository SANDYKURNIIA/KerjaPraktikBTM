...
<div class="panel panel-default card-view">
	<div class="panel-heading">
		<div class="pull-left">
			<h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">PASIEN LABOR POLI</span></h6>
		</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#datable').DataTable({
			...
			"ajax": {
				"url": '<?= base_url('apelkes/tampil_poli_pulang'); ?>',
				"type": 'POST',
				"data": {
					tipe: 'today',
	...
	function tampilHariIni() {
		...
		$('#datable').DataTable({
			...
			"ajax": '<?php echo base_url('apelkes/tampil_poli_pulang'); ?>',
			"deferRender": true,
			"processing": true,
			"order": [],
			"columnDefs": [{
	...
	function reload_data_form_labor(id_pel_lab) {
		...
		$('#tableFormLabor').DataTable({
			...
			"ajax": {
				"url": '<?php echo base_url('Apelkes/tampil_form_labor'); ?>',
				"type": 'POST',
				"data": {
...
<script type="text/javascript">
	...
	function kembalikan(no,nama) {
        swal({
            title: "Apakah kamu yakin?",
            text: "Mengembalikan Labor Pasien " + nama + " ?",
            type: "warning",
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Apelkes/kembalikan_labor",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        no: no,
