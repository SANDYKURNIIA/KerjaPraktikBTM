            ...
            <div class="col-md-12">
                ...
                <div class="col-md-2">
                    <label class="mt-0 txt-dark">Jenis Klaim :</label>
                        ...
                        <select class="form-control select2" placeholder="Choose a Category" name="cara_bayar"
                            id="cara_bayar">
                ...
                <div class="col-md-2">
                    <label class="mt-0 txt-dark">Jenis Pelayanan :</label>
                        ...
                        <select class="form-control select2" placeholder="Choose a Category" name="jenis_pelayanan"
                            id="jenis_pelayanan">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Labor/Tampil_laporan_pendapatan_labor'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Labor/Tampil_Range_pendapatan_labor'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir,
