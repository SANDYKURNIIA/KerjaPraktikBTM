<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="span span-success">TINDAKAN HOMECARE</span></h6>
        </div>
    ...
    <div class="panel-wrapper collapse in">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-body mt-20">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">BIAYA SARANA</label>
                                            <div class="col-md-9 has-success">
                                                <input type="number" class="form-control" placeholder="BIAYA SARANA" id="upBiayaSarana" name="biaya_sarana" oninput="setTotal1()"></input>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">JASA + TRANSPORT</label>
                                            <div class="col-md-9 has-success">
                                                <input type="text" class="form-control" placeholder="JASA + TRANSPORT" id="upJasa" name="jasa" oninput="setTotal1()"></input>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 has-success">
                                                <input type="text" class="form-control" disabled="" placeholder="TOTAL" id="upTotal" name="total"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer mb-10 mr-15">
                            ...
                            <button onclick="up_tindakan_homecare()" class="btn btn-success btn-anim  btn-sm" type="button"><i class="icon-rocket"></i><span class="btn-text">Submit</span></button>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="myLargeModalLabel"><i class="icon-user mr-10"></i> EDIT TINDAKAN HOMECARE
                        </h5>
                    </div>
                    <div class="modal-body">
                        <div class="form-wrap">
        ...
        <script type="text/javascript">
            function up_tindakan_homecare() {
                upBiaya = $('#upBiayaSarana').val();
                upTindakan = $('#upTindakan').val();
                upJasa = $('#upJasa').val();
                upTotal = $('#upTotal').val();

                $.ajax({
                    url: "<?= base_url() . 'Homecare/insert_tindakan_homecare' ?>",
                    method: "POST",
                    dataType: 'json',
                    cache: true,
                    data: {
                        upBiayaSarana: upBiayaSarana,
                    ...
                    success: function(data) {
                        if (data.status == "success") {
                            ...
                            $('#upTindakan').val('');
                            $('#upJasa').val('');
                            $('#tablehomecare').DataTable().ajax.reload();
            ...
            function edit_tindakan_homecare(id_list_tindakan) {
                $.ajax({
                    url: "<?php echo base_url() ?>Homecare/getDataTindakanHomecare",
                    data: {
                    ...
                    success: function(data) {
                        if (data.status_dt == "found") {
                            ...
                            $("#inTindakan").val(data.nama_tindakan);
                            $("#inBiayaSarana").val(data.biaya_sarana);
                            $("#inJasa").val(data.jasa_transport);
            ...
            function updateTindakan() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() ?>Homecare/edit_tindakan_homecare",
                    dataType: 'json',
                    data: {
                        id: id,
                        nama: nama,
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#datable').DataTable({
                    ...
                    "ajax": '<?php echo base_url('Homecare/tampil_tindakan_homecare'); ?>',
                    "deferRender": true,
                    "processing": true,
                    "order": [],
                    "columnDefs": [{
