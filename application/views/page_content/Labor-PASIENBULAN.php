							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group ">
										...
										<div class="col-md-9 has-success" onchange="pilihTindakanLabor_BULAN()">
											<select class="form-control filled-input select2"
												style="border: 1px solid lightgreen;" tabindex="1" name="inTindakanLabor"
												id="inTindakanLabor_BULAN">
												<option value="-">-</option>
												<?php
								...
								<div class="col-md-6">
									<div class="form-group ">
										...
										<div class="col-md-9 has-error">
											<input type="text" class="form-control " id="inJumlahLabor_BULAN" disabled
												placeholder="jumlah" oninput="hargaTotalLabor()">
									...
									<div class="form-group ">
										...
										<div class="col-md-9 has-error">
											<input type="text" class="form-control" disabled
												id="outBiayaTindakanLabor_BULAN">
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group pull-right">
										<button onclick="insert_labor_bulan()"
