								...
								<div class="col-md-6">
									<div class="form-group ">
										...
										<div class="col-md-9 has-error">
											<input type="text" class="form-control " id="inJumlahLabor_ANAK" disabled
							...
							<div class="row">
								<div class="col-md-8">
									<div class="form-group pull-right">
										<button onclick="insert_labor_ANAK()"
