                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-9 has-success ">
                                                        <select class="form-control filled-input select2" style="border: 1px solid lightgreen;" name="inNamaObat" id="inNamaObat" onchange="pilih_obat()">
                                                            ...
                                                            foreach ($obat as $row) :
                                                            ?>
                                                                <option value="<?php echo $row["id_logistik"] . "|" . $row["harga_cost"] . "|" . $row["produsen"] . "|" . $row["margin"] . "|" . $row["harga_persediaan"]; ?>"><?php echo $row["nama"]; ?></option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3 has-success">
                                                            <input type="number" value="0" class="form-control" id="outDiskonRs" oninput="setHargaPers()">
                                                            <span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-wrap">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6"><div type="submit" class="btn btn-success  mr-10" onclick="insertObatFaktur1()">TAMBAH</div></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="panel-heading">
        ...
        <div class="modal fade" id="modalInputDetailTambahan" role="dialog" aria-labelledby="myLargeModalLabell" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <?php echo form_open_multipart('Obat_hibah/insertTotalFakturLogFarm'); ?>
                    <div class="modal-body">
        ...
        <div class="modal fade" id="cetak_dp" role="dialog" aria-labelledby="myLargeModalLabell" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" action="<?php echo base_url('Obat_hibah/cetak') ?>" method="post" enctype="multipart/form-data" role="form">
...
<script type="text/javascript">
    function insertFaktur() {
        ...
        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Obat_hibah/insertFaktur",
                method: "POST",
                dataType: 'json',
                data: {
                    tgl_masuk: tgl_masuk,
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Obat_hibah/tampil_pelayanan_masuk'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePo(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Obat_hibah/tampil_pelayanan_masuk'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
...
<script type="text/javascript">
    ...
    function hapus_faktur(id_faktur) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Obat_hibah/hapus_faktur",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_faktur: id_faktur
    ...
    function reload_total_harga(id_faktur) {
        ...
        $('#outTotalHarga').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Obat_hibah/tampil_total_harga'); ?>',
                "type": 'POST',
                "data": {
                    idFaktur: id_faktur
                },
    ...
    function hapus_isi_list_faktur(obat,id_detail_struk) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Obat_hibah/hapus_isi_list_faktur",
                    method: "POST",
                    dataType: 'json',
                    data: {
    ...
    function setHargaHasil() {
        ...
        hitungHargaPers = hargaHitungHna - (hargaHitungHna * (diskon_rs / 100)) + (hargaHitungHna * (ppn / 100));
    ...
    function setHargaPers() {
        ...
        hitungHargaPers = hna - (hna * (diskon_rs / 100)) + (hna * (ppn / 100));
        if (harga_pers == 0) {
            hargaPers = hitungHargaPers;
        } else {
            hargaPers = (harga_pers + parseFloat(hitungHargaPers)) / 2
        ...
        $("#outTotal1").val(convertToRupiah(hitungHargaPers * frek));
    ...
    function insertObatFaktur1() {
        ...
        if (tglExp == "") {
            ...
            $.ajax({
                type: "POST",
                url: "Obat_hibah/insertObatFaktur1",
                dataType: 'json',
                data: {
                    idFaktur: id_faktur,
                    id_struk: id_struk,
    ...
    function reload_isi_list_faktur( id_struk) {
        ...
        $('#isiFaktur1').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Obat_hibah/tampil_list_faktur1'); ?>',
                "type": 'POST',
                "data": {
                    id_struk: id_struk
                },
...
<script type="text/javascript">
    function myFunction() {
        ...
        if (no_faktur != '') {
            $.ajax({
                url: "<?php echo base_url(); ?>Obat_hibah/check_noFaktur1",
                method: "POST",
                data: {
                    no_faktur: no_faktur
                },
...
<script>
    ...
    function cetak_dp(id_faktur, no_faktur, no_dokumen, id_produsen, id_struk) {
        ...
        $.ajax({
            url: "<?= base_url() . 'Obat_hibah/getHargaFaktur' ?>",
            data: {
                no_faktur: no_faktur,
