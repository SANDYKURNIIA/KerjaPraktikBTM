<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="span span-success">PENGELUARAN AFKIR</span></h6>
        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 has-success">
                                            ...
                                            $noDok = $noValid . "/" . "PA/FARM-RSBT/" . numtor(date("m")) . "/" . date("Y");
                                            ?>

                                            <!--end ajax-->
                                            <input type="text" id="no_dokumen" name="no_dokumen" class="form-control" value="<?= $noDok ?>"></input>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-wrap">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="col-md-9 has-success ">
                                                                    <select class="form-control filled-input select2" style="border: 1px solid lightgreen;" name="upNama" id="upNama" onchange="pilih_obat()">
                                                                        ...
                                                                        foreach ($obat as $row) :
                                                                        ?>
                                                                            <option value="<?php echo $row->id_logistik . "|" . $row->harga_cost . "|" . $row->jml_satuan_terkecil . "|" . round($row->stok_tersedia) . "|" . $row->kadaluarsa; ?>"><?php echo $row->nama . " (" . $row->produsen . ")"; ?></option>
                                                        ...
                                                        <input type="hidden" class="form-control" autocomplete="off" placeholder="REKOMENDASI" id="inExp" disabled>
                                                        ...
                                                        <div class="col-md-6 mt-10">
                                                            <div class="form-group ">
                                                                <label class="control-label col-md-3 mt-10">JUMLAH AFKIR</label>
                                                                <div class="col-md-9 has-success">
        ...
        <div class="modal fade bs-example-modal-lg" id="modalEditFaktur" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="overflow : auto !important;">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-body mt-20">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Tanggal Afkir</label>
                                        <div class="col-md-9 has-success">
                                            <input type="date" placeholder="TANGGAL MASUK" id="up_tgl_faktur" name="up_tgl_faktur" data-toggle="datepicker" class="form-control filled-input" autocomplete="off"></input>
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 has-success">
                                            ...
                                            <input type="text" id="up_no_dokumen" name="up_no_dokumen" disabled="" class="form-control"></input>
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 has-success">
                                            <select class="form-control filled-input select2" style="border: 1px solid lightgreen;" name="upVendor" id="upVendor">
                                                ...
                                                ?>
                                                    <option value="<?php echo strtoupper($row['nama_produsen']); ?>">
                                                        <?php echo strtoupper($row['nama_produsen']); ?></option>
                    ...
                    <div class="modal-footer mb-10 mr-15">
                        <input type="hidden" class="form-control " autocomplete="off" id="upFaktur">

                        <button onclick="editFaktur()" class="btn btn-success btn-anim  btn-sm" type="button"><i class="icon-rocket"></i><span class="btn-text">EDIT</span></button>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    function insertFaktur() {
        ...
        dataString = '&tgl_faktur=' + tgl_faktur + '&no_dokumen=' + no_dokumen + '&no_index=' + noIndex;

        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Afkir_logfar/insertFaktur",
                method: "POST",
                dataType: 'json',
                data: dataString,
                success: function(data) {
                    if (data.status == "success") {
                        swal({
                            title: "good job!",
                            type: "success",
                            text: "Faktur Retur " + no_dokumen + " Berhasil ditambahkan",
    ...
    function editFaktur() {
        ...
        tgl_faktur = $('#up_tgl_faktur').val();
        id_vendor = $('#upVendor').val();
        idFaktur = $('#upFaktur').val();

        dataString = '&tgl_faktur=' + tgl_faktur +
            '&id_vendor=' + id_vendor + '&id_faktur=' + idFaktur;

        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Afkir_logfar/updateFaktur",
                method: "POST",
                dataType: 'json',
                data: dataString,
                success: function(data) {
                    if (data.status == "success") {
                        swal({
                            title: "good job!",
                            type: "success",
                            text: "Faktur Retur " + id_vendor + " Berhasil ditambahkan",
                            confirmButtonColor: "#3cb878",
                        });
    ...
    function hapus_faktur(id_faktur) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Afkir_logfar/hapus_faktur_po",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_faktur: id_faktur,
    ...
    function edit_faktur(id_faktur, id_vendor, tgl_faktur, no_dokumen) {
        $("#up_tgl_faktur").val(tgl_faktur);
        $("#up_no_dokumen").val(no_dokumen);
        $("#upVendor").val(id_vendor).change();
        $("#upFaktur").val(id_faktur);
    ...
    function insertObatFaktur() {
        ...
        dataString = 'idFaktur=' + id_faktur + '&harga=' + harga + '&ket=' + ket +
            '&frek=' + frek + '&idLogistik=' + idLogistik + '&tglExp=' + exp +
            '&id=' + ID;

        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Afkir_logfar/insertObatFaktur",
                method: "POST",
                dataType: 'json',
                data: dataString,
                success: function(data) {
    ...
    function reload_isi_list_faktur(idFaktur) {
        ...
        $('#isiFaktur1').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Afkir_logfar/tampil_list_faktur'); ?>',
                "type": 'POST',
                "data": {
                    idFaktur: idFaktur
                },
    ...
    function hapus_list_faktur(id_detail) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Afkir_logfar/hapus_list_faktur",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_detail: id_detail,
    ...
    function reload_list_faktur(idFaktur) {
        ...
        $('#isiFaktur').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Afkir_logfar/tampil_obat'); ?>',
                "type": 'POST',
                "data": {
                    idFaktur: idFaktur
                },
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Afkir_logfar/tampil_data'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePo(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Afkir_logfar/tampil_data'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
