...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        ...
        <div align="right">
            <?php if ($datatipe == "mcu") { ?>
                <div class="btn btn-primary btn-anim btn-sm " onclick="tambahFormFaktur1()"><i class="icon-rocket"></i><span class="btn-text">TAMBAH FORM PERMINTAAN</span>
                    <div></div>
                </div>
            <?php } else { ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 has-success">
                                        <input type="number" class="form-control " autocomplete="off" placeholder="JUMLAH PERMINTAAN" id="inJumlah">
...
<script type="text/javascript">
    function tambahFormFaktur() {
        $.ajax({
            method: "POST",
            dataType: 'json',
            url: "<?php echo base_url() ?>Permintaan_obat_unit/insertFormPermintaanObatBaru",
    ...
    function insertPermintaanObat() {
        ...
        $.ajax({
            method: "POST",
            dataType: 'json',
            url: "<?php echo base_url() ?>Permintaan_obat_unit/insertPermintaanObatFarmasi",
            data: {
                idReq: idReq,
                idObat: obat,
                tgl: tgl,
    ...
    function hapusRequest(id_req, nama) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Permintaan_obat_unit/hapus_request",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_req: id_req,
    ...
    function hapusPermintaan(id_req, nama) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Permintaan_obat_unit/hapus_permintaan",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_req: id_req,
    ...
    $(document).ready(function() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Permintaan_obat_unit/Tampil_permintaan_obat'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function reload_data_tindakan(id_req) {
        ...
        $('#tabletindakan').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Permintaan_obat_unit/tampil_list_tindakan'); ?>',
                "type": 'POST',
                "data": {
                    id_req: id_req
                },
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Permintaan_obat_unit/Tampil_Range_Permintaan_obat'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
