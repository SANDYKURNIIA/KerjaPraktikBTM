<div class="panel-wrapper collapse in">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-md-9 has-success">
                                            <input type="text" class="form-control " disabled="" id="inPoli">
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 has-success">
                                            <input type="text" class="form-control  " disabled="" id="inTglKeluar">
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="control-label col-md-5">PASIEN TB</label>
                                            <div class="col-md-12 has-success">
                                                <div class="radio-button radio-button-primary" style="margin-left: 90px; margin-top: -10px;">
                                                    <input id="alergi_obat1" type="radio" name="alergi_obat" value="Ada" onclick="showTextbox()">
                                                    <label class="control-label" for="alergi_obat1">Ada</label>
                                                </div>
                                                <div class="has-success" style="margin-left: 150px; margin-top: -28px;">
                                                    <input type="text" class="form-control" placeholder="Nomor Regis SITB" id="alergi_obat" style="display: none;">
                                                </div>
                                                <span class="help-block"></span>
                                                <div class="col-md-7" style="margin-left: 330px; margin-top: -51px;">
                                                    <div class="btn btn-success" id="buttonValidasi" onclick="validate()" style="display: none; ">Validasi</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <hr>
                                <center>
                                    <label style="font-style: italic;" class="panel-title txt-dark">Tekanan Darah (mmHg)</label>
                                </center>

                                <div style="align-items: center;">
                                    <center>
                                        <div class="has-success" id="the-basics">
                                            <input id="inputSistole" type="number" oninput="sistole(this.value)" value="0" style="height:40px; text-align:center; border-color: #55C08A;">
                                            <input id="inputDiastole" type="number" oninput="diastole(this.value)" value="0" style="height:40px; text-align:center; border-color: #55C08A;">
                                        </div>
                                </div>
                                </center>

                                <p><label style="margin-left: 340px; color:#000000;">
                                        Sistole
                                    </label>
                                    <label style="margin-left: 120px; color:#000000;">
                                        Diastole
                                </p></label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label col-md-10">Penggunaan Dializer</label>
                                            <div class="col-md-12">
                                                <div class="radio-button radio-button-primary">
                                                    <input id="multipleUse" type="radio" name="multiple_single" class="radio-input" value="85% Rp 788,375">
                                                    <label class="control-label" for="multipleUse">Multiple Use</label>

                                                    <input id="singleUse" type="radio" name="multiple_single" class="radio-input" style="margin-left: 30px;" value="100% Rp 927,500">
                                                    <label class="control-label" for="singleUse">Single Use</label>

                                                    <span class="control-label" id="selectedValue" style="margin-left: 500px;"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <script>
                                    function updateSelectedValue() {
                                        ...
                                        const selectedRadio = document.querySelector('input[name="multiple_single"]:checked');
                                        selectedValueSpan.textContent = selectedRadio ? selectedRadio.value : '';
                                    }
                                    const radioButtons = document.querySelectorAll('input[name="multiple_single"]');
                                ...
                                <h6 class="txt-dark capitalize-font"><i class="icon-notebook mr-10"></i>INACBG</h6>
                                <hr>
                                <!-- /Row -->

                                <div class="row" id="outNaikKelas">
                                                    ...
                                                    <div class="form-group pl-15">
                                                        ...
                                                        <div class="panel-body" style="margin-left:-1em;">
                                                            ...
                                                            <div class="pt-20" style="color:#e84a5f;">*File tidak boleh lebih besar
                                                                dari
                                                                5 mb, dan hanya berformat .jpg |.png |</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        function finalEklaim() {
            ...
            tipe_masuk = $("#inJenisPel").val();
            $.ajax({
                url: "<?= base_url() . 'Eklaim/finalClaim' ?>",
                method: "POST",
                cache: true,
                dataType: 'json',
                data: {
        ...
        function onlineEklaim() {
            ...
            payor_cd = splitDiag[1];
            $.ajax({
                url: "<?= base_url() . 'Eklaim/onlineClaim' ?>",
                method: "POST",
                cache: true,
                dataType: 'json',
                data: {
    ...
    <script type="text/javascript">
        ...
        function showTextbox() {
            document.getElementById("alergi_obat").style.display = "block";
            document.getElementById("buttonValidasi").style.display = "block";
        }

        function hideTextbox() {
            document.getElementById("alergi_obat").style.display = "none";
            document.getElementById("buttonValidasi").style.display = "none";
