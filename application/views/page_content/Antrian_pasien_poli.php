					...
					<div class="col-sm-13">
						<div class="panel panel-default card-view pb-0">
                            ...
                            <input type="text" class="form-control rounded-input text-center" value="<?= $count_data['jumlah']; ?>" disabled>
								...
								<input type="hidden" id="no_antrian" value="<?php $no= $antrian_data['no_antri']; echo ($inisial.$no); ?>" disabled>
										...
										<div class="col-md-6 mb-30">
											<div class="panel panel-pricing mb-0 center">
												<div class="panel-heading text-center">
													...
													<div class="btn btn-success btn-rounded btn-lg" onclick="playSuara(<?=  "'".$antrian_data['no_antri']."','".$antrian_data['nama']."','".$inisial."'"; ?>)">
														PLAY</div>
...
<script type="text/javascript">
    $(document).ready(function() {
		...
		if (no_antrian == 'l0') {
            ...
            $('#tabledata').DataTable({
                    ...
                    "ajax": '<?php echo base_url('Poli/tampilAntrian'); ?>',
                    "deferRender": true,
                    "processing": true,
                    "order": [],
                    "columnDefs": [{
	...
	function skip_data(id_antrian) {
		...
		function playTableSuara(no_antri,kode, poli, nama) {
				$.ajax({  
					url : "<?= base_url() ?>Poli/playSuara",					
					method: "POST",
					dataType: 'json',
