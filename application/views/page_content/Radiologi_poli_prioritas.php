...
<div class="panel panel-default card-view">
	<div class="panel-heading">
		<div class="pull-left">
			<h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">POLI PRIORITAS</span></h6>
		</div>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h5 class="modal-title" id="myLargeModalLabel"><i class="icon-user mr-10"></i> TINDAKAN RADIOLOGI POLI PRIORITAS
					</h5>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#formdata').submit(function(e) {
				...
				$.ajax({
					url: '<?php echo base_url(); ?>Radiologi/post_radiologi_prioritas',
					type: "POST",
					data: formData,
					processData: false,
					contentType: false,
			...
			$('#datable').DataTable({
				...
				"ajax": '<?php echo base_url('Radiologi/tampil_poli_prioritas'); ?>',
				"deferRender": true,
				"processing": true,
				"order": [],
				"columnDefs": [{
		...
		function reload_data_radiologi(id_pelayanan) {
			...
			$('#tableradiologi').DataTable({
				...
				"ajax": {
					"url": '<?php echo base_url('Radiologi/tampil_poli_prioritas_radiologi'); ?>',
					"type": 'POST',
					"data": {
		...
		function reload_total_radiologi(id_pelayanan) {
			...
			$('#outTotalHargaRadiologi').DataTable({
				...
				"ajax": {
					"url": '<?php echo base_url('Radiologi/tampil_total_poliprioritas_radiologi'); ?>',
					"type": 'POST',
					"data": {
						id_pelayanan: id_pelayanan
					},
		...
		function edit_data_tindakan(id_pelayanan, id_history) {
			$.ajax({
				url: "<?= base_url() . 'Radiologi/getdata_PoliPrioritasALL' ?>",
				data: {
		...
		function edit_tindakan_radiologi(id_pelayanan, id_tindakan_radiologi) {
			$.ajax({
				url: "<?= base_url() . 'Radiologi/getdata_prioritas_formById' ?>",
				data: {
					pelayanan: id_pelayanan,
	...
	<script type="text/javascript">
		...
		function insert_radiologi2() {
			...
			$.ajax({
				url: "<?= base_url() . 'Radiologi/insert_radiologi_prioritas' ?>",
				method: "POST",
				dataType: 'json',
				data: dataString,
				success: function(data) {
