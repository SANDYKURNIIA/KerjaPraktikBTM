...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN PENDAPATAN TUNAI KASIR</span></h6>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Kasir/tampil_laporan_pendapatan'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Kasir/tampil_laporan_pendapatan'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
    ...
    function cetak(tgl,staff) {

        $.ajax({
            type: 'POST',
            url: "<?= base_url() . 'Laporan_kasir/Cetak_pendapatan_harian' ?>",
            data: {
                tgl: tgl,
                staff: staff,
            },
