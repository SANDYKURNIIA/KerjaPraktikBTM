					...
					<table id="datable" class="table table-hover display pb-30">
						<thead>
							<tr class="bg-success">
								...
								<th>TOTAL BIAYA</th>
								<th>BIAYA IGD</th>
								<th>OBAT RUANG IGD</th>
								<th>BIAYA RANAP</th>
								<th>OBAT RUANG RANAP</th>
							...
							<div class="form-body">
								...
								<div class="row">
									<div class="col-md-offset-3 col-md-9">
										<button class="btn btn-primary btn-rounded mr-10" type="submit" name="action" value="cetak_penata">CETAK</button>
										<!-- <button class="btn btn-success btn-rounded mr-10" type="submit" name="action" value="pulang">CETAK DAN PULANG</button> -->
									</div>
								</div>
							</div>
