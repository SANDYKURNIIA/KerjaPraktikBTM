                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button class="btn btn-primary btn-rounded mr-10" type="submit" name="action" value="cetak_ulang" id="cetak">CETAK</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Kasir/tampil_pasien_pulang'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Kasir/tampil_pasien_pulang'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
