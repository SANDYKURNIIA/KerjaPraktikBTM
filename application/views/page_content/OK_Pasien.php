...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">PASIEN KAMAR OPERASI</span></h6>
        </div>
                ...
                <div class="table-responsive">
                    <table id="datable" class="table table-hover display  pb-30">
                        <thead>
                            <tr class="bg-success">
                                <th>NO</th>
                                <?php $auth = $this->session->userdata('data_auth');
                                if ($auth->tipe == 'cssd') { ?>
                                    <th>OBAT</th>
                                <?php } else { ?>
                                    <th>FORM</th>
                    ...
                    <div class="modal-body">
                        <div class="form-body mt-20" style="margin-left:-1em">
                            <div class="row">
                                <div class="col-md-6">
                                    <form id="dataAlkes">
                                        <label for="" class="control-label col-md-3">NAMA TINDAKAN</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('OK_Pasien/tampil_pasien'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
