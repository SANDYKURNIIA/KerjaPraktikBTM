                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 has-success">
                                            ...
                                            <textarea class="form-control" id="inKet"></textarea>
                                            <span class="help-block"></span>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mt-10">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-9 has-success">
                                                        ...
                                                        <input type="text" class="form-control" id="inHarga" oninput="tampilHarga1()">
                                                        <span class="help-block"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-9 has-success">
                                                        <input type="text" autocomplete="off" class="form-control filled-input" placeholder="DISKON" id="inDiskonPR">
                                                        <span class="help-block"></span>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="modal fade bs-example-modal-lg" id="modalEditFaktur" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="overflow : auto !important;">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h5 class="modal-title mt-10" id="myLargeModalLabel"><i class="icon-user mr-10"></i>EDIT FORM PO</h5>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Tanggal PO</label>
                                        <div class="col-md-9 has-success">
                                            <input type="date" placeholder="TANGGAL MASUK" value="<?php echo date("Y-m-d"); ?>" id="upTgl_faktur" name="tgl_faktur" data-toggle="datepicker" class="form-control filled-input" autocomplete="off"></input>
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 has-success">
                                            ...
                                            <select class="form-control filled-input select2" id="upId_vendor" name="id_vendor">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 has-success">
                                            ...
                                            <input type="text" id="upNo_dokumen" name="no_dokumen" class="form-control"></input>
                                            <input type="hidden" id="inFaktur_up" name="inFaktur_up" class="form-control"></input>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 has-success">
                                            ...
                                            <textarea class="form-control" id="upKet"></textarea>
                                            <span class="help-block"></span>
                                        </div>
                    ...
                    <div class="modal-footer mb-10 mr-15">
                        ...
                        <button onclick="update_Faktur()" class="btn btn-success btn-anim  btn-sm" type="button"><i class="icon-rocket"></i><span class="btn-text">SIMPAN</span></button>
...
<script type="text/javascript">
    ...
    function update_Faktur() {

        tgl_faktur = $('#upTgl_faktur').val();
        id_vendor = $('#upId_vendor').val();
        no_dokumen = $('#upNo_dokumen').val();
        idFaktur = $('#inFaktur_up').val();
        keterangan = $('#upKet').val();

        dataString = '&tgl_faktur=' + tgl_faktur +
            '&id_vendor=' + id_vendor + '&no_dokumen=' + no_dokumen +
            '&idFaktur=' + idFaktur + '&keterangan=' + keterangan;

        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Po_obat/update_Faktur",
                method: "POST",
                dataType: 'json',
                data: dataString,
                success: function(data) {
                    if (data.status == "success") {
                        swal({
                            title: "good job!",
                            type: "success",
                            text: "FAKTUR " + id_vendor + " Berhasil diubah",
                            confirmButtonColor: "#3cb878",
                        });
                        tgl_faktur = $('#upTgl_faktur').val("");
                        id_vendor = $('#upId_vendor').val("");
    ...
    function edit_faktur(id_faktur, no_dokumen) {
        // alert(no_dokumen);

        $("#inFaktur_up").val(id_faktur);
        // $("#no_dokumen1").val(no_dokumen);
        $.ajax({
            url: "<?= base_url() . 'Po_obat/getDataPO' ?>",
            data: {
                id_faktur: id_faktur,
            },
            type: 'POST',
            ...
            success: function(data) {
                if (data.status_dt == 'found') {
                    $("#upNo_dokumen").val(data.no_dokumen);
                    $("#upTgl_faktur").val(data.tgl_faktur);
                    $("#upKet").val(data.keterangan);
                    $("#upId_vendor").val(data.id_vendor).change();
                } else {
                    swal({
                        title: "Gagal!",
                        type: "warning",
    ...
    function tampilHarga1() {
        ...
        $("#outHargaPR").val(convertToRupiah(total.toFixed(0)));
    ...
    function insertObatFaktur() {
        ...
        $.ajax({
            url: "<?= base_url() . 'Po_obat/insertObatFaktur' ?>",
            method: "POST",
            dataType: 'json',
            data: dataString,
            success: function(data) {
...
<script type="text/javascript">
    ...
    function edit_obat(id_logistik, nama, harga, rekom, tipe, id_detail, frek) {
        ...
        //     '&id=' + ID + '&id2=' + ID2 +
        //     '&diskon=' + rekom + '&ppn=' + tipe + '&id_detail=' + id_detail;

        // $().ready(function() {
        $.ajax({
            url: "<?php echo base_url() ?>Po_obat/getPerencanaan",
            method: "POST",
            dataType: 'json',
            data: {
                id_faktur:id_detail
