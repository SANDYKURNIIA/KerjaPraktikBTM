...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN MUTASI UNIT </span></h6>
        </div>
        ...
        <script type="text/javascript">
            ...
            "ajax": '<?php echo base_url('IGD/tampil_laporan_UGD_ranap'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
            ...
            "ajax": {
                "url": '<?= base_url('IGD/tampil_range_laporan_UGD_ranap'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
