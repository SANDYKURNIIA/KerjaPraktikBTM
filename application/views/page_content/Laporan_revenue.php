...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN REVENUE</span></h6>
        </div>
        ...
        <div class="row mt-30">
            <div class="col-md-12">
                <div class="col-md-3 mt-20 pl-5">
                    <button class="btn btn-primary btn-anim btn-sm" onclick="tampilHariIni();"><i class="icon-rocket"></i><span class="btn-text">BULAN INI </span>
                </div>
                <div class="col-md-3">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Laporan_pendapatan/getPendapatan_revenue'); ?>',
                "type": 'POST',
                "data": {
                    mulai: '<?= date('Y-m-01') ?>',
                    akhir: '<?= date('Y-m-t') ?>'
        ...
        $('#outTotalHarga').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Laporan_pendapatan/getTotal_revenue'); ?>',
                "type": 'POST',
                "data": {
                    mulai: '<?= date('Y-m-01') ?>',
                    akhir: '<?= date('Y-m-t') ?>'
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        TampilHarga(mulai, akhir)
    }


    function TampilHarga(mulai, akhir) {
        $('#outTotalHarga').DataTable().destroy();
        $('#outTotalHarga').DataTable({
            "language": {
                "sEmptyTable": "Tidak ada data yang tersedia pada tabel ini",
                "sProcessing": "Sedang memproses...",
