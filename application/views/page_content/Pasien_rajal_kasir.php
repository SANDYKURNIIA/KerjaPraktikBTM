                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-wrap">
                                                        <div class="form-body">
                                                            <div class="modal-body">
                                                                <form class="form-horizontal" action="<?php echo base_url('Kasir_poli/print_kasir_rajal') ?>" method="post" target="_blank" novalidate>
                                                                        ...
                                                                        <div id="pasien_asuransi" style="display: none;">
                                                                            <div class="row">
                                                                                <center>
                                                                                    ...
                                                                                    <button class="btn btn-danger btn-anim  btn-rounded mr-10" type="submit" name="action" value="pulang"><i class="icon-logout"></i><span class="btn-text">CHECKOUT</span></button>
                                                                                    <button title="Hanya melihat billing, dan belum di check out!" class="btn btn-warning btn-anim btn-rounded mr-10" type="submit" name="action" value="cetak"><i class="icon-printer"></i><span class="btn-text">LIHAT BILLING</span></button>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('kasir_poli/tampil_pasien_rajal'); ?>',
                "type": 'POST',
                "data": {
                    poli: '<?= $poli ?>',
...
<script>
    ...
    function check_out(id_pelayanan, id_history, nama) {
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: "<?php echo base_url() ?>Kasir_poli/insertCheckOutKasir",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_pelayanan: id_pelayanan,
