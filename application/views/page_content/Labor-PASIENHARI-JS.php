<script type="text/javascript">
				...
				function reload_data_labor_HARI(id_pelayanan) {    
						...
						$('#tablelaborHARI').DataTable({
							...
							"ajax": {
								"url": '<?php echo base_url('Labor/tampil_all_labor_hari_sendiri'); ?>',
								"type": 'POST',
								"data": {
...
<script type="text/javascript">
				...
				// Labor
				function insert_labor_HARI() { 
                    a = $("#inTindakanLabor_HARI").val();
                    splitDiag = a.split("|");
                    harga = parseFloat(splitDiag[1]);
                    frek = parseFloat($("#inJumlahLabor_HARI").val());
                    total = harga * frek;
                    id_pel_lab = $('#id_pel_lab_HARI').val();
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.status == "success") {
								...
								$('#outBiayaTindakanLabor_HARI').val('');
								$('#inJumlahLabor_HARI').val('');
								$('#outTotalLabor_HARI').val('');
								$('#tablelaborHARI').DataTable().ajax.reload();
				...
				function pilihTindakanLabor_HARI() {
                    a = $("#inTindakanLabor_HARI").val();
                    splitDiag = a.split("|");

                    harga = parseFloat(splitDiag[1]);
                    $("#outBiayaTindakanLabor_HARI").val(convertToRupiah(harga));
                    document.getElementById("inJumlahLabor_HARI").value = "1";
                    document.getElementById("outTotalLabor_HARI").value = convertToRupiah(harga);
                }
