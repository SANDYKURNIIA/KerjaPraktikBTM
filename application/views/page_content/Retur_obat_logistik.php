<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="span span-success">RETUR OBAT</span></h6>
        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 has-success">
                                            ...
                                            $noDok = $noValid . "/" . "RB/FARM-RSBT/" . numtor(date("m")) . "/" . date("Y");
                                            ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-wrap">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mt-10">
                                                            <div class="form-group ">
                                                                <label class="control-label col-md-3 mt-10">JUMLAH RETUR</label>
                                                                <div class="col-md-9 has-success">
...
<script type="text/javascript">
    function insertFaktur() {
        ...
        dataString = '&tgl_faktur=' + tgl_faktur +
            '&id_vendor=' + id_vendor + '&no_dokumen=' + no_dokumen + '&no_index=' + noIndex + '&no_faktur=' + no_faktur;

        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Retur_obat_logistik/insertFaktur",
                method: "POST",
                dataType: 'json',
                data: dataString,
                success: function(data) {
    ...
    function hapus_faktur(id_faktur) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Retur_obat_logistik/hapus_faktur_po",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_faktur: id_faktur,
    ...
    function insertObatFaktur() {
        ...
        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Retur_obat_logistik/insertObatFaktur",
                method: "POST",
                dataType: 'json',
                data: dataString,
                success: function(data) {
    ...
    function reload_isi_list_faktur(idFaktur) {
        ...
        $('#isiFaktur1').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Retur_obat_logistik/tampil_list_faktur'); ?>',
                "type": 'POST',
                "data": {
                    idFaktur: idFaktur
                },
    ...
    function hapus_list_faktur(id_detail) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Retur_obat_logistik/hapus_list_faktur",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_detail: id_detail,
    ...
    function reload_list_faktur(idFaktur) {
        ...
        $('#isiFaktur').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Retur_obat_logistik/tampil_obat'); ?>',
                "type": 'POST',
                "data": {
                    idFaktur: idFaktur
                },
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Retur_obat_logistik/tampil_data'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePo(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Retur_obat_logistik/tampil_range'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
