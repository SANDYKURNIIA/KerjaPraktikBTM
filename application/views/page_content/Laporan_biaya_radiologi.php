...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN REHAB MEDIK DAN KESEHATAN JIWA</span></h6>
        </div>
        ...
        <div class="row mt-30">
            <div id="form-filter" class="col-md-12">
                ...
                <div class="col-md-3">
                        ...
                        <label class="mt-0 txt-dark">Jenis Pemeriksaan :</label>
...
<script type="text/javascript">
    ...
    //             },
    //         },
    //         "ajax": '<?php echo base_url('Laporan/Tampil_laporan_rehab_medik'); ?>',
    //         "deferRender": true,
    //         "processing": true,
    //         "order": [],
    //         "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Radiologi/Tampil_Range_cara_bayar'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir,
