<div class="panel panel-default card-view mt-20 ">
    <div class="panel-heading">
        ...
        <div class="pull-right">
            <h6 class="panel-title txt-dark"><a class="label label-success font-weight-100" href="<?php echo base_url() ?>pasien/print_tracer_auto" target="popup-example" onClick="javascript:open('', 'popup-example', 'height=400,width=255,resizable=Yes')">DAFTAR PASIEN POLI</a></h6>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#datable').DataTable({
                ...
                "ajax": '<?php echo base_url('Pasien/tampil_datarajal1'); ?>',
                "deferRender": true,
                "processing": true,
                "order": [],
                "columnDefs": [{
