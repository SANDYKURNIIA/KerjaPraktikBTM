...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">PASIEN RAWAT JALAN UGD</span></h6>
        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="modal-body">
                            <form class="form-horizontal" action="<?php echo base_url('Kasir/print_kasir_rajal') ?>" method="post" enctype="multipart/form-data" role="form" target="_blank" novalidate>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                <label class="control-label col-md-6">Yang Sudah Dibayar</label>
                                                <div class="col-md-6">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Kasir/Tampil_pasien_rajal_ugd'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
...
<script>
    ...
    function check_out(id_pelayanan, id_history, nama) {
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: "<?php echo base_url() ?>Kasir/insertCheckOutKasir",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_pelayanan: id_pelayanan,
