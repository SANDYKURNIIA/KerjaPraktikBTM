...
<div class="panel panel-default card-view">
	<div class="panel-heading">
		<div class="pull-left">
			<h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">PASIEN RADIOLOGI</span></h6>
		</div>
								...
								<div class="col-md-6">
									<div class="form-group ">
										...
										<div class="col-md-9 has-error">
											<input type="text" class="form-control " id="inJumlahRadiologi" value="1" disabled placeholder="jumlah" oninput="hargaTotalRadiologi()">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#datable').DataTable({
			...
			"ajax": '<?php echo base_url('Penunjang_RM/tampil_pasien_radiologi'); ?>',
			"deferRender": true,
			"processing": true,
			"order": [],
			"columnDefs": [{
	...
	function reload_data_radiologi(id_pelayanan) {
		...
		$('#tableradiologi').DataTable({
			...
			"ajax": {
				"url": '<?php echo base_url('Penunjang_RM/tampil_rajal_radiologi'); ?>',
				"type": 'POST',
				"data": {
	...
	function edit_data_tindakan(id_pelayanan, id_history) {
		$.ajax({
			url: "<?= base_url() . 'Penunjang_RM/getdata_radiologiALL' ?>",
			data: {
...
<script type="text/javascript">
	...
	function insert_radiologi() {
		...
		dataString = 'id=' + ID + '&harga=' + harga +
			...
			'&frek=' + frek + '&total=' + total + '&jenis_pelayanan=' + "RADIOLOGI" + '&diagnosa=' + diagnosa+
	...
	function pilih_obat1(idResep, tipe, cara_bayar) {
