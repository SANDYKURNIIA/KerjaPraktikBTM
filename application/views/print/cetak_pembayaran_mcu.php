        ...
        <table>
            <tr>
                <td>
                    ...
                    // echo "<br>NO HP: " . $pasien['no_hp'];
                    echo "<br>ALAMAT : " . $pasien['alamat'];
                    echo "<br>PERUSAHAAN : " . $pasien['perusahaan'];
                    $tanggal = date("d M Y H:i", strtotime($pasien['tanggal']));
                ...
                <div class="kolom">
                    <div class="row ">
                        <div class="col-sm-12">
                            ...
                            <h4 class="panel-title txt-dark"> TINDAKAN MCU</h4>
                            <table id="datable_1" class="table table-hover display  pb-30">
                                ...
                                <tbody>
                                    ...
                                    <tr class="txt-dark">
                                        ...
                                        <td> </td>
                                        <td>Total</td>
                                        <td><?php echo "<b>Rp " . number_format($tindakan, 0, ',', '.') . "</b>";   ?></td>
                                    </tr>
                                        ...
                                        <div class="table-wrap">
                                            <div class="table-responsive">
                                                <table id="datable_1" class="table table-hover display  pb-30">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $total = $tindakan + $apotik + $labor + $radio;
                                                        ?>
