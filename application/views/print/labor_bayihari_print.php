	...
	<div class="content">
		...
		<table style="padding:10px; margin-top:15px; border-collapse: collapse;">
				...
				<tr>
					...
					<td>&nbsp;11 - 16 Sec</td>
					<td>&nbsp;&nbsp; 0 - 6 Hr</td>
					<td><center><?= $print_labor['protein06'] ?></center></td>
					<td>&nbsp;4.6 - 7.0 g/dl</td>
				</tr>
				...
				<tr>
					...
					<td>&nbsp;0.7 - 1.3</td>
					<td>&nbsp;&nbsp; 1 Minggu </td>
					<td><center><?= $print_labor['protein1'] ?></center></td>
					<td>&nbsp;4.4 - 7.6 gr/dl</td>
				</tr>
				...
				<tr>
					...
					<td>&nbsp;25  - 40 Sec</td>
					<td>&nbsp;&nbsp; 7 Bln - 1 thn</td>
					<td><center><?= $print_labor['protein71'] ?></center></td>
					<td>&nbsp;5.1 - 7.3 gr/dl</td>
				</tr>
				...
				<tr>
					...
					<td></td>
					<td>&nbsp;&nbsp; 0 - 4 Hr</td>
					<td><center><?= $print_labor['albumin04'] ?></center></td>
					<td>&nbsp;2.8 - 4.4 gr/dl</td>
				</tr>

				<tr>
					<td>&nbsp;&nbsp; 1 Hr</td>
					<td><center><?= $print_labor['hb1_hari'] ?></center></td>
					<td>&nbsp;15,2 - 23,6 g/dl</td>
					<td>&nbsp;&nbsp; 4 Hr - 14 Thn</td>
					<td><center><?= $print_labor['albumin414'] ?></center></td>
					<td>&nbsp;3.8 - 5.4 gr/dl</td>
				</tr>

				<tr>
					<td>&nbsp;&nbsp; 1 - 6 Hr</td>
					<td><center><?= $print_labor['hb16_hari'] ?></center></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 7 - 23 Hr</td>
					<td><center><?= $print_labor['hb723_hari'] ?></center></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 37 hR - 1 Thn</td>
					<td><center><?= $print_labor['hb371_hari'] ?></center></td>
					<td>&nbsp;9.0 - 16.6 g/dl</td>
					<td>&nbsp;&nbsp; 3 - 5 Hr</td>
					<td></td>
					<td>&nbsp;< 16.0 mg/dl</td>
				...
				<tr>
					<td>&nbsp;&nbsp;  1 Hr</td>
					<td><center><?= $print_labor['hematokrit1_hari'] ?></center></td>
					<td>&nbsp;44 - 72 %</td>
					<td>&nbsp;&nbsp; > 5 Hr - 60 Thn</td>
					<td></td>
					<td>&nbsp;0.3 - 1.2 mg/dl</td>
				...
				<tr>
					<td>&nbsp;&nbsp;  1 - 6 Hr</td>
					<td><center><?= $print_labor['hematokrit16_hari'] ?></center></td>
					<td>&nbsp;50 - 82 %</td>
					<td>&nbsp;BILIRUBIN : DIREK</td>
					<td></td>
					<td>&nbsp;0 - 0.2 mg/dl</td>
				...
				<tr>
					<td>&nbsp;&nbsp;  7 - 23 Hr</td>
					<td><center><?= $print_labor['hematokrit723_hari'] ?></center></td>
					<td>&nbsp;42 - 63 %</td>
					<td>&nbsp;BILIRUBIN : INDIREK</td>
					<td></td>
					<td>&nbsp;0 - 1.1 mg/dl</td>
				...
				<tr>
					<td>&nbsp;&nbsp;  24 - 37 Hr</td>
					<td><center><?= $print_labor['hematokrit2437_hari'] ?></center></td>
					<td>&nbsp;31 - 59 %</td>
					<td></td>
					<td></td>
					<td></td>
				...
				<tr>
					...
					<td>&nbsp;0 - 1 %</td>
					<td>&nbsp;0- 10 Hr</td>
					<td><center><?= $print_labor['sgot010'] ?></center></td>
					<td>&nbsp;47 - 150 U/L</td>
				</tr>
				...
				<tr>
					...
					<td>&nbsp;1 - 5 %</td>
					<td>&nbsp;10 Hr - 24 Bln</td>
					<td><center><?= $print_labor['sgot1024'] ?></center></td>
					<td>&nbsp;9 - 80 U/L</td>
				</tr>
				...
				<tr>
					...
					<td>&nbsp;1 - 11 %</td>
					<td>&nbsp;&nbsp; 24 Bln - 60 Thn</td>
					<td><center><?= $print_labor['sgot2460'] ?></center></td>
					<td>&nbsp;L  15 - 40 U/L</td>
				</tr>
				...
				<tr>
					<td>&nbsp;&nbsp; 1 Hr</td>
					<td><center><?= $print_labor['mcv1_hari'] ?></center></td>
					<td>&nbsp;98 - 122 fl</td>
					<td>&nbsp;GGT</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 2 - 6 Hr</td>
					<td><center><?= $print_labor['mcv26_hari'] ?></center></td>
					<td>&nbsp;94 - 150 fl</td>
					<td></td>
					<td></td>
					<td>&nbsp;P  <38 U/L</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 7 - 23 Hr</td>
					<td><center><?= $print_labor['mcv723_hari'] ?></center></td>
					<td>&nbsp;84 - 128 fl</td>
					<td>&nbsp;CRP</td>
					<td></td>
					<td>&nbsp;< 10 Mg/L</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 24 - 37 Hr</td>
					<td><center><?= $print_labor['mcv2437_hari'] ?></center></td>
					<td>&nbsp;82 - 126 fl</td>
					<td></td>
					<td></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 1 Hr</td>
					<td><center><?= $print_labor['mch1_hari'] ?></center></td>
					<td>&nbsp;33 - 41 pg/cell</td>
					<td>&nbsp;NA</td>
					<td><center><?= $print_labor['na'] ?></center></td>
					<td>&nbsp;128 - 138 mmol/l</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 2 - 6 Hr</td>
					<td><center><?= $print_labor['mch26_hari'] ?></center></td>
					<td>&nbsp;29 - 45 pg/cell</td>
					<td>&nbsp;K </td>
					<td><center><?= $print_labor['k'] ?></center></td>
					<td>&nbsp;3,9 - 4,9 mmol/l</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 7 - 23 Hr</td>
					<td><center><?= $print_labor['mch723_hari'] ?></center></td>
					<td>&nbsp;26 - 38 pg/cell</td>
					<td>&nbsp;CL</td>
					<td><center><?= $print_labor['cl'] ?></center></td>
					<td>&nbsp;88 - 100 mmol/l</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 1 Hr</td>
					<td><center><?= $print_labor['mchc1_hari'] ?></center></td>
					<td>&nbsp;31 - 35  g/dl</td>
					<td></td>
					<td></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 2 - 6 Hr</td>
					<td><center><?= $print_labor['mchc26_hari'] ?></center></td>
					<td>&nbsp;24 - 36 g/dl</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 7 - 23 Hr</td>
					<td><center><?= $print_labor['mchc723_hari'] ?></center></td>
					<td>&nbsp;25 - 37 g/dl</td>
					<td>&nbsp;NS 1</td>
					<td></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; Premature</td>
					<td><center><?= $print_labor['prematur'] ?></center></td>
					<td>&nbsp;20 - 60 mg/dl</td>
					<td>&nbsp;RHESUS</td>
				...
				<tr>
					<td>&nbsp;&nbsp; Bayi</td>
					<td><center><?= $print_labor['bayi'] ?></center></td>
					<td>&nbsp;54 - 103 mg/dl</td>
					<td></td>
					<td></td>
					<td></td>
