                    ...
                    <div class="kolom">
                        <div class="row ">
                            <div class="col-sm-12">
                                    ...
                                    <table id="datable_1" class="table table-hover display  pb-30">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="txt-dark">
                                                ...
                                                <td> </td>
                                                <td>Total</td>
                                                <td><?php echo "<b>Rp " . number_format($gizi, 0, ',', '.') . "</b>";   ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                <?php } else {
                                ...
                                ?>
                                <?php
                                if (count($data_terapi_wicara) > 0) {
                                ?>
                                    <h6 class="panel-title txt-dark">POLI TERAPI WICARA</h6>
                                    <table id="datable_1" class="table table-hover display  pb-30">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php
                                            $wicara = 0;
                                            foreach ($data_terapi_wicara as $row) {
                                            ...
                                            <tr class="txt-dark">
                                                ...
                                                <td> </td>
                                                <td>Total</td>
                                                <td><?php echo "<b>Rp " . number_format($wicara, 0, ',', '.') . "</b>";   ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                <?php } else {
                                        ...
                                        <div class="table-wrap">
                                            <div class="table-responsive">
                                                <table id="datable_1" class="table table-hover display  pb-30">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $total_semua = $total_pelayanan + $biaya_jasa_his + $apotikppn + $obatok + $igd + $labor + $radio + $anak
                                                            + $apelkes + $bedah + $fisio + $gigi + $mata + $obgyne + $ok + $tht + $kulit + $jantung
                                                            + $internis + $umum + $akp + $bdm + $jiwa + $ort + $paru + $hd + $saraf + $uro + $ginjal
                                                            + $pnm + $rehab + $gizi + $wicara + $trasnportasi + $kia + $kemo;
                                                        ?>
                                                        ...
                                                        <tr class="txt-dark" width="30%">
                                                            ...
                                                            <input type="hidden" id="outTotal" value="<?php echo intval($total_semua - $dp - $diskon - $selisih); ?>">
