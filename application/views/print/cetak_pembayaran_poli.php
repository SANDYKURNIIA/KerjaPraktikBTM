                                            ...
                                            <div class="table-responsive">
                                                <table id="datable_1" class="table table-hover display  pb-30">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                        $totalppn = ($total_semua - $diskon) * 0.11;
                                                        // $poli = $this->db->query("SELECT sum(total) total from tindakan_farmasi where id_pelayanan ='$inPel' and depo ='APOTIK' and frek!=0")->row();
                                                        // if (isset($poli)> 0) {
                                                        //     $apotikppn = $poli->total * 0.11;
                                                        $poli = $this->db->query("SELECT count(*) from history_pelayanan where id_pelayanan ='$inPel' and nama_poli != 'EM4488C53' and id_pelayanan not in(
                                                            SELECT id_pelayanan from history_pelayanan_ranap)")->result();
                                                        if ($poli > 0) {
                                                            $apotikppn = $apotik * 0.11;
                                                        ...
                                                        <tr class="txt-dark" width="30%">
                                                            ...
                                                            <td class="font_angka"><?php echo "(Rp " . number_format($totalppn - $apotikppn, 0, ',', '.') . ")";   ?>
                                                            </td>
                                                        </tr>
                                                        <tr class="txt-dark" width="30%">
                                                            <td> </td>
                                                            ...
                                                            <td> </td>
                                                            <td>PPN TERHUTANG </td>
                                                            <td class="font_angka"><?php echo "<b>Rp " . number_format($apotikppn, 0, ',', '.') . "</b>";   ?>
                                                            </td>
                                                        </tr>
                                                        <tr class="txt-dark" width="30%">
                                                            <td> </td>
                                                            ...
                                                            <td> </td>
                                                            <td>TOTAL </td>
                                                            <td class="font_angka"><?php echo "<b>Rp " . number_format(($total_semua - $diskon) + $apotikppn, 0, ',', '.') . "</b>";   ?>
                                                            </td>
                                                        </tr>
                                                        <tr class="txt-dark" width="30%">
                                                            <td> </td>
                                                        ...
                                                        <tr class="txt-dark" width="30%">
                                                            ...
                                                            <input type="hidden" id="outTotal" value="<?php echo intval((($total_semua - $diskon) + $apotikppn) - $dp  - $selisih); ?>">
                                                            <input type="hidden" id="outTotalAwal" value="<?php echo intval($total_semua + $apotikppn);  ?>">
                                                            ...
                                                            <td class="font_angka"><?php echo "<b>Rp " . number_format(((($total_semua - $diskon) + $apotikppn) - $dp - $selisih), 0, ',', '.') . "</b>";   ?>
                                                            </td>
                                                        </tr>
                                                        <tr class="txt-dark" width="30%">
                                                            <td> </td>
                                                            ...
                                                            <td>TERBILANG : </td>
                                                            <br><br>
                                                            <td colspan="4" class="font_angka" style="font-style: italic;"># <?= Terbilang(($total_semua - $diskon) + $apotikppn) ?> #</td>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
