...
<body onload="myFunction()">
	...
	<!-- Laki-laki FEACES -->
		...
		<table style="padding:10px; margin-top:15px; border-collapse: collapse;">
				...
				<tr>
					<td>&nbsp;&nbsp; <i>- INR</i></td>
					<td><center><?= $print_labor['inr'] ?></center></td>
					<td>&nbsp;0.7 - 1.3</td>
					<td>&nbsp;UREUM </td>
					<td><center><?= $print_labor['ureum'] ?></center></td>
					<td>&nbsp;10 - 50 mg/dl</td>
				...
				<tr>
					<td>&nbsp;&nbsp; <i>- APTT</i></td>
					<td><center><?= $print_labor['aptt'] ?></center></td>
					<td>&nbsp;25  - 40 Sec</td>
					<td>&nbsp;CREATININ</td>
					<td><center><?= $print_labor['creatinin'] ?></center></td>
					<td>&nbsp;0.2 - 0.4 mg/dl</td>
				...
				<tr>
					...
					<td></td>
					<td>&nbsp;ALBUMIN</td>
					<td><center><?= $print_labor['albumin'] ?></center></td>
					<td>&nbsp;3.8 - 5.4 gr/dl</td>
				</tr>

				<tr>
					<td>&nbsp;&nbsp; 40 Hr - 50 Hr</td>
					<td><center><?= $print_labor['hb4050'] ?></center></td>
					<td>&nbsp;9.0 - 16.6 g/dl</td>
					<td>&nbsp;BILIRUBIN TOTAL</td>
					<td></td>
					<td>&nbsp;0.3 - 1.2 mg/dl</td>
				...
				<tr>
					<td>&nbsp;&nbsp; > 50 Hr - 2.5Bln</td>
					<td><center><?= $print_labor['hb5025'] ?></center></td>
					<td>&nbsp;9.2 - 13.6 g/dl</td>
					<td>&nbsp;BILIRUBIN : DIREK</td>
					<td></td>
					<td>&nbsp;0 - 0.2 mg/dl</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 2.6 - 3.5 Bln</td>
					<td><center><?= $print_labor['hb2635'] ?></center></td>
					<td>&nbsp;9.6 - 12.8 g/dl</td>
					<td>&nbsp;BILIRUBIN : INDIREK</td>
					<td></td>
					<td>&nbsp;0 - 1.1 mg/dl</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 4  - 7 Bln</td>
					<td><center><?= $print_labor['hb47'] ?></center></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 8 Bln  - 12 Bln</td>
					<td><center><?= $print_labor['hb812'] ?></center></td>
					<td>&nbsp;150 - 400 RIBU/mm³</td>
					<td>&nbsp;ALT / SGPT</td>
					<td><center><?= $print_labor['sgpt'] ?></center></td>
					<td>&nbsp;13 - 45 U/L</td>
				</tr>
				...
				<tr>
					<td>&nbsp;&nbsp;  40 Hr - 50 Hr</td>
					<td><center><?= $print_labor['hematokrit4050'] ?></center></td>
					<td>&nbsp;30 - 54 %</td>
					<td>&nbsp;GGT</td>
				...
				<tr>
					<td>&nbsp;&nbsp;  > 50 Hr - 2.5Bln</td>
					<td><center><?= $print_labor['hematokrit5025'] ?></center></td>
					<td>&nbsp;30 - 46 %</td>
					<td></td>
					<td></td>
					<td>&nbsp;P  <38 U/L</td>
				...
				<tr>
					<td>&nbsp;&nbsp;  2.6 - 3.5 Bln</td>
					<td><center><?= $print_labor['hematokrit2635'] ?></center></td>
					<td>&nbsp;31 - 43 %</td>
				...
				<tr>
					<td>&nbsp;&nbsp;  4  - 7 Bln</td>
					<td><center><?= $print_labor['hematokrit47'] ?></center></td>
					<td>&nbsp;32 - 44 %</td>
					<td>&nbsp;TRIGLISERIDA</td>
					<td><center><?= $print_labor['trigiserida'] ?></center></td>
					<td>&nbsp;60 - 150 mg/dl</td>
				...
				<tr>
					<td>&nbsp;&nbsp;  8 Bln  - 12 Bln</td>
					<td><center><?= $print_labor['hematokrit812'] ?></center></td>
					<td>&nbsp;35 - 43 %</td>
					<td>&nbsp;CHOLESTEROL</td>
					<td><center><?= $print_labor['cho'] ?></center></td>
					<td>&nbsp;L 120 - 200 mg/dl</td>
				...
				<tr>
					...
					<td>&nbsp;17 - 60 %</td>
					<td>&nbsp;CRP</td>
					<td><center><?= $print_labor['crp'] ?></center></td>
					<td>&nbsp;< 10 Mg/L</td>
				</tr>
				...
				<tr>
					<td>&nbsp;&nbsp; 37 Hr</td>
					<td><center><?= $print_labor['mcv37'] ?></center></td>
					<td>&nbsp;82 - 126 fl</td>
					<td>&nbsp;&nbsp;NA</td>
					<td><center><?= $print_labor['na'] ?></center></td>
					<td>&nbsp;128 - 138 mmol/l</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 1.5 - 2.5 Bln</td>
					<td><center><?= $print_labor['mcv1525'] ?></center></td>
					<td>&nbsp;81 - 121 fl</td>
					<td>&nbsp;&nbsp;K</td>
					<td><center><?= $print_labor['k'] ?></center></td>
					<td>&nbsp;3,9 - 4,9 mmol/l</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 2.6 - 3.5 Bln</td>
					<td><center><?= $print_labor['mcv2635'] ?></center></td>
					<td>&nbsp;77 - 113 fl</td>
					<td>&nbsp;&nbsp;CL</td>
					<td><center><?= $print_labor['cl'] ?></center></td>
					<td>&nbsp;88 - 100 mmol/l</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 3.5  - 7 Bln</td>
					<td><center><?= $print_labor['mcv357'] ?></center></td>
					<td>&nbsp;73 - 109 fl</td>
					<td>&nbsp;&nbsp; Ca</td>
					<td><center><?= $print_labor['ca'] ?></center></td>
					<td>&nbsp;0,99 - 1,29 mmol/l</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 37 Hr</td>
					<td><center><?= $print_labor['mch37'] ?></center></td>
					<td>&nbsp;26 - 38 pg/cell</td>
					<td>&nbsp;WIDAL</td>
					<td><center><?= $print_labor['widal'] ?></center></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 1 - 1.5 Bln</td>
					<td><center><?= $print_labor['mch115'] ?></center></td>
					<td>&nbsp;25- 387pg/cell</td>
					<td>&nbsp;TROPONIN </td>
					<td><center><?= $print_labor['troponin'] ?></center></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 2 - 2.5 Bln</td>
					<td><center><?= $print_labor['mch225'] ?></center></td>
					<td>&nbsp;24 - 36 pg/cell</td>
					<td>&nbsp;NS 1</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 2.6 - 3.5 Bln</td>
					<td><center><?= $print_labor['mch2635'] ?></center></td>
					<td>&nbsp;23 - 36 pg/cell</td>
					<td>&nbsp;IgG/IgM DENGUE</td>
					<td><center><?= $print_labor['dengue'] ?></center></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 3.6 - 10 Bln</td>
					<td><center><?= $print_labor['mch3610'] ?></center></td>
					<td>&nbsp;21 - 33 pg/cell</td>
					<td>&nbsp;IgG/IgM SALMONELLA</td>
					<td><center><?= $print_labor['salmonella'] ?></center></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 37 Hr</td>
					<td><center><?= $print_labor['mchc37'] ?></center></td>
					<td>&nbsp;25 - 37 g/dl</td>
					<td>&nbsp;B20 </td>
					<td><center><?= $print_labor['b20'] ?></center></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 40 Hr - 7 Bln</td>
					<td><center><?= $print_labor['mchc407'] ?></center></td>
					<td>&nbsp;26 - 34 g/dl</td>
					<td>&nbsp;VDRL</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 8 - 12 Bln</td>
					<td><center><?= $print_labor['mchc812'] ?></center></td>
					<td>&nbsp;28 - 32 g/dl</td>
					<td>&nbsp;GOLONGAN DARAH</td>
					<td><center><?= $print_labor['gol_darah'] ?></center></td>
					<td></td>
		...
		<table style="border: 0px solid black; ">
			<tr>
				<td style="font-size:11px; width:12%; font-weight:bold; border: 0px solid black; padding-bottom:0px;">Nama Pasien</td>
				<td style="font-size:11px; width:38%; border: 0px solid black; padding-bottom:0px;">:</td>
				<td style="font-size:11px; width:12%; font-weight:bold; border: 0px solid black; padding-bottom:0px;">Jenis Kelamin</td>
				<td style="font-size:11px; width:13%; border: 0px solid black; padding-bottom:0px;">: <?= $print_labor['jenis_kelamin']; ?></td>
				<td style="font-size:11px; width:13%; font-weight:bold; border: 0px solid black; padding-bottom:0px;">&nbsp;&nbsp;&nbsp;&nbsp;Jam Sampling</td>
				<td style="font-size:11px; width:13%; border: 0px solid black; padding-bottom:0px;">:  <?php date_default_timezone_get('Asia/Jakarta');
			...
			<tr>
				...
				<td style="font-size:11px; width:38%; border: 0px solid black; padding-bottom:0px;">: </td>
				<td style="font-size:11px; width:12%; font-weight:bold; border: 0px solid black; padding-bottom:0px;">Cara Bayar</td>
				<td style="font-size:11px; width:13%; border: 0px solid black; padding-bottom:0px;">: </td>
				<td style="font-size:11px; width:12%; font-weight:bold; border: 0px solid black; padding-bottom:0px;">&nbsp;&nbsp;&nbsp;&nbsp;Jam Selesai</td>
				<td style="font-size:11px; width:13%; border: 0px solid black; padding-bottom:0px;">: <?php date_default_timezone_get('Asia/Jakarta');
                                                   setlocale(LC_TIME, 'IND');
			...
			<tr>
				<td style="font-size:11px; width:12%; font-weight:bold; border: 0px solid black;">Tanggal</td>
				<td style="font-size:11px; width:38%; border: 0px solid black;">: <?php date_default_timezone_get('Asia/Jakarta');
																						   setlocale(LC_TIME, 'IND');
																						   echo strftime("%A, %e %B %Y"); ?></td>
				<td style="font-size:11px; width:12%; font-weight:bold; border: 0px solid black;">Poli / Kelas</td>
				<td style="font-size:11px; width:13%; border: 0px solid black;">: </td>
		...
		<table style="padding:10px; margin-top:15px; border-collapse: collapse;">
				...
				<tr>
					<td>&nbsp;&nbsp; 3.6 - 3.5 Bln</td>
					<td><center><?= $print_labor['mch3635'] ?></center></td>
					<td>&nbsp;23 - 36 pg/cell</td>
					<td>&nbsp;IgG/IgM DENGUE</td>
					<td><center><?= $print_labor['dengue'] ?></center></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 2.6 - 10 Bln</td>
					<td><center><?= $print_labor['mch2610'] ?></center></td>
					<td>&nbsp;21 - 33 pg/cell</td>
					<td>&nbsp;IgG/IgM SALMONELLA</td>
					<td><center><?= $print_labor['salmonella'] ?></center></td>
					<td></td>
