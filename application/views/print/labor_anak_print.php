		...
		<?php elseif ($print_labor['jenis_kelamin'] == 'LAKI-LAKI' && $print_labor['jenis_form'] == ''): ?>
			...
			<table style="padding:10px; margin-top:5px; border-collapse: collapse;">
				...
				<tr>
					...
					<td>&nbsp;25  - 40 Sec</td>
					<td>&nbsp;  14 - 18 Thn</td>
					<td><center><?= $print_labor['albumin1418'] ?></center></td>
					<td>&nbsp;3.2 - 4.5 mg/dl</td>
				</tr>
				...
				<tr>
					<td>&nbsp;&nbsp;  1 - 1.5 Thn</td>
					<td><center><?= $print_labor['hb115'] ?></center></td>
				...
				<tr>
					<td>&nbsp;&nbsp;  1.5 - 3 Thn</td>
					<td><center><?= $print_labor['hb153'] ?></center></td>
				...
				<tr>
					<td>&nbsp;&nbsp;  3 - 16 Thn</td>
					<td><center><?= $print_labor['hb316'] ?></center></td>
				...
				<tr>
					<td>&nbsp;&nbsp;  1 - 3 Thn</td>
					<td><center><?= $print_labor['hematokrit13'] ?></center></td>
					<td>&nbsp;35 - 43 %</td>
					<td>&nbsp;ALT / SGPT</td>
				...
				<tr>
					<td>&nbsp;&nbsp;  3 - 5 Thn</td>
					<td><center><?= $print_labor['hematokrit35'] ?></center></td>
					<td>&nbsp;31 -  43 %</td>
					<td>&nbsp;</td>
					<td></td>
					<td>&nbsp;P  7 - 35 U/L</td>
				...
				<tr>
					<td>&nbsp;&nbsp;  5 - 10 Thn</td>
					<td><center><?= $print_labor['hematokrit510'] ?></center></td>
					<td>&nbsp;33 - 45 %</td>
					<td></td>
					<td></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp;  10 - 16 Thn</td>
					<td><center><?= $print_labor['hematokrit1016'] ?></center></td>
					<td>&nbsp;31 - 45  %</td>
					<td>&nbsp;AST/SGOT</td>
					<td><center><?= $print_labor['sgot'] ?></center></td>
					<td>&nbsp;L  15 - 40 U/L</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 1 - 1.5 Thn</td>
					<td><center><?= $print_labor['mcv115'] ?></center></td>
					<td>&nbsp;74 - 106 fl</td>
					<td>&nbsp;CRP</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 1.5 - 3 Thn</td>
					<td><center><?= $print_labor['mcv153'] ?></center></td>
					<td>&nbsp;73 - 101 fl</td>
					<td></td>
					<td></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 3 - 5Thn</td>
					<td><center><?= $print_labor['mcv35'] ?></center></td>
					<td>&nbsp;72 - 88  fl</td>
					<td>&nbsp;ERITROSIT</td>
					<td><center><?= $print_labor['eritrosit'] ?></center></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 5 - 10 Thn</td>
					<td><center><?= $print_labor['mcv510'] ?></center></td>
					<td>&nbsp;69 - 93 fl</td>
					<td>&nbsp;&nbsp; - NA</td>
					<td><center><?= $print_labor['na'] ?></center></td>
					<td>&nbsp;128 - 138 mmol/l</td>
				...
				<tr>
					<td>&nbsp;&nbsp; > 10 Thn</td>
					<td><center><?= $print_labor['mcv10'] ?></center></td>
					<td>&nbsp;80 - 96 fl</td>
					<td>&nbsp;&nbsp; - K</td>
					<td><center><?= $print_labor['k'] ?></center></td>
					<td>&nbsp;3,9 - 4,9 mmol/l</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 1 -5 Thn</td>
					<td><center><?= $print_labor['mch15'] ?></center></td>
					<td>&nbsp;23 - 31 pg/cell</td>
					<td>&nbsp;&nbsp; - Ca</td>
					<td><center><?= $print_labor['ca'] ?></center></td>
					<td>&nbsp;0,99 - 1,29 mmol/l</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 5 - 10 Thn</td>
					<td><center><?= $print_labor['mch510'] ?></center></td>
					<td>&nbsp;22 - 34 pg/cell</td>
					<td></td>
					<td></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; > 10 Thn</td>
					<td><center><?= $print_labor['mch10'] ?></center></td>
					<td>&nbsp;28 - 33 pg/cell</td>
					<td>&nbsp;MALARIA</td>
					<td><center><?= $print_labor['malaria'] ?></center></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 1 - 1.5</td>
					<td><center><?= $print_labor['mchc115'] ?></center></td>
					<td>&nbsp;28 - 32 g/dl</td>
					<td>&nbsp;TROPONIN </td>
					<td><center><?= $print_labor['troponin'] ?></center></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 1.5 - 3 Thn</td>
					<td><center><?= $print_labor['mchc153'] ?></center></td>
					<td>&nbsp;26 - 34 g/dl</td>
					<td>&nbsp;NS 1 </td>
				...
				<tr>
					<td>&nbsp;&nbsp; 3 - 10 Thn</td>
					<td><center><?= $print_labor['mchc310'] ?></center></td>
					<td>&nbsp;32 - 36 g/dl</td>
					<td>&nbsp;IgG/IgM DENGUE</td>
					<td><center><?= $print_labor['dengue'] ?></center></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; > 10 Thn</td>
					<td><center><?= $print_labor['mchc10'] ?></center></td>
					<td>&nbsp;33 - 36 g/dl</td>
					<td>&nbsp;IgG/IgM SALMONELLA</td>
					<td><center><?= $print_labor['salmonella'] ?></center></td>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp; 1 - 15 Thn</td>
					<td><center><?= $print_labor['creatinin1115'] ?></center></td>
					<td>&nbsp;0.3 - 0.7 mg/dl</td>
				...
				<tr>
					<td>&nbsp;&nbsp; 15 - 18 Thn</td>
					<td><center><?= $print_labor['creatinin1518'] ?></center></td>
					<td>&nbsp;0.5 - 1.0 mg/dl</td>
					<td></td>
					<td></td>
					<td></td>
