...
<body onload="myFunction()">
    <div class="panel panel-default card-view">
        ...
        <div class="content">
            <label style="display:block; width:x; height:y;text-align: center;"><b>RESEP</b></label>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                ...
                                <!-- <td>
                                    <h1 style="margin-left: 20px; font-size: 50px; font-weight: bold;"> <?= strtoupper($antri[0]['inisial']) . $antri[0]['no_antri']; ?> </h1>
                                </td> -->
                                ...
                                <table width=100%>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td width="20%"><?php echo $row['tindakan'] . ', ' . $row['cara_pemakaian'] . ' (' . $row['keterangan'] . ')';  ?></td>
