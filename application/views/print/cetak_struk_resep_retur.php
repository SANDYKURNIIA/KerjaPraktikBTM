            ...
            ?>
                <tr>
                    ...
                    <td width="20%"><?php $harga = $row['total'] / $row['frek'];
                                    echo "Rp " . number_format(abs($harga), 0, ',', '.');   ?></td>
                    <td width="10%"><?php echo abs($row['frek']);
                                    ?></td>
                    <td width="20%"><?php echo "Rp " . number_format(abs($harga * $row['frek']), 0, ',', '.');  ?></td>
                    <td width="20%"><?php echo $row['keterangan'];  ?></td>

                </tr>
            <?php $sum += abs($harga) * abs($row['frek']);
            }
