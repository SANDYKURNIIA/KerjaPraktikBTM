            ...
            <table>
                <tr>
                    <td>
                        ...
                        echo "<br>TANGGAL MASUK : " . date("d M Y", strtotime($pasien['tgl_masuk'])) . ' - ' . str_replace('T', ' ', $tgl_keluar_rajal);
                                    ...
                                    <div class="table-wrap">
                                        <div class="table-responsive">
                                            <table id="datable_1" class="table table-hover display  pb-30">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $total_semua = $total_pelayanan + $apotik + $obatok + $igd + $labor + $radio + $anak
                                                    ...
                                                    <tr class="txt-dark" width="30%">
                                                        ...
                                                        <input type="hidden" id="opsi" value="<?php echo $opsi;  ?>">
                                                        <input type="hidden" id="total_bayar" value="<?php echo $total_bayar; ?>">
                                                        <input type="hidden" id="bayar_tunai" value="<?php echo $bayar_tunai; ?>">
                                                        <input type="hidden" id="karyawantunai" value="<?php echo $karyawantunai; ?>">
                                                        <input type="hidden" id="opsi_lanjut" value="<?php echo $opsi_lanjut; ?>">
                                                        <input type="hidden" id="jenis_bank" value="<?php echo $jenis_bank; ?>">
                                                        <input type="hidden" id="jenis_asuransi" value="<?php echo $jenis_asuransi; ?>">
                                                        <input type="hidden" id="opsi_bayar_aia" value="<?php echo $opsi_bayar_aia; ?>">
                                                        <input type="hidden" id="total_bayarAIA" value="<?php echo $total_bayarAIA; ?>">
                                                        <input type="hidden" id="inBayarAIA" value="<?php echo $inBayarAIA;  ?>">
                                                        <input type="hidden" id="karyawan_tunaiAIA" value="<?php echo $karyawan_tunaiAIA; ?>">
                                                        <input type="hidden" id="hutang" value="<?php echo $hutang; ?>">
                                                        <input type="hidden" id="hutangAIA" value="<?php echo $hutangAIA; ?>">
                                                        <input type="hidden" id="setara" value="<?php echo $setara; ?>">
                                                        <input type="hidden" id="setara2" value="<?php echo $setara2; ?>">
...
<script type="text/javascript">
    ...
    function myFunction() {
        ...
        bayar_tunai = $('#bayar_tunai').val();
        karyawantunai = $('#karyawantunai').val();
        opsi_lanjut = $('#opsi_lanjut').val();
        jenis_asuransi = $('#jenis_asuransi').val();
        jenis_bank = $('#jenis_bank').val();
        opsi_bayar_aia = $('#opsi_bayar_aia').val();
        total_bayarAIA = $('#total_bayarAIA').val();
        inBayarAIA = $('#inBayarAIA').val();
        karyawan_tunaiAIA = $('#karyawan_tunaiAIA').val();
        hutang = $('#hutang').val();
        hutangAIA = $('#hutangAIA').val();
        setara = $('#setara').val();
        setara2 = $('#setara2').val();
        $.ajax({
            type: "POST",
