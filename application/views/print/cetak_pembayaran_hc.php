            ...
            <table>
                <tr>
                    ...
                    <td> <?php
                            ...
                            echo "<br>TANGGAL MASUK : " . date('d M Y H:i', strtotime($pasien['tanggal']));
                ...
                <div class="kolom">
                    <div class="row ">
                        <div class="col-sm-12">
                            ...
                            <h4 class="panel-title txt-dark"> TINDAKAN HOMECARE</h4>
                            ...
                            if (count($obat) > 0) { ?>
                                ...
                                <table id="datable_1" class="table table-hover display  pb-30">
                                    ...
                                    <tbody>
                                        ...
                                        // $ranap = $this->db->query("SELECT sum(total) total from tindakan_farmasi where id_pelayanan ='$inMcu' and depo ='RANAP'")->row();
                                        // if (($ranap->total) > 0) {
                                        //     $ppn = 0;
                                        // } else {
                                            $ppn = $apotik * 0.11;
