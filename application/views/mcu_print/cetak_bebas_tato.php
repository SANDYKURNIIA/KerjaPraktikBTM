                    ...
                    <table style="margin-left:40px" cellspacing=0>
                        <tr height=10px>
                            <td width=200px colspan=2>
                                Yang bertanda tangan dibawah ini, Dokter Rumah Sakit Bakti Timah Karimun, dengan ini menerangkan bahwa :
                            </td>
                        </tr>
                        <tr height=10px>
                            <td width=265px>
                        ...
                        <tr height=20px>
                            <td colspan=2>
                                <br>
                                <br>
                                1. 1.	Telah melakukan pemeriksaan fisik pasien tersebut dengan hasil <b><?=$sehat?></b>
                                <br>
                                <br>
                               
                                2. Pemeriksaan Tgl <?=indo_date2($tgl_periksa)?> (<?=$labor?>) dengan hasil pemeriksaan <b><?=$hasil?> (Hasil laboratorium terlampir).</b>
                ...
                <table style="float: right;" cellpadding="5">
                    ...
                    <tbody>
                        ...
                        <tr class="txt-dark" width="30%">
                            <td>Tanjung Balai Karimun, <?= indo_date2($tgl_periksa) ?></td>
