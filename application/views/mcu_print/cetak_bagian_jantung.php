    ...
    <table width=100% cellspacing=0>
            ...
            <td>
                ...
                <h3 style="margin-top:-10px; text-align: center;">
                    <b><u>
                            <br>
                            <br>
                            PEMERIKSAAN BAGIAN PENYAKIT JANTUNG
                    </b></u>
                </h3>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <table  cellspacing=0 >
                    <tr height=70px>
                        <td width=200px colspan=2 style="text-align: left;">
                    ...
                    <tr height=70px>
                        <td colspan=2>
                            ...
                            Telah melakukan pemeriksaan Jantung kepada pasien tersebut dengan hasil :
                            <br>
