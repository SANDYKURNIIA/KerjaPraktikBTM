...
<script>
    $(document).ready(function(e) {
        ...
        steps = new Array();
        // Set up the canvas
        var canvas2 = document.getElementById("can1");
        ...
        clearBtn1.addEventListener("click", function(e) {
            ...
            var img = new Image();
            img.onload = function() {
                ctx2.drawImage(img, 0, 0, 500, 700);
                steps.length = 0;
        ...
        submitBtn1.addEventListener("click", function(e) {
            ...
            var img = new Image();
            img.onload = function() {
                ctx3.drawImage(img, 0, 0, 500, 700);
                steps.length = 0;
            ...
            img1.onload = function() {
                ctx2.drawImage(img1, 0, 0, 500, 700);
                // ctx2.scale(1, 0.5);
                steps.length = 0;
                steps[no] = ctx2.getImageData(0, 0, canvas2.width, canvas2.height);
            }
            img1.src = '<?php echo $gambar; ?>';
