...
<!-- Link cdn icon-->
<!-- <script src="https://kit.fontawesome.com/f5db2dff69.js" crossorigin="anonymous"></script> -->
...
<div class="fixed-sidebar-left">
	...
	<ul class="nav navbar-nav side-nav nicescroll-bar">
		...
		<?php if ($datatipe == 'rekam medis' && $status == 'aktif') { ?>
			...
			<li>
				<a href="<?= base_url('Vclaim/Peserta') ?>"><i class="icon-magnifier mr-10"></i>PESERTA BPJS</a>
			</li>
			<li>
			...
			<li>
				...
				<ul id="dashboard_dr" class="collapse collapse-level-1">
					...
					<?php if ($user == '20171016') { ?>
						<li>
							<a href="<?= base_url('Pasien/Pasien_rajal_all') ?>">TAMPIL SEMUA PASIEN POLI</a>
						</li>
					<?php } ?>
					<li>
			...
			<li>
				<a href="<?= base_url('Laporan/Laporan_pt_igd_ranap'); ?>">LAPORAN PENYAKIT TERTINGGI IGD RANAP</a>
			</li>
			<li>
			...
			<li>
				<a href="<?= base_url('Laporan_kunjungan_dokpri') ?>"><i class="icon-hourglass mr-10"></i>LAPORAN KUNJUNGAN DOKTER PRIO</a>
			</li>
			<li>
				<a href="<?= base_url('Laporan_biometri') ?>"><i class="icon-hourglass mr-10"></i>LAPORAN BIOMETRI</a>
			</li>
			<li>
				<a href="<?= base_url('Antrian_poli') ?>"><i class="icon-hourglass mr-10"></i>ANTRIAN POLI</a>
			</li>
			<li>
				<a href="<?= base_url('Erm_edit_staff/edit_staff') ?>"><i class="icon-hourglass mr-10"></i>EDIT STAFF</a>
			</li>
			...
			<li>
				<a data-toggle="collapse" style="cursor:pointer;" data-target="#bpjs"><i class="icon-graph mr-10"></i>VCLAIM BPJS<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
				<ul id="bpjs" class="collapse collapse-level-1">
					<li>
						<a href="<?= base_url('Vclaim/Monitoring') ?>">MONITORING KUNJUNGAN</a>
					</li>
					<li>
						<a href="<?= base_url('Vclaim/Monitoring_klaim') ?>">MONITORING KLAIM</a>
					</li>
					<li>
						<a href="<?= base_url('Vclaim/Prb') ?>"><i class="icon-magnifier mr-10"></i>PENCARIAN PRB</a>
					</li>

					<li>
						<a href="<?= base_url('Vclaim/Cari_Sep_Internal') ?>"><i class="icon-magnifier mr-10"></i>SEP INTERNAL</a>
					</li>
					<li>
						<a href="<?= base_url('SEP/List_rujukan') ?>"><i class="icon-graph mr-10"></i>LIST RUJUKAN KELUAR RS</a>
					</li>
					<li>
						<a href="<?= base_url('SEP/List_rujukan_khusus') ?>"><i class="icon-graph mr-10"></i>LIST RUJUKAN KHUSUS</a>
					</li>
				</ul>
			</li>
			<li>
			...
			<li>
				<a href="<?= base_url('Task_Id') ?>"><i class="ti-package mr-10 "></i>TASK ID </a>
			</li>


		<?php } elseif (($datatipe == 'poliinternis' || $datatipe == 'poliobgyne' || $datatipe == 'politht' || $datatipe === 'polimata' || $datatipe == 'polikulit' || $datatipe == 'poliumum' || $datatipe == 'polianak' || $datatipe == 'poligigi' || $datatipe == 'polijantung' || $datatipe == 'polibedah' || $datatipe == 'rehab'
			|| $datatipe == 'polihemodialisa' || $datatipe == 'poliakupuntur' || $datatipe == 'polibedahmulut' || $datatipe == 'polikesjiwa' || $datatipe == 'poliorthopedi' || $datatipe == 'poliparu' || $datatipe == 'polisaraf' || $datatipe == 'poliurologi' || $datatipe == 'polipenyakitmulut' || $datatipe == 'poliginjal' || $datatipe == 'polipsikolog' || $datatipe == 'poligizi'
			|| $datatipe == 'terapiwicara' || $datatipe == 'kemoterapi' || $datatipe == 'polistifin' || $datatipe == 'poliorthodonti' || $datatipe == 'konservasigigi' || $datatipe == 'okupasi') && $status = 'aktif') {
			if ($datatipe == 'poliinternis') {
				...
				$nama = "POLI STIFIN";
			} elseif ($datatipe == 'poliorthodonti') {
				$nama = "POLI ORTHODONTI";
			} elseif ($datatipe == 'konservasigigi') {
				$nama = "KONSERVASI GIGI";
			} elseif ($datatipe == 'okupasi') {
				$nama = "OKUPASI";
			}
		?>
			<li>
			...
			<li>
				<a href="<?= base_url('Rawatinap/pasien_odc') ?>"><i class="icon-hourglass mr-10"></i>PASIEN ODC</a>
			</li>
			<!-- <li>
			...
			<li>
				<a href="<?= base_url('Pengeluaran_obat_unit') ?>"><i class="ti-package mr-10 "></i>PENGELUARAN OBAT UNIT</a>
			</li>

			<!-- <li>
				<a href="<?= base_url('Logistik_farmasi/Laporan_persediaan'); ?>">STOK OPNAME</a>
			</li>
			<li>
				<a href="<?= base_url('Laporan_farmasi/Laporan_persediaan/unit'); ?>">LAPORAN PERSEDIAAN</a>
			</li> -->
			<li>
				<a href="<?= base_url('Laporan_diagnosa_tbc/'); ?>">LAPORAN DIAGNOSA TBC</a>
			</li>
			<li>
				<a href="<?= base_url('Laporan/Laporan_obat_fopi') ?>"><i class="icon-hourglass mr-10"></i>FORMULARIUM OBAT</a>
			</li>
			<li>
		...
		<?php } elseif ($datatipe == 'igd' || $datatipe == 'ppm' && $status == 'aktif') { ?>
			...
			<?php if ($user == '20199128') { ?>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan/laporan_operasional_penunjang') ?>"><i class="icon-note mr-10 "></i>LAPORAN OPERASIONAL PENUNJANG</a>
				</li>
			<?php } ?>
			<li>
				<a class="klik_menu" id="kriteriaHais" href="<?= base_url('IGD/Kriteria_Hais') ?>"><i class="icon-drawar mr-10 "></i>KRITERIA HAIS </a>
			</li>
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan_kunjungan_ranap') ?>"><i class="icon-note mr-10 "></i>LAPORAN KUNJUNGAN RAWAT INAP</a>
			</li>
		...
		<?php } elseif ($datatipe == 'gizi') { ?>
			...
			<li>
				<a href="<?= base_url('Rawatinap/pasien_gizi') ?>"><i class="ti-package mr-10 "></i>DATA PASIEN GIZI </a>
			</li>
			<li>
				<a href="<?= base_url('Rawatinap/riwayat_pasien_gizi') ?>"><i class="ti-package mr-10 "></i>HISTORI PASIEN GIZI </a>
			</li>
			<!-- <li>
		...
		<?php } elseif ($datatipe == 'operasional' && $status == 'aktif') { ?>
			<!-- ZIDANE -->
			<li>
				<a href="<?= base_url('Laporan/bor') ?>"><i class="icon-hourglass mr-10"></i>LAPORAN BOR</a>
			</li>
			<li>
				<a href="<?= base_url('Jasamedis') ?>"><i class="icon-hourglass mr-10"></i>LAPORAN JASMED</a>
			</li>
		...
		<?php } elseif ($datatipe == 'rawatinap' && $status == 'aktif') { ?>
			...
			<li>
				<a href="<?= base_url('OK_Pasien/Poli') ?>"><i class="icon-people mr-10"></i>PASIEN POLI OK</a>
			</li>
			<!-- <li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Rawatinap/Pasien_riwayat') ?>"><i class="icon-note mr-10 "></i>RIWAYAT PASIEN RANAP</a>
			</li> -->
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan_kunjungan_ranap') ?>"><i class="icon-note mr-10 "></i>LAPORAN KUNJUNGAN RAWAT INAP</a>
			</li>
			...
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Erm_ranap/erm_ranap') ?>"><i class="icon-note mr-10 "></i>RIWAYAT ERM RANAP</a>
			</li>

			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Apelkes/ranap') ?>"><i class="fa fa-money mr-10 "></i>TAGIHAN SEMENTARA</a>
			</li>
			<!-- <li>
				<a href="<?= base_url('Obat_bebas') ?>"><i class="ti-package mr-10 "></i>OBAT BEBAS</a>
			</li> -->
			<?php if ($izinAkses == 'admin') { ?>
				...
				<li>
					<a href="<?= base_url('Rawatinap/perawat_inap') ?>"><i class="icon-hourglass mr-10"></i>UBAH RUANGAN PERAWAT</a>
				</li>
				<li>
			...
			<li>
				<a href="<?= base_url('laporan_diagnosa_diare') ?>"><i class="icon-note mr-10 "></i>LAPORAN DIAGNOSA DIARE </a>
			</li>
		...
		<?php } elseif ($datatipe == 'radiologi' && $status == 'aktif') { ?>
			...
			<!-- <li>
				<a href="<?= base_url('Radiologi/PasienUSG2') ?>"><i class="icon-user-follow mr-10 "></i>PAS USG 21</a>
			</li>
			<li>
				<a href="<?= base_url('Radiologi/PasienCT2') ?>"><i class="icon-user-follow mr-10 "></i>PAS CT 22</a>
			</li>
			<li>
				<a href="<?= base_url('Radiologi/PasienRontgen2') ?>"><i class="icon-user-follow mr-10 "></i>PAS RONTGEN 23</a>
			</li> -->
		...
		<?php } elseif ($datatipe == 'ok' && $status == 'aktif') { ?>
			...
			<li>
				<a href="<?= base_url('OK_Pasien/Laporan_Cetak_so'); ?>"><i class="ti-printer mr-10"></i>CETAK SO OK</a>
			</li>
			<li>
...
<?php } elseif ($datatipe == 'polifisio' && $status == 'aktif') { ?>
	...
	<li>
		<a href="<?= base_url('Pasien/Riwayat_Pasien_Fisio') ?>"><i class="icon-user-follow mr-10 "></i>RIWAYAT PASIEN FISIO</a>
	</li>
	<li>
		<a href="<?= base_url('Permintaan_obat_unit') ?>"><i class="icon-drawar mr-10"></i>PERMINTAAN OBAT</a>
	</li>
...
<?php } elseif (($datatipe == 'labor' || $datatipe == 'laboratorium') && $status == 'aktif') { ?>
	...
	<li>
		...
		<ul id="ui_admin" class="collapse collapse-level-1">
			...
			<li>
				<a href="<?= base_url('Labor/Laporan_kunjungan_labor_mcu') ?>"><i class="icon-doc mr-10 "></i>LAPORAN KUNJUNGAN & PENDAPATAN LABOR MCU</a>
			</li>
			<li>
				<a href="<?= base_url('Labor/laporan_tindakan') ?>"><i class="icon-doc mr-10 "></i>LAPORAN LABOR
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TINDAKAN</a>
			...
			<li>
				<a href="<?= base_url('Labor/laporan_pasien_gram') ?>"><i class="icon-doc mr-10 "></i>LAPORAN PASIEN PENGECATAN GRAM</a>
			</li>
			<li>
...
<?php } elseif ($datatipe == 'logistik farmasi' && $status == 'aktif') { ?>
	...
	<li>
		<a href="<?= base_url('Penerimaan_obat') ?>"><i class="ti-package mr-10 "></i>PENERIMAAN OBAT </a>
	</li>
	<li>
		<a href="<?= base_url('Pengeluaran_obat_rs') ?>"><i class="ti-package mr-10 "></i>PENGELUARAN OBAT </a>
	</li>
	<li>
	...
	<li>
		...
		<ul id="ui_dr" class="collapse collapse-level-1">
			...
			<li>
				<a href="<?= base_url('Logistik_farmasi/Laporan_pembelian_hibah'); ?>">LAPORAN PEMBELIAN HIBAH</a>
			</li>
			<li>
				<a href="<?= base_url('Pembelian_obat_bebas/Laporan_pembelian_donasi'); ?>">LAPORAN OBAT DONASI</a>
			</li>
			<li>
	...
	<li>
		<a data-toggle="collapse" data-target="#laporanscm"><i class="icon-note mr-10"></i>LAPORAN OBAT SCM <span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="laporanscm" class="collapse collapse-level-1">
			<li>
				<a href="<?= base_url('LaporanMaterial_Scm/Laporan_scm/material') ?>"><i class="icon-drawar mr-10 "></i>LAPORAN MATERIAL SCM </a>
			</li>
			<li>
				<a href="<?= base_url('LaporanMaterial_Scm/Laporan_scm/obat') ?>"><i class="icon-drawar mr-10 "></i>LAPORAN OBAT SCM </a>
			</li>
			<li>
				<a href="<?= base_url('ApotekLuar_ObatScm/Menu/obat') ?>"><i class="ti-package mr-10 "></i>APOTEK LUAR OBAT SCM </a>
			</li>
			<li>
				<a href="<?= base_url('ApotekLuar_ObatScm/Menu/bmhp') ?>"><i class="ti-package mr-10 "></i>APOTEK LUAR OBAT BMHP SCM </a>
			</li>
			<li>
				<a href="<?= base_url('Billing_ListingObat') ?>"><i class="ti-package mr-10 "></i>BILLING LISTING OBAT </a>
			</li>
			<li>
				<a href="<?= base_url('AgingObat_Scm/Menu/obat') ?>"><i class="ti-package mr-10 "></i>AGING OBAT SCM </a>
			</li>
			<li>
				<a href="<?= base_url('AgingObat_Scm/Menu/bmhp') ?>"><i class="ti-package mr-10 "></i>AGING BMHP SCM </a>
			</li>
		</ul>
	</li>
	<li>
	...
	<li>
		<a href="<?= base_url('Laporan_farmasi/Laporan_persediaan/all'); ?>">LAPORAN PERSEDIAAN SEMUA UNIT</a>
	</li>
	<li>
		<a href="<?= base_url('Permintaan_obat_unit') ?>"><i class="icon-drawar mr-10"></i>PERMINTAAN OBAT</a>
	</li>
...
<?php } elseif ($datatipe == 'mcu' && $status == 'aktif') { ?>
	...
	<li>
		<a class="klik_menu" id="ranap" href="<?= base_url('Kasir/Pasien_mcu') ?>"><i class="icon-drawar mr-10 "></i>KASIR PASIEN MCU</a>
	</li>
	<!-- <li>
...
<?php } elseif ($datatipe == 'edp' && $status == 'aktif') { ?>
	...
	<li>
		<a href="<?= base_url('Master_staff') ?>"><i class="icon-drawar mr-10 "></i>MASTER STAFF </a>
	</li>
	...
	<li>
		<a href="<?= base_url('AgingObat_Scm') ?>"><i class="ti-package mr-10 "></i>AGING OBAT SCM </a>
	</li>
	<li>
		<a href="<?= base_url('Jurnal_Biaya_farmasi/laporan_persediaan_material') ?>"><i class="ti-package mr-10 "></i>LAPORAN PERSEDIAAN </a>
	</li>
	<li>
		<a href="<?= base_url('Laporan_diagnosa_tbc/tampil_bhce') ?>"><i class="ti-package mr-10 "></i>LAPORAN BCHE </a>
	</li>
	<li>
		<a href="http://36.92.141.3/SITB_monitoring/adminController"><i class="icon-drawar mr-10  "></i>TBC MONITORING</a>
	</li>
...
<?php } elseif ($datatipe == 'rawatjalan' && $status == 'aktif') { ?>
	...
	<li>
		<a style="cursor:pointer;" data-toggle="collapse" data-target="#rl1"><i class="icon-graph mr-10"></i>LAPORAN OPERASIONAL<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="rl1" class="collapse collapse-level-1">
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan/laporan_penunjang') ?>"><i class="icon-note mr-10 "></i>LAPORAN TINDAKAN PENUNJANG</a>
			</li>
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan/laporan_operasional_penunjang') ?>"><i class="icon-note mr-10 "></i>LAPORAN UNIT PENUNJANG</a>
			</li>
			<li>
			...
			<li>
				<a href="<?= base_url('Laporan') ?>">LAPORAN KUNJUGAN </a>
			</li>
		</ul>
	</li>
	<li>
...
<?php } elseif (($datatipe == 'apotik' && $status == 'aktif') || ($datatipe == 'deporanap' && $status == 'aktif')) { ?>
	...
	<li>
		<a class="klik_menu" id="permintaanobata" href="<?= base_url('Apotik_poli/Riwayat_resep_manual') ?>"><i class="icon-people mr-10 "></i>RIWAYAT FARMASI</a>
	</li>
	<li>
		<a href="<?= base_url('Laporan_obat_ruangan_ranap') ?>"><i class="icon-hourglass mr-10"></i>LAPORAN OBAT RUANGAN RANAP</a>
	</li>
	<li>
	...
	<li>
		<a href="<?= base_url('Laporan_total_billing_dan_diagnosa') ?>"><i class="ti-package mr-10 "></i>LAPORAN TOTAL BILLING DAN DIAGNOSA</a>
	</li>
	<li>
		<a href="<?= base_url('Logistik_farmasi/Laporan_persediaan'); ?>">STOK OPNAME</a>
	</li>
	...
	?>
		...
		<li>
			<a class="klik_menu" id="permintaanobata" href="<?= base_url('Laporan_farmasi/Laporan_respon_time_non') ?>"><i class="icon-people mr-10 "></i>LAPORAN RESPON TIME NON RACIKAN</a>
		</li>
		<li>
			<a class="klik_menu" id="permintaanobata" href="<?= base_url('Laporan_farmasi/Laporan_respon_time_racikan') ?>"><i class="icon-people mr-10 "></i>LAPORAN RESPON TIME RACIKAN</a>
		</li>
		<li>
			<a class="klik_menu" id="permintaanobata" href="<?= base_url('Logistik_farmasi/Laporan_persediaan') ?>"><i class="icon-graph mr-10 "></i>LAPORAN PERSEDIAAN OBAT</a>
		</li>
		<li>
		...
		<li>
			...
			<ul id="laporanscm" class="collapse collapse-level-1">
				...
				<li>
					<a href="<?= base_url('AgingObat_ScmMenu/bmhp') ?>"><i class="ti-package mr-10 "></i>AGING BMHP SCM </a>
				</li>
			</ul>
		</li>
		<li>
...
<?php } elseif ($datatipe == 'kasir' && $status == 'aktif') { ?>
	...
	<li>
		...
		<ul id="dashboard_pasien" class="collapse collapse-level-1">
			...
			<li>
				<a class="klik_menu" id="ranap" href="<?= base_url('Kasir/Pasien_kamar_jenazah') ?>"><i class="icon-drawar mr-10 "></i>PASIEN KAMAR JENAZAH</a>
			</li>
			<!-- <li>
	...
	<li>
		...
		<ul id="dashboard_poli" class="collapse collapse-level-1">
			...
			<li>
				<a class="klik_menu" id="ranap" href="<?= base_url('Kasir_poli/okupasi') ?>"><i class="icon-drawar mr-10 "></i>POLI OKUPASI</a>
			</li>
			<li>
			...
			<li>
				<a class="klik_menu" id="ranap" href="<?= base_url('Kasir_poli/konservasi_gigi') ?>"><i class="icon-drawar mr-10 "></i>POLI KONSERVASI GIGI</a>
			</li>
		</ul>
	</li>
	<li>
		...
		<ul id="dashboard_pulang" class="collapse collapse-level-1">
			...
			<li>
				<a href="<?= base_url('Kasir/Pasien_pulang_hc'); ?>"><i class="fa fa-share mr-10 "></i>PASIEN PULANG HOMECARE</a>
			</li>
			<?php if ($id_staff == 'STF2180' || $id_staff == 'tr7281yy' || $id_staff == 'STF3556') { ?>
				<li>
					<a href="<?= base_url('CetakBilling') ?>"><i class="icon-hourglass mr-10"></i>CETAK BILLING</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Rawatinap/Pasien_riwayat') ?>"><i class="icon-note mr-10 "></i>KEMBALIKAN CO PASIEN RANAP</a>
				</li>
				<li>
					<a class="klik_menu" id="ranap" href="<?= base_url('Casemix/Pasien_ranap') ?>"><i class="icon-drawar mr-10 "></i>PASIEN CASEMIX RANAP</a>
				</li>
			<?php } ?>
	...
	<li>
		<a style="cursor:pointer;" data-toggle="collapse" data-target="#dashboard_pend"><i class="icon-docs mr-10"></i> PENDAPATAN KASIR <span class="pull-right"><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="dashboard_pend" class="collapse collapse-level-1">
			<li>
				<a href="<?= base_url('Kasir/Pendapatan_tunai'); ?>"><i class="icon-doc mr-10 "></i>VERIFIKASI PENDAPATAN KASIR</a>
			</li>
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan/Laporan_total_kasir') ?>">LAPORAN TOTAL KASIR</a>
			</li>
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Kasir/Laporan_pendapatan') ?>">LAPORAN PENDAPATAN KASIR HARIAN</a>
			</li>
		</ul>
	</li>
	<li>
		...
		<ul id="total11" class="collapse collapse-level-1">
			...
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan/Laporan_pendapatan_rajal') ?>">LAPORAN TOTAL POLI</a>
			</li>
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan/Laporan_pendapatan_igd') ?>">LAPORAN TOTAL IGD</a>
			</li>
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan/Laporan_total_pasien') ?>">LAPORAN TOTAL PASIEN</a>
			</li>
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan_kunjungan_ranap/Laporan_pengisian_ranap') ?>">LAPORAN PENGISIAN RANAP</a>
			</li>
			<li>
				<a href="<?= base_url('Laporan/Laporan_staff_kasir') ?>">LAPORAN PENDAPATAN KASIR</a>
			</li>
	...
	?>
		<li>
			<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan/laporan_belum_checkout') ?>">LAPORAN PASIEN BELUM CHECKOUT</a>
		</li>
		<li>
...
<?php } elseif ($datatipe == 'bendahara' && $status == 'aktif') { ?>
	...
	<li>
		...
		<ul id="jurnal" class="collapse collapse-level-1">
			...
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Keuangan_IJD/Bymhd_ijd') ?>">AKTUAL IJD</a>
			</li>
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Keuangan_IJD/Summary_ijd') ?>">LAPORAN JURNAL IJD</a>
			</li>
			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Keuangan_IJD/Pembayaran_IJD') ?>">PEMBAYARAN IJD</a>
			</li>
		</ul>
	</li>
	...
	<?php } ?>
<?php } elseif ($datatipe == 'administrasi medis' && $status == 'aktif') { ?>
...
<?php } elseif ($datatipe == 'keuangan') { ?>
	<?php if ($data->ruangan == 'utang_farmasi') { ?>
		<li>
			...
			<ul id="dashboard_keu_logfar" class="collapse collapse-level-1">
				...
				<li>
					<a href="<?= base_url('Pembelian_obat_bebas') ?>"></i>PENERIMAAN OBAT PEBAL</a>
				</li>
				<li>
		...
		<li>
			<a href="<?= base_url('CetakBilling') ?>"><i class="icon-hourglass mr-10"></i>CETAK BILLING ALL</a>
		</li>

		<li>
			<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/pelacakan_npb') ?>"><i class="fa fa-search mr-10"></i>PELACAKAN NPB</a>
		</li>
		<li>
			<a data-toggle="collapse" data-target="#jurnal_far"><i class="fa fa-folder mr-10"></i>JURNAL PERSEDIAAN<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
			<ul id="jurnal_far" class="collapse collapse-level-1">
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Verifikasi_farmasi') ?>">VERIFIKASI PERSEDIAAN</a>
				</li>

				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Jurnal_persediaan_farmasi') ?>">JURNAL PERSEDIAAN</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Jurnal_farmasi_verifikasi/persediaan') ?>">VERIFIKASI JURNAL</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Laporan_jurnal_farmasi/persediaan') ?>">LAPORAN JURNAL PERSEDIAAN</a>
				</li>

			</ul>
		</li>
		<li>
			<a data-toggle="collapse" data-target="#jurnal_far1"><i class="fa fa-folder mr-10"></i>JURNAL UTANG<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
			<ul id="jurnal_far1" class="collapse collapse-level-1">

				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Verifikasi_hutang_farmasi') ?>">VERIFIKASI UTANG</a>
				</li>

				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Jurnal_hutang_farmasi') ?>">JURNAL UTANG</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Jurnal_farmasi_verifikasi/hutang') ?>">VERIFIKASI JURNAL</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Laporan_jurnal_farmasi/hutang') ?>">LAPORAN JURNAL UTANG</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_utang_piutang/Aging/utang') ?>">LAPORAN AGING UTANG</a>
				</li>
			</ul>
		</li>

		<li>
			<a data-toggle="collapse" data-target="#pembayaran-piutang"><i class="fa fa-folder mr-10"></i>PIUTANG<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
			<ul id="pembayaran-piutang" class="collapse collapse-level-1">
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_keuangan/Laporan_jurnal_rajal_nontunai') ?>">JURNAL PYMHD RAJAL</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_keuangan_nontunai/Jurnal_rajal_nontunai') ?>">JURNAL RAJAL NON TUNAI</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_keuangan/Laporan_jurnal_ranap_nontunai') ?>">JURNAL PYMHD RANAP</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_keuangan_nontunai/Jurnal_ranap_nontunai') ?>">JURNAL RANAP NON TUNAI</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_utang_piutang/Pembayaran_piutang') ?>">PEMBAYARAN PIUTANG</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_utang_piutang/Aging/pymhd') ?>">LAPORAN AGING PYMHD</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_utang_piutang/Aging/piutang') ?>">LAPORAN AGING PIUTANG</a>
				</li>
			</ul>
		</li>
		<li>
			<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_keuangan_nontunai/Verifikasi_jurnal/PYMHD') ?>">VERIFIKASI JURNAL PYMHD</a>
		</li>
		<li>
			<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_keuangan_nontunai/Verifikasi_jurnal/PIUTANG') ?>">VERIFIKASI JURNAL PIUTANG</a>
		</li>
		<li>
			<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_keuangan/Verifikasi_jurnal_pendapatan') ?>">VERIFIKASI JURNAL PENDAPATAN</a>
		</li>
		<li>
			<a data-toggle="collapse" data-target="#bukti_kas"><i class="fa fa-folder mr-10"></i>BUKTI KAS/BANK<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
			<ul id="bukti_kas" class="collapse collapse-level-1">

				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Bukti_kas') ?>">BUKTI KAS/BANK</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Verifikasi_Bukti_kas') ?>">VERIFIKASI BUKTI KAS/BANK</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Sisa_utang_vendor') ?>">LAPORAN SISA PEMBAYARAN UTANG</a>
				</li>
			</ul>
		</li>
		<li>
			...
			<ul id="jurnalkas" class="collapse collapse-level-1">
				...
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_kasbank/Laporan/kas') ?>">LAPORAN JURNAL KAS</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_kasbank/Laporan/bank') ?>">LAPORAN JURNAL BANK</a>
				</li>
			</ul>
		</li>
		<li>
			...
			<ul id="jurnal2" class="collapse collapse-level-1">
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_keuangan_nontunai/Laporan_summary_nontunai/PYMHD') ?>">LAPORAN JURNAL PYMHD</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_keuangan_nontunai/Laporan_summary_nontunai/PIUTANG') ?>">LAPORAN JURNAL PIUTANG</a>
				</li>
				<li>
		...
		<li>
			<a style="cursor:pointer;" data-toggle="collapse" data-target="#jurnalRupa"><i class="icon-note mr-10"></i>JURNAL RUPA-RUPA<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
			<ul id="jurnalRupa" class="collapse collapse-level-1">
				<li>
	...
	<?php } else if ($data->ruangan == 'piutang') { ?>
		<li>
		...
		<li>
			<a class="klik_menu" id="rajal" href="<?= base_url('Kasir_poli/obat_bebas') ?>"><i class="icon-drawar mr-10 "></i>BILLING OBAT BEBAS</a>
		</li>
		<li>
			<a class="klik_menu" id="ranap" href="<?= base_url('Kasir/Pasien_mcu') ?>"><i class="icon-drawar mr-10 "></i>BILLING PASIEN MCU</a>
		</li>
		...
		<li>
			<a data-toggle="collapse" data-target="#dashboard_pulang"><i class="icon-grid mr-10"></i>PASIEN PULANG<span class="pull-right"><span class="label label-success mr-12">3</span><i class="fa fa-fw fa-angle-down"></i></span></a>
			<ul id="dashboard_pulang" class="collapse collapse-level-1">
				<?php if ($id_staff == 'tr7281yy') { ?>
					<li>
						<a class="klik_menu" id="ranap" href="<?= base_url('Casemix/Pasien_ranap') ?>"><i class="icon-drawar mr-10 "></i>CASEMIX RANAP</a>
					</li>
					<li>
						<a class="klik_menu" id="tambahan" href="<?= base_url('Rawatinap/Pasien_riwayat') ?>"><i class="icon-note mr-10 "></i>KEMBALIKAN CO PASIEN RANAP</a>
					</li>
		...
		<li>
			...
			<ul id="pembayaran-piutang" class="collapse collapse-level-1">
				...
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_utang_piutang/Pembayaran_piutang_non_verif') ?>">PEMBAYARAN TIDAK LULUS VERIFIKASI</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_utang_piutang/Aging/pymhd') ?>">LAPORAN AGING PYMHD</a>
				</li>
				...
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_piutang/Sisa_piutang_vendor') ?>">LAPORAN SISA PIUTANG</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_piutang/Sisa_piutang_vendor_pasien') ?>">LAPORAN SISA PIUTANG PASIEN</a>
				</li>

			</ul>
		</li>
		<li>
			<a style="cursor:pointer;" data-toggle="collapse" data-target="#jasmed"><i class="icon-note mr-10"></i>LAPORAN JASA MEDIS<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
			<ul id="jasmed" class="collapse collapse-level-1">
				<li>
					<a href="<?= base_url('Jasamedis/realese') ?>"><i class="icon-hourglass mr-10"></i>LAPORAN JASMED SETELAH REALISASI</a>
				</li>
				<li>
					<a href="<?= base_url('Jasamedis') ?>"><i class="icon-hourglass mr-10"></i>LAPORAN JASMED SEMUA</a>
				</li>
	...
	<?php } else { ?>
		...
		<li>
			<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan_pendapatan/Laporan_revenue') ?>"><i class="fa fa-file mr-10 "></i>LAPORAN REVENUE</a>
		</li>
		<li>
			<a data-toggle="collapse" data-target="#dashboard_pulangg"><i class="icon-grid mr-10"></i>PENDAPATAN KASIR PER PASIEN<span class="pull-right"><span class="label label-success mr-12">3</span><i class="fa fa-fw fa-angle-down"></i></span></a>
			<ul id="dashboard_pulangg" class="collapse collapse-level-1">
				<li>
					<a href="<?= base_url('Kasir_pendapatan/Pasien_pulang_poli2'); ?>"><i class="fa fa-share mr-10 "></i>PASIEN POLI</a>
				</li>
				<li>
					<a href="<?= base_url('Kasir_pendapatan/pasien_pulang2'); ?>"><i class="fa fa-share mr-10 "></i>PASIEN RANAP</a>
				</li>
				<li>
					<a href="<?= base_url('Kasir_pendapatan/pasien_pulang_ugd2'); ?>"><i class="fa fa-share mr-10 "></i>PASIEN UGD</a>
				</li>
			</ul>
		</li>
		<li>
		...
		<li>
			<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_manual/Saldo_awal') ?>">SALDO AWAL</a>
		</li>
		<li>
		...
		<li>
			...
			<ul id="jurnal_far1" class="collapse collapse-level-1">
				...
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_utang_piutang/Verifikasi') ?>">VERIFIKASI PEMBAYARAN</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_utang_piutang/Jurnal_verifikasi') ?>">JURNAL PEMBAYARAN UTANG</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_utang_piutang/Laporan_jurnal') ?>">LAPORAN JURNAL PEMBAYARAN UTANG</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_utang_piutang/Aging/utang') ?>">LAPORAN AGING UTANG</a>
				</li>
		...
		<li>
			...
			<ul id="bukti_kas" class="collapse collapse-level-1">
				...
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_utang_piutang/Pembayaran_piutang_verifikasi') ?>">VERIF PEMBAYARAN PIUTANG</a>
				</li>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Sisa_utang_vendor') ?>">LAPORAN SISA PEMBAYARAN UTANG</a>
				</li>
		...
		<li>
			...
			<ul id="jurnal3" class="collapse collapse-level-1">
				...
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_Biaya_farmasi/Verifikasi') ?>">VERIFIKASI JURNAL MATERIAL</a>
				</li>
		...
		<li>
			...
			<ul id="jurnal2" class="collapse collapse-level-1">
				...
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan_keuangan/Jasa_service') ?>">LAPORAN JASA SERVIS</a>
				</li>
			</ul>
		</li>
	<?php } ?>
...
<?php } elseif ($datatipe == 'opmed') { ?>
	<li>
		<a onclick="dashboard()" style="cursor:pointer;" class="icon-graph mr-10" href="#"> DASHBOARD</a>
	</li>
	<li>
		<a style="cursor:pointer;" data-toggle="collapse" data-target="#chart_dr"><i class="icon-graph mr-10"></i>LAPORAN<span class="pull-right"><span class="label label-success mr-10">4</span><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="chart_dr" class="collapse collapse-level-1">
...
<?php } elseif ($datatipe == 'direktur') { ?>
	<li>
		<a onclick="dashboard()" style="cursor:pointer;" href="#"><i class="icon-graph mr-10"></i>DASHBOARD</a>
	</li>
	<li>
		<a style="cursor:pointer;" data-toggle="collapse" data-target="#chart_dr"><i class="icon-graph mr-10"></i>LAPORAN<span class="pull-right"><span class="label label-success mr-10">4</span><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="chart_dr" class="collapse collapse-level-1">
	...
	<!-- <li>
		<a href="<?= base_url('Laporan_farmasi/target_poli'); ?>"><i class="ti-package mr-10"></i>TARGET POLI</a>
	</li> -->
	<li>
	...
	<li>
		<a style="cursor:pointer;" data-toggle="collapse" data-target="#Bk_dr"><i class="icon-graph mr-10"></i>VERIFIKASI KEUANGAN<span class="pull-right"><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="Bk_dr" class="collapse collapse-level-1">

			<li>
				<a class="klik_menu" id="tambahan" href="<?= base_url('Jurnal_farmasi/Verifikasi_Bukti_kas') ?>">VERIFIKASI BUKTI KAS</a>
			</li>
		</ul>
	</li>

	<li>
		<a style="cursor:pointer;" data-toggle="collapse" data-target="#as_sui"><i class="icon-graph mr-10"></i>RADIOLOGI<span class="pull-right"><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="as_sui" class="collapse collapse-level-1">
			<li>
				<a href="<?= base_url('Radiologi/PasienMcu') ?>"><i class="icon-user-follow mr-10 "></i>PASIEN MCU</a>
			</li>
			<li>
				<a href="<?= base_url('Radiologi/PasienUSG2') ?>"><i class="icon-user-follow mr-10 "></i>PASIEN USG</a>
			</li>
			<li>
				<a href="<?= base_url('Radiologi/PasienCT2') ?>"><i class="icon-user-follow mr-10 "></i>PASIEN CT</a>
			</li>
			<li>
				<a href="<?= base_url('Radiologi/PasienRontgen2') ?>"><i class="icon-user-follow mr-10 "></i>PASIEN RONTGEN</a>
			</li>
		</ul>
	</li>
	<li>
	...
	<!-- <li>
		<a style="cursor:pointer;" data-toggle="collapse" data-target="#as_ri"><i class="icon-graph mr-10"></i>RIWAYAT RADIOLOGI<span class="pull-right"><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="as_ri" class="collapse collapse-level-1">
			<li>
				<a href="<?= base_url('Radiologi/Riwayat_radiologi_USG') ?>"><i class="icon-history mr-10"></i>RIWAYAT RADIOLOGI USG</a>
			</li>
			<li>
				<a href="<?= base_url('Radiologi/Riwayat_radiologi_CT') ?>"><i class="icon-history mr-10"></i>RIWAYAT RADIOLOGI CT</a>
			</li>
			<li>
				<a href="<?= base_url('Radiologi/Riwayat_radiologi_Rontgen') ?>"><i class="icon-history mr-10"></i>RIWAYAT RADIOLOGI RONTGEN</a>
			</li>
		</ul>
	</li> -->
<?php } elseif ($datatipe == 'expertise') { ?>
	<li>
		<a style="cursor:pointer;" data-toggle="collapse" data-target="#as_sui"><i class="icon-graph mr-10"></i>RADIOLOGI<span class="pull-right"><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="as_sui" class="collapse collapse-level-1">
			<li>
...
<?php } elseif ($datatipe == 'homecare') { ?>
	...
	<!-- SIDEBAR BARU -->
<?php } elseif ($datatipe == 'kamar jenazah') { ?>
	<li>
		<a href="<?= base_url('Homecare/tindakan_jenazah') ?>"><i class="fa fa-solid fa-bed">&nbsp; </i> KAMAR JENAZAH</a>
	</li>

	<li>
		<a href="<?= base_url('Homecare/tindakan_jasa_jenazah') ?>"><i class="fa fa-pencil-square-o" aria-hidden="true">&nbsp; </i> TINDAKAN JENAZAH</a>
	</li>
	<li>
		<a href="<?= base_url('Permintaan_obat') ?>"><i class="icon-hourglass mr-10"></i>PERMINTAAN OBAT</a>
	</li>
...
<?php } elseif ($datatipe == 'laporan') { ?>
	<li>
		<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan/Laporan_kunjunganbyCB') ?>">KUNJUNGAN PER-KLAIM</a>
	</li>
	<li>
		<a style="cursor:pointer;" data-toggle="collapse" data-target="#rl1"><i class="icon-graph mr-10"></i>LAPORAN RL 1<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="rl1" class="collapse collapse-level-1">
...
<?php } elseif ($datatipe == 'keperawatan') { ?>
	...
	<?php } ?>
<?php } elseif ($datatipe == 'sekretariat' || $datatipe == 'opmed_unit') { ?>
	<li>
		<a href="<?= base_url('IGD/Laporan_igd') ?>"><i class="fa fa-ambulance mr-10"></i>LAPORAN KUNJUNG UGD &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
	</li>
	<li>
	...
	<li>
		<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan/kunjungan') ?>">LAPORAN KUNJUNGAN</a>
	</li>
	<li>
		<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan/laporan_operasional_penunjang') ?>"><i class="icon-note mr-10 "></i>LAPORAN UNIT PENUNJANG</a>
	</li>
	...
	<li>
		<a href="<?= base_url('Laporan/bor_new'); ?>">LAPORAN BOR </a>
	</li>
	<li>
		<a class="klik_menu" id="tambahan" href="<?= base_url('Laporan_kunjungan_ranap') ?>"><i class="icon-note mr-10 "></i>LAPORAN KUNJUNGAN RAWAT INAP</a>
	</li>
...
<?php } elseif ($datatipe == 'farmasi laporan') { ?>
	<li>
		<a href="<?= base_url('Laporan'); ?>">LAPORAN KUNJUNGAN</a>
	</li>
	<li>
		<a class="klik_menu" id="laporanObatRajal" href="<?= base_url('Apotik_laporan/Laporan_pasien_rajal') ?>"> </i>LAPORAN OBAT PASIEN RAJAL</a>
	</li>
	<li>
		<a class="klik_menu" id="laporanObatRajal" href="<?= base_url('Apotik_laporan/Laporan_pasien_Igd') ?>"> </i>LAPORAN OBAT PASIEN IGD </a>
	</li>
	<li>
		<a class="klik_menu" id="laporanObatRajal" href="<?= base_url('Apotik_laporan/Laporan_pasien_Ranap') ?>"> </i>LAPORAN OBAT PASIEN RANAP </a>
	</li>
<?php } elseif ($datatipe == 'mutu') { ?>
	<li>
		<a href="<?= base_url('LaporanKunjunganPoli/Laporan_waktu_tunggu_poli'); ?>">LAPORAN KUNJUNGAN</a>
	</li>
...
<?php } elseif ($datatipe == 'ppi' && $status == 'aktif') {
?>
	<li>
		<a data-toggle="collapse" style="cursor:pointer;" data-target="#ui_rad"><i class="icon-user-following mr-10"></i>Form Audit PPI<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="ui_rad" class="collapse collapse-level-1">
			<li>
				<a href="<?= base_url('Formulir_Monitoring_Pemrosesan_Alat_Kesehatan_Bebas_Pakai') ?>"><i class="icon-note mr-10 "></i>Formulir Monitoring Pemrosesan Alat Kesehatan Bebas Pakai</a>
			</li>
			<li>
				<a href="<?= base_url('Formulir_Monitoring_Pelaksaan_PPI_diKamar_Jenazah') ?>"><i class="icon-note mr-10 "></i>Formulir Monitoring Pelaksaan PPI diKamar Jenazah</a>
			</li>
			<li>
				<a href="<?= base_url('Formulir_Monitoring_Mengelolaan_Limbah_Benda_Tajam') ?>"><i class="icon-note mr-10"></i>Formulir Monitoring Mengelolaan Limbah Benda Tajam</a>
			</li>
			<li>
				<a href="<?= base_url('Formulir_kebersihan_tangan') ?>"><i class="icon-note mr-10"></i>Formulir Kebersihan Tangan</a>
			</li>
			<li>
				<a href="<?= base_url('Formulir_fasilitas_kebersihan_tangan') ?>"><i class="icon-note mr-10"></i>Formulir Fasilitas Kebersihan Tangan</a>
			</li>
			<!-- <li>
				<a href="<?= base_url('Formulir_APD/form_fasilitas_apd') ?>"><i class="icon-note mr-10"></i>Formulir Fasilitas APD</a>
			</li>
			<li>
				<a href="<?= base_url('Formulir_APD/form_kepatuhan_apd') ?>"><i class="icon-note mr-10"></i>Formulir APD</a>
			</li> -->
		</ul>
	</li>
<?php } elseif ($datatipe == 'controller' || $datatipe == 'treasury') { ?>
	<?php if ($data->ruangan == 'chief controller') { ?>
		<li>
			<a data-toggle="collapse" data-target="#dashboard_keu_logfar"><i class="icon-drawar mr-10"></i>LOGISTIK FARMASI<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
			<ul id="dashboard_keu_logfar" class="collapse collapse-level-1">
				<li>
	...
	<li>
		...
		<ul id="jurnal2" class="collapse collapse-level-1">
			...
			<?php if ($data->ruangan == 'chief controller') { ?>
				<li>
					<a class="klik_menu" id="tambahan" href="<?= base_url('Trial_balance') ?>">TRIAL BALANCE</a>
				</li>
			<?php } ?>
		</ul>
	</li>
...
<?php } elseif ($datatipe == 'vp finance') { ?>
	<li>
		<a onclick="dashboard()" style="cursor:pointer;" href="#"><i class="icon-graph mr-10"></i> DASHBOARD PASIEN</a>
	</li>
	<li>
		<a href="<?= base_url('Laporan/Laporan_pasien_batal'); ?>"><i class="icon-doc mr-10 "></i>LAPORAN PASIEN BATAL BEROBAT</a>
	</li>
...
<?php } elseif ($datatipe == 'allpoli') { ?>
	<li>
		<a data-toggle="collapse" style="cursor:pointer;" data-target="#allpoli"><i class="icon-user-following mr-10"></i>PASIEN POLI<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="allpoli" class="collapse collapse-level-1">
			<?php $dbpoli = $this->db->query("SELECT l.* FROM list_poli l, dokter d where l.kdpoli_bpjs = d.dokter_spes and d.status ='AKTIF' and d.dokter_spes !='-' 
			and d.dokter_spes !='ANT' and d.dokter_spes !='PAK' and d.dokter_spes !='RAD' 
			group by l.id_list_poli order by l.nama_panjang asc")->result();
			foreach ($dbpoli as $row) {
			?>
				<li>
					<a href="<?= base_url('All_Poli/Poli/') . $row->id_list_poli ?>"><i class="fa fa-file mr-10"></i><?= $row->nama_panjang ?></a>
				</li>
			<?php } ?>
		</ul>
	</li>
	...
	<li>
		<a data-toggle="collapse" style="cursor:pointer;" data-target="#allpoli1"><i class="icon-user-following mr-10"></i>TAGIHAN SEMENTARA PASIEN POLI<span class="pull-right"><span class="label label-success mr-10"></span><i class="fa fa-fw fa-angle-down"></i></span></a>
		<ul id="allpoli1" class="collapse collapse-level-1">
			<?php $dbpoli = $this->db->query("SELECT l.* FROM list_poli l, dokter d where l.kdpoli_bpjs = d.dokter_spes and d.status ='AKTIF' and d.dokter_spes !='-' 
			and d.dokter_spes !='ANT' and d.dokter_spes !='PAK' and d.dokter_spes !='RAD' 
			group by l.id_list_poli order by l.nama_panjang asc")->result();
			foreach ($dbpoli as $row) {
			?>
				<li>
					<a href="<?= base_url('All_Poli/TagihanPoli/') . $row->id_list_poli ?>"><i class="fa fa-file mr-10"></i><?= $row->nama_panjang ?></a>
				</li>
			<?php } ?>
		</ul>
	</li>
	...
	<li>
		<a href="<?= base_url('AntrianpoliAll') ?>"><i class="icon-drawar mr-10 "></i>ANTRIAN POLI </a>
	</li>
	<li>
		<a class="klik_menu" id="tambahan" href="<?= base_url('LaporanKunjunganPoli') ?>"><i class="icon-note mr-10 "></i>LAPORAN KUNJUNGAN POLI</a>
	</li>
