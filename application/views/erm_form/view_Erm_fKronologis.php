  ...
  <div class="col-sm-12">
    <div class="panel panel-default card-view">
      <div class="panel-heading">
        <div class="pull-left">
          <h6 class="panel-title txt-dark">Form Kronologis</h6>
        </div>
    ...
    <div class="panel panel-default card-view">
      <div class="panel-heading">
        <div class="pull-left">
          <h6 class="panel-title txt-dark">DAFTAR UPLOAD FORM KRONOLOGIS</h6>
        </div>
        <div class="clearfix"></div>
      </div>
...
<script type="text/javascript">
  $(document).ready(function(e) {
    ...
    reload_data_id_pel(id_pelayanan);
      ...
      $.ajax({
        url:"<?= base_url("Erm_fKronologis/getDokter"); ?>",
        method:"GET",
        dataType:"JSON",
        cache:false,
...
<script type="text/javascript">
  ...
  function reload_data_id_pel(id_pelayanan) { //utk reload data diagnosa pasien jika berhasil
    ...
    $('#tabel_upload').DataTable({
      ...
      "ajax": {
        "url": '<?php echo base_url('Erm_fKronologis/tampil_data'); ?>',
        "type": 'POST',
        "data": {
  ...
  $("#formUpload").submit((e)=>{
    ...
    $.ajax({
      url: '<?= base_url("Erm_fKronologis/insert_data"); ?>',
      type: "POST",
      data: formData,
      processData: false,
  ...
  function pilih(id) {
    $('#id').val(id);
    $.ajax({
      url: "<?= base_url("Erm_fKronologis/getDataUpdate") ?>",
      method: "POST",
      dataType: 'json',
      data: {
        id: id
  ...
  $("#edit").on("click",function(e){
    ...
    var formData = new FormData($("#formUpload")[0]);
    $.ajax({
      url: '<?= base_url("Erm_fKronologis/updateData"); ?>',
      type: "POST",
      data: formData,
      processData: false,
      enctype: 'multipart/form-data',
  ...
  function hapus(id) { //utk hapus diagnosa pasien
    swal({
      ...
      $().ready(function() {
        $.ajax({
          url: "<?= base_url("Erm_fKronologis/deleteData") ?>",
          method: "POST",
          dataType: 'json',
          data: {
            id: id,
