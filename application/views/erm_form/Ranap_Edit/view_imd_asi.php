...
<script type="text/javascript">
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_ranap_imd/get_ass_per",
      method: "POST",
      dataType: 'json',
      data: {
        id: id_history
      ...
      success: function(data) {
        $('#id').val(data.id_imd);
        $('#inIbu').val(data.nama_ibu);
        $('#inJam').val(data.jam_lahir);
        $('#jam_mulai').val(data.waktu_mulai);
        $('#jam_selesai').val(data.waktu_selesai);
        $('#inKontak').val(data.lama_kontak);
        $('#inMenyusui1').val(data.bayi_menyusui);
        $('#inMenyusui2').val(data.menolong);
        $('#inAlasan').val(data.alasan);
        $('#inCatatan').val(data.catatan);
        /*----------------------*/
        ...
        $('input[name="kontak"][value="' + data.kontak_kulit + '"]').prop("checked", true);
        /*-----------------------------------------*/
...
<script type="text/javascript">
  function simpan() {
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_ranap_imd/update_imd_asi",
      method: "POST",
      dataType: 'json',
      data: dataString,
      success: function(data) {
  ...
  function cetak() {
    id = $('#id').val();
    window.location.href = "<?php echo base_url('Erm_ranap/print_imd_asi/') ?>" + id;
  }
