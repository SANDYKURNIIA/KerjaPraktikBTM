...
<div class="row">
  <div class="col-sm-12">
          ...
          <div class="form-wrap">
            ...
            <div class="form-group">
              <div class="col-md-3">
                ...
                <input type="text" disabled class="form-control" id="inRawat">
                <!-- <input type="text" disabled class="form-control" value="<?= $nama ?>" id="inNama"> -->
              </div>
            </div>
                ...
                <div class="form-group" id="spirit">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="form-group" id="spirit">
                      <div class="col-md-12">
                        <h5 style="margin-top: 30px;"><strong>
                            <label class="control-label mb-10 text-left"><b>KEBIASAAN BERKEMIH<b /><span
                                  class="help"></span></label>
                          </strong>
                        </h5>
                      </div>
    ...
    <script type="text/javascript">
      function cetak() {
        id = $('#id').val();
        window.location.href = "<?php echo base_url('Erm_ranap/print_ulang_geriatri/') ?>" + id;
      }
      function simpan() {
        ...
        $.ajax({
          url: "<?php echo base_url() ?>Erm_ranap_ulang_jatuh_geriatri/formulangjatuhgeriatri",
          method: "POST",
          dataType: 'json',
          data: dataString,
          success: function (data) {
