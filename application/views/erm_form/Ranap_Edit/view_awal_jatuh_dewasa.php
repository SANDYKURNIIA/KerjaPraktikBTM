...
<script type="text/javascript">
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_ranap_awal_jatuh_dewasa/get_ass_per",
      method: "POST",
      dataType: 'json',
      data: {
        id: id_history
...
<script type="text/javascript">
  function simpan() {
    ...
    dataString = 'jatuh=' + jatuh + '&no_rm=' + no_rm + '&sekunder='+ sekunder + '&bantu=' + bantu + '&infus=' + infus + '&id_pelayanan=' + id_pelayanan + '&id_history=' + id_history +
      '&berjalan=' + berjalan + '&mental=' + mental + '&skor_total=' + skor_total + '&diagnosa=' + diagnosa + '&id=' + id;


    $.ajax({
      url: "<?php echo base_url() ?>Erm_ranap_awal_jatuh_dewasa/update_asesmen",
      method: "POST",
      dataType: 'json',
      data: dataString,
      success: function(data) {
...
<script type="text/javascript">
  ...
  function cetak() {
        id = $('#id').val();
        window.location.href = "<?php echo base_url('Erm_ranap/print_awal_dewasa/') ?>" + id;
    }
