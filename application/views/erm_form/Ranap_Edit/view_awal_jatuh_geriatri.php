...
<script type="text/javascript">
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_ranap_awal_jatuh_geriatri/get_ass_per",
      method: "POST",
      dataType: 'json',
      data: {
        id: id_history
...
<script type="text/javascript">
  ...
  function simpan() {
    ...
    dataString = 'jatuh1=' + jatuh1 + '&no_rm=' + no_rm + '&jatuh2=' + jatuh2 + '&delirium=' + delirium + '&disorientasi=' + disorientasi + '&id_pelayanan=' + id_pelayanan + '&id_history=' + id_history +
      '&agitasi=' + agitasi + '&kacamata=' + kacamata + '&buram=' + buram + '&berkemih=' + berkemih + '&transfer=' + transfer + '&mobilitas=' + mobilitas + '&skor_total=' + skor_total + '&diagnosa=' + diagnosa + '&id=' + id;


    $.ajax({
      url: "<?php echo base_url() ?>Erm_ranap_awal_jatuh_geriatri/update_asesmen",
      method: "POST",
      dataType: 'json',
      data: dataString,
      success: function(data) {
    ...
    function cetak() {
        id = $('#id').val();
        window.location.href = "<?php echo base_url('Erm_ranap/print_awal_geriatri/') ?>" + id;
    }
  function sumScore() {
