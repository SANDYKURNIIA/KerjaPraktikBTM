                    ...
                    <div class="form-wrap">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="has-success">
                                        ...
                                        echo '<input type="text" id="tanggal_lahirs" readonly name="tanggal_lahirs" class="form-control" value="' . $tanggal_indonesia . '">'; ?>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="has-success">
                                        ...
                                        <textarea class="form-control" cols="8" rows="8" id="riwayat_kelahiran" name="riwayat_kelahiran"><?php echo $resume_bayi_tabung['riwayat_kelahiran'] ?></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="has-success">
                                        ...
                                        <textarea class="form-control" cols="8" rows="8" id="pemeriksaan_fisik" name="pemeriksaan_fisik"><?php echo $resume_bayi_tabung['pemeriksaan_fisik'] ?></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="has-success">
                                        ...
                                        <textarea class="form-control" cols="8" rows="8" id="hasil_pemeriksaan_penunjang" name="hasil_pemeriksaan_penunjang"><?php echo $resume_bayi_tabung['hasil_pemeriksaan_penunjang'] ?></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="has-success">
                                        ...
                                        <textarea class="form-control" cols="8" rows="8" id="prosedur_terapi" name="prosedur_terapi"><?php echo $resume_bayi_tabung['prosedur_terapi'] ?></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="has-success">
                                        ...
                                        <textarea class="form-control" cols="8" rows="8" id="terapi_obat_yang_diberikan" name="terapi_obat_yang_diberikan"><?php echo $resume_bayi_tabung['terapi_obat_yang_diberikan'] ?></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="has-success">
                                        ...
                                        <textarea class="form-control" cols="8" rows="8" id="kondisi_pasien_saat_pulang" name="kondisi_pasien_saat_pulang"><?php echo $resume_bayi_tabung['kondisi_pasien_saat_pulang'] ?></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="has-success">
                                        ...
                                        <textarea class="form-control" cols="8" rows="8" id="edukasi_yang_sudah_diberikan" name="edukasi_yang_sudah_diberikan"><?php echo $resume_bayi_tabung['edukasi_yang_sudah_diberikan'] ?></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="has-success">
                                        ...
                                        <input type="date" class="form-control" id="tanggal_kontrol_kembali" name="tanggal_kontrol_kembali" value="<?php echo $resume_bayi_tabung['tanggal_kontrol_kembali'] ?>">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <a type="button" target="_blank" class="btn btn-primary mb-4" id="cetak" href="<?= base_url('Erm_resume_bayi_tabung/print_out/' . $id_pelayanan . '/' . $id_history . '') ?>"> Cetak</a>
                            </div>
                        </div>
                    </div>
                </div>
