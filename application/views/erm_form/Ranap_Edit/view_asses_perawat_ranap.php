  ...
  <div class="col-sm-12">
    <div class="panel panel-default card-view">
      <div class="panel-heading">
        <div class="pull-left">
          <h6 class="panel-title txt-dark">Assesment Perawat Ranap</h6>
        </div>
            ...
            <div class="form-group">
              ...
              <div class="form-group ">
                <div class="col-md-12">
                  ...
                  <div class="radio-button radio-button-primary">
                    <input id="cMasuk3" name="cMasuk" type="radio" value="Lainnya">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-md-3">
                        ...
                        <!-- <div class="row"> -->
                        <div class="form-group">
                          <label class="control-label mb-10 text-left" style="opacity: 0.75;">- Resiko sedang: <strong>16-20</strong></label>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <!-- <div class="row"> -->
                        <div class="form-group">
                          <label class="control-label mb-10 text-left" style="opacity: 0.75;">- Resiko Tinggi: <strong>11-15</strong></label>
                        </div>
                        <!-- </div> -->
                      </div>
                      <!-- <div class="row"> -->
                      <div class="form-group">
                        <label class="control-label mb-10 text-left" style="opacity: 0.75;">- Resiko sangat tinggi: <strong>
                            < 10 </strong></label>
                      </div>
                    </div>
                    <div class="col-md-6">
                  ...
                  <!-- <div class="form-group">
                        <div class="col-md-12">
                          <label class="control-label mb-10 text-left">Dokter Pemeriksa<span class="help"></span></label>
                          <span id="dkpemeriksa_error" class="text-danger"></span>
                          <div class="has-success">
                            <input type="text" class="form-control" name="dokter_ugd">
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-md-12">
                          <label class="control-label mb-10 text-left">Diagnosa Masuk<span class="help"></span></label>
                      ...
                      <div class="form-group">
                        <div class="col-md-12">
                          ...
                          <div class="has-success">
                            <input type="text" class="form-control" name="dari_rajal">
                          </div>
                        </div>
                      </div> -->
                  ...
                  <div class="form-group" id="spirit">
                    ...
                    <div class="form-group">
                      <div class="col-md-4">
                        ...
                        <div class="row">
                          <div class="radio-button radio-button-primary">
                            <input id="alergi1" type="radio" name="alergi" value="Tidak Ada">
                    ...
                    <div id="banyak" style="display:none;">
                        ...
                        <div>
                          ...
                          <div class="form-group">
                            <div class="col-md-4">
                              ...
                              <div class="row">
                                <div class="radio-button radio-button-primary">
                                  <input id="alergi_obat2" type="radio" name="alergi_obat" value="Tidak Ada">
                                ...
                                <div class="radio-button radio-button-primary">
                                  ...
                                  <div class=" ">
                                    <input type="text" class="form-control alergi_obat_textbox" id="alergi_obat_textbox" name="alergi_obat_textbox" style="display: none; width: 250px;">
                                    <span class="help-block"></span>
                                  </div>
                                </div>
                              </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-3">
                          ...
                          <div class="row">
                            <div class="radio-button radio-button-primary">
                              <input id="reaksi_alergi2" type="radio" name="reaksi_alergi" value="Tidak">
                      ...
                      <!-- <div class="form-group" id="reaksi_utama" name="reaksi_utama" style="display: none;"> -->
                      <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <div class="col-md-3">
                      <div class="row">
                        <div class="radio-button radio-button-primary">
                          <input id="transfusi_darah2" type="radio" name="transfusi_darah" value="Tidak">
                      ...
                      <div class=" " id="transfusi_darah_detail" style="display: none;">
                        <input type="text" class="form-control" id="transfusi_darah_detail" name="transfusi_darah_detail" placeholder="Detail transfusi darah">
                        <span class="help-block"></span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <div class="radio-button radio-button-primary">
                        <input id="merokok1" type="radio" name="merokok" value="Tidak">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <div class="radio-button radio-button-primary">
                        <input id="alkohol1" type="radio" name="alkohol" value="Tidak">
                        <label class="control-label" for="alkohol1">
                          Tidak
                        </label>
                      </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="radio-button radio-button-primary">
                      <input id="obat_penenang1" name="obat_penenang" type="radio" value="Tidak">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group ">
                      <div class="col-md-3">
                        ...
                        <span id="keluhan_error" class="text-danger"></span>
                        <div class="radio-button radio-button-primary">
                          <input id="keluhan1" type="radio" name="keluhan" value="Tidak">
                          <label class="control-label" for="keluhan1">
                            Tidak
                          </label>
                        </div>
                        <div class="radio-button radio-button-primary">
                          <input id="keluhan2" type="radio" name="keluhan" value="Ya">
                          <label class="control-label" for="keluhan2">
                            Ya
                          </label>
                        </div>
                        <!-- <div class=" " id="lainnya_penyakit_keluarga_detail" style="display: none;">
                  ...
                  <div class="form-group form-group-spacing">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="radio-button radio-button-primary">
                              <div class="col-md-12">
                                ...
                                <label class="control-label" for="asupan1">Tidak</label>
                              </div>
                              <div class="col-md-12">
                                <input id="asupan2" type="radio" name="asupan" value="1">
                                <label class="control-label" for="asupan2">Ya </label>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="form-group ">
                      <div class="col-md-3">
                        ...
                        <div class="radio-button radio-button-primary">
                          <input id="bak2" type="radio" name="bak" value="Urin Rendah">
                    ...
                    <div class="form-group">
                      <div class="col-md-12">
                        <h5 style="margin-top: 30px;"><strong>
                            <label class="control-label mb-10 text-left">SEKSUAL/REPRODUKSI DEWASA<span class="help"></span></label>
                          </strong>
                        </h5>
                      </div>
                      <div class="form-group ">
                        ...
                        <div class="form-group ">
                          <div class="col-md-3">
                            <label class="control-label mb-10 text-left" id="title3">Penggunaan Alat Kontrasepsi</label>
                      ...
                      <div class="col-md-10">
                        <label class="control-label mb-3 text-left" id="title4">(Laki-Laki)Apakah Punya Masalah Prostat</label>
                      ...
                      <script>
                        $(document).ready(function() {
                          ...
                          $('#keperawatan17').change(function() {
                            if ($(this).is(':checked')) {
                              $('#keperawatann').show(); // Menampilkan input teks jika 'Lainnya' dipilih
                            } else {
                              $('#keperawatann').hide(); // Menyembunyikan input teks jika tidak dipilih
                            }
                          });
                        });
                      </script>
...
<script type="text/javascript">
  ...
  document.addEventListener("DOMContentLoaded", function() {
    // Fungsi untuk mendapatkan nilai dari radiobutton yang dipilih
    ...
    // Mendapatkan nilai dari radiobutton dengan nama 'persepsi'
    const persepsiValue = getSelectedRadioValue('persepsi');

    // Menampilkan nilai yang dipilih
    console.log("Nilai yang dipilih untuk persepsi:", persepsiValue);
  });
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_ranap_asesmen_perawat/get_ass_per",
      method: "POST",
      dataType: 'json',
      data: {
        id: id_history
      ...
      success: function(data) {
        if (data.id_masalah_kep) {
          let selectedMasalah = data.id_masalah_kep;

          if (typeof selectedMasalah === "string") {
            selectedMasalah = selectedMasalah.split(','); // Ubah string ke array
          }

          console.log("Masalah Keperawatan Terpilih:", selectedMasalah); // Debugging

          // Loop melalui array ID masalah keperawatan yang dipilih
          selectedMasalah.forEach(function(id) {
            $('#keperawatan' + id).prop("checked", true);
          });
        }
        if (data.cMasuk == "Jalan" || data.cMasuk == "Kursi Roda") {
          $('input[name="cMasuk"][value="' + data.cMasuk + '"]').prop("checked", true);
        } else {
          $('input[name="cMasuk"][value="Lainnya"]').prop("checked", true);
          $('#cMasuk').val(data.cMasuk);
          $('#cMasuk').show();
        }
        if (data.kondisi_masuk == "Mandiri" || data.kondisi_masuk == "Tempat Tidur") {
          $('input[name="kondisi"][value="' + data.kondisi_masuk + '"]').prop("checked", true);
        } else {
          $('input[name="kondisi"][value="Lainnya"]').prop("checked", true);
          $('#kondisi').val(data.kondisi_masuk);
          $('#kondisi').show();
        }
        if (data.alergi_obat == "Tidak Ada") {
          $('input[name="alergi_obat"][value="' + data.alergi_obat + '"]').prop("checked", true);
        } else {
          $('input[name="alergi_obat"][value="Ada"]').prop("checked", true);
          $('#alergi_obat').val(data.alergi_obat);
          $('#alergi_obat').show();
        }
        if (data.alergi == "Tidak Ada") {
          $('input[name="alergi"][value="' + data.alergi + '"]').prop("checked", true);
        } else {
          $('input[name="alergi"][value="Ada"]').prop("checked", true);
          // $('#alergi').val(data.jam_alergi);
          $('#banyak').show();
        }
        if (data.alergi_obat == "Tidak Ada") {
          $('input[name="alergi"][value="' + data.alergi_obat + '"]').prop("checked", true);
        } else {
          $('input[name="alergi"][value="Ada, Jenis/Nama Obat"]').prop("checked", true);
          // $('#alergi').val(data.jam_alergi);
          $('#alergi_obat_textbox').show();
        }
        if (data.keluhan == "Tidak") {
          $('input[name="keluhan"][value="' + data.keluhan + '"]').prop("checked", true);
        } else {
          $('input[name="keluhan"][value="Ya"]').prop("checked", true);
          $('#banyak2').show();
        }

        if (data.transfusi_darah == "Tidak") {
          $('input[name="transfusi_darah"][value="' + data.transfusi_darah + '"]').prop("checked", true);
        } else {
          $('#transfusi_darah_detail').show();
          $('input[name="transfusi_darah"][value="Pernah"]').prop("checked", true);
        }

        if (data.merokok == "Tidak") {
          $('input[name="merokok"][value="' + data.merokok + '"]').prop("checked", true);
        } else {
          $('#jumlah_rokok').show();
          $('input[name="merokok"][value="Pernah"]').prop("checked", true);
        }

        if (data.alkohol == "Tidak") {
          $('input[name="alkohol"][value="' + data.alkohol + '"]').prop("checked", true);
        } else {
          $('#jumlah_alkohol').show();
          $('input[name="alkohol"][value="Pernah"]').prop("checked", true);
        }

        if (data.obat_penenang == "Tidak") {
          $('input[name="obat_penenang"][value="' + data.obat_penenang + '"]').prop("checked", true);
        } else {
          $('#obat_penenang_detail').show();
          $('input[name="obat_penenang"][value="Pernah"]').prop("checked", true);
        }
        // if (data.obat_penenang == "Tidak") {
        //   $('input[name="obat_penenang"][value="' + data.obat_penenang + '"]').prop("checked", true);
        // } else {
        ...
        if (data.penyebab == "Penyebab lain") {
          $('#lainnyaa').show();
          $('input[name="penyebab"][value="' + data.penyebab + '"]').prop("checked", true);
        } else {
          $('input[name="penyebab"][value="' + data.penyebab + '"]').prop("checked", true);
        }
        if (data.nyeri == "Ya") {
          $('#nyerii').show();
          $('input[name="nyeri"][value="' + data.nyeri + '"]').prop("checked", true);
        } else {
          $('input[name="nyeri"][value="' + data.nyeri + '"]').prop("checked", true);
        }
        if (data.pola == "Lainnya") {
          $('#polaa').show();
          $('input[name="pola"][value="' + data.pola + '"]').prop("checked", true);
        } else {
          $('input[name="pola"][value="' + data.pola + '"]').prop("checked", true);
        }
        if (data.cara == "Ya") {
        ...
        if (data.mental == "Lainnya") {
          $('#mental').show();
          $('input[name="mental"][value="' + data.mental + '"]').prop("checked", true);
        } else {
          $('input[name="mental"][value="' + data.mental + '"]').prop("checked", true);
        }
        if (data.intake == "Lain-lain") {
          $('#intake_lain_lain').show();
          $('input[name="intake"][value="' + data.intake + '"]').prop("checked", true);
        } else {
          $('input[name="intake"][value="' + data.intake + '"]').prop("checked", true);
        }
        if (data.turun == "00") {
          $('#detail_penurunan_berat').show();
          $('input[name="turun"][value="' + data.turun + '"]').prop("checked", true);
        } else {
          $('input[name="turun"][value="' + data.turun + '"]').prop("checked", true);
        }
        if (data.keperawatan17 == "Lain-lain") {
          $('input[name="keperawatan"][value="' + data.keperawatan17 + '"]').prop("checked", true);
          $('#keperawatann').show();
        } else {
          $('input[name="keperawatan"][value="' + data.keperawatan17 + '"]').prop("checked", true);
        }
        if (data.pkeluarga11 == "Lainnya") {
          $('input[name="pkeluarga"][value="' + data.pkeluarga11 + '"]').prop("checked", true);
          $('#lainnya_penyakit_keluarga_detail').show();
        } else {
          $('input[name="pkeluarga"][value="' + data.pkeluarga11 + '"]').prop("checked", true);
        }
        if (data.tempat_tinggal == "Tinggal Serumah" || data.tempat_tinggal == "Sendiri") {
          $('input[name="tinggal"][value="' + data.tempat_tinggal + '"]').prop("checked", true);
        } else {
          $('input[name="tinggal"][value="Lainnya"]').prop("checked", true);
          $('#tinggal').val(data.tempat_tinggal);
          $('#tinggal').show();
        }
        if (data.pekerjaan == "PNS" || data.pekerjaan == "Polri/TNI" || data.pekerjaan == "Swasta") {
          $('input[name="pekerjaan"][value="' + data.pekerjaan + '"]').prop("checked", true);
        } else {
          $('input[name="pekerjaan"][value="Lainnya"]').prop("checked", true);
          $('#pekerjaan').val(data.pekerjaan);
          $('#pekerjaan').show();
        }
        if (data.sumber_informasi == "Pasien" || data.sumber_informasi == "Keluarga") {
          $('input[name="informasi"][value="' + data.sumber_informasi + '"]').prop("checked", true);
        } else {
          $('input[name="informasi"][value="Lainnya"]').prop("checked", true);
          $('#informasi').val(data.sumber_informasi);
          $('#informasi').show();
        }
        /*--------------------------------------*/
        ...
        $('#m').val(data.m);
        $('#v').val(data.v);
        $('input[name="keperawatan"][value="' + data.keperawatan + '"]').prop("checked", true);
        ...
        $('input[name="dokter_ugd"]').val(data.dokter_ugd);
        $('input[name="kepala"]').val(data.kepala);
        $('input[name="hidung"]').val(data.hidung);
        $('input[name="mulut"]').val(data.mulut);
        $('input[name="leher"]').val(data.leher);
        $('input[name="thorax"]').val(data.thorax);
        $('input[name="jantung"]').val(data.jantung);
        $('input[name="paru"]').val(data.paru);
        $('input[name="andomen"]').val(data.andomen);
        $('input[name="punggung"]').val(data.punggung);
        $('input[name="ekstremitas"]').val(data.ekstremitas);
        $('input[name="genetalia"]').val(data.genetalia);
        $('input[name="bradan_score"]').val(data.bradan_score);
        $('input[name="jumlah_rokok"]').val(data.jumlah_rokok);
        $('input[name="jumlah_alkohol"]').val(data.jumlah_alkohol);
        $('input[name="diagnosa_masuk"]').val(data.diagnosa_masuk);
        $('input[name="dari_rajal"]').val(data.dari_rajal);
        // $('input[name="reaksi_utama"]').val(data.reaksi_utama);
        // $('input[name="inHaid"]').val(data.tgl_haid);
        $('input[name="kterdekat"]').val(data.keluarga_terdekat);
        $('input[name="hubungan"]').val(data.hubungan);
        $('input[name="lainnyaa"]').val(data.lainnyaa);
        $('input[name="nyerii"]').val(data.nyerii);
        $('input[name="polaa"]').val(data.polaa);
        $('input[name="mentall"]').val(data.mentall);
        $('input[name="obat_penenang_detail"]').val(data.obat_penenang_detail);
        $('input[name="intake_lain_lain_textbox"]').val(data.intake_lain_lain_textbox);
        $('textarea[name="keterangan"]').val(data.keterangan);
        $('input[name="transfusi_darah_detail"]').val(data.transfusi_darah_detail);
        $('input[name="alergi_obat_textbox"]').val(data.alergi_obat_textbox);
        $('input[name="keperawatann"]').val(data.keperawatann);

        $('input[name="taliIkat_detail"]').val(data.taliIkat_detail);
        $('input[name="diagKhusus"]').val(data.diagKhusus);
        $('input[name="detail_penyakit_keluarga_lainnya"]').val(data.detail_penyakit_keluarga_lainnya);
        ...
        $('input[name="aktifitas_score"]').val(data.aktifitas_score);

        // $('input[name="taliIkat"]').val(data.taliIkat);

        $('input[name="resiko_score"]').val(data.resiko_score);

        $('input[name="nutrisi_score"]').val(data.nutrisi_score);
        $('input[name="merokok"][value="' + data.riwayat_merokok + '"]').prop("checked", true);
        $('input[name="alkohol"][value="' + data.riwayat_alkohol + '"]').prop("checked", true);
        $('input[name="caraa"][value="' + data.caraa + '"]').prop("checked", true);
        $('input[name="bab"][value="' + data.bab + '"]').prop("checked", true);
        $('input[name="bak"][value="' + data.bak + '"]').prop("checked", true);
        $('input[name="hamil"][value="' + data.hamil + '"]').prop("checked", true);
        $('input[name="kontrasepsi"][value="' + data.alat_kontrasepsi + '"]').prop("checked", true);
        $('input[name="prostat"][value="' + data.masalah_prostat + '"]').prop("checked", true);
        $('input[name="pemuka"][value="' + data.pemuka_agama + '"]').prop("checked", true);
        $('input[name="status"][value="' + data.status_pernikahan + '"]').prop("checked", true);
        $('input[name="keluarga"][value="' + data.keluarga + '"]').prop("checked", true);
        $('input[name="aktivitas"][value="' + data.aktivitas + '"]').prop("checked", true);
        $('input[name="emosional"][value="' + data.status_emosional + '"]').prop("checked", true);
        $('input[name="persepsi"][value="' + data.persepsi + '"]').prop("checked", true);
        $('input[name="kelembaban"][value="' + data.kelembaban + '"]').prop("checked", true);
        $('input[name="aktifitas"][value="' + data.aktifitas + '"]').prop("checked", true);
        $('input[name="mobilitas"][value="' + data.mobilitas + '"]').prop("checked", true);
        $('input[name="nutrisi"][value="' + data.nutrisi + '"]').prop("checked", true);
        $('input[name="gesekan"][value="' + data.gesekan + '"]').prop("checked", true);

        $('input[name="reaksi_alergi"][value="' + data.reaksi_alergi + '"]').prop("checked", true);
        $('input[name="transfusi_darah"][value="' + data.transfusi_darah + '"]').prop("checked", true);
        $('input[name="obat_penenang"][value="' + data.obat_penenang + '"]').prop("checked", true);
        $('input[name="riwayat_keluarga"][value="' + data.riwayat_keluarga + '"]').prop("checked", true);
        $('input[name="keperluan"][value="' + data.keperluan + '"]').prop("checked", true);
        $('input[name="nyeri"][value="' + data.nyeri + '"]').prop("checked", true);
        $('input[name="penyebab"][value="' + data.penyebab + '"]').prop("checked", true);
        $('input[name="karakter"][value="' + data.karakter + '"]').prop("checked", true);
        $('input[name="frekuensi"][value="' + data.frekuensi + '"]').prop("checked", true);
        $('input[name="durasi"][value="' + data.durasi + '"]').prop("checked", true);
        $('input[name="selama"][value="' + data.selama + '"]').prop("checked", true);
        $('input[name="hygiene"][value="' + data.hygiene + '"]').prop("checked", true);
        $('input[name="makan"][value="' + data.makan + '"]').prop("checked", true);
        $('input[name="mandi"][value="' + data.mandi + '"]').prop("checked", true);
        $('input[name="toilet"][value="' + data.toilet + '"]').prop("checked", true);
        $('input[name="tangga"][value="' + data.tangga + '"]').prop("checked", true);
        $('input[name="pakaian"][value="' + data.pakaian + '"]').prop("checked", true);
        $('input[name="kontrolBab"][value="' + data.kontrolBab + '"]').prop("checked", true);
        $('input[name="kontrolBak"][value="' + data.kontrolBak + '"]').prop("checked", true);
        $('input[name="transfer"][value="' + data.transfer + '"]').prop("checked", true);
        $('input[name="berjalan"][value="' + data.berjalan + '"]').prop("checked", true);
        $('input[name="pola"][value="' + data.pola + '"]').prop("checked", true);
        $('input[name="cara"][value="' + data.cara + '"]').prop("checked", true);
        $('input[name="mental"][value="' + data.mental + '"]').prop("checked", true);
        $('input[name="umur"][value="' + data.umur + '"]').prop("checked", true);
        $('input[name="jenis_kelamin"][value="' + data.jenis_kelamin + '"]').prop("checked", true);
        $('input[name="diagnosis"][value="' + data.diagnosis + '"]').prop("checked", true);
        $('input[name="gangguan"][value="' + data.gangguan + '"]').prop("checked", true);
        $('input[name="faktor"][value="' + data.faktor + '"]').prop("checked", true);
        $('input[name="anestesi"][value="' + data.anestesi + '"]').prop("checked", true);
        $('input[name="obatan"][value="' + data.obatan + '"]').prop("checked", true);
        $('input[name="intake"][value="' + data.intake + '"]').prop("checked", true);
        $('input[name="masalah"][value="' + data.masalah + '"]').prop("checked", true);
        $('input[name="turun"][value="' + data.turun + '"]').prop("checked", true);
        $('input[name="asupan"][value="' + data.asupan + '"]').prop("checked", true);
        $('input[name="bps"][value="' + data.bps + '"]').prop("checked", true);
        $('input[name="nrs"][value="' + data.nrs + '"]').prop("checked", true);
        $('input[name="flacc"][value="' + data.flacc + '"]').prop("checked", true);
        $('input[name="taliIkat"][value="' + data.taliIkat + '"]').prop("checked", true);

        /*--------------------------------------*/
        if (data.lain_lain.match(/Asma/)) {
          $('input[name="lain_lain"][value="Asma"]').prop("checked", true);
        }
        if (data.lain_lain.match(/Eksim Kulit/)) {
          $('input[name="lain_lain"][value="Eksim Kulit"]').prop("checked", true);
        }
        if (data.lain_lain.match(/Sabun/)) {
          $('input[name="lain_lain"][value="Sabun"]').prop("checked", true);
        }
        if (data.lain_lain.match(/Makanan/)) {
          $('input[name="lain_lain"][value="Makanan"]').prop("checked", true);
        }
        if (data.lain_lain.match(/Debu/)) {
          $('input[name="lain_lain"][value="Debu"]').prop("checked", true);
        }
        if (data.lain_lain.match(/Udara/)) {
          $('input[name="lain_lain"][value="Udara"]').prop("checked", true);
        }

        // $('input[name="pKeluarga"][value="' + data.riwayat_keluarga + '"]').prop("checked", true);


        if (data.riwayat_keluarga.match(/Asma/)) {
          $('input[name="pkeluarga"][value="Asma"]').prop("checked", true);
        }
        if (data.riwayat_keluarga.match(/Hipertensi/)) {
          $('input[name="pkeluarga"][value="Hipertensi"]').prop("checked", true);
        }
        if (data.riwayat_keluarga.match(/PPOK/)) {
          $('input[name="pkeluarga"][value="PPOK"]').prop("checked", true);
        }
        if (data.riwayat_keluarga.match(/Diabetes/)) {
          $('input[name="pkeluarga"][value="Diabetes"]').prop("checked", true);
        }
        if (data.riwayat_keluarga.match(/Kanker/)) {
          $('input[name="pkeluarga"][value="Kanker"]').prop("checked", true);
        }
        if (data.riwayat_keluarga.match(/TBUlcus/)) {
          $('input[name="pkeluarga"][value="TBUlcus"]').prop("checked", true);
        }
        if (data.riwayat_keluarga.match(/Jantung/)) {
          $('input[name="pkeluarga"][value="Jantung"]').prop("checked", true);
        }
        if (data.riwayat_keluarga.match(/Hepatitis/)) {
          $('input[name="pkeluarga"][value="Hepatitis"]').prop("checked", true);
        }
        if (data.riwayat_keluarga.match(/Kejang/)) {
          $('input[name="pkeluarga"][value="Kejang"]').prop("checked", true);
        }
        if (data.riwayat_keluarga.match(/Stroke/)) {
          $('input[name="pkeluarga"][value="Stroke"]').prop("checked", true);
        }
        if (data.riwayat_keluarga.match(/Tidak Ada/)) {
          $('input[name="pkeluarga"][value="Tidak Ada"]').prop("checked", true);
        }
        if (data.riwayat_keluarga.match(/Lainnya/)) {
          $('input[name="pkeluarga"][value="Lainnya"]').prop("checked", true);
          $('#lainnya_penyakit_keluarga_detail').show();
        }
        ...
        if (data.keperluan.match(/Menolak dilakukan tranfusi darah karena kepercayaan/)) {
          $('input[name="keperluan"][value="Menolak dilakukan tranfusi darah karena kepercayaan"]').prop("checked", true);
        }
        if (data.keperluan.match(/Menolak pulang hari tertentu karena kepercayaan/)) {
          $('input[name="keperluan"][value="Menolak pulang hari tertentu karena kepercayaan"]').prop("checked", true);
        }
        if (data.keperluan.match(/Menolak dilayani oleh petugas atau perawat laki-laki/)) {
          $('input[name="keperluan"][value="Menolak dilayani oleh petugas atau perawat laki-laki"]').prop("checked", true);
        }
        if (data.keperluan.match(/Menolak dilayani oleh petugas atau perawat perempuan/)) {
          $('input[name="keperluan"][value="Menolak dilayani oleh petugas atau perawat perempuan"]').prop("checked", true);
        }
        if (data.keperluan.match(/Menolak dirawat oleh medis dan mencari pengobatan alternatif/)) {
          $('input[name="keperluan"][value="Menolak dirawat oleh medis dan mencari pengobatan alternatif"]').prop("checked", true);
        }
        if (data.keperluan.match(/Bimbingan Ibadah/)) {
          $('input[name="keperluan"][value="Bimbingan Ibadah"]').prop("checked", true);
        }
        if (data.keperluan.match(/Motivasi Kesembuhan/)) {
          $('input[name="keperluan"][value="Motivasi Kesembuhan"]').prop("checked", true);
        }

        if (data.keperawatan.match(/Integritas Kulit/)) {
          $('input[name="keperawatan"][value="Integritas Kulit"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Keselamatan pasien atau injuri/)) {
          $('input[name="keperawatan"][value="Keselamatan pasien atau injuri"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Nyeri/)) {
          $('input[name="keperawatan"][value="Nyeri"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Pola tidur/)) {
          $('input[name="keperawatan"][value="Pola tidur"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Penanganan nutrisi/)) {
          $('input[name="keperawatan"][value="Penanganan nutrisi"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Jalan nafas atau pertukaran gas/)) {
          $('input[name="keperawatan"][value="Jalan nafas atau pertukaran gas"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Perawatan diri/)) {
          $('input[name="keperawatan"][value="Perawatan diri"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Suhu tubuh/)) {
          $('input[name="keperawatan"][value="Suhu tubuh"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Mobilitas atau aktifitas/)) {
          $('input[name="keperawatan"][value="Mobilitas atau aktifitas"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Tumbuh kembang/)) {
          $('input[name="keperawatan"][value="Tumbuh kembang"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Konflik peran/)) {
          $('input[name="keperawatan"][value="Konflik peran"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Perfusi jaringan/)) {
          $('input[name="keperawatan"][value="Perfusi jaringan"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Pengetahuan atau komunikasi atau informasi/)) {
          $('input[name="keperawatan"][value="Pengetahuan atau komunikasi atau informasi"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Keseimbangan cairan atau elektrolit/)) {
          $('input[name="keperawatan"][value="Keseimbangan cairan atau elektrolit"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Eliminasi/)) {
          $('input[name="keperawatan"][value="Eliminasi"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Cemas/)) {
          $('input[name="keperawatan"][value="Cemas"]').prop("checked", true);
        }
        if (data.keperawatan.match(/Lain-lain/)) {
          $('input[name="keperawatan"][value="Lain-lain"]').prop("checked", true);
          $('#keperawatann').show();
        }
      }
    });
...
<script type="text/javascript">
  ...
  function simpan() {
    ...
    bps = $('input[name="bps"]:checked').val();
    nrs = $('input[name="nrs"]:checked').val();
    flacc = $('input[name="flacc"]:checked').val();
    dokter_ugd = $('input[name="dokter_ugd"]').val();
    diagnosa_saat_dirajal = $('input[name="diagnosa_masuk"]').val();
    ...
    obat_penenang = $('input[name="obat_penenang"]').val();
    ...
    taliIkat = $('input[name="taliIkat"]').val();
    ...
    dataString = 'no_rm=' + no_rm + '&nama=' + nama + '&tgl_lahir=' + tgl_lahir + '&id_pelayanan=' + id_pelayanan + '&id_history=' + id_history +
      ...
      '&tinggi_badan=' + tinggi_badan + '&dokter_ugd=' + dokter_ugd + '&diagnosa_masuk=' + diagnosa_saat_dirajal + '&dari_rajal=' + dari_rajal +
      ...
      '&bak=' + bak + '&hamil=' + hamil + //'&tgl_haid=' + tgl_haid +//
      ...
      '&sumber_informasi=' + sumber_informasi + '&id=' + id + '&kepala=' + kepala + '&hidung=' + hidung + '&mulut=' + mulut + '&leher=' + leher +
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_ranap_asesmen_perawat/update_asses_perawat_ranap",
      method: "POST",
      dataType: 'json',
      data: dataString,
      success: function(data) {
        if (data.status == "success") {
          ...
          if (dokter_ugd == '' | dokter_ugd == null) {
            $('#dkpemeriksa_error').html('*wajib diisi');
          } else {
            $('#dkpemeriksa_error').html('');
          }
          if (diagnosa_saat_dirajal == '' | diagnosa_saat_dirajal == null) {
            $('#diagnosa_error').html('*wajib diisi');
          } else {
            $('#diagnosa_error').html('');
          }
          if (dari_rajal == '' | dari_rajal == null) {
            $('#keluhan_error').html('*wajib diisi');
          } else {
            $('#keluhan_error').html('');
          }
          if (alergi_obat == '' | alergi_obat == null) {
            $('#alergiobat_error').html('*wajib diisi');
          } else {
            $('#alergiobat_error').html('');
          }
          ...
          // if (reaksi_utama == '' | reaksi_utama == null) {
          //   $('#reaksi_error').html('*wajib diisi');
          // } else {
          //   $('#reaksi_error').html('');
          // }
          if (merokok == '' | merokok == null) {
            $('#rokok_error').html('*wajib diisi');
          } else {
            $('#rokok_error').html('');
          }
          if (alkohol == '' | alkohol == null) {
            $('#alkohol_error').html('*wajib diisi');
          } else {
            $('#alkohol_error').html('');
          }
          ...
          if (pemuka_agama == '' | pemuka_agama == null) {
            $('#pemuka_error').html('*wajib diisi');
          } else {
            $('#pemuka_error').html('');
          }
          if (id_masalah_kep == '' | id_masalah_kep == null) {
            $('#idMasalahKep_error').html('*wajib diisi');
          } else {
            $('#idMasalahKep_error').html('');
          }
  ...
  function cetak() {
    id = $('#id').val();
    window.location.href = "<?php echo base_url('Erm_ranap/print_ass_per_ranap/') ?>" + id;
  }
</script>