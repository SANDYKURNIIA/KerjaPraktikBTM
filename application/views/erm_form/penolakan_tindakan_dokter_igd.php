    ...
    <div class="col-sm-12">
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                <div class="pull-left">
                    <h6 class="panel-title txt-dark">Formulir Penolakan Tindakan Kedokteran</h6>
                </div>
                ...
                <div class="panel-body">
                    <div class="form-wrap">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label class="control-label col-md-2"><b> Diagnosis (WD & DD): <b /><span id="diagnosis_error" class="text-danger"></span><span class="help"></span></label>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label class="control-label col-md-2"><b>Diagnosis Dasar:<b /><span id="diagnosis_d_error" class="text-danger"></span><span class="help"></span></label>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label class="control-label col-md-2"><b>Tindakan Kedokteran:<b /> <span id="tindakan_error" class="text-danger"></span><span class="help"></span></label>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label class="control-label col-md-2"><b>Indikasi Tindakan:<b /><span id="indikasi_error" class="text-danger"></span><span class="help"></span></label>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label class="control-label col-md-2"><b>Tata Cara: <p style="font-style: italic; font-size: smaller;">Tipe sedasi/anesthesia
                                            ...
                                            </p><b /><span id="tata_error" class="text-danger"></span><span class="help"></span></label>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label class="control-label col-md-2"><b>Tujuan:<b /><span id="tuj_error" class="text-danger"></span><span class="help"></span></label>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label class="control-label col-md-2"><b>Resiko & Komplikasi<b /><span id="risk_error" class="text-danger"></span><span class="help"></span></label>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label class="control-label col-md-2"><b>Prognosis <p style="font-style: italic; font-size: smaller;">Prognosis vital, prognosis fungsi dan
                                            ...
                                            </p><b /><span id="prog_error" class="text-danger"></span><span class="help"></span></label>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label class="control-label col-md-2"><b>Alternatif & Risiko
                                            ...
                                            <b /><span id="alt_error" class="text-danger"></span><span class="help"></span></label>
                                ...
                                <div class="col-md-12">
                                    <label class="control-label col-md-2"><b>Hal lain yang akan dilakukan untuk
                                            ...
                                            <p style="font-style: italic;font-size: small;">
                                                ...
                                                Resusitasi
                                            </p><b /><span id="hal_error" class="text-danger"></span><span class="help"></span></label>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <label class="control-label mb-10 text-left">Penolakan tindakan <span class="help"></span></label>
        ...
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                <div class="pull-left">
                    <h6 class="panel-title txt-dark">DAFTAR PENOLAKAN TINDAKAN DOKTER</h6>
                </div>
                <div class="clearfix"></div>
            </div>
            <div class="panel-wrapper collapse in">
...
<script type="text/javascript">
    ...
    function simpan() {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>Erm_penolakan_tindakan_kedokteran/insert_penolakan_tindakan",
            method: "POST",
            dataType: 'json',
            data: dataString,
    ...
    function reload_data_id_pel(id_pelayanan) { //utk reload data diagnosa pasien jika berhasil
        ...
        $('#tabel_terapi').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Erm_penolakan_tindakan_kedokteran/tampil_list_pen_tindakan_dokter'); ?>',
                "type": 'POST',
                "data": {
    ...
    function pilih(id) {
        $('#id').val(id);
        $.ajax({
            url: "<?php echo base_url() ?>Erm_penolakan_tindakan_kedokteran/getPenTindakanDok",
            method: "POST",
            dataType: 'json',
            data: {
                id: id
    ...
    function cetak() {
        id = $('#id').val();
        window.location.href = "<?php echo base_url('Erm_igd_edit/print_penolakan/') ?>" + id;
    }
    ...
    function edit() {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>Erm_penolakan_tindakan_kedokteran/edit_penolakan_tindakan",
            method: "POST",
            dataType: 'json',
            data: dataString,
            success: function(data) {
