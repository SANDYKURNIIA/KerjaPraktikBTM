                     ...
                     <div class="form-wrap">
                         ...
                         <div class="form-group">
                             <div class="col-md-3">
                                 ...
                                 <div class="has-success">
                                     <input type="Text" class="form-control" id=ahlibedah>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                             <div class="col-md-3">
                                 ...
                                 <div class="has-success">
                                     <input type="Text" class="form-control" id=asisten1>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                             <div class="col-md-3">
                                 ...
                                 <div class="has-success">
                                     <input type="Text" class="form-control" id=asisten2>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                             <div class="col-md-12">
                                 ...
                                 <div class="has-success">
                                     <input type="Text" class="form-control" id=diag_pra_opr>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                             ...
                             <div class="col-md-2">
                                 <div class="radio-button radio-button-primary">
                                     <input id="t_operasi1" type="radio" name="t_operasi" value="Laser, Capsulotomy">
                             ...
                             <div class="col-md-2">
                                 <div class="radio-button radio-button-primary">
                                     <input id="t_operasi2" type="radio" name="t_operasi" value="lainnya">
                                     <label class="control-label" for="t_operasi2">
                                         Operasi Lain
                                     </label>
                                 </div>
                                 <div class="has-success">
                                     <input type="text" class="form-control" id=operasi_lain value="" style="display: none;">
                                 </div>
                                 <span class="help-block"></span>
                             </div>
                         </div>
                         <div class="form-group">
                             <div class="col-md-12">
                                 ...
                                 <div class="has-success">
                                     <input type="Text" class="form-control" id=diag_post_opr>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                             <div class="col-md-12">
                                 ...
                                 <div class="has-success">
                                     <input type="Text" class="form-control" id=indikasi_opr>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                             ...
                             <div class="col-md-2">
                                 <div class="radio-button radio-button-primary">
                                     <input id="jenis_opr1" type="radio" name="jenis_opr" value="Ringan">
                             ...
                             <div class="col-md-2">
                                 <div class="radio-button radio-button-primary">
                                     <input id="jenis_opr2" type="radio" name="jenis_opr" value="Sedang">
                             ...
                             <div class="col-md-2">
                                 <div class="radio-button radio-button-primary">
                                     <input id="jenis_opr3" type="radio" name="jenis_opr" value="Berat">
                             ...
                             <div class="col-md-2">
                                 <div class="radio-button radio-button-primary">
                                     <input id="jenis_opr4" type="radio" name="jenis_opr" value="Khusus">
                         ...
                         <div class="form-group">
                             <div class="col-md-4">
                                 ...
                                 <div class="has-success">
                                     <input type="date" class="form-control" id=tgl_operasi>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                             <div class="col-md-4">
                                 ...
                                 <div class="has-success">
                                     <input type="time" class="form-control" id=opr_mulai>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                             <div class="col-md-4">
                                 ...
                                 <div class="has-success">
                                     <input type="time" class="form-control" id=opr_selesai>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                             <div class="col-md-6">
                                 ...
                                 <div class="has-success">
                                     <textarea class="form-control" name="" cols="30" rows="5" id=jaringan></textarea>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-md-2">
                                 <div class="radio-button radio-button-primary">
                                     <input id="p_phatologis1" type="radio" name="p_phatologis" value="Ya">
                             ...
                             <div class="col-md-2">
                                 <div class="radio-button radio-button-primary">
                                     <input id="p_phatologis2" type="radio" name="p_phatologis" value="Tidak">
                         ...
                         <div class="form-group">
                             <div class="col-md-6">
                                 ...
                                 <div class="has-success">
                                     <textarea class="form-control" name="" cols="30" rows="5" id=b_labor></textarea>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                             <div class="col-md-6">
                                 ...
                                 <div class="has-success">
                                     <textarea class="form-control" name="" cols="30" rows="5" id=uraian></textarea>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                             <div class="col-md-6">
                                 ...
                                 <div class="has-success">
                                     <textarea class="form-control" name="" cols="30" rows="5" id=c_approach></textarea>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                             <div class="col-md-6">
                                 ...
                                 <div class="has-success">
                                     <textarea class="form-control" name="" cols="30" rows="5" id=p_penderita></textarea>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                             <div class="col-md-6">
                                 ...
                                 <div class="has-success">
                                     <textarea class="form-control" name="" cols="30" rows="5" id=s_kelainan></textarea>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                         ...
                         <div class="form-group">
                             <div class="col-md-3">
                                 <label id="jenis" class="control-label mb-10 text-left">Jenis Pasien<span class="help"></span></label>
                                 <div class="has-success">
                                     <input type="Text" class="form-control" id=jenis_laser>
                                     <input type="text" class="form-control" id=jenis_pasien value="" style="display: none;">
                                 </div>
                             </div>
                             ...
                             <div class="col-md-3">
                                 ...
                                 <div class="has-success">
                                     <input type="Text" class="form-control" id=jumlah_spot>
                                 </div>
                             </div>
                             <div class="col-md-3">
                                 <label class="control-label mb-10 text-left">Besar Spot<span class="help"></span></label>
                                 <div class="has-success">
                                     <input type="Text" class="form-control" id=besar_spot>
                                 </div>
                             </div>
                             <div class="col-md-3">
                                 ...
                                 <div class="has-success">
                                     ...
                                     <input type="text" class="form-control" id=durasi_val value="" style="display: none;">
                                 </div>
                             </div>
                         </div>
 ...
 <script>
     function simpan() {
         ...
         dataString = 'no_rm=' + no_rm + '&id_pelayanan=' + id_pelayanan + '&id_history=' + id_history + '&nama=' + nama + '&Ruang=' + Ruang +
         ...
         $.ajax({
             url: "<?php echo base_url() ?>Erm_laporan_tin_operasi/insert_tind_opr",
             method: "POST",
             dataType: 'json',
             data: dataString,
    ...
    //     id = $('#inHis').val();
    //     id_pelayanan = $('#inPel').val();
    //     window.location.href = "<?php echo base_url('Erm_poli/print_tin_opr/') ?>" + id + '/' + id_pelayanan;
    // }
 </script>