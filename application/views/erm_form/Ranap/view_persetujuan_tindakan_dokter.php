                ...
                <div class="panel-body">
                    <div class="form-wrap">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="has-success">
                                        <input type="text" class="form-control" id="pemberi_info" placeholder="-">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    ...
                                    <div class="has-success">
                                        <input type="text" class="form-control" id="penerima_info" placeholder="-">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 has-success">
                                        <textarea class="form-control" name="" id="diagnosis" cols="30" rows="3" placeholder="-"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 has-success">
                                        <textarea class="form-control" name="" id="diagnosis_d" cols="30" rows="3" placeholder="-"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="checkbox checkbox-success col-md-3">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 has-success">
                                        <textarea class="form-control" name="" id="tindakan" cols="30" rows="3" placeholder="-"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="checkbox checkbox-success col-md-3">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 has-success">
                                        <textarea class="form-control" name="" id="indikasi" cols="30" rows="3" placeholder="-"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="checkbox checkbox-success col-md-3">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 has-success">
                                        <textarea class="form-control" name="" id="tatacara" cols="30" rows="3" placeholder="-"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="checkbox checkbox-success col-md-3">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 has-success">
                                        <textarea class="form-control" name="" id="tujuan" cols="30" rows="3" placeholder="-"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="checkbox checkbox-success col-md-3">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 has-success">
                                        <textarea class="form-control" name="" id="risiko" cols="30" rows="3" placeholder="-"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="checkbox checkbox-success col-md-3">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 has-success">
                                        <textarea class="form-control" name="" id="prognosis" cols="30" rows="3" placeholder="-"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="checkbox checkbox-success col-md-3">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 has-success">
                                        <textarea class="form-control" name="" id="alt_risiko" cols="30" rows="3" placeholder="-"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="checkbox checkbox-success col-md-3">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 has-success">
                                        <textarea class="form-control" name="" id="hal_lain" cols="30" rows="3" placeholder="-"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                    <div class="checkbox checkbox-success col-md-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="has-success">
                                            <div id="tgl_tindakan" class="form-control"></div>
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <br />
                            <div class="row">
                                <button data-toggle="modal" data-target="#modal_ttd" id="modal_ttd00" aria-expanded="false" aria-controls="poli_sore" class="btn btn-primary btn-anim btn-sm"><i class="icon-rocket"></i><span class="btn-text">TANDA TANGAN</span></button>
                    ...
                    <div class="col-md-4">
                        ...
                        <br />
                        <div class="row">
                            <button data-toggle="modal" data-target="#modal_ttd1" id="modal_ttd11" aria-expanded="false" aria-controls="poli_sore" class="btn btn-primary btn-anim btn-sm"><i class="icon-rocket"></i><span class="btn-text">TANDA TANGAN</span></button>
                    ...
                    <div class="col-md-4">
                        ...
                        <br />
                        <div class="row">
                            <button data-toggle="modal" data-target="#modal_ttd2" id="modal_ttd22" aria-expanded="false" aria-controls="poli_sore" class="btn btn-primary btn-anim btn-sm"><i class="icon-rocket"></i><span class="btn-text">TANDA TANGAN</span></button>
...
<script type="text/javascript">
    ...
    function simpan() {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>Erm_ranap_persetujuan_kedokteran/insert_persetujuan_tindakan",
            method: "POST",
            dataType: 'json',
            data: dataString,
            success: function(data) {
                if (data.status == "success") {
                    window.location.href = "<?php echo base_url('Erm_ranap_persetujuan_kedokteran/formpersetujuan/') ?>" + id_pelayanan + '/' + id_history;
                } else if (data.error) {
    ...
    function reload_data_id_pel(id_pelayanan) { //utk reload data diagnosa pasien jika berhasil
        ...
        $('#tabel_terapi').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('Erm_ranap_persetujuan_kedokteran/tampil_list_per_tindakan_dokter'); ?>',
                "type": 'POST',
                "data": {
    ...
    window.onload = function() {
        document.getElementById('tgl_tindakan').innerText = getTodayDate();
    };

    function pilih(id) {
        $('#id').val(id);
        $.ajax({
            url: "<?php echo base_url() ?>Erm_ranap_persetujuan_kedokteran/getPerTindakanDok",
            method: "POST",
            dataType: 'json',
            data: {
                id: id
            ...
            success: function(data) {
                if (data.status_dt == "found") {
                    ...
                    document.querySelector('#modal_ttd00').disabled = true;
                    document.querySelector('#modal_ttd11').disabled = true;
                    document.querySelector('#modal_ttd22').disabled = true;
    ...
    function cetak() {
        id = $('#id').val();
        window.location.href = "<?php echo base_url('Erm_ranap/print_persetujuan/') ?>" + id;
    }
