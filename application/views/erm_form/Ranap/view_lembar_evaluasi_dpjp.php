                    ...
                    <div class="form-wrap">
                        ...
                        <div class="form-group">
                            <div class="col-md-8">
                                ...
                                <input type="date" class="form-control" id="inWaktu" name="inWaktu">
                        ...
                        <div class="form-group">
                            <div class="col-md-4">
                                <label class="control-label mb-8 text-left">Nama Dokter<span
                            ...
                            <div class="form-group">
                                <div class="col-md-4">
                                    <label class="control-label mb-10 text-left">Sebagai DPJP<span
                                            class="help"></span></label>
                                    <div class="has-success">
                        ...
                        <div class="col-md-4">
                            ...
                            <br />
                            <span id="ttd_error" class="text-danger"></span>
                            <div class="row">
...
<script type="text/javascript">
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_ranap_evaluasi_dpjp/insert_evaluasi",
      method: "POST",
      dataType: 'json',
      data: dataString,
