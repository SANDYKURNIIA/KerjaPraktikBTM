                                    ...
                                    <div class="button-list mt-25">
                                        ...
                                        if ($icu_only) {
                                            ...
                                            echo $buttonListIcuOnly;
                                                    ...
                                                    $btn_cls = isset($btn_asesmen_perawat) ? $btn_asesmen_perawat : 'btn-success';
                                                    $buttonListFULLERM = "
                                                        <div style='display: block;'>
                                                            <h5 class='txt-dark capitalize-font'><i class='fa fa-file mr-10'></i>ERM</h5>
                                                            <hr width='100%'>

                                                            <a class='btn {$btn_cls} col-md-5 asses_per_ranap' href='" . base_url('Erm_ranap_asesmen_perawat/formasesmenranap/') . "$id_pelayanan/$id_histori'>
