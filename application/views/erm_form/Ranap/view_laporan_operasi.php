          ...
          <div class="panel-body">
            <div class="form-wrap">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <label class="control-label mb-5 text-left">Jenis Operasi</label>

                  <div class="row" style="margin-top:5px;">
                    <div class="col-md-3"><label class="radio-label"><input type="radio" name="inJenOperasi"
                          value="Ringan"> Ringan</label></div>
                    <div class="col-md-3"><label class="radio-label"><input type="radio" name="inJenOperasi"
                          value="Sedang"> Sedang</label></div>
                    <div class="col-md-3"><label class="radio-label"><input type="radio" name="inJenOperasi"
                          value="Besar"> Besar</label></div>
                    <div class="col-md-3"><label class="radio-label"><input type="radio" name="inJenOperasi"
                          value="Khusus"> Khusus</label></div>
                  </div>
                </div>

                <div class="col-md-6">
                  <label class="control-label mb-5 text-left">Posisi Operasi</label>

                  <div class="has-success">
                    <textarea class="form-control" name="inPosisiOperasi" id="inPosisiOperasi" rows="1"
              ...
              <div class="row" style="padding-left:15px; padding-right:15px; margin-top:5px;">

                <!-- KIRI : JENIS PEMBIUSAN -->
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label mb-5 text-left">Jenis Pembiusan</label>

                    <div class="row" style="margin-top:5px;">
                      <div class="col-md-4">
                        <label class="radio-label">
                          <input type="radio" name="inAnestesi" value="Lokal Anastesi"> Lokal Anastesi
                        </label>
                      </div>

                      <div class="col-md-4">
                        <label class="radio-label">
                          <input type="radio" name="inAnestesi" value="Regional Anastesi"> Regional Anastesi
                        </label>
                      </div>

                      <div class="col-md-4">
                        <label class="radio-label">
                          <input type="radio" name="inAnestesi" value="Generali Anastesi"> Generali Anastesi
                        </label>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label mb-10 text-left">
                      Antiseptik dilakukan di daerah operasi dengan :
                    </label>

                    <div class="row" style="margin-top:5px;">
                      <div class="col-md-3">
                        <input id="inAntiseptik1" type="radio" name="inAntiSeptik" value="Betadine">
                        <label class="control-label" for="inAntiseptik1">Betadine</label>
                      </div>

                      <div class="col-md-3">
                        <input id="inAntiseptik2" type="radio" name="inAntiSeptik" value="Alkohol">
                        <label class="control-label" for="inAntiseptik2">Alkohol</label>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group" style="margin-top: 15px; margin-bottom: 25px;">
                <div class="col-md-6">
                  ...
                  <label class="control-label mb-10 text-left" style="display:block; margin-bottom:12px;">
                    Waktu Operasi<span class="help"></span>
                  </label>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="has-success">
                        ...
                        echo '<input type="text" id="inTglOperasi" readonly name="inTglOperasi" 
                    class="form-control" value="' . $tanggal_operasi . '">'; ?>
                        <span class="help-block"></span>
                      </div>
                    </div>
              ...
              <script>
                ...
                function hitungLamaOperasi() {
                  ...
                  if (selesaiTotal < mulaiTotal) selesaiTotal += 24 * 60;
                  ...
                  <div class="row option-row">
                    <div class="col-md-6 option-item">
                      <div class="radio-button radio-button-primary">
                        ...
                        <label class="control-label" for="inPenOperasi1">Tidak Ada</label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6 option-item">
                      <div class="radio-button radio-button-primary">
                        ...
                        <label class="control-label" for="inPenOperasi2">Ada</label>
                      </div>
                  ...
                  <div class="row option-row">
                    <div class="col-md-6 option-item">
                      <div class="radio-button radio-button-primary">
                        ...
                        <label class="control-label" for="inKomplikasi1">Tidak Ada</label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6 option-item">
                      <div class="radio-button radio-button-primary">
                        ...
                        <label class="control-label" for="inKomplikasi2">Ada</label>
                      </div>
              ...
              <script>
                document.getElementById('inPenOperasi2').addEventListener('change', function () {
                  document.getElementById('inPenOperasi').style.display = 'block';
                });
                document.getElementById('inPenOperasi1').addEventListener('change', function () {
                  document.getElementById('inPenOperasi').style.display = 'none';
                });

                document.getElementById('inKomplikasi2').addEventListener('change', function () {
                  document.getElementById('inKomplikasi').style.display = 'block';
                });
                document.getElementById('inKomplikasi1').addEventListener('change', function () {
                  document.getElementById('inKomplikasi').style.display = 'none';
                });
              </script>
              ...
              <style>
                /* Samakan tinggi label agar sejajar */
                .label-fixed-height {
                  min-height: 42px;
                  display: flex;
                ...
                /* Samakan tinggi container input agar semua sejajar */
                .input-fixed-height {
                  min-height: 60px;
                  /* aman, tidak mengubah ukuran field */
                  display: flex;
              ...
              <div class="form-group">
                ...
                <div class="col-md-3">
                  <label class="control-label mb-30 text-left label-fixed-height">
                    Jaringan yang di Eksisi/Insisi<span class="help"></span>
                  </label>

                  <div class="has-success input-fixed-height">
                ...
                <div class="col-md-3">
                  <label class="control-label mb-30 text-left label-fixed-height">
                    Jenis Pemeriksaan yang dikirim ke Laboratorium<span class="help"></span>
                  </label>
                ...
                <div class="col-md-3">
                  <label class="control-label mb-30 text-left label-fixed-height">
                    Nomor Pendaftaran Implan yang dipasang :<span class="help"></span>
                  </label>
            ...
            <div class="form-group">
              ...
              <div class="form-group text-center" style="margin-top: 30px;">
                ...
                <div class="col-md-6">
                  ...
                  <button type="button" id="btnSimpan" class="btn btn-success mb-4" onclick="simpan()">
                    <i class="fa fa-save"></i> Simpan
                  </button>

                  <button type="button" id="btnPrint" class="btn btn-default mb-4" disabled
                    onclick="printLaporanOperasi()">
              ...
              <script type="text/javascript">
                ...
                function printLaporanOperasi() {
                  let id_pelayanan = $('#inPel').val();
                  let id_history = $('#inHis').val();

                  if (!id_pelayanan || !id_history) {
                    alert("Data belum lengkap untuk print!");
                    return;
                  }

                  window.open(
                    "<?php echo base_url('Erm_laporan_operasi/print_out/'); ?>"
