            ...
            <div class="form-wrap">
              ...
              <div class="form-group">
                <div class="col-md-6">
                  ...
                  <input type="text" disabled class="form-control" value="<?= isset($nama_ruangan) ? $nama_ruangan : '' ?>">
                </div>
              </div>
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        ...
        <input type="time" class="form-control" id="inOpeSelesai" name="inOpeSelesai">
              ...
              <div class="form-group">
                <div class="col-md-3">
                  <label class="control-label mb-10 text-left">Jenis Pemeriksaan yang dikirim ke Laboratorium<span class="help"></span></label>
                  <div class="has-success">
