<form>
          ...
          <div class="panel-body">
                  ...
                  <div class="col-sm-12">
                      ...
                      <div class="col-md-8">
                        ...
                        <div class="col-md-3">
                          <div class="checkbox checkbox-success">
                            ...
                            <label class="control-label" for="kamarmandi_1">
                              Jauh
                            </label>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="checkbox checkbox-success">
                            ...
                            <label class="control-label" for="kamarmandi_2">
                              Dekat
                            </label>
                          </div>
                        </div>
                    ...
                    <div class="form-group ">
                      <div class="col-md-8">
                        ...
                        <div class="col-md-3">
                          <div class="checkbox checkbox-success">
                            <input id="toilet_1" type="checkbox" name="kloset" value="Jongkok" onclick="checkOnlyOne3(this.id)">
                        ...
                        <div class="col-md-3">
                          <div class="checkbox checkbox-success">
                            <input id="toilet_2" type="checkbox" name="kloset" value="Duduk" onclick="checkOnlyOne3(this.id)">
            ...
            <div class="form-group">
              <div class="col-md-6">
                ...
                <div class="has-success">
                  <textarea class="form-control" cols="2" rows="2" id="Alamat" name="inAlamat" placeholder="-"></textarea>
            ...
            <div class="form-group">
              <div class="col-md-6">
                ...
                <div class="has-success">
                  <textarea class="form-control" cols="2" rows="2" id="penjemput" name="inpenjemput" placeholder="-"></textarea>
            ...
            <div class="form-group">
              <div class="col-md-6">
                ...
                <div class="has-success">
                  <textarea class="form-control" cols="2" rows="2" id="hubungan" name="inhubungan" placeholder="-"></textarea>
  ...
  <script type="text/javascript">
    ...
    function checkOnlyOne3(id) {
      var checkboxes3 = document.getElementsByName('kloset');
  ...
  <script type="text/javascript">
    ...
    function simpan() {
      ...
      toilet = $('input[name="kloset"]:checked').val();
      ...
      keperluan15 = $('#hubungan').val();
      managemenNyeri = $('#managemenNyeri').val();
      ...
      $.ajax({
        url: "<?php echo base_url() ?>Discharge_planning/store",
        method: "POST",
        dataType: 'json',
        data: {
