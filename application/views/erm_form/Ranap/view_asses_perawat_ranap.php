            ...
            <div class="form-group">
              ...
              <div class="form-group ">
                ...
                <div class="form-group">
                  <div class="col-md-12">
                    <h5 style="margin-top: 30px;"><strong>
                        <label class="control-label mb-10 text-left"><b>BAGIAN 1 PEMERIKSAAN FISIK</b><span
                            class="help"></span></label></strong>
                    </h5>
                  </div>
                  ...
                  <div class="form-group col-md-12">
                    <label class="control-label mb-6 text-left" style="opacity: 0.75;"><strong>GLASGOW COMA SCALE
                        (GCS)</strong> </label>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group col-md-12">
                    ...
                    <div class="col-md-9">
                      <div class="form-group ">
                        <label class="control-label mb-6 text-left" style="opacity: 0.75;">Membuka mata secara spontan
                          tanpa rangsangan:
                          <strong>4</strong></label>
                      </div>
                      <div class="form-group">
                        <label class="control-label mb-6 text-left" style="opacity: 0.75;">Membuka mata setelah
                          diperintahkan:
                      ...
                      <div class="form-group">
                        <label class="control-label mb-6 text-left" style="opacity: 0.75;">Tidak membuka mata dengan
                          rangsangan nyeri:
                  ...
                  <div class="col-md-6">
                    <div class="form-group col-md-12">
                      <label class="control-label mb-10 text-left" style="opacity: 0.75;"><strong>VERBAL:</strong>
                      </label>
                    </div>
                    <div class="col-md-9 ">
                      <div class="form-group ">
                      ...
                      <div class="form-group">
                        <label class="control-label mb-10 text-left" style="opacity: 0.75;">Orientasi terganggu /
                          bingung:
                          <strong>4</strong></label>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label mb-10 text-left" style="opacity: 0.75;">Tidak ada respon verbal
                  ...
                  <div class="col-md-6">
                    <div class="form-group col-md-12">
                      <label class="control-label mb-10 text-left" style="opacity: 0.75;"><strong>MOVEMENT
                          (GERAKAN):</strong> </label>
                    </div>
                    <div class="col-md-11">
                      <div class="form-group ">
                        <label class="control-label mb-10 text-left" style="opacity: 0.75;">Dapat bergerak mengikuti
                          perintah pemeriksa:
                      ...
                      <div class="form-group">
                        <label class="control-label mb-10 text-left" style="opacity: 0.75;">Melakukan gerakan menghindar
                          saat diberi rangsangan nyeri:
                          <strong>4</strong></label>
                      </div>
                      <div class="form-group">
                        <label class="control-label mb-10 text-left" style="opacity: 0.75;">Fleksi abnormal lengan ata
                          tungkai saat diberi rangsangan nyeri:
                          <strong>3</strong></label>
                      </div>
                      <div class="form-group">
                        <label class="control-label mb-10 text-left" style="opacity: 0.75;">Ekstensi abnormal lengan
                          atau tungkai saat diberi rangsangan nyeri:
                          <strong>2</strong></label>
                      </div>
                      <div class="form-group">
                        <label class="control-label mb-10 text-left" style="opacity: 0.75;">Tidak ada respon dengan
                          rangsangan nyeri:
                          <strong>1</strong></label>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group col-md-12">
                      <label class="control-label mb-10 text-left" style="opacity: 0.75;"><strong>Penilaian
                          GCS:</strong> </label>
                    </div>
                    <div class="col-md-9">
                      <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-4">
                      ...
                      <div class="">
                        <input type="number" disabled class="form-control" name="gcs" id="gcs" placeholder="" value="<?= isset($asesmen->gcs) ? $asesmen->gcs : ''; ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-md-4">
                        ...
                        <div class="">
                          <input type="number" class="form-control" name="e" id="e" value="<?= isset($asesmen->e) ? $asesmen->e : '0'; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-md-4">
                        ...
                        <div class=" ">
                          <input type="number" class="form-control" name="m" id="m" value="<?= isset($asesmen->m) ? $asesmen->m : '0'; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <div class="col-md-4">
                        ...
                        <div class=" ">
                          <input type="number" class="form-control" name="v" id="v" value="<?= isset($asesmen->v) ? $asesmen->v : '0'; ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class=" ">
                            <input type="text" class="form-control" name="tekanan_darah" id="tekanan_darah"
                              placeholder="mmHg" value="<?= isset($asesmen->tekanan_darah) ? $asesmen->tekanan_darah : ''; ?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-4">
                          ...
                          <div class=" ">
                            <input type="number" class="form-control" name="suhu" id="suhu" placeholder="Celsius" value="<?= isset($asesmen->suhu) ? $asesmen->suhu : ''; ?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-4">
                          ...
                          <div class=" ">
                            <input type="text" class="form-control" name="frequensi_nadi" id="frequensi_nadi"
                              placeholder="x/menit" value="<?= isset($asesmen->frequensi_nadi) ? $asesmen->frequensi_nadi : ''; ?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-4">
                          ...
                          <div class=" ">
                            <input type="number" class="form-control" name="spo2" id="spo2" placeholder="" value="<?= isset($asesmen->spo2) ? $asesmen->spo2 : ''; ?>">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-4">
                          ...
                          <div class=" ">
                            <input type="text" class="form-control" name="berat_badan" id="berat_badan"
                              placeholder="Kg" value="<?= isset($asesmen->berat_badan) ? $asesmen->berat_badan : ''; ?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-4">
                          ...
                          <div class=" ">
                            <input type="text" class="form-control" name="frequensi_nafas" id="frequensi_nafas"
                              placeholder="x/menit" value="<?= isset($asesmen->frequensi_nafas) ? $asesmen->frequensi_nafas : ''; ?>">
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-4">
                          ...
                          <div class=" ">
                            <input type="text" class="form-control" name="tinggi_badan" id="tinggi_badan"
                              placeholder="Cm" value="<?= isset($asesmen->tinggi_badan) ? $asesmen->tinggi_badan : ''; ?>">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                      ...
                      <div class="col-md-7">
                        <div class="form-group">
                          <div class="col-md-12">
                            <label class="control-label mb-10 text-left"><b>Kepala: </b><span
                                class="help"></span></label>
                            <div class=" ">
                              <input type="text" class="form-control" name="kepala" id="kepala" cols="30" rows="2"
                                value="<?= isset($asesmen->kepala) ? $asesmen->kepala : 'Dalam Batas Normal'; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                            <label class="control-label mb-10 text-left"><b>Hidung: </b><span
                                class="help"></span></label>
                            <div class=" ">
                              <input type="text" class="form-control" name="hidung" id="hidung" cols="30" rows="2"
                                value="<?= isset($asesmen->hidung) ? $asesmen->hidung : 'Dalam Batas Normal'; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                            <label class="control-label mb-10 text-left"><b>Mulut: </b><span
                                class="help"></span></label>
                            <div class=" ">
                              <input type="text" class="form-control" name="mulut" id="mulut" cols="30" rows="2"
                                value="<?= isset($asesmen->mulut) ? $asesmen->mulut : 'Dalam Batas Normal'; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                            <label class="control-label mb-10 text-left"><b>Leher: </b><span
                                class="help"></span></label>
                            <div class=" ">
                              <input type="text" class="form-control" name="leher" id="leher" cols="30" rows="2"
                                value="<?= isset($asesmen->leher) ? $asesmen->leher : 'Dalam Batas Normal'; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                            <label class="control-label mb-10 text-left"><b>THORAX : </b><span
                                class="help"></span></label>
                            <div class=" ">
                              <input type="text" class="form-control" name="thorax" id="thorax" cols="30" rows="2"
                                value="<?= isset($asesmen->thorax) ? $asesmen->thorax : 'Dalam Batas Normal'; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                            <label class="control-label mb-10 text-left"><b>Jantung : </b><span
                                class="help"></span></label>
                            <div class=" ">
                              <input type="text" class="form-control" name="jantung" id="jantung" cols="30" rows="2"
                                value="<?= isset($asesmen->jantung) ? $asesmen->jantung : 'Dalam Batas Normal'; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                            <label class="control-label mb-10 text-left"><b>Paru : </b><span
                                class="help"></span></label>
                            <div class=" ">
                              <input type="text" class="form-control" name="paru" id="paru" cols="30" rows="2"
                                value="<?= isset($asesmen->paru) ? $asesmen->paru : 'Dalam Batas Normal'; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                            <label class="control-label mb-10 text-left"><b>Andomen dan Pelvis : </b><span
                                class="help"></span></label>
                            <div class=" ">
                              <input type="text" class="form-control" name="andomen" id="andomen" cols="30" rows="2"
                                value="<?= isset($asesmen->andomen) ? $asesmen->andomen : 'Dalam Batas Normal'; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                            <label class="control-label mb-10 text-left"><b>Punggung dan Pinggang : </b><span
                                class="help"></span></label>
                            <div class=" ">
                              <input type="text" class="form-control" name="punggung" id="punggung" cols="30" rows="2"
                                value="<?= isset($asesmen->punggung) ? $asesmen->punggung : 'Dalam Batas Normal'; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                            <label class="control-label mb-10 text-left"><b>Ekstremitas : </b><span
                                class="help"></span></label>
                            <div class=" ">
                              <input type="text" class="form-control" name="ekstremitas" id="ekstremitas" cols="30"
                                rows="2" value="<?= isset($asesmen->ekstremitas) ? $asesmen->ekstremitas : 'Dalam Batas Normal'; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <div class="col-md-12">
                            <label class="control-label mb-10 text-left"><b>Genetalia : </b><span
                                class="help"></span></label>
                            <div class=" ">
                              <input type="text" class="form-control" name="genetalia" id="genetalia" cols="30" rows="2"
                                value="<?= isset($asesmen->genetalia) ? $asesmen->genetalia : 'Dalam Batas Normal'; ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group col-md-2">
                        ...
                        <div class=" ">
                          <input class="form-control" cols="1" rows="1" id="bradan_score" name="bradan_score"
                            disabled></input>
                  ...
                  <div class="form-group" id="spirit">
                    ...
                    <div class="form-group">
                      <div class="col-md-4">
                        ...
                        <div class="row">
                          <div class="radio-button radio-button-primary">
                            <input id="alergi1" type="radio" name="alergi" value="Tidak Ada" <?= (isset($asesmen->alergi) ? ($asesmen->alergi == 'Tidak Ada' ? 'checked' : '') : 'checked'); ?>>
                            <label class="control-label" for="alergi1">
                              Tidak Ada
                            </label>
                          </div>
                          <div class="radio-button radio-button-primary">
                            <input id="alergi2" type="radio" name="alergi" value="Ada" <?= (isset($asesmen->alergi) && $asesmen->alergi == 'Ada') ? 'checked' : ''; ?>>
                            <label class="control-label" for="alergi2">
                              Ada
                            </label>
                            <div class="has-success">
                              <input type="text" class="form-control" value="<?= isset($asesmen->riwayat_alergi) ? $asesmen->riwayat_alergi : ''; ?>" id="riwayat_alergi"
                                style="display: none;">
                            </div>
                          </div>
                        </div>
                    ...
                    <div id="banyak" style="display:none;">
                        ...
                        <div>
                          ...
                          <div class="form-group">
                            <div class="col-md-4">
                              ...
                              <div class="row">
                                <div class="radio-button radio-button-primary">
                                  <input id="alergi_obat1" type="radio" name="alergi_obat" value="Tidak Ada" <?= (isset($asesmen->alergi_obat) ? ($asesmen->alergi_obat == 'Tidak Ada' ? 'checked' : '') : 'checked'); ?>>
                                  <label class="control-label" for="alergi_obat1">
                                    Tidak Ada
                                  </label>
                                </div>
                                <div class="radio-button radio-button-primary">
                                  <input id="alergi_obat2" type="radio" name="alergi_obat" value="Ada" <?= (isset($asesmen->alergi_obat) && $asesmen->alergi_obat == 'Ada') ? 'checked' : ''; ?>>
                                  <label class="control-label" for="alergi_obat2">
                                    Ada, Jenis/Nama Obat
                                  </label>
                                  <div class=" ">
                                    <input type="text" class="form-control alergi_obat_textbox"
                                      name="alergi_obat_textbox" id="alergi_obat_textbox"
                                      style="display: none; width: 250px;" value="<?= isset($asesmen->alergi_obat_textbox) ? $asesmen->alergi_obat_textbox : ''; ?>">
                                    <span class="help-block"></span>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div class="row">
                            <div class="col-md-4">
                              <div class="checkbox checkbox-success">
                                <input id="lain_lain" type="checkbox" name="lain_lain" value="Asma" <?= (isset($asesmen->lain_lain) && strpos($asesmen->lain_lain, 'Asma') !== false) ? 'checked' : ''; ?>>
                                <label class="control-label" for="lain_lain">
                                  Asma
                                </label>
                              </div>
                              <div class="checkbox checkbox-success">
                                <input id="lain_lain1" type="checkbox" name="lain_lain" value="Eksim Kulit" <?= (isset($asesmen->lain_lain) && strpos($asesmen->lain_lain, 'Eksim Kulit') !== false) ? 'checked' : ''; ?>>
                                <label class="control-label" for="lain_lain1">
                                  Eksim Kulit
                                </label>
                              </div>
                              <div class="checkbox checkbox-success">
                                <input id="lain_lain2" type="checkbox" name="lain_lain" value="Sabun" <?= (isset($asesmen->lain_lain) && strpos($asesmen->lain_lain, 'Sabun') !== false) ? 'checked' : ''; ?>>
                                <label class="control-label" for="lain_lain2">
                                  Sabun
                                </label>
                              </div>
                              <div class="checkbox checkbox-success">
                                <input id="lain_lain3" type="checkbox" name="lain_lain" value="Makanan" <?= (isset($asesmen->lain_lain) && strpos($asesmen->lain_lain, 'Makanan') !== false) ? 'checked' : ''; ?>>
                                <label class="control-label" for="lain_lain3">
                                  Makanan
                                </label>
                              </div>
                              <div class="checkbox checkbox-success">
                                <input id="lain_lain4" type="checkbox" name="lain_lain" value="Debu" <?= (isset($asesmen->lain_lain) && strpos($asesmen->lain_lain, 'Debu') !== false) ? 'checked' : ''; ?>>
                                <label class="control-label" for="lain_lain4">
                                  Debu
                                </label>
                              </div>
                              <div class="checkbox checkbox-success">
                                <input id="lain_lain5" type="checkbox" name="lain_lain" value="Udara" <?= (isset($asesmen->lain_lain) && strpos($asesmen->lain_lain, 'Udara') !== false) ? 'checked' : ''; ?>>
                      ...
                      <div class="form-group">
                        <div class="col-md-3">
                          ...
                          <div class="row">
                            <div class="radio-button radio-button-primary">
                              <input id="reaksi_alergi1" type="radio" name="reaksi_alergi" value="Tidak" <?= (isset($asesmen->reaksi_alergi) ? ($asesmen->reaksi_alergi == 'Tidak' ? 'checked' : '') : 'checked'); ?>>
                              <label class="control-label" for="reaksi_alergi1">
                                Tidak
                              </label>
                            </div>
                            <div class="radio-button radio-button-primary">
                              <input id="reaksi_alergi2" type="radio" name="reaksi_alergi" value="Ya" <?= (isset($asesmen->reaksi_alergi) && $asesmen->reaksi_alergi == 'Ya') ? 'checked' : ''; ?>>
                              <label class="control-label" for="reaksi_alergi2">
                                Ya
                              </label>
                              <div class=" ">
                                <input type="text" class="form-control" id="reaksi_alergi_detail"
                                  style="display: none;" value="<?= isset($asesmen->reaksi_alergi_detail) ? $asesmen->reaksi_alergi_detail : ''; ?>">
                                <span class="help-block"></span>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="form-group" style="display: none;">
                        <div class="col-md-6">
                          ...
                          <div class=" ">
                            <input class="form-control" name="reaksi_utama" id="reaksi_utama" cols="30"
                              rows="2" value="<?= isset($asesmen->reaksi_utama) ? $asesmen->reaksi_utama : ''; ?>"></input>
                          </div>
                        </div>
                      </div>
                      <script>
                    ...
                    <div class="form-group">
                      <div class="col-md-3">
                        <div class="row">
                          <div class="radio-button radio-button-primary">
                            <input id="transfusi_darah1" type="radio" name="transfusi_darah" value="Tidak" <?= (isset($asesmen->transfusi_darah) ? ($asesmen->transfusi_darah == 'Tidak' ? 'checked' : '') : 'checked'); ?>>
                            <label class="control-label" for="transfusi_darah1">
                              Tidak
                            </label>
                          </div>
                          <div class="radio-button radio-button-primary">
                            <input id="transfusi_darah2" type="radio" name="transfusi_darah" value="Pernah" <?= (isset($asesmen->transfusi_darah) && $asesmen->transfusi_darah == 'Pernah') ? 'checked' : ''; ?>>
                        ...
                        <div class=" " id="transfusi_darah_detail" style="display: none;">
                          <input type="text" class="form-control" name="transfusi_darah_detail"
                            id="transfusi_darah_detail" placeholder="Detail transfusi darah" value="<?= isset($asesmen->transfusi_darah_detail) ? $asesmen->transfusi_darah_detail : ''; ?>">
                          <span class="help-block"></span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-3">
                        <div class="radio-button radio-button-primary">
                          <input id="merokok1" type="radio" name="merokok" value="Tidak" <?= (isset($asesmen->merokok) ? ($asesmen->merokok == 'Tidak' ? 'checked' : '') : 'checked'); ?>>
                          <label class="control-label" for="merokok1">
                            Tidak
                          </label>
                        </div>
                        <div class="radio-button radio-button-primary">
                          <input id="merokok2" type="radio" name="merokok" value="Ya" <?= (isset($asesmen->merokok) && $asesmen->merokok == 'Ya') ? 'checked' : ''; ?>>
                    ...
                    <div class="form-group" id="form-input-jmlrokok">
                      <div class="col-md-3">
                        <label id="text_jumlah_rokok" class="control-label mb-10 text-left">Berapa batang rokok per -
                          hari<span class="help"></span></label>
                        <div id="jumlah_rokok" style="display: none;">
                          <input id="input_jumlah_rokok" type="number" class="form-control" name="jumlah_rokok"
                            placeholder="Jumlah/Hari" value="<?= isset($asesmen->jumlah_rokok) ? $asesmen->jumlah_rokok : ''; ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-3">
                        <div class="radio-button radio-button-primary">
                          <input id="alkohol1" type="radio" name="alkohol" value="Tidak" <?= (isset($asesmen->alkohol) ? ($asesmen->alkohol == 'Tidak' ? 'checked' : '') : 'checked'); ?>>
                          <label class="control-label" for="alkohol1">
                            Tidak
                          </label>
                        </div>
                        <div class="radio-button radio-button-primary">
                          <input id="alkohol2" type="radio" name="alkohol" value="Ya" <?= (isset($asesmen->alkohol) && $asesmen->alkohol == 'Ya') ? 'checked' : ''; ?>>
                    ...
                    <div class="form-group">
                      <div class="col-md-3">
                        <label id="text_jumlah_alkohol" class="control-label mb-10 text-left">Berapa minuman per -
                          hari<span class="help"></span></label>
                        <div class=" " id="jumlah_alkohol" style="display: none;">
                          <input id="input_jumlah_alkohol" type="number" class="form-control" name="jumlah_alkohol"
                            placeholder="Jumlah/Hari" value="<?= isset($asesmen->jumlah_alkohol) ? $asesmen->jumlah_alkohol : ''; ?>">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="form-group" id="form-input-jmlobat">
                    <div class="col-md-3">
                      <label id="text_jumlah_obat" class="control-label mb-10 text-left">Berapa konsumsi obat per -
                        hari<span class="help"></span></label>
                      <div id="obat_penenang_detail" style="display: none;">
                        <input id="input_obat_penenang_detail" type="number" class="form-control"
                          name="obat_penenang_detail" placeholder="Jumlah/Hari">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-md-3">
                      ...
                      <div class=" " id="lainnya_penyakit_keluarga_detail" style="display: none;">
                        <input type="text" class="form-control" name="detail_penyakit_keluarga_lainnya"
                          id="detail_penyakit_keluarga_lainnya" placeholder="Detail penyakit keluarga lainnya">
                        <!-- <span class="help-block"></span> -->
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-12">
                        <h5 style="margin-top: 30px;"><strong>
                            <label class="control-label mb-10 text-left"><b>BAGIAN 3 KENYAMANAN</b><span
                                class="help"></span></label>
                          </strong>
                        </h5>
                      </div>
                      ...
                      <div class=" " id="banyak2" style="display: none;">
                        <div class="col-md-7">
                          <h5 style="margin-top: 30px;">
                            <label class="control-label mb-10 text-left"><b>Skala Nyeri </b><span
                                  class="help"></span></label>
                          </h5>
                          ...
                          <div class="col-md-14">
                            ...
                            <div class="radio-button radio-button-primary"
                              style="display: flex; gap: 70px; align-items: center;">
                            ...
                            <div class="col-md-3">
                              <div class="form-group ">
                                <label class="control-label mb-10 text-left" style="opacity: 0.75;">Tidak nyeri :
                                  <strong>0</strong></label>
                              </div>
                              <div class="form-group">
                                <label class="control-label mb-10 text-left" style="opacity: 0.75;">Nyeri ringan :
                                  <strong> 1 - 3</strong></label>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label mb-10 text-left" style="opacity: 0.75;">Nyeri sedang :
                                <strong>4 - 6 </strong></label>
                            </div>
                            <div class="form-group">
                              <label class="control-label mb-10 text-left" style="opacity: 0.75;">Nyeri berat :
                                <strong>7 - 10 </strong></label>
                            </div>
                          </div>
                          ...
                          <div class="slidecontainer col-md-14">
                            ...
                            <span id="val"></span>
                            <input id="slide" name="skala_nyeri" type="range" min="0" max="10" value="0"
                              oninput="updateNyeri(event)" onchange="updateNyeri(event)" />
                            <span class="help-block"></span>
                            <div id="state"><img src='<?= base_url() . 'assets/dist/img/tidak_nyeri.png'; ?>'
                                width=7%></img>
                              <br>
                        ...
                        <div class="form-group form-group-spacing">
                          <div class="col-md-12">
                            <label class="control-label mb-10 text-left">Flac Scale (Indikasi: digunakan pada pasien
                              bayi dan anak < 5 tahun), Kategori :</label>
                        ...
                        <div class="col-md-5">
                          <button data-toggle="modal" data-target="#modal_gambar" aria-expanded="false"
                            aria-controls="poli_sore" class="btn btn-primary btn-anim btn-sm"><i
                              class="icon-rocket"></i><span class="btn-text">GAMBAR</span></button>
                          ...
                          <div class="form-group">
                            <div class="modal fade" id="modal_gambar" role="dialog"
                              aria-labelledby="newPeternakModallabel" aria-hidden="true">
                          ...
                          <div class="form-group">
                            <div class="col-md-12">
                              <label class="control-label mb-10 text-left"><b>Keterangan : </b><span
                                    class="help"></span></label>
                              <div class=" ">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="form-group col-md-2">
                          ...
                          <div class=" ">
                            <input class="form-control" cols="1" rows="1" id="aktifitas_score" name="aktifitas_score"
                              disabled></input>
                            <span class="help-block text-danger"></span>
                          </div>
                        </div>
                    ...
                    <div class="form-group form-group-spacing">
                      ...
                      <div class="form-group">
                        <div class="col-md-3">
                          ...
                          <div class=" " id="taliIkat_detail" style="display: none;">
                            <input type="text" class="form-control" name="taliIkat_detail" id="taliIkat_detail"
                              placeholder="">
                            <span class="help-block"></span>
                          </div>
                        </div>
                      ...
                      <div class="col-md-12">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="radio-button radio-button-primary">
                                <div class="col-md-12">
                                  ...
                                  <label class="control-label" for="diagnosis1">Tidak Ada/Bedrest/Dibantu Perawat
                                    (0)</label>
                                </div>
                                <div class="col-md-12">
                          ...
                          <div class="form-group form-group-spacing">
                            <div class="col-md-12">
                              <label class="control-label mb-10 text-left">D. Menggunakan Infus/Heparin/Pengencer Dara
                                :</label>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="radio-button radio-button-primary">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <label class="control-label" for="anestesi2">Lupa akan keterbatasan/Pelupa
                                    (15)</label>
                                </div>
                                <!-- <div class="col-md-12">
                          ...
                          <div class="form-group col-md-2">
                            ...
                            <div class=" ">
                              <input class="form-control" cols="1" rows="1" id="resiko_score" name="resiko_score"
                                disabled></input>
                              <span class="help-block text-danger"></span>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            <div class="col-md-3">
                              ...
                              <div id="intake_lain_lain" style="display: none;">
                                <input type="text" class="form-control" id="intake_lain_lain_textbox"
                                  name="intake_lain_lain_textbox">
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="form-group ">
                          <div class="col-md-4">
                            <label class="control-label mb-10 text-left">Masalah yang berhubungan dengan nutrisi
                              :</label>
                        ...
                        <div class="form-group">
                          <div class="col-md-4">
                            <label class="control-label mb-10 text-left">Pasien dengan diagnosis khusus<span
                                class="help"></span></label>
                            <span id="diagKhusus_error" class="text-danger"></span>
                            <div class=" ">
                              <input type="text" class="form-control" name="diagKhusus" id="diagKhusus"
                                placeholder="Diabetes melitus, hipertensi, jantung, CKD, Stroke, dll">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <head>
                          <meta charset="UTF-8">
                          <meta name="viewport" content="width=device-width, initial-scale=1.0">
                          <title>Form Pengkajian Padiatrik</title>
                          <style>
                            .form-group {
                              margin-bottom: 15px;
                            }
                            ...
                            .bagian-v-paediatric .form-group {
                              margin-top: 0;
                              margin-bottom: 22px;
                            }

                            .bagian-v-paediatric .form-group:last-child {
                              margin-bottom: 0;
                            }

                            .bagian-v-paediatric .control-label {
                              display: block;
                              margin: 0 0 7px 0;
                            }

                            .bagian-v-paediatric .control-label.mb-10 {
                              margin-bottom: 7px !important;
                            }

                            .bagian-v-paediatric .radio-button-primary>div,
                            .bagian-v-paediatric .checkbox-primary>div {
                              margin-bottom: 8px;
                            }

                            .bagian-v-paediatric .radio-button-primary>div:last-child,
                            .bagian-v-paediatric .checkbox-primary>div:last-child {
                              margin-bottom: 0;
                            }

                            .bagian-v-paediatric .section-title {
                              margin-top: 28px;
                              margin-bottom: 15px;
                            }

                            .bagian-v-paediatric .section-title:first-of-type {
                              margin-top: 0;
                            }

                            .bagian-v-paediatric .input-group {
                            ...
                            .bagian-v-paediatric .input-group .form-control {
                              display: block;
                              flex: 1 1 auto;
                              width: 1%;
                            ...
                            .bagian-v-paediatric .input-group-addon {
                              display: flex !important;
                              flex: 0 0 auto;
                              align-items: center;
                            ...
                            .bagian-v-paediatric #detail_komplikasi,
                            .bagian-v-paediatric #detail_masalah_maternal,
                            .bagian-v-paediatric #detail_pernah_dirawat,
                            .bagian-v-paediatric #detail_masalah_neonatal {
                              margin-top: 8px;
                            }
                          </style>
                          <?php
                            // Tampilkan bagian PENGKAJIAN KHUSUS PAEDIATRIC hanya untuk pasien
                            // berusia 1 bulan sampai dengan 18 tahun (dihitung dari tanggal lahir).
                            $show_paediatric = false;
                            if (!empty($tgl_lahir)) {
                              $dob = DateTime::createFromFormat('d-m-Y', $tgl_lahir);
                              if ($dob instanceof DateTime) {
                                $now = new DateTime();
                                if ($dob <= $now) {
                                  $ageDiff = $dob->diff($now);
                                  $minUsia1Bulan = ($ageDiff->y > 0) || ($ageDiff->m >= 1);
                                  $maxUsia18Tahun = ($ageDiff->y < 18) || ($ageDiff->y == 18 && $ageDiff->m == 0 && $ageDiff->d == 0);
                                  $show_paediatric = $minUsia1Bulan && $maxUsia18Tahun;
                                }
                              }
                            }
                          ?>
                          <div class="bagian-v-paediatric" id="wrap_bagian_paediatric" <?= $show_paediatric ? '' : 'style="display:none;"'; ?>>
                            <div class="col-md-12">
                              <h5 class="section-title" style="margin-top: 20px;"><strong>PENGKAJIAN KHUSUS
                                  PAEDIATRIC</strong></h5>
                            </div>

                             <?php 
                              $val_lama_kehamilan = isset($asesmen->paed_lama_kehamilan) && $asesmen->paed_lama_kehamilan !== '' ? $asesmen->paed_lama_kehamilan : (isset($asesmen->lama_kehamilan) ? $asesmen->lama_kehamilan : '');
                              $val_satuan_kehamilan = isset($asesmen->lama_kehamilan_satuan) ? $asesmen->lama_kehamilan_satuan : '';

                              $val_komplikasi_tipe = isset($asesmen->paed_komplikasi_tipe) && $asesmen->paed_komplikasi_tipe !== '' ? $asesmen->paed_komplikasi_tipe : (isset($asesmen->komplikasi_tipe) ? $asesmen->komplikasi_tipe : '');
                              $val_komplikasi = isset($asesmen->komplikasi) && $asesmen->komplikasi !== '' ? $asesmen->komplikasi : (!empty($val_komplikasi_tipe) && $val_komplikasi_tipe !== 'Tidak' ? 'Ya' : 'Tidak');

                              $val_masalah_maternal_ket = isset($asesmen->masalah_maternal_ket) && $asesmen->masalah_maternal_ket !== '' ? $asesmen->masalah_maternal_ket : '';
                              $val_masalah_maternal = isset($asesmen->paed_masalah_maternal) && $asesmen->paed_masalah_maternal !== '' ? $asesmen->paed_masalah_maternal : (isset($asesmen->masalah_maternal) ? $asesmen->masalah_maternal : (!empty($val_masalah_maternal_ket) ? 'Ya' : 'Tidak'));

                              $persal_str = isset($asesmen->paed_persalina_tipe) && !empty($asesmen->paed_persalina_tipe) ? $asesmen->paed_persalina_tipe : (isset($asesmen->riwayat_persalinan) ? $asesmen->riwayat_persalinan : '');
                              $val_persalinan = !empty($persal_str) ? (is_array($persal_str) ? $persal_str : explode(',', $persal_str)) : [];

                              $val_penyulit = isset($asesmen->paed_penyulit_persalinan) && $asesmen->paed_penyulit_persalinan !== '' ? $asesmen->paed_penyulit_persalinan : (isset($asesmen->penyulit_persalinan) ? $asesmen->penyulit_persalinan : '');

                              $val_post_natal = isset($asesmen->paed_post_natal) && $asesmen->paed_post_natal !== '' ? $asesmen->paed_post_natal : (isset($asesmen->post_natal) ? $asesmen->post_natal : '');
                              $val_post_natal_lain = isset($asesmen->post_natal_lain) && $asesmen->post_natal_lain !== '' ? $asesmen->post_natal_lain : '';

                              $imun_str = isset($asesmen->paed_riwayat_imunisasi) && !empty($asesmen->paed_riwayat_imunisasi) ? $asesmen->paed_riwayat_imunisasi : (isset($asesmen->imunisasi) ? $asesmen->imunisasi : '');
                              $val_imunisasi = !empty($imun_str) ? (is_array($imun_str) ? $imun_str : explode(',', $imun_str)) : [];

                              $val_lahir_umur_kehamilan = isset($asesmen->paed_lahir_umur_kehamilan) && $asesmen->paed_lahir_umur_kehamilan !== '' ? $asesmen->paed_lahir_umur_kehamilan : (isset($asesmen->lahir_umur_kehamilan) ? $asesmen->lahir_umur_kehamilan : '');
                              $val_lahir_umur_satuan = isset($asesmen->lahir_umur_kehamilan_satuan) ? $asesmen->lahir_umur_kehamilan_satuan : '';

                              $val_pernah_dirawat = isset($asesmen->paed_pernah_dirawat) && $asesmen->paed_pernah_dirawat !== '' ? $asesmen->paed_pernah_dirawat : (isset($asesmen->pernah_dirawat) ? $asesmen->pernah_dirawat : '');
                              $val_dirawat_dimana = isset($asesmen->paed_pernah_dirawat_dimana) && $asesmen->paed_pernah_dirawat_dimana !== '' ? $asesmen->paed_pernah_dirawat_dimana : (isset($asesmen->dirawat_dimana) ? $asesmen->dirawat_dimana : '');
                              $val_dirawat_kapan = isset($asesmen->paed_pernah_dirawat_kapan) && $asesmen->paed_pernah_dirawat_kapan !== '' ? $asesmen->paed_pernah_dirawat_kapan : (isset($asesmen->dirawat_kapan) ? $asesmen->dirawat_kapan : '');

                              $val_lk_lahir = isset($asesmen->paed_lk_saat_lahir) && $asesmen->paed_lk_saat_lahir !== '' ? $asesmen->paed_lk_saat_lahir : (isset($asesmen->lk_lahir) ? $asesmen->lk_lahir : '');
                              $val_bb_lahir = isset($asesmen->paed_bb_saat_lahir) && $asesmen->paed_bb_saat_lahir !== '' ? $asesmen->paed_bb_saat_lahir : (isset($asesmen->bb_lahir) ? $asesmen->bb_lahir : '');
                              $val_tb_lahir = isset($asesmen->paed_tb_saat_lahir) && $asesmen->paed_tb_saat_lahir !== '' ? $asesmen->paed_tb_saat_lahir : (isset($asesmen->tb_lahir) ? $asesmen->tb_lahir : '');
                              $val_usia_sampai_umur = isset($asesmen->paed_asi_sampai_umur) && $asesmen->paed_asi_sampai_umur !== '' ? $asesmen->paed_asi_sampai_umur : (isset($asesmen->usia_sampai_umur) ? $asesmen->usia_sampai_umur : '');
                              $val_susu_formula_mulai = isset($asesmen->paed_susu_formula_mulai) && $asesmen->paed_susu_formula_mulai !== '' ? $asesmen->paed_susu_formula_mulai : (isset($asesmen->susu_formula_mulai) ? $asesmen->susu_formula_mulai : '');
                              $val_makanan_tambahan_mulai = isset($asesmen->paed_makanan_tambahan_umur) && $asesmen->paed_makanan_tambahan_umur !== '' ? $asesmen->paed_makanan_tambahan_umur : (isset($asesmen->makanan_tambahan_mulai) ? $asesmen->makanan_tambahan_mulai : '');

                              $val_masalah_neonatus = isset($asesmen->paed_masalah_neonatus) && $asesmen->paed_masalah_neonatus !== '' ? $asesmen->paed_masalah_neonatus : (isset($asesmen->masalah_neonatal) ? $asesmen->masalah_neonatal : '');
                              $val_masalah_neonatal_tipe = isset($asesmen->masalah_neonatal_tipe) ? $asesmen->masalah_neonatal_tipe : ($val_masalah_neonatus !== 'Tidak' && $val_masalah_neonatus !== 'Ya' ? $val_masalah_neonatus : '');

                              $val_jaundice_rds = isset($asesmen->jaundice_rds) && $asesmen->jaundice_rds !== '' ? $asesmen->jaundice_rds : (isset($asesmen->paed_masalah_neonatus) && $asesmen->paed_masalah_neonatus !== 'Tidak' && $asesmen->paed_masalah_neonatus !== 'Ya' ? $asesmen->paed_masalah_neonatus : (isset($asesmen->masalah_neonatal_tipe) ? $asesmen->masalah_neonatal_tipe : ''));

                              $val_tengkurap = isset($asesmen->paed_tengkurap_bln) && $asesmen->paed_tengkurap_bln !== '' ? $asesmen->paed_tengkurap_bln : (isset($asesmen->tengkurap) ? $asesmen->tengkurap : '');
                              $val_duduk = isset($asesmen->paed_duduk_bln) && $asesmen->paed_duduk_bln !== '' ? $asesmen->paed_duduk_bln : (isset($asesmen->duduk) ? $asesmen->duduk : '');
                              $val_merangkak = isset($asesmen->paed_merangkak_bln) && $asesmen->paed_merangkak_bln !== '' ? $asesmen->paed_merangkak_bln : (isset($asesmen->merangkak) ? $asesmen->merangkak : '');
                              $val_berdiri = isset($asesmen->paed_berdiri_bln) && $asesmen->paed_berdiri_bln !== '' ? $asesmen->paed_berdiri_bln : (isset($asesmen->berdiri) ? $asesmen->berdiri : '');
                              $val_berjalan = isset($asesmen->paed_berjalan_bln) && $asesmen->paed_berjalan_bln !== '' ? $asesmen->paed_berjalan_bln : (isset($asesmen->berjalan) ? $asesmen->berjalan : (isset($asesmen->berjalan_paediatric) ? $asesmen->berjalan_paediatric : ''));

                              $val_keluhan_tumbuh_kembang = isset($asesmen->paed_keluhan_tumbuh_kembang) && $asesmen->paed_keluhan_tumbuh_kembang !== '' ? $asesmen->paed_keluhan_tumbuh_kembang : (isset($asesmen->keluhan_tumbuh_kembang) ? $asesmen->keluhan_tumbuh_kembang : '');
                              $val_diagnosa_medis = isset($asesmen->paed_diagnosa_medis) && $asesmen->paed_diagnosa_medis !== '' ? $asesmen->paed_diagnosa_medis : (isset($asesmen->diagnosa_medis) ? $asesmen->diagnosa_medis : '');
                            ?>
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  <div class="col-md-8">
                                    <label class="control-label mb-10 text-left">Lama kehamilan :</label>
                                    <span id="lama_kehamilan_error" class="text-danger"></span>
                                    <div class=" ">
                                      <input type="text" class="form-control" id="lama_kehamilan" name="lama_kehamilan" value="<?= $val_lama_kehamilan; ?>">
                                      <span class="help-block"></span>
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                    ...
                                    <div class=" ">
                                      <select class="form-control" id="lama_kehamilan_satuan"
                                        name="lama_kehamilan_satuan">
                                        <option value="Bln" <?= ($val_satuan_kehamilan == 'Bln') ? 'selected' : ''; ?>>Bln</option>
                                        <option value="Minggu" <?= ($val_satuan_kehamilan == 'Minggu') ? 'selected' : ''; ?>>Minggu</option>
                                      </select>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group form-group-spacing">
                                  <div class="col-md-12">
                                    ...
                                    <span id="komplikasi_error" class="text-danger"></span>
                                    <div class="radio-button radio-button-primary">
                                      <div class="col-md-12">
                                        <input id="komplikasi1" type="radio" name="komplikasi" value="Tidak" <?= ($val_komplikasi == 'Tidak' || $val_komplikasi == 'tidak') ? 'checked' : ''; ?>>
                                        <label class="control-label" for="komplikasi1">Tidak</label>
                                      </div>
                                      <div class="col-md-12">
                                        <input id="komplikasi2" type="radio" name="komplikasi" value="Ya" <?= ($val_komplikasi == 'Ya' || $val_komplikasi == 'ya' || (!empty($val_komplikasi_tipe) && $val_komplikasi_tipe != 'Tidak')) ? 'checked' : ''; ?>>
                                        <label class="control-label" for="komplikasi2">Ya. Tipe :
                                          PEB/DM/HT/IPF/lain-lain</label>
                                      </div>
                                      <div id="detail_komplikasi" style="<?= ($val_komplikasi == 'Ya' || $val_komplikasi == 'ya' || (!empty($val_komplikasi_tipe) && $val_komplikasi_tipe != 'Tidak')) ? '' : 'display: none;'; ?>">
                                        <div class="col-md-8">
                                          <input type="text" class="form-control" id="komplikasi_tipe"
                                            name="komplikasi_tipe" placeholder="Sebutkan tipe komplikasi" value="<?= $val_komplikasi_tipe; ?>">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div class="form-group form-group-spacing">
                                  <div class="col-md-12">
                                    <label class="control-label mb-10 text-left">Masalah maternal :</label>
                                    <span id="masalah_maternal_error" class="text-danger"></span>
                                    <div class="radio-button radio-button-primary">
                                      <div class="col-md-12">
                                        <input id="masalah_maternal1" type="radio" name="masalah_maternal"
                                          value="Tidak" <?= ($val_masalah_maternal == 'Tidak' || $val_masalah_maternal == 'tidak') ? 'checked' : ''; ?>>
                                        <label class="control-label" for="masalah_maternal1">Tidak</label>
                                      </div>
                                      <div class="col-md-12">
                                        <input id="masalah_maternal2" type="radio" name="masalah_maternal" value="Ya" <?= ($val_masalah_maternal == 'Ya' || $val_masalah_maternal == 'ya' || !empty($val_masalah_maternal_ket)) ? 'checked' : ''; ?>>
                                        <label class="control-label" for="masalah_maternal2">Ya :</label>
                                      </div>
                                      <div id="detail_masalah_maternal" style="<?= ($val_masalah_maternal == 'Ya' || $val_masalah_maternal == 'ya' || !empty($val_masalah_maternal_ket)) ? '' : 'display: none;'; ?>">
                                        <div class="col-md-8">
                                          <input type="text" class="form-control" id="masalah_maternal_ket"
                                            name="masalah_maternal_ket" placeholder="Sebutkan masalah maternal" value="<?= $val_masalah_maternal_ket; ?>">
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <h5 class="section-title"><strong>Riwayat Natal</strong></h5>
                                  </div>
                                </div>

                                <!-- Riwayat Persalinan (3 di atas, 2 di bawah) -->
                                <div class="form-group form-group-spacing">
                                  <div class="col-md-12">
                                    <label class="control-label mb-10 text-left">Riwayat Persalinan :</label>
                                    <span id="riwayat_persalinan_error" class="text-danger"></span>
                                    <div class="checkbox checkbox-primary">
                                      <!-- Baris 1 (3 pilihan) -->
                                      <div class="col-md-12" style="margin-bottom: 10px; padding-left: 0;">
                                        <div class="col-md-4">
                                          <input id="persalinan_pv" type="checkbox" name="riwayat_persalinan[]"
                                            value="pV" <?= in_array('pV', $val_persalinan) ? 'checked' : ''; ?>>
                                          <label class="control-label" for="persalinan_pv">pV</label>
                                        </div>
                                        <div class="col-md-4">
                                          <input id="persalinan_sc" type="checkbox" name="riwayat_persalinan[]"
                                            value="SC" <?= in_array('SC', $val_persalinan) ? 'checked' : ''; ?>>
                                          <label class="control-label" for="persalinan_sc">SC</label>
                                        </div>
                                        <div class="col-md-4">
                                          <input id="persalinan_ve" type="checkbox" name="riwayat_persalinan[]"
                                            value="VE" <?= in_array('VE', $val_persalinan) ? 'checked' : ''; ?>>
                                          <label class="control-label" for="persalinan_ve">VE</label>
                                        </div>
                                      </div>

                                      <!-- Baris 2 (2 pilihan: RE & Penyulit Persalinan) -->
                                      <div class="col-md-12" style="padding-left: 0;">
                                        <div class="col-md-4">
                                          <input id="persalinan_re" type="checkbox" name="riwayat_persalinan[]"
                                            value="RE" <?= in_array('RE', $val_persalinan) ? 'checked' : ''; ?>>
                                          <label class="control-label" for="persalinan_re">RE</label>
                                        </div>
                                        <div class="col-md-8">
                                          <input id="penyulit_persalinan_cb" type="checkbox"
                                            name="penyulit_persalinan_cb" value="1" <?= (!empty($val_penyulit) || (isset($asesmen->penyulit_persalinan_cb) && $asesmen->penyulit_persalinan_cb == '1')) ? 'checked' : ''; ?>>
                                          <label class="control-label" for="penyulit_persalinan_cb">Penyulit persalinan
                                            :</label>
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  <!-- Box Input Penyulit Persalinan (Hidden secara default) -->
                                  <div id="detail_penyulit_persalinan" class="col-md-8"
                                    style="<?= (!empty($val_penyulit) || (isset($asesmen->penyulit_persalinan_cb) && $asesmen->penyulit_persalinan_cb == '1')) ? '' : 'display: none;'; ?> margin-top: 10px; padding-left: 15px;">
                                    <input type="text" class="form-control" id="penyulit_persalinan"
                                      name="penyulit_persalinan" placeholder="Sebutkan penyulit persalinan" value="<?= $val_penyulit; ?>">
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <h5 class="section-title"><strong>Riwayat Post Natal</strong></h5>
                                  </div>
                                </div>

                                <div class="form-group form-group-spacing">
                                  <div class="col-md-12">
                                    <span id="post_natal_error" class="text-danger"></span>
                                    <div class="radio-button radio-button-primary">
                                      <div class="col-md-3">
                                        <input id="post_natal1" type="radio" name="post_natal" value="Prematur" <?= ($val_post_natal == 'Prematur') ? 'checked' : ''; ?>>
                                        <label class="control-label" for="post_natal1">Prematur</label>
                                      </div>
                                      <div class="col-md-3">
                                        <input id="post_natal2" type="radio" name="post_natal" value="Aterm" <?= ($val_post_natal == 'Aterm') ? 'checked' : ''; ?>>
                                        <label class="control-label" for="post_natal2">Aterm</label>
                                      </div>
                                      <div class="col-md-3">
                                        <input id="post_natal3" type="radio" name="post_natal" value="Post date" <?= ($val_post_natal == 'Post date') ? 'checked' : ''; ?>>
                                        <label class="control-label" for="post_natal3">Post date</label>
                                      </div>
                                      <div class="col-md-3">
                                        <input id="post_natal4" type="radio" name="post_natal" value="Lain-lain" <?= ($val_post_natal == 'Lain-lain' || (!empty($val_post_natal_lain) && !in_array($val_post_natal, ['Prematur', 'Aterm', 'Post date']))) ? 'checked' : ''; ?>>
                                        <label class="control-label" for="post_natal4">Lain-lain</label>
                                      </div>
                                    </div>
                                  </div>

                                  <!-- Box Input Post Natal Lain-lain (Hidden secara default) -->
                                  <div id="detail_post_natal_lain" class="col-md-8"
                                    style="<?= ($val_post_natal == 'Lain-lain' || !empty($val_post_natal_lain)) ? '' : 'display: none;'; ?> margin-top: 10px; padding-left: 15px;">
                                    <input type="text" class="form-control" id="post_natal_lain" name="post_natal_lain"
                                      placeholder="Sebutkan riwayat post natal lainnya" value="<?= $val_post_natal_lain; ?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <div class="col-md-12">
                                    <h5 class="section-title"><strong>Riwayat Imunisasi</strong></h5>
                                  </div>
                                </div>
                                ...
                                <div class="form-group form-group-spacing">
                                  <div class="col-md-12">
                                    <div class="checkbox checkbox-primary">
                                      ...
                                      <div class="col-md-3"><input id="imun_hepb1" type="checkbox" name="imunisasi[]"
                                          value="Hep B I" <?= in_array('Hep B I', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_hepb1">Hep B I</label>
                                      </div>
                                      <div class="col-md-3"><input id="imun_hepb2" type="checkbox" name="imunisasi[]"
                                          value="Hep B II" <?= in_array('Hep B II', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_hepb2">Hep B
                                          II</label></div>
                                      <div class="col-md-3"><input id="imun_hepb3" type="checkbox" name="imunisasi[]"
                                          value="Hep B III" <?= in_array('Hep B III', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_hepb3">Hep B
                                          III</label></div>
                                      <div class="col-md-3"><input id="imun_hepb4" type="checkbox" name="imunisasi[]"
                                          value="Hep B IV" <?= in_array('Hep B IV', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_hepb4">Hep B
                                          IV</label></div>

                                      <div class="col-md-3"><input id="imun_hepb5" type="checkbox" name="imunisasi[]"
                                          value="Hep B V" <?= in_array('Hep B V', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_hepb5">Hep B V</label>
                                      </div>
                                      <div class="col-md-3"><input id="imun_dpt1" type="checkbox" name="imunisasi[]"
                                          value="DPT I" <?= in_array('DPT I', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_dpt1">DPT I</label></div>
                                      <div class="col-md-3"><input id="imun_dpt2" type="checkbox" name="imunisasi[]"
                                          value="DPT II" <?= in_array('DPT II', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_dpt2">DPT II</label>
                                      </div>
                                      <div class="col-md-3"><input id="imun_dpt3" type="checkbox" name="imunisasi[]"
                                          value="DPT III" <?= in_array('DPT III', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_dpt3">DPT III</label>
                                      </div>

                                      <div class="col-md-3"><input id="imun_bcg" type="checkbox" name="imunisasi[]"
                                          value="BCG" <?= in_array('BCG', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_bcg">BCG</label></div>
                                      <div class="col-md-3"><input id="imun_booster1" type="checkbox" name="imunisasi[]"
                                          value="Booster I" <?= in_array('Booster I', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_booster1">Booster
                                          I</label></div>
                                      <div class="col-md-3"><input id="imun_booster2" type="checkbox" name="imunisasi[]"
                                          value="Booster II" <?= in_array('Booster II', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_booster2">Booster
                                          II</label></div>
                                      <div class="col-md-3"><input id="imun_booster3" type="checkbox" name="imunisasi[]"
                                          value="Booster III" <?= in_array('Booster III', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_booster3">Booster
                                          III</label></div>

                                      <div class="col-md-3"><input id="imun_polio1" type="checkbox" name="imunisasi[]"
                                          value="Polio I" <?= in_array('Polio I', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_polio1">Polio I</label>
                                      </div>
                                      <div class="col-md-3"><input id="imun_polio2" type="checkbox" name="imunisasi[]"
                                          value="Polio II" <?= in_array('Polio II', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_polio2">Polio
                                          II</label></div>
                                      <div class="col-md-3"><input id="imun_polio3" type="checkbox" name="imunisasi[]"
                                          value="Polio III" <?= in_array('Polio III', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_polio3">Polio
                                          III</label></div>
                                      <div class="col-md-3"><input id="imun_boosterp1" type="checkbox"
                                          name="imunisasi[]" value="Booster I (Polio)" <?= in_array('Booster I (Polio)', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label"
                                          for="imun_boosterp1">Booster I</label></div>

                                      <div class="col-md-3"><input id="imun_boosterp2" type="checkbox"
                                          name="imunisasi[]" value="Booster II (Polio)" <?= in_array('Booster II (Polio)', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label"
                                          for="imun_boosterp2">Booster II</label></div>
                                      <div class="col-md-3"><input id="imun_boosterp3" type="checkbox"
                                          name="imunisasi[]" value="Booster III (Polio)" <?= in_array('Booster III (Polio)', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label"
                                          for="imun_boosterp3">Booster III</label></div>
                                      <div class="col-md-3"><input id="imun_hib1" type="checkbox" name="imunisasi[]"
                                          value="HIB I" <?= in_array('HIB I', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_hib1">HIB I</label></div>
                                      <div class="col-md-3"><input id="imun_hib2" type="checkbox" name="imunisasi[]"
                                          value="HIB II" <?= in_array('HIB II', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_hib2">HIB II</label>
                                      </div>

                                      <div class="col-md-3"><input id="imun_hib3" type="checkbox" name="imunisasi[]"
                                          value="HIB III" <?= in_array('HIB III', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_hib3">HIB III</label>
                                      </div>
                                      <div class="col-md-3"><input id="imun_hib4" type="checkbox" name="imunisasi[]"
                                          value="HIB IV" <?= in_array('HIB IV', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_hib4">HIB IV</label>
                                      </div>
                                      <div class="col-md-3"><input id="imun_campak" type="checkbox" name="imunisasi[]"
                                          value="Campak" <?= in_array('Campak', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_campak">Campak</label>
                                      </div>
                                      <div class="col-md-3"><input id="imun_mmr" type="checkbox" name="imunisasi[]"
                                          value="MMR" <?= in_array('MMR', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_mmr">MMR</label></div>

                                      <div class="col-md-3"><input id="imun_varilla" type="checkbox" name="imunisasi[]"
                                          value="Varilla" <?= in_array('Varilla', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label"
                                          for="imun_varilla">Varilla</label></div>
                                      <div class="col-md-3"><input id="imun_typhoid" type="checkbox" name="imunisasi[]"
                                          value="Typhoid" <?= in_array('Typhoid', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label"
                                          for="imun_typhoid">Typhoid</label></div>
                                      <div class="col-md-3"><input id="imun_hepa1" type="checkbox" name="imunisasi[]"
                                          value="Hep A I" <?= in_array('Hep A I', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_hepa1">Hep A I</label>
                                      </div>
                                      <div class="col-md-3"><input id="imun_hepa2" type="checkbox" name="imunisasi[]"
                                          value="Hep A II" <?= in_array('Hep A II', $val_imunisasi) ? 'checked' : ''; ?>><label class="control-label" for="imun_hepa2">Hep A
                                          II</label></div>
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                  <div class="col-md-8">
                                    <label class="control-label mb-10 text-left">Lahir umur kehamilan :</label>
                                    <span id="lahir_umur_kehamilan_error" class="text-danger"></span>
                                    <div class=" ">
                                      <input type="text" class="form-control" id="lahir_umur_kehamilan"
                                        name="lahir_umur_kehamilan" value="<?= $val_lahir_umur_kehamilan; ?>">
                                      <span class="help-block"></span>
                                    </div>
                                  </div>
                                  <div class="col-md-4">
                                    <label class="control-label mb-10 text-left">&nbsp;</label>
                                    <div class=" ">
                                      <select class="form-control" id="lahir_umur_kehamilan_satuan"
                                        name="lahir_umur_kehamilan_satuan">
                                        <option value="Bln" <?= ($val_lahir_umur_satuan == 'Bln') ? 'selected' : ''; ?>>Bln</option>
                                        <option value="Minggu" <?= ($val_lahir_umur_satuan == 'Minggu') ? 'selected' : ''; ?>>Minggu</option>
                                      </select>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group form-group-spacing">
                                  <div class="col-md-12">
                                    <label class="control-label mb-10 text-left">Pernah di rawat sebelumnya :</label>
                                    <span id="pernah_dirawat_error" class="text-danger"></span>
                                    <div class="radio-button radio-button-primary">
                                      <div class="col-md-6">
                                        <input id="pernah_dirawat1" type="radio" name="pernah_dirawat" value="Tidak" <?= ($val_pernah_dirawat == 'Tidak' || $val_pernah_dirawat == 'tidak') ? 'checked' : ''; ?>>
                                        <label class="control-label" for="pernah_dirawat1">Tidak</label>
                                      </div>
                                      <div class="col-md-6">
                                        <input id="pernah_dirawat2" type="radio" name="pernah_dirawat" value="Ya" <?= ($val_pernah_dirawat == 'Ya' || $val_pernah_dirawat == 'ya' || !empty($val_dirawat_dimana)) ? 'checked' : ''; ?>>
                                        <label class="control-label" for="pernah_dirawat2">Ya</label>
                                      </div>
                                    </div>
                                  </div>
                                  <div id="detail_pernah_dirawat" style="<?= ($val_pernah_dirawat == 'Ya' || $val_pernah_dirawat == 'ya' || !empty($val_dirawat_dimana)) ? '' : 'display: none;'; ?>">
                                    <div class="col-md-6">
                                      <label class="control-label mb-10 text-left">Dimana :</label>
                                      <input type="text" class="form-control" id="dirawat_dimana" name="dirawat_dimana" value="<?= $val_dirawat_dimana; ?>">
                                    </div>
                                    <div class="col-md-6">
                                      <label class="control-label mb-10 text-left">Kapan :</label>
                                      <input type="text" class="form-control" id="dirawat_kapan" name="dirawat_kapan" value="<?= $val_dirawat_kapan; ?>">
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  <div class="col-md-6">
                                    <label class="control-label mb-10 text-left">LK anak saat lahir :</label>
                                    <div class="input-group">
                                      <input type="number" class="form-control" id="lk_lahir" name="lk_lahir" value="<?= $val_lk_lahir; ?>">
                                      <span class="input-group-addon">cm</span>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <label class="control-label mb-10 text-left">BB anak saat lahir :</label>
                                    <div class="input-group">
                                      <input type="number" class="form-control" id="bb_lahir" name="bb_lahir"
                                        step="0.01" value="<?= $val_bb_lahir; ?>">
                                ...
                                <div class="form-group">
                                  <div class="col-md-6">
                                    <label class="control-label mb-10 text-left">TB anak saat lahir :</label>
                                    <div class="input-group">
                                      <input type="number" class="form-control" id="tb_lahir" name="tb_lahir" value="<?= $val_tb_lahir; ?>">
                                      <span class="input-group-addon">cm</span>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <label class="control-label mb-10 text-left">Usia sampai umur :</label>
                                    <div class="input-group">
                                      <input type="text" class="form-control" id="usia_sampai_umur"
                                        name="usia_sampai_umur" value="<?= $val_usia_sampai_umur; ?>">
                                      <span class="input-group-addon">bln/th</span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  <div class="col-md-6">
                                    <label class="control-label mb-10 text-left">Susu formula mulai :</label>
                                    <div class="input-group">
                                      <input type="text" class="form-control" id="susu_formula_mulai"
                                        name="susu_formula_mulai" value="<?= $val_susu_formula_mulai; ?>">
                                      <span class="input-group-addon">bln/th</span>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <label class="control-label mb-10 text-left">Makanan tambahan mulai :</label>
                                    <div class="input-group">
                                      <input type="text" class="form-control" id="makanan_tambahan_mulai"
                                        name="makanan_tambahan_mulai" value="<?= $val_makanan_tambahan_mulai; ?>">
                                      <span class="input-group-addon">bln/th</span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group form-group-spacing">
                                  <div class="col-md-12">
                                    <label class="control-label mb-10 text-left">Masalah neonatal :</label>
                                    <span id="masalah_neonatal_error" class="text-danger"></span>
                                    <div class="radio-button radio-button-primary">
                                      <div class="col-md-6">
                                        <input id="masalah_neonatal1" type="radio" name="masalah_neonatal"
                                          value="Tidak" <?= ($val_masalah_neonatus == 'Tidak' || $val_masalah_neonatus == 'tidak') ? 'checked' : ''; ?>>
                                        <label class="control-label" for="masalah_neonatal1">Tidak</label>
                                      </div>
                                      <div class="col-md-6">
                                        <input id="masalah_neonatal2" type="radio" name="masalah_neonatal" value="Ya" <?= ($val_masalah_neonatus == 'Ya' || $val_masalah_neonatus == 'ya' || !empty($val_masalah_neonatal_tipe)) ? 'checked' : ''; ?>>
                                        <label class="control-label" for="masalah_neonatal2">Ya. Tipe :</label>
                                      </div>
                                    </div>
                                  </div>
                                  <div id="detail_masalah_neonatal" style="<?= ($val_masalah_neonatus == 'Ya' || $val_masalah_neonatus == 'ya' || !empty($val_masalah_neonatal_tipe)) ? '' : 'display: none;'; ?>">
                                    <div class="col-md-8">
                                      <input type="text" class="form-control" id="masalah_neonatal_tipe"
                                        name="masalah_neonatal_tipe" value="<?= $val_masalah_neonatal_tipe; ?>">
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <label class="control-label mb-10 text-left">Jaundice/RDS/PJB/Kelainan kongenital
                                      :</label>
                                    <div class=" ">
                                      <input type="text" class="form-control" id="jaundice_rds" name="jaundice_rds" value="<?= $val_jaundice_rds; ?>">
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  <div class="col-md-6">
                                    <label class="control-label mb-10 text-left">Tengkurap :</label>
                                    <div class="input-group">
                                      <input type="number" class="form-control" id="tengkurap" name="tengkurap" value="<?= $val_tengkurap; ?>">
                                      <span class="input-group-addon">bln</span>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <label class="control-label mb-10 text-left">Duduk :</label>
                                    <div class="input-group">
                                      <input type="number" class="form-control" id="duduk" name="duduk" value="<?= $val_duduk; ?>">
                                      <span class="input-group-addon">bln</span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  <div class="col-md-6">
                                    <label class="control-label mb-10 text-left">Merangkak :</label>
                                    <div class="input-group">
                                      <input type="number" class="form-control" id="merangkak" name="merangkak" value="<?= $val_merangkak; ?>">
                                      <span class="input-group-addon">bln</span>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <label class="control-label mb-10 text-left">Berdiri :</label>
                                    <div class="input-group">
                                      <input type="number" class="form-control" id="berdiri" name="berdiri" value="<?= $val_berdiri; ?>">
                                      <span class="input-group-addon">bln</span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                      <input type="number" class="form-control" id="berjalan" name="berjalan" value="<?= $val_berjalan; ?>">
                                      <span class="input-group-addon">bln</span>
                                    </div>
                                  </div>
                                </div>
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <div class="col-md-12">
                                  <label class="control-label mb-10 text-left">Keluhan tumbuh kembang sekarang :</label>
                                  <span id="keluhan_tumbuh_kembang_error" class="text-danger"></span>
                                  <div class=" ">
                                    <textarea class="form-control" rows="2" id="keluhan_tumbuh_kembang"
                                      name="keluhan_tumbuh_kembang"><?= $val_keluhan_tumbuh_kembang; ?></textarea>
                                    <span class="help-block"></span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                <div class="col-md-12">
                                  <label class="control-label mb-10 text-left">Diagnosa Medis :</label>
                                  <span id="diagnosa_medis_error" class="text-danger"></span>
                                  <div class=" ">
                                    <textarea class="form-control" rows="2" id="diagnosa_medis"
                                      name="diagnosa_medis"><?= $val_diagnosa_medis; ?></textarea>
                                    <span class="help-block"></span>
                                  </div>
                                </div>
                              </div>
                          ...
                          <script>
                            $(document).ready(function () {
                              ...
                              $('input[name="komplikasi"]').change(function () {
                                if ($(this).val() === 'Ya') {
                                  $('#detail_komplikasi').show();
                                } else {
                                  $('#detail_komplikasi').hide();
                                  $('#komplikasi_tipe').val('');
                                }
                              });

                              $('input[name="masalah_maternal"]').change(function () {
                                if ($(this).val() === 'Ya') {
                                  $('#detail_masalah_maternal').show();
                                } else {
                                  $('#detail_masalah_maternal').hide();
                                  $('#masalah_maternal_ket').val('');
                                }
                              });

                              $('input[name="pernah_dirawat"]').change(function () {
                                if ($(this).val() === 'Ya') {
                                  $('#detail_pernah_dirawat').show();
                                } else {
                                  $('#detail_pernah_dirawat').hide();
                                  $('#dirawat_dimana, #dirawat_kapan').val('');
                                }
                              });

                              $('input[name="masalah_neonatal"]').change(function () {
                                if ($(this).val() === 'Ya') {
                                  $('#detail_masalah_neonatal').show();
                                } else {
                                  $('#detail_masalah_neonatal').hide();
                                  $('#masalah_neonatal_tipe').val('');
                                }
                              });
                              $(document.getElementById('penyulit_persalinan_cb')).on('change', function () {
                                if ($(this).is(':checked')) {
                                  $('#detail_penyulit_persalinan').slideDown();
                                } else {
                                  $('#detail_penyulit_persalinan').slideUp();
                                  $('#penyulit_persalinan').val(''); // Reset value saat di-uncheck
                                }
                              });

                              $('input[name="post_natal"]').on('change', function () {
                                if ($(this).val() === 'Lain-lain') {
                                  $('#detail_post_natal_lain').slideDown();
                                } else {
                                  $('#detail_post_natal_lain').slideUp();
                                  $('#post_natal_lain').val(''); // Reset value jika memilih opsi selain Lain-lain
                                }
                              });
                        ...
                        <body>
                          <div class="col-md-12">
                            <div class="form-group form-group-spacing">
                              <div class="col-md-12">
                                <label class="control-label mb-10 text-left">1. Apakah pasien mengalami penurunan berat
                                  badan yang tidak direncanakan/tidak diinginkan dalam 6 bulan terakhir? :</label>
                                ...
                                <div class="radio-button radio-button-primary">
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <label class="control-label" for="turun3">Ya, ada penurunan berat badan
                                      sebanyak:</label>
                                  </div>
                                  <div id="detail_penurunan_berat" style="display: none;">
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <label class="control-label" for="turun8">Tidak tahu berapa Kg penurunannya
                                        (2)</label>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group form-group-spacing">
                            <div class="col-md-12">
                              <label class="control-label mb-10 text-left">2. Apakah asupan makanan pasien berkurang
                                karena penurunan nafsu makan/ kesulitan menerima makanan? :</label>
                          ...
                          <div class="form-group col-md-2">
                            ...
                            <div class=" ">
                              <input class="form-control" cols="1" rows="1" id="nutrisi_score" name="nutrisi_score"
                                disabled></input>
                              <span class="help-block text-danger"></span>
                            </div>
                          </div>
                      ...
                      <div class="col-md-12">
                        <!-- <div class="row"> -->
                        <div class="form-group ">
                          <label class="control-label mb-10 text-left" style="opacity: 0.75;">- Bila skor >= 2, pasien
                            beresiko malnutrisi, konsul ke ahli gizi <strong></strong></label>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-10">
                          ...
                          <div class="checkbox checkbox-success">
                            <input id="keperluan1" type="checkbox" name="keperluan"
                              value="Menolak dilakukan tranfusi darah karena kepercayaan">
                            <label class="control-label" for="keperluan1">
                              Menolak dilakukan tranfusi darah karena kepercayaan
                            </label>
                          </div>
                          <div class="checkbox checkbox-success">
                            <input id="keperluan2" type="checkbox" name="keperluan"
                              value="Menolak pulang hari tertentu karena kepercayaan">
                            <label class="control-label" for="keperluan2">
                              Menolak pulang hari tertentu karena kepercayaan
                            </label>
                          </div>
                          <div class="checkbox checkbox-success">
                            <input id="keperluan3" type="checkbox" name="keperluan"
                              value="Menolak dilayani oleh petugas atau perawat laki-laki">
                            <label class="control-label" for="keperluan3">
                              Menolak dilayani oleh petugas / perawat laki-laki
                            </label>
                          </div>
                          <div class="checkbox checkbox-success">
                            <input id="keperluan4" type="checkbox" name="keperluan"
                              value="Menolak dilayani oleh petugas atau perawat perempuan">
                            <label class="control-label" for="keperluan4">
                              Menolak dilayani oleh petugas / perawat perempuan
                            </label>
                          </div>
                          <div class="checkbox checkbox-success">
                            <input id="keperluan5" type="checkbox" name="keperluan"
                              value="Menolak dirawat oleh medis dan mencari pengobatan alternatif">
                        ...
                        <!-- ============================================================ -->
                        <!-- KEBUTUHAN KOMUNIKASI/PENDIDIKAN DAN PENGAJARAN (MAKS 3 PILIHAN / BARIS) -->
                        <!-- ============================================================ -->

                        <style>
                          .kebutuhan-komunikasi-pendidikan .form-group-spacing {
                            margin-bottom: 18px;
                          }

                          .kebutuhan-komunikasi-pendidikan .radio-button,
                          .kebutuhan-komunikasi-pendidikan .checkbox {
                            margin-bottom: 12px;
                          }

                          .kebutuhan-komunikasi-pendidikan .inline-input {
                        ...
                        <div class="kebutuhan-komunikasi-pendidikan">

                          <div class="col-md-12">
                            <h5 style="margin-top: 10px; margin-bottom: 20px;">
                              <strong>KEBUTUHAN KOMUNIKASI/PENDIDIKAN DAN PENGAJARAN</strong>
                            </h5>
                          </div>

                          <?php 
                            $val_bicara = isset($asesmen->kom_bicara) && $asesmen->kom_bicara !== '' ? $asesmen->kom_bicara : (isset($asesmen->bicara) ? $asesmen->bicara : '');
                            $val_bicara_kapan = isset($asesmen->kom_serangan_bicara_kapan) && $asesmen->kom_serangan_bicara_kapan !== '' ? $asesmen->kom_serangan_bicara_kapan : (isset($asesmen->bicara_kapan) ? $asesmen->bicara_kapan : '');

                            $bahasa_str = isset($asesmen->kom_bahasa) && !empty($asesmen->kom_bahasa) ? $asesmen->kom_bahasa : (isset($asesmen->bahasa) ? $asesmen->bahasa : '');
                            $val_bahasa = !empty($bahasa_str) ? (is_array($bahasa_str) ? $bahasa_str : explode(',', $bahasa_str)) : [];
                            $val_bahasa_daerah_ket = isset($asesmen->kom_bahasa_daerah_detail) && $asesmen->kom_bahasa_daerah_detail !== '' ? $asesmen->kom_bahasa_daerah_detail : (isset($asesmen->bahasa_daerah_ket) ? $asesmen->bahasa_daerah_ket : '');
                            $val_bahasa_lain_ket = isset($asesmen->kom_bahasa_lain_detail) && $asesmen->kom_bahasa_lain_detail !== '' ? $asesmen->kom_bahasa_lain_detail : (isset($asesmen->bahasa_lain_ket) ? $asesmen->bahasa_lain_ket : '');

                            $val_penerjemah = isset($asesmen->kom_perlu_penterjemah) && $asesmen->kom_perlu_penterjemah !== '' ? $asesmen->kom_perlu_penterjemah : (isset($asesmen->penerjemah) ? $asesmen->penerjemah : '');
                            $val_penerjemah_bahasa = isset($asesmen->kom_penterjemah_bahasa) && $asesmen->kom_penterjemah_bahasa !== '' ? $asesmen->kom_penterjemah_bahasa : (isset($asesmen->penerjemah_bahasa) ? $asesmen->penerjemah_bahasa : '');

                            $val_bahan_isyarat = isset($asesmen->kom_bahan_isyarat) && $asesmen->kom_bahan_isyarat !== '' ? $asesmen->kom_bahan_isyarat : (isset($asesmen->bahan_isyarat) ? $asesmen->bahan_isyarat : '');

                            $hambatan_str = isset($asesmen->kom_hambatan_belajar) && !empty($asesmen->kom_hambatan_belajar) ? $asesmen->kom_hambatan_belajar : (isset($asesmen->hambatan_belajar) ? $asesmen->hambatan_belajar : '');
                            $val_hambatan = !empty($hambatan_str) ? (is_array($hambatan_str) ? $hambatan_str : explode(',', $hambatan_str)) : [];
                            $val_hambatan_lain_ket = isset($asesmen->hambatan_lain_ket) && $asesmen->hambatan_lain_ket !== '' ? $asesmen->hambatan_lain_ket : '';

                            $cara_belajar_str = isset($asesmen->kom_cara_belajar_disukai) && !empty($asesmen->kom_cara_belajar_disukai) ? $asesmen->kom_cara_belajar_disukai : (isset($asesmen->cara_belajar) ? $asesmen->cara_belajar : '');
                            $val_cara_belajar = !empty($cara_belajar_str) ? (is_array($cara_belajar_str) ? $cara_belajar_str : explode(',', $cara_belajar_str)) : [];
                            $val_cara_belajar_lain_ket = isset($asesmen->cara_belajar_lain_ket) && $asesmen->cara_belajar_lain_ket !== '' ? $asesmen->cara_belajar_lain_ket : '';

                            $val_tingkat_pendidikan = isset($asesmen->kom_tingkat_pendidikan) && $asesmen->kom_tingkat_pendidikan !== '' ? $asesmen->kom_tingkat_pendidikan : (isset($asesmen->tingkat_pendidikan) ? $asesmen->tingkat_pendidikan : '');

                            $kebutuhan_pemb_str = isset($asesmen->kom_potensial_kebutuhan_pembelajaran) && !empty($asesmen->kom_potensial_kebutuhan_pembelajaran) ? $asesmen->kom_potensial_kebutuhan_pembelajaran : (isset($asesmen->kebutuhan_pembelajaran) ? $asesmen->kebutuhan_pembelajaran : '');
                            $val_kebutuhan_pembelajaran = !empty($kebutuhan_pemb_str) ? (is_array($kebutuhan_pemb_str) ? $kebutuhan_pemb_str : explode(',', $kebutuhan_pemb_str)) : [];
                            $val_kebutuhan_lain_ket = isset($asesmen->kom_potensial_lain_detail) && $asesmen->kom_potensial_lain_detail !== '' ? $asesmen->kom_potensial_lain_detail : (isset($asesmen->kebutuhan_lain_ket) ? $asesmen->kebutuhan_lain_ket : '');
                          ?>
                              ...
                              <div class="col-md-9">
                                <div class="row">
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="radio-button radio-button-primary">
                                      <input id="bicara1" type="radio" name="bicara" value="Normal" <?= ($val_bicara == 'Normal') ? 'checked' : ''; ?>>
                                      <label class="control-label" for="bicara1">Normal</label>
                                    </div>
                                  </div>
                                  <div class="col-md-8 col-sm-8 col-xs-12">
                                    <div class="radio-button radio-button-primary">
                                      <input id="bicara2" type="radio" name="bicara"
                                        value="Serangan awal gangguan bicara" <?= ($val_bicara == 'Serangan awal gangguan bicara' || !empty($val_bicara_kapan)) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="bicara2">Serangan awal gangguan bicara, kapan
                                        :</label>
                                      <span id="wrap_bicara_kapan" style="<?= ($val_bicara == 'Serangan awal gangguan bicara' || !empty($val_bicara_kapan)) ? '' : 'display: none;'; ?>">
                                        <input type="text" class="form-control inline-input" id="bicara_kapan"
                                          name="bicara_kapan" placeholder="Tuliskan waktu..." value="<?= $val_bicara_kapan; ?>">
                                      </span>
                                    </div>
                                  </div>
                                </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group form-group-spacing">
                              <div class="col-md-3">
                                <label class="control-label mb-10 text-left">Bahasa sehari-hari :</label>
                              </div>
                              <div class="col-md-9">
                                <div class="row">
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="bahasa1" type="checkbox" name="bahasa[]"
                                        value="Indonesia, aktif/pasif" <?= (in_array('Indonesia, aktif/pasif', $val_bahasa) || (isset($bahasa_str) && stripos($bahasa_str, 'indonesia') !== false)) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="bahasa1">Indonesia, aktif / pasif</label>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="bahasa3" type="checkbox" name="bahasa[]" value="Inggris, aktif/pasif" <?= (in_array('Inggris, aktif/pasif', $val_bahasa) || (isset($bahasa_str) && stripos($bahasa_str, 'inggris') !== false)) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="bahasa3">Inggris, aktif / pasif</label>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="bahasa2" type="checkbox" name="bahasa[]" value="Daerah" <?= (in_array('Daerah', $val_bahasa) || !empty($val_bahasa_daerah_ket) || (isset($bahasa_str) && (stripos($bahasa_str, 'daerah') !== false || stripos($bahasa_str, 'jawa') !== false || stripos($bahasa_str, 'sunda') !== false))) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="bahasa2">Daerah :</label>
                                      <span id="wrap_bahasa_daerah" style="<?= (in_array('Daerah', $val_bahasa) || !empty($val_bahasa_daerah_ket) || (isset($bahasa_str) && (stripos($bahasa_str, 'daerah') !== false || stripos($bahasa_str, 'jawa') !== false || stripos($bahasa_str, 'sunda') !== false))) ? '' : 'display: none;'; ?>">
                                        <input type="text" class="form-control inline-input" id="bahasa_daerah_ket"
                                          name="bahasa_daerah_ket" placeholder="Nama daerah..." value="<?= $val_bahasa_daerah_ket; ?>">
                                      </span>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="bahasa4" type="checkbox" name="bahasa[]" value="Lain-lain" <?= (in_array('Lain-lain', $val_bahasa) || !empty($val_bahasa_lain_ket) || (isset($bahasa_str) && stripos($bahasa_str, 'lain') !== false)) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="bahasa4">Lain-lain :</label>
                                      <span id="wrap_bahasa_lain" style="<?= (in_array('Lain-lain', $val_bahasa) || !empty($val_bahasa_lain_ket) || (isset($bahasa_str) && stripos($bahasa_str, 'lain') !== false)) ? '' : 'display: none;'; ?>">
                                        <input type="text" class="form-control inline-input" id="bahasa_lain_ket"
                                          name="bahasa_lain_ket" placeholder="Bahasa lainnya..." value="<?= $val_bahasa_lain_ket; ?>">
                                      </span>
                                    </div>
                                  </div>
                                </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group form-group-spacing">
                              <div class="col-md-3">
                                <label class="control-label mb-10 text-left">Perlu penerjemah :</label>
                              </div>
                              <div class="col-md-9">
                                <div class="row">
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="radio-button radio-button-primary">
                                      <input id="penerjemah1" type="radio" name="penerjemah" value="Tidak" <?= ($val_penerjemah == 'Tidak' || $val_penerjemah == 'tidak') ? 'checked' : ''; ?>>
                                      <label class="control-label" for="penerjemah1">Tidak</label>
                                    </div>
                                  </div>
                                  <div class="col-md-8 col-sm-8 col-xs-12">
                                    <div class="radio-button radio-button-primary">
                                      <input id="penerjemah2" type="radio" name="penerjemah" value="Ya" <?= ($val_penerjemah == 'Ya' || $val_penerjemah == 'ya' || !empty($val_penerjemah_bahasa)) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="penerjemah2">Ya, Bahasa :</label>
                                      <span id="wrap_penerjemah_bahasa" style="<?= ($val_penerjemah == 'Ya' || $val_penerjemah == 'ya' || !empty($val_penerjemah_bahasa)) ? '' : 'display: none;'; ?>">
                                        <input type="text" class="form-control inline-input" id="penerjemah_bahasa"
                                          name="penerjemah_bahasa" placeholder="Bahasa..." value="<?= $val_penerjemah_bahasa; ?>">
                                      </span>
                                    </div>
                                  </div>
                                </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group form-group-spacing">
                              <div class="col-md-3">
                                <label class="control-label mb-10 text-left">Bahan Isyarat :</label>
                              </div>
                              <div class="col-md-9">
                                <div class="row">
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="radio-button radio-button-primary">
                                      <input id="isyarat1" type="radio" name="bahan_isyarat" value="Ya" <?= ($val_bahan_isyarat == 'Ya' || $val_bahan_isyarat == 'ya') ? 'checked' : ''; ?>>
                                      <label class="control-label" for="isyarat1">Ya</label>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="radio-button radio-button-primary">
                                      <input id="isyarat2" type="radio" name="bahan_isyarat" value="Tidak" <?= ($val_bahan_isyarat == 'Tidak' || $val_bahan_isyarat == 'tidak') ? 'checked' : ''; ?>>
                                      <label class="control-label" for="isyarat2">Tidak</label>
                                    </div>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group form-group-spacing">
                              <div class="col-md-3">
                                <label class="control-label mb-10 text-left">Hambatan belajar :</label>
                              </div>
                              <div class="col-md-9">
                                <div class="row">
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="hambatan1" type="checkbox" name="hambatan_belajar[]" value="Bahasa" <?= in_array('Bahasa', $val_hambatan) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="hambatan1">Bahasa</label>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="hambatan2" type="checkbox" name="hambatan_belajar[]" value="Cemas" <?= in_array('Cemas', $val_hambatan) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="hambatan2">Cemas</label>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="hambatan3" type="checkbox" name="hambatan_belajar[]" value="Menulis" <?= in_array('Menulis', $val_hambatan) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="hambatan3">Menulis</label>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="hambatan4" type="checkbox" name="hambatan_belajar[]" value="Lain-lain" <?= (in_array('Lain-lain', $val_hambatan) || !empty($val_hambatan_lain_ket)) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="hambatan4">Lain-lain</label>
                                      <span id="wrap_hambatan_lain" style="<?= (in_array('Lain-lain', $val_hambatan) || !empty($val_hambatan_lain_ket)) ? '' : 'display: none;'; ?>">
                                        <input type="text" class="form-control inline-input" id="hambatan_lain_ket"
                                          name="hambatan_lain_ket" placeholder="Jelaskan..." value="<?= $val_hambatan_lain_ket; ?>">
                                      </span>
                                    </div>
                                  </div>
                                </div>
                          ...
                          <!-- 6. Cara Belajar yang Disukai (Checkbox - Maks 3 per baris) -->
                          <div class="col-md-12">
                            <div class="form-group form-group-spacing">
                              <div class="col-md-3">
                                <label class="control-label mb-10 text-left">Cara belajar disukai :</label>
                              </div>
                              <div class="col-md-9">
                                <div class="row">
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="cara_belajar1" type="checkbox" name="cara_belajar[]"
                                        value="Audio-Visual/gambar" <?= in_array('Audio-Visual/gambar', $val_cara_belajar) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="cara_belajar1">Audio-Visual / gambar</label>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="cara_belajar2" type="checkbox" name="cara_belajar[]" value="Diskusi" <?= in_array('Diskusi', $val_cara_belajar) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="cara_belajar2">Diskusi</label>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="cara_belajar3" type="checkbox" name="cara_belajar[]" value="Lain-lain" <?= (in_array('Lain-lain', $val_cara_belajar) || !empty($val_cara_belajar_lain_ket)) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="cara_belajar3">Lain-lain :</label>
                                      <span id="wrap_cara_belajar_lain" style="<?= (in_array('Lain-lain', $val_cara_belajar) || !empty($val_cara_belajar_lain_ket)) ? '' : 'display: none;'; ?>">
                                        <input type="text" class="form-control inline-input" id="cara_belajar_lain_ket"
                                          name="cara_belajar_lain_ket" placeholder="Jelaskan..." value="<?= $val_cara_belajar_lain_ket; ?>">
                                      </span>
                                    </div>
                                  </div>
                                </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group form-group-spacing">
                              <div class="col-md-3">
                                <label class="control-label mb-10 text-left">Tingkat pendidikan :</label>
                              </div>
                              <div class="col-md-9">
                                <div class="row">
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="radio-button radio-button-primary"><input id="pendidikan1" type="radio"
                                        name="tingkat_pendidikan" value="TK" <?= ($val_tingkat_pendidikan == 'TK') ? 'checked' : ''; ?>><label class="control-label"
                                        for="pendidikan1">TK</label></div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="radio-button radio-button-primary"><input id="pendidikan2" type="radio"
                                        name="tingkat_pendidikan" value="SD" <?= ($val_tingkat_pendidikan == 'SD') ? 'checked' : ''; ?>><label class="control-label"
                                        for="pendidikan2">SD</label></div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="radio-button radio-button-primary"><input id="pendidikan3" type="radio"
                                        name="tingkat_pendidikan" value="SMP" <?= ($val_tingkat_pendidikan == 'SMP') ? 'checked' : ''; ?>><label class="control-label"
                                        for="pendidikan3">SMP</label></div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="radio-button radio-button-primary"><input id="pendidikan4" type="radio"
                                        name="tingkat_pendidikan" value="SMA" <?= ($val_tingkat_pendidikan == 'SMA') ? 'checked' : ''; ?>><label class="control-label"
                                        for="pendidikan4">SMA</label></div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="radio-button radio-button-primary"><input id="pendidikan5" type="radio"
                                        name="tingkat_pendidikan" value="Akademi" <?= ($val_tingkat_pendidikan == 'Akademi') ? 'checked' : ''; ?>><label class="control-label"
                                        for="pendidikan5">Akademi</label></div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="radio-button radio-button-primary"><input id="pendidikan6" type="radio"
                                        name="tingkat_pendidikan" value="Sarjana" <?= ($val_tingkat_pendidikan == 'Sarjana') ? 'checked' : ''; ?>><label class="control-label"
                                        for="pendidikan6">Sarjana</label></div>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group form-group-spacing">
                              <div class="col-md-3">
                                <label class="control-label mb-10 text-left">Potensial kebutuhan pembelajaran :</label>
                              </div>
                              <div class="col-md-9">
                                <div class="row">
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="kebutuhan1" type="checkbox" name="kebutuhan_pembelajaran[]"
                                        value="Proses penyakit" <?= in_array('Proses penyakit', $val_kebutuhan_pembelajaran) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="kebutuhan1">Proses penyakit</label>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="kebutuhan2" type="checkbox" name="kebutuhan_pembelajaran[]"
                                        value="Pengobatan/tindakan" <?= in_array('Pengobatan/tindakan', $val_kebutuhan_pembelajaran) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="kebutuhan2">Pengobatan / tindakan</label>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="kebutuhan3" type="checkbox" name="kebutuhan_pembelajaran[]"
                                        value="Nutrisi" <?= in_array('Nutrisi', $val_kebutuhan_pembelajaran) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="kebutuhan3">Nutrisi</label>
                                    </div>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="kebutuhan4" type="checkbox" name="kebutuhan_pembelajaran[]"
                                        value="Terapi/obat" <?= in_array('Terapi/obat', $val_kebutuhan_pembelajaran) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="kebutuhan4">Terapi / obat</label>
                                    </div>
                                  </div>
                                  <div class="col-md-8 col-sm-8 col-xs-12">
                                    <div class="checkbox checkbox-primary">
                                      <input id="kebutuhan5" type="checkbox" name="kebutuhan_pembelajaran[]"
                                        value="Lain-lain" <?= (in_array('Lain-lain', $val_kebutuhan_pembelajaran) || !empty($val_kebutuhan_lain_ket)) ? 'checked' : ''; ?>>
                                      <label class="control-label" for="kebutuhan5">Lain-lain, jelaskan :</label>
                                      <span id="wrap_kebutuhan_lain" style="<?= (in_array('Lain-lain', $val_kebutuhan_pembelajaran) || !empty($val_kebutuhan_lain_ket)) ? '' : 'display: none;'; ?>">
                                        <input type="text" class="form-control inline-input" id="kebutuhan_lain_ket"
                                          name="kebutuhan_lain_ket" placeholder="Penjelasan..." value="<?= $val_kebutuhan_lain_ket; ?>">
                                      </span>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <script>
                          $(document).ready(function () {
                            ...
                            $('input[name="bicara"]').change(function () {
                              if ($(this).val() === 'Serangan awal gangguan bicara') {
                                $('#wrap_bicara_kapan').show();
                              } else {
                                $('#wrap_bicara_kapan').hide();
                                $('#bicara_kapan').val('');
                              }
                            });

                            $('#bahasa2').change(function () {
                              if ($(this).is(':checked')) {
                                $('#wrap_bahasa_daerah').show();
                              } else {
                                $('#wrap_bahasa_daerah').hide();
                                $('#bahasa_daerah_ket').val('');
                              }
                            });

                            $('#bahasa4').change(function () {
                              if ($(this).is(':checked')) {
                                $('#wrap_bahasa_lain').show();
                              } else {
                                $('#wrap_bahasa_lain').hide();
                                $('#bahasa_lain_ket').val('');
                              }
                            });

                            $('input[name="penerjemah"]').change(function () {
                              if ($(this).val() === 'Ya') {
                                $('#wrap_penerjemah_bahasa').show();
                              } else {
                                $('#wrap_penerjemah_bahasa').hide();
                                $('#penerjemah_bahasa').val('');
                              }
                            });

                            $('#hambatan4').change(function () {
                              if ($(this).is(':checked')) {
                                $('#wrap_hambatan_lain').show();
                              } else {
                                $('#wrap_hambatan_lain').hide();
                                $('#hambatan_lain_ket').val('');
                              }
                            });

                            $('#cara_belajar3').change(function () {
                              if ($(this).is(':checked')) {
                                $('#wrap_cara_belajar_lain').show();
                              } else {
                                $('#wrap_cara_belajar_lain').hide();
                                $('#cara_belajar_lain_ket').val('');
                              }
                            });

                            $('#kebutuhan5').change(function () {
                              if ($(this).is(':checked')) {
                                $('#wrap_kebutuhan_lain').show();
                              } else {
                                $('#wrap_kebutuhan_lain').hide();
                                $('#kebutuhan_lain_ket').val('');
                              }
                            });
                        ...
                        <style>
                          .respon-kognitif .form-group-spacing {
                            margin-bottom: 18px;
                          }

                          .respon-kognitif .checkbox-list {
                            display: flex;
                            flex-direction: column;
                            gap: 8px;
                          }

                          .respon-kognitif .checkbox {
                            margin-top: 0;
                            margin-bottom: 0;
                          }
                        </style>

                        <div class="respon-kognitif">

                          <div class="col-md-12">
                            <h5 style="margin-top: 10px; margin-bottom: 20px;">
                              <strong>RESPON KOGNITIF</strong>
                            </h5>
                          </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group form-group-spacing">
                              <div class="col-md-5 col-sm-6">
                                <label class="control-label text-left" style="font-weight: normal; font-size: 14px;">
                                  Pasien/keluarga mengizinkan informasi tentang :
                                </label>
                              </div>
                              <div class="col-md-7 col-sm-6">
                                <div class="checkbox-list">
                                  ...
                                  <div class="checkbox checkbox-primary">
                                    <input id="kognitif1" type="checkbox" name="respon_kognitif[]"
                                      value="Penyakit yang diderita">
                                    <label class="control-label" for="kognitif1">Penyakit yang diderita</label>
                                  </div>

                                  <div class="checkbox checkbox-primary">
                                    <input id="kognitif2" type="checkbox" name="respon_kognitif[]"
                                      value="Tindakan pemeriksaan lanjut">
                                    <label class="control-label" for="kognitif2">Tindakan pemeriksaan lanjut</label>
                                  </div>

                                  <div class="checkbox checkbox-primary">
                                    <input id="kognitif3" type="checkbox" name="respon_kognitif[]"
                                      value="Tindakan pengobatan dan perawatan yang diberikan">
                                    <label class="control-label" for="kognitif3">Tindakan pengobatan dan perawatan yang
                                      diberikan</label>
                                  </div>

                                  <div class="checkbox checkbox-primary">
                                    <input id="kognitif4" type="checkbox" name="respon_kognitif[]"
                                      value="Perencanaan diet dan menu">
                                    <label class="control-label" for="kognitif4">Perencanaan diet dan menu</label>
                                  </div>

                                  <div class="checkbox checkbox-primary">
                                    <input id="kognitif5" type="checkbox" name="respon_kognitif[]"
                                      value="Perubahan aktivitas sehari-hari">
                                    <label class="control-label" for="kognitif5">Perubahan aktivitas sehari-hari</label>
                                  </div>

                                  <div class="checkbox checkbox-primary">
                                    <input id="kognitif6" type="checkbox" name="respon_kognitif[]"
                                      value="Perawatan setelah dirumah">
                                    <label class="control-label" for="kognitif6">Perawatan setelah dirumah</label>
                                  </div>
                      ...
                      <div class="col-md-12">
                        <h5 style="margin-top: 30px;"><strong>
                            ...
                            <label class="control-label mb-10 text-left"><b>BAGIAN 4 MASALAH KEPERAWATAN</b><span
                                class="help"></span></label>
                          </strong></h5>
                      </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <?php for ($i = 0; $i < ceil(count($masalah_keperawatan) / 2); $i++): ?>
                              ...
                              <div class="checkbox checkbox-success">
                                <input id="keperawatan<?= $masalah->id_masalah_kep; ?>" type="checkbox" name="keperawatan[]"
                                  value="<?= $masalah->id_masalah_kep; ?>">
                ...
                <div class="form-group">
                  <div class="col-md-12">
                    <h5 style="margin-top: 30px;"><strong>
                        <label class="control-label mb-10 text-left"><b>BAGIAN 5 EKONOMI/PSIKOSOSIAL</b><span
                                class="help"></span></label>
                      </strong>
                    </h5>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-3">
                          <label class="control-label mb-10 text-left">Keluarga Terdekat<span
                              class="help"></span></label>
...
<script type="text/javascript">
  function displayErrors(response) {
    const errorMappings = [{
      spanId: 'berat_badan_error',
      responseKey: 'berat_badan'
    },
    {
      spanId: 'nafas_error',
      responseKey: 'frequensi_nafas'
    },
    {
      spanId: 'tinggi_badan_error',
      responseKey: 'tinggi_badan'
    },
    {
      spanId: 'spo2_error',
      responseKey: 'spo2'
    ...
    errorMappings.forEach(mapping => {
      ...
      if (errorMessage) {
        ...
        $('#' + mapping.spanId)[0].scrollIntoView({
          behavior: 'smooth',
          block: 'center'
        });
      } else {
  ...
  function simpan() {
    ...
    if (reaksi_alergi === "Ya") {
      reaksi_alergi = $('#reaksi_alergi_detail').val();
    }
    ...
    kom_bicara = $('input[name="bicara"]:checked').val() || '';
    kom_serangan_bicara_kapan = $('#bicara_kapan').val() || '';

    var kom_bahasa_arr = [];
    $('input[name="bahasa[]"]').each(function () {
      if ($(this).is(":checked")) { kom_bahasa_arr.push($(this).val()); }
    });
    kom_bahasa = kom_bahasa_arr.toString();
    kom_bahasa_daerah_detail = $('#bahasa_daerah_ket').val() || '';
    kom_bahasa_lain_detail = $('#bahasa_lain_ket').val() || '';

    kom_perlu_penterjemah = $('input[name="penerjemah"]:checked').val() || '';
    kom_penterjemah_bahasa = $('#penerjemah_bahasa').val() || '';
    kom_bahan_isyarat = $('input[name="bahan_isyarat"]:checked').val() || '';

    var kom_hambatan_arr = [];
    $('input[name="hambatan_belajar[]"]').each(function () {
      if ($(this).is(":checked")) { kom_hambatan_arr.push($(this).val()); }
    });
    if ($('#hambatan4').is(':checked') && $('#hambatan_lain_ket').val()) {
      kom_hambatan_arr.push($('#hambatan_lain_ket').val());
    }
    kom_hambatan_belajar = kom_hambatan_arr.toString();

    var kom_cara_belajar_arr = [];
    $('input[name="cara_belajar[]"]').each(function () {
      if ($(this).is(":checked")) { kom_cara_belajar_arr.push($(this).val()); }
    });
    if ($('#cara_belajar3').is(':checked') && $('#cara_belajar_lain_ket').val()) {
      kom_cara_belajar_arr.push($('#cara_belajar_lain_ket').val());
    }
    kom_cara_belajar_disukai = kom_cara_belajar_arr.toString();

    kom_tingkat_pendidikan = $('input[name="tingkat_pendidikan"]:checked').val() || '';

    var kom_potensial_arr = [];
    $('input[name="kebutuhan_pembelajaran[]"]').each(function () {
      if ($(this).is(":checked")) { kom_potensial_arr.push($(this).val()); }
    });
    kom_potensial_kebutuhan_pembelajaran = kom_potensial_arr.toString();
    kom_potensial_lain_detail = $('#kebutuhan_lain_ket').val() || '';

    var kognitif_arr = [];
    $('input[name="respon_kognitif[]"]').each(function () {
      if ($(this).is(":checked")) { kognitif_arr.push($(this).val()); }
    });
    kognitif_izin_informasi = kognitif_arr.toString();

    var lama_kehamilan_val = $('#lama_kehamilan').val() || '';
    var lama_kehamilan_satuan_val = $('#lama_kehamilan_satuan').val() || '';
    paed_lama_kehamilan = lama_kehamilan_val ? (lama_kehamilan_val + ' ' + lama_kehamilan_satuan_val) : '';

    var komplikasi_val = $('input[name="komplikasi"]:checked').val() || '';
    paed_komplikasi_tipe = (komplikasi_val === 'Ya') ? ($('#komplikasi_tipe').val() || '') : komplikasi_val;

    var masalah_maternal_val = $('input[name="masalah_maternal"]:checked').val() || '';
    paed_masalah_maternal = (masalah_maternal_val === 'Ya') ? ($('#masalah_maternal_ket').val() || '') : masalah_maternal_val;

    var paed_persalina_arr = [];
    $('input[name="riwayat_persalinan[]"]').each(function () {
      if ($(this).is(":checked")) { paed_persalina_arr.push($(this).val()); }
    });
    paed_persalina_tipe = paed_persalina_arr.toString();

    paed_penyulit_persalinan = $('#penyulit_persalinan_cb').is(':checked') ? ($('#penyulit_persalinan').val() || '') : '';

    var post_natal_val = $('input[name="post_natal"]:checked').val() || '';
    paed_post_natal = (post_natal_val === 'Lain-lain') ? ($('#post_natal_lain').val() || '') : post_natal_val;

    var paed_imunisasi_arr = [];
    $('input[name="imunisasi[]"]').each(function () {
      if ($(this).is(":checked")) { paed_imunisasi_arr.push($(this).val()); }
    });
    paed_riwayat_imunisasi = paed_imunisasi_arr.toString();

    paed_keluhan_tumbuh_kembang = $('#keluhan_tumbuh_kembang').val() || '';
    paed_diagnosa_medis = $('#diagnosa_medis').val() || '';

    var lahir_umur_val = $('#lahir_umur_kehamilan').val() || '';
    var lahir_umur_satuan_val = $('#lahir_umur_kehamilan_satuan').val() || '';
    paed_lahir_umur_kehamilan = lahir_umur_val ? (lahir_umur_val + ' ' + lahir_umur_satuan_val) : '';

    paed_pernah_dirawat = $('input[name="pernah_dirawat"]:checked').val() || '';
    paed_pernah_dirawat_dimana = $('#dirawat_dimana').val() || '';
    paed_pernah_dirawat_kapan = $('#dirawat_kapan').val() || '';

    paed_lk_saat_lahir = $('#lk_lahir').val() || '';
    paed_bb_saat_lahir = $('#bb_lahir').val() || '';
    paed_tb_saat_lahir = $('#tb_lahir').val() || '';
    paed_asi_sampai_umur = $('#usia_sampai_umur').val() || '';
    paed_susu_formula_mulai = $('#susu_formula_mulai').val() || '';
    paed_makanan_tambahan_umur = $('#makanan_tambahan_mulai').val() || '';

    var masalah_neonatal_val = $('input[name="masalah_neonatal"]:checked').val() || '';
    paed_masalah_neonatus = (masalah_neonatal_val === 'Ya') ? ($('#masalah_neonatal_tipe').val() || '') : masalah_neonatal_val;

    paed_tengkurap_bln = $('#tengkurap').val() || '';
    paed_duduk_bln = $('#duduk').val() || '';
    paed_merangkak_bln = $('#merangkak').val() || '';
    paed_berdiri_bln = $('#berdiri').val() || '';
    paed_berjalan_bln = $('#berjalan').val() || '';
    ...
    dataString = 'no_rm=' + no_rm + '&nama=' + nama + '&tgl_lahir=' + tgl_lahir + '&id_pelayanan=' + id_pelayanan + '&id_history=' + id_history +
      ...
      '&kom_bicara=' + kom_bicara + '&kom_serangan_bicara_kapan=' + kom_serangan_bicara_kapan + '&kom_bahasa=' + kom_bahasa +
      '&kom_bahasa_daerah_detail=' + kom_bahasa_daerah_detail + '&kom_bahasa_lain_detail=' + kom_bahasa_lain_detail +
      '&kom_perlu_penterjemah=' + kom_perlu_penterjemah + '&kom_penterjemah_bahasa=' + kom_penterjemah_bahasa +
      '&kom_bahan_isyarat=' + kom_bahan_isyarat + '&kom_hambatan_belajar=' + kom_hambatan_belajar +
      '&kom_cara_belajar_disukai=' + kom_cara_belajar_disukai + '&kom_tingkat_pendidikan=' + kom_tingkat_pendidikan +
      '&kom_potensial_kebutuhan_pembelajaran=' + kom_potensial_kebutuhan_pembelajaran + '&kom_potensial_lain_detail=' + kom_potensial_lain_detail +
      '&kognitif_izin_informasi=' + kognitif_izin_informasi +
      '&paed_lama_kehamilan=' + paed_lama_kehamilan + '&paed_komplikasi_tipe=' + paed_komplikasi_tipe +
      '&paed_masalah_maternal=' + paed_masalah_maternal + '&paed_persalina_tipe=' + paed_persalina_tipe +
      '&paed_penyulit_persalinan=' + paed_penyulit_persalinan + '&paed_post_natal=' + paed_post_natal +
      '&paed_riwayat_imunisasi=' + paed_riwayat_imunisasi + '&paed_keluhan_tumbuh_kembang=' + paed_keluhan_tumbuh_kembang +
      '&paed_diagnosa_medis=' + paed_diagnosa_medis + '&paed_lahir_umur_kehamilan=' + paed_lahir_umur_kehamilan +
      '&paed_pernah_dirawat=' + paed_pernah_dirawat + '&paed_pernah_dirawat_dimana=' + paed_pernah_dirawat_dimana +
      '&paed_pernah_dirawat_kapan=' + paed_pernah_dirawat_kapan + '&paed_lk_saat_lahir=' + paed_lk_saat_lahir +
      '&paed_bb_saat_lahir=' + paed_bb_saat_lahir + '&paed_tb_saat_lahir=' + paed_tb_saat_lahir +
      '&paed_asi_sampai_umur=' + paed_asi_sampai_umur + '&paed_susu_formula_mulai=' + paed_susu_formula_mulai +
      '&paed_makanan_tambahan_umur=' + paed_makanan_tambahan_umur + '&paed_masalah_neonatus=' + paed_masalah_neonatus +
      '&paed_tengkurap_bln=' + paed_tengkurap_bln + '&paed_duduk_bln=' + paed_duduk_bln +
      '&paed_merangkak_bln=' + paed_merangkak_bln + '&paed_berdiri_bln=' + paed_berdiri_bln +
      '&paed_berjalan_bln=' + paed_berjalan_bln;
    ...
    if (!id_masalah_kep && isValid) {
      ...
      $('#idMasalahKep_error')[0].scrollIntoView({
        behavior: 'smooth',
        block: 'center'
      });
      isValid = false;
    ...
    $.ajax({
      url: "<?= site_url('Erm_ranap_asesmen_perawat/insert_asses_perawat_ranap') ?>",
      method: "POST",
      dataType: 'json',
      data: dataString,
  ...
  $(document).ready(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $('#dokter_pemeriksa').val(data.dokter_pemeriksa || data.dpjp || '');
