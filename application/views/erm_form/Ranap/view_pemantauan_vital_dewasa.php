              ...
              <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="inRawat">
                        ...
                        <div class="form-group" id="spirit">
                            <div class="col-md-12">
                                <h5 style="margin-top: 30px;"><strong>
                                        <label class="control-label mb-10 text-left"><b>TANDA VITAL<b /><span class="help"></span></label>
                                    </strong>
                                </h5>
                            </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <div class=" ">
                                <input class="form-control" cols="1" rows="1" id="total_ews" name="total_ews" disabled></input>
                        ...
                        <div class="col-md-6">
                            <div class="form-group col-md-12">
                                <label class="control-label mb-6 text-left" style="opacity: 0.75;"><strong>EWSS PASIEN DEWASA:</strong> </label>
                            </div>
                            <div class="col-md-9">
                                <div class="form-group ">
