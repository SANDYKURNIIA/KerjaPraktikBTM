<!-- Tindakan hd -->
<div class="modal fade bs-example-modal-lg" id="modal_kemo" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                ...
                <div class="form-wrap">
                    ...
                    <div class="form-body mt-10">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-9 has-success" onchange="pilihTindakanKemo()">
                                        <select class="form-control filled-input select2" style="border: 1px solid lightgreen;" tabindex="1" name="inTindakanKemo" id="inTindakanKemo">
                                            <option value="-">-</option>
                                            <?php
                                            foreach ($tindakan_kemo as $row) :
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-9 has-error">
                                        <input type="number" class="form-control" id="inJumlahKemo" value="1" min="1" placeholder="jumlah" oninput="hargaTotalKemo()">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-9 has-error">
                                        <input type="text" class="form-control " disabled="" id="outBiayaTindakanKemo">
                                        <input type="hidden" class="form-control " disabled="" id="idPelayananKemo">
                                        <input type="hidden" class="form-control " disabled="" id="idHistoryKemo">
                                        <input type="hidden" class="form-control " disabled="" id="jumTindakanKemo">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 has-error">
                                        <input type="text" class="form-control" disabled="" id="outTotalKemo">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-9 has-success">
                                        <select class="form-control filled-input select2" placeholder="PILIH NAMA DOKTER" style="border: 1px solid lightgreen;" tabindex="1" id="inDPJPKemo" name="namaDPJPKemo">
                                            <option value="-">-</option>
                                            <?php
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <button onclick="insert_tindakanKemo()" class="btn btn-success btn-anim  btn-sm ml-20 mt-5"><i class="icon-rocket"></i><span class="btn-text">SIMPAN</span>
            ...
            <div class="modal-body mt-30">
                ...
                <div class="table-wrap" style="width: 100%; margin: auto ">
                    <div class="table-responsive">
                        <table class="table table-hover display  pb-60" id="tabletindakanKemo">
                            <thead>
                                <tr class="bg-success">
                                    <th>NO</th>
                                    <th>NAMA TINDAKAN</th>
            ...
            <div class="row">
                ...
                <div class="col-md-4 pull-right mt-20">
                    ...
                    <div class="table-wrap" style="width: 85%; margin-bottom:40px;">
                        <div class="table-responsive ">
                            <table class="table table-hover display " id="outTotalHargaKemo">
                                <thead>
                                    <tr class="bg-success">
...
<script type="text/javascript">
    function reload_data_tindakan(id_pelayanan) {
        $('#tabletindakanKemo').dataTable().fnClearTable();
        $('#tabletindakanKemo').dataTable().fnDestroy();
        $('#tabletindakanKemo').DataTable({
            "pageLength": 10,
            "language": {
    ...
    function reload_total_harga(id_pelayanan) {
        $('#outTotalHargaKemo').dataTable().fnClearTable();
        $('#outTotalHargaKemo').dataTable().fnDestroy();
        $('#outTotalHargaKemo').DataTable({
            "pageLength": 10,
            "searching": false,
            "lengthChange": false,
            "bInfo": false,
    ...
    function tindakan_kemo(id_pelayanan, id_history) {
        $.ajax({
            ...
            success: function(data) {
                if (data.status_dt == "found") {
                    ...
                    $("#idPelayananKemo").val(data.data['id_pelayanan']);
                    $("#idHistoryKemo").val(id_history);
                    // $("#inDPJPKemo").val(data.data['dpjp']).change();
                    $("#modal_kemo").modal('show');
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == "success") {
                            ...
                            $('#tabletindakanKemo').DataTable().ajax.reload();
                            $('#outTotalHargaKemo').DataTable().ajax.reload();
                        } else {
                            swal({
                                title: "Gagal!",
                                type: "warning",
    ...
    function pilihTindakanKemo() {
        a = $("#inTindakanKemo").val();
        splitDiag = a.split("|");

        harga = parseFloat(splitDiag[1]);
        $("#outBiayaTindakanKemo").val(convertToRupiah(harga));
        document.getElementById("inJumlahKemo").value = "1";
        document.getElementById("outTotalKemo").value = convertToRupiah(harga);
    }

    function insert_tindakanKemo() {
        a = $("#inTindakanKemo").val();
        dokter = $("#inDPJPKemo").val();
        splitDiag = a.split("|");
        harga = parseFloat(splitDiag[1]);
        frek = parseFloat($("#inJumlahKemo").val());
        total = harga * frek;
        var ID = Math.random().toString(36).substr(2, 16);
        idPelayanan = $('#idPelayananKemo').val();
        // count = $("#jumTindakan").val();
        id_history = $('#idHistoryKemo').val();
        nama_dokter = $.trim($("#inDPJPKemo").children("option:selected").text());

        dataString = 'id_tindakan_poli_gigi=' + ID + '&harga=' + harga +
            '&idPelayanan=' + idPelayanan + '&id_list_tindakan=' + splitDiag[0] +
            '&frek=' + frek + '&total=' + total +
            '&dokter=' + dokter + '&id_history=' + id_history + '&nama_dokter=' + nama_dokter + '&nama_tindakan=' + splitDiag[1]+
            '&eklaim=' + 'PENUNJANG';
        $.ajax({
    ...
    function hargaTotalKemo() {
        splitDiag = a.split("|");
        harga = parseFloat(splitDiag[1]);
        frek = parseFloat($("#inJumlahKemo").val());
        total = harga * frek;

        $("#outTotalKemo").val(convertToRupiah(total));
