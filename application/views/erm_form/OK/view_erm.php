                                ...
                                <div class="col-lg-12">
                                    <div class="button-list mt-25">
                                        ...
                                        <div style="display: block;">
                                            ...
                                            <a class="btn <?= isset($btn_asesmen_perawat) ? $btn_asesmen_perawat : 'btn-success'; ?> col-md-5 asses_per_ranap" href="<?php echo base_url('Erm_ranap_asesmen_perawat/formasesmenranap/') . $id_pelayanan . '/' . $id_histori; ?>">
