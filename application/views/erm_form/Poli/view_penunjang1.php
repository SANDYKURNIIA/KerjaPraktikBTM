                                    ...
                                    <div class="col-md-9 has-success">
                                        <select class="form-control filled-input select2" placeholder="PILIH NAMA DOKTER" style="border: 1px solid lightgreen;" tabindex="1" id="inDPJP" name="namaDPJP">
                                            ...
                                            foreach ($dokter as $row) : ?>
                                                <option value="<?php echo $row->id_dokter; ?>" <?php if($row->id_dokter == $dokter){ echo "selected";}?>>
            ...
            <div class="modal-body">
                <div class="form-wrap">
                    ...
                    <div class="form-body mt-10">
					    ...
					    <option value="5">Obat Racikan</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function edit_radiologi(id_pelayanan, id_history, jenis_pelayanan) {
        $.ajax({
            url: "<?= base_url() . 'Poli/get_radiologi' ?>",
            data: {
                pelayanan: id_pelayanan,
                history: id_history
            },
    ...
    function insert_labor() {
        ...
        dataString = 'id=' + ID + '&harga=' + harga +
            ...
            '&frek=' + frek + '&total=' + total + '&keta=' + keta + '&ring=' + ring + '&id_form_lab=' + id_form_lab + '&nama_tindakan=' + nama + '&kode_lis=' + kode_lis;
        $.ajax({
    ...
    function request_labor1(id) {
        $.ajax({
            url: "<?= base_url() . 'Poli/req_form_labor_prioritas' ?>",
            method: "POST",
            dataType: 'json',
            data: {
                id: id,
    ...
    function insert_labor_prioritas() {
        ...
        $.ajax({
            url: "<?= base_url() . 'Poli/insert_labor_prioritas' ?>",
            method: "POST",
            dataType: 'json',
            data: dataString,
            success: function(data) {
    ...
    function insert_radiologi_prioritas() {
        ...
        dataString = 'id=' + ID + '&harga=' + harga +
            ...
            '&frek=' + frek + '&total=' + total;
        $.ajax({
            url: "<?= base_url() . 'Poli/insert_radiologi_prioritas' ?>",
            method: "POST",
            dataType: 'json',
            data: dataString,
            success: function(data) {
    ...
    function hapus_radiologi_prioritas(id_tindakan_radiologi, id_pelayanan, nama) {
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Radiologi/hapus_data_radiologi_prioritas",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id_tindakan_radiologi: id_tindakan_radiologi,
