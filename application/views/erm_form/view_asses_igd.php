                    ...
                    <div class="form-wrap">
                      ...
                      <div class="form-group ">
                        <div class="col-md-12">
                          ...
                          <div class="form-group">
                          <div class="col-md-12">
                          <label class="control-label mb-10 text-left">ASESMEN AWAL PASIEN IGD <span class="help"></span></label>
                           </div>
                      ...
                      <div class="form-group">
                          <div class="col-md-12">
                          <label class="control-label mb-10 text-left"><b>KEADAAN UMUM<b/><span class="help"></span></label>
                           </div>

                      <div class="form-group">
                          <div class="col-md-12">
                          <label class="control-label mb-10 text-left">Kesadaran : GCS :<span class="help"></span></label>
                           </div>
...
<!--modal 1-->
                      <div class="form-group">
                          <div class="col-md-12">
                          <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newPeternakModal">Perawat/Bidan yang melakukan Pengkajian</a>
                        </div>
                      </div>
