                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="has-success">
                                    <textarea class="form-control" name="" cols="30" rows="5" id="evaluasi"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function simpan() {
        ...
        dataString = 'no_rm=' + no_rm + '&id_pelayanan=' + id_pelayanan + '&evaluasi=' + evaluasi +'&id_history=' + id_history;

        $.ajax({
            url: "<?php echo base_url() ?>Erm_dpjp/insert_lembar_evaluasi",
            method: "POST",
            dataType: 'json',
            data: dataString,
            success: function(data) {
