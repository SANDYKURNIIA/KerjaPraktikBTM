                    ...
                    <div class="form-wrap">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="has-success">
                                    <textarea class="form-control" name="" id="riwayat_penyakit" cols="30" rows="5" id="riwayat"></textarea>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    function simpan() {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>Erm_igd/insert_lembar_rujukan",
            method: "POST",
            dataType: 'json',
            data: dataString,
            success: function(data) {
                if (data.status == "success") {
                    window.location.href = "<?php echo base_url('Erm_igd/form/') ?>" + id_pelayanan;
                } else if (data.error) {
                    if (data.tempat != '') {
    ...
    function cetak() {
        id = $('#inHis').val();
        window.location.href = "<?php echo base_url('Erm_igd_edit/print_rujukan/') ?>" + id;
    }
</script>
<script type="text/javascript">
    $(document).ready(function() {
        id_history = $('#inHis').val();
        $.ajax({
            url: "<?php echo base_url() ?>Erm_igd_edit/get_rujukan",
            method: "POST",
            dataType: 'json',
            data: {
                id: id_history
            ...
            success: function(data) {
                ...
                $('#tempat1').val(data.tempat1);
                $('#hasil_periksa').val(data.hasil_periksa);
                $('#terapi1').val(data.terapi1);
