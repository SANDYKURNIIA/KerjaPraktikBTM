...
<script type="text/javascript">
    ...
    function pilih(id) {
        $('#id_form').val(id);
        $.ajax({
            url: "<?php echo base_url() ?>Erm_igd/get_peng_khusus",
            method: "POST",
            dataType: 'json',
            data: {
                id: id
    ...
    function simpan() {
        ...
        dataString = 'no_rm=' + no_rm + '&id_pelayanan=' + id_pelayanan + '&id_history=' + id_history +
            ...
            '&nafas=' + nafas + '&nyeri=' + nyeri + '&jam=' + jam +
        ...
        $.ajax({
            url: "<?php echo base_url() ?>Erm_igd/insert_peng_khusus",
            method: "POST",
            dataType: 'json',
            data: dataString,
            success: function(data) {
    ...
    function edit() {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>Erm_igd/edit_peng_khusus",
            method: "POST",
            dataType: 'json',
            data: dataString,
            success: function(data) {
    ...
    function hapus_tindakan(id) { //utk hapus diagnosa pasien
        swal({
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Erm_igd/hapus_tindakan_pengawasan",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        id: id,
    ...
    function reload_data_id_pel(id_pelayanan) { //utk reload data diagnosa pasien jika berhasil
        ...
        $('#tabel_terapi').DataTable({
            ...
            "ajax": {
                "url": '<?php echo base_url('erm_igd/tampil_list_penngawasan'); ?>',
                "type": 'POST',
                "data": {
