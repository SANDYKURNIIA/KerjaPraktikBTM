											...
											<div class="row">
												...
												<div class="col-md-2">
													<div class="radio-button radio-button-primary">
														<input id="alat_bantu_dengar" type="radio" name="kebutuhan_khusus" value="Tidak Ada" checked>
												...
												<div class="col-md-2">
													<div class="radio-button radio-button-primary">
														<input id="alat_bantu_dengar" type="radio" name="kebutuhan_khusus" value="Alat Bantu Dengar" checked>
														<label class="control-label" for="alat_bantu_dengar">
															Alat Bantu Dengar
														</label>
													</div>
											...
											<div class="form-group">
													...
													<div class="row">
														<div class="col-md-6">
															<div class="checkbox checkbox-primary">
																<input id="dahulu_tidakada" type="checkbox" name="penyakit_past" value="Tidak Ada">
												...
												<div class="col-md-6">
													...
													<div class="row">
														<div class="col-md-6">
															<div class="checkbox checkbox-primary">
																<input id="keluarga_tidakada" type="checkbox" name="penyakit_keluarga" value="Tidak Ada">
									...
									<div class="col-md-12">
										<div class="row">
											<h5 style="margin-top: 30px;">
												<strong>
													<label class="control-label mb-6 text-left"><b>MASALAH
															KEPERAWATAN<b />
															<spanclass="help">
																</span></label>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$.ajax({
			url: "<?php echo base_url() ?>Erm_asesmen_awal/get_ass_per",
			method: "POST",
			dataType: 'json',
			data: {
				id: id_history
			...
			success: function(data) {
				$('#id').val(data.id_form_assesmen_awal_rajal);
				...
				$('input[name="jatuh"][value="' + data.jatuh + '"]').prop("checked", true);
				$('input[name="gangguan_ba"][value="' + data.gangguan_ba + '"]').prop("checked", true);
				$('input[name="bingung"][value="' + data.bingung + '"]').prop("checked", true);
				$('input[name="depresi"][value="' + data.depresi + '"]').prop("checked", true);
				$('input[name="pusing"][value="' + data.pusing + '"]').prop("checked", true);
				$('input[name="jalan"][value="' + data.jalan + '"]').prop("checked", true);
				$('input[name="pikun"][value="' + data.pikun + '"]').prop("checked", true);
				$('input[name="obat"][value="' + data.obat + '"]').prop("checked", true);
				$('input[name="perawatan"][value="' + data.perawatan + '"]').prop("checked", true);
				...
				$('input[name="penyakit_past"][value="' + data.penyakit_past + '"]').prop("checked", true);
				$('input[name="penyakit_keluarga"][value="' + data.penyakit_keluarga + '"]').prop("checked", true);
				...
				$('input[name="lingkar_lengan"]').val(data.lingkar_lengan);


				$('#keluhan_utama').val(data.keluhan_utama);
				$('#riwayat_penggunaobat').val(data.riwayat_penggunaobat);
				$('#riwayat_Alloanamnesa').val(data.alloanamnesa);
