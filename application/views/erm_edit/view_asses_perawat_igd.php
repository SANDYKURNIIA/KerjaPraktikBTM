                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group ">
                          ...
                          <div class="form-group ">
                            <div class="col-md-4">
                              ...
                              <div class="radio-button radio-button-primary">
                                <input id="keluhan_bak3" type="radio" name="keluhan_bak" value="Pendarahan">
                                <label class="control-label" for="keluhan_bak3">
                                  Pendarahan
                                </label>
                              </div>
                            </div>
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="has-success">
                              <input type="text" class="form-control" id="warna_feces">
                              <span class="help-block"></span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group ">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class=" has-success">
                              <input type="text" class="form-control" id="warna_bak">
                            </div>
                          </div>
                        </div>
                      </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_igd_edit/get_ass_per",
      method: "POST",
      dataType: 'json',
      data: {
        id: id_history
      ...
      success: function(data) {
        $('#id').val(data.id_form_ass_per_igd);
        if (data.pRujuk == "Tidak") {
          $('input[name="pRujuk"][value="' + data.pRujuk + '"]').prop("checked", true);
        } else {
          $('input[name="pRujuk"][value="Ya"]').prop("checked", true);
          $('#inAsalRujuk').val(data.pRujuk);
          $('#inAsalRujuk').show();
        }
        if (data.wajib_ibadah == "Baligh" || data.wajib_ibadah == "Belum Baligh") {
          $('input[name="wajib_ibadah"][value="' + data.wajib_ibadah + '"]').prop("checked", true);
        } else {
          $('input[name="wajib_ibadah"][value="Halangan Lainnya"]').prop("checked", true);
          $('#wajib_ibadah').val(data.wajib_ibadah);
          $('#wajib_ibadah').show();
        }
        if (data.durasi == "Konsisten" || data.durasi == "Intermiten") {
          $('input[name="durasi"][value="' + data.durasi + '"]').prop("checked", true);
        } else {
          $('input[name="durasi"][value="Lainnya"]').prop("checked", true);
          $('#durasi').val(data.ham_eko);
          $('#durasi').show();
        }

        if (data.frek_bab == 'Tidak dapat dikaji') {
          $('input[name="frek_bab"]').prop("checked", true);
        } else {
          $('#frek_bab').val(data.frek_bab)
        }


        $('input[name="thaharah"][value="' + data.thaharah + '"]').prop("checked", true);
        $('input[name="sholat"][value="' + data.sholat + '"]').prop("checked", true);
        $('input[name="skala_nyeri"][value="' + data.skala_nyeri + '"]').prop("checked", true);
        $('input[name="penurunan_bb"][value="' + data.penurunan_bb + '"]').prop("checked", true);
        $('input[name="kurang_makan"][value="' + data.kurang_makan + '"]').prop("checked", true);
        $('input[name="kurus"][value="' + data.kurus + '"]').prop("checked", true);
        $('input[name="skala_nyeri"][value="' + data.skala_nyeri + '"]').prop("checked", true);
        $('input[name="turun_bb"][value="' + data.turun_bb + '"]').prop("checked", true);
        $('input[name="diare"][value="' + data.diare + '"]').prop("checked", true);
        $('input[name="makan_kurang"][value="' + data.makan_kurang + '"]').prop("checked", true);
        $('input[name="malnutrisi"][value="' + data.malnutrisi + '"]').prop("checked", true);
        // $('input[name="sempoyongan"][value="' + data.sempoyongan + '"]').prop("checked", true);
        // $('input[name="penopang"][value="' + data.penopang + '"]').prop("checked", true);
        // $('input[name="risiko"][value="' + data.risiko + '"]').prop("checked", true);
        $('input[name="jatuh3bln"][value="' + data.jatuh3bln + '"]').prop("checked", true);
        $('input[name="alatbantu"][value="' + data.alatbantu + '"]').prop("checked", true);
        $('input[name="sulitjalan"][value="' + data.sulitjalan + '"]').prop("checked", true);

        if (data.jatuh3bln === "Ya" || data.alatbantu === "Ya" || data.sulitjalan === "Ya") {
          $('#intervensi_form').collapse('show');
          arrayTeks1 = data.intervensi_risiko.split(",");
          arrayTeks1.forEach(item => {
            $(`input[name="intervensi_risiko"][value="${item}"]`).prop("checked", true);
          });
        } else {
          $('#intervensi_form').collapse('hide')
        }

        $('input[name="dekubitus_bantuan"][value="' + data.dekubitus_bantuan + '"]').prop("checked", true);
        $('input[name="inkontinensia"][value="' + data.inkontinensia + '"]').prop("checked", true);
        $('input[name="rwyt_dekubitus"][value="' + data.rwyt_dekubitus + '"]').prop("checked", true);
        $('input[name="dekubitus_umur65"][value="' + data.dekubitus_umur65 + '"]').prop("checked", true);
        $('input[name="dekubitus_anak"][value="' + data.dekubitus_anak + '"]').prop("checked", true);
        ...
        $('input[name="keluhan_bak"][value="' + data.keluhan_bak + '"]').prop("checked", true);
        ...
        $('input[name="lokasi_nyeri"]').val(data.lokasi_nyeri);
        $('#warna_feces').val(data.warna_feces);
        $('#frek_bak').val(data.frek_bak);
        ...
        arrayTeks.forEach(item => {
          $(`input[name="masalah_keperawatan"][value="${item}"]`).prop("checked", true);
        });

        if (data.masalah.match(/Lainnya:/)) {
          $('input[name="masalah_keperawatan"][value="Lainnya:"]').prop("checked", true);
          $("#masalah_keperawatan").show();
          let teksLainnya = null;
          arrayTeks.forEach(item => {
            if (item.startsWith("Lainnya:")) {
              teksLainnya = item.substring("Lainnya:".length).trim();
              // return; // Berhenti setelah menemukan teks yang dicari
            }
          });
          $('#masalah_keperawatan').val(teksLainnya);
        }



        if (data.kondisi_umum.match(/Baik/)) {
          $('input[name="kondisi_umum"][value="Baik"]').prop("checked", true);
        }
        if (data.kondisi_umum.match(/Tampak Sakit/)) {
          $('input[name="kondisi_umum"][value="Tampak Sakit"]').prop("checked", true);
        }
        if (data.kondisi_umum.match(/Sesak/)) {
          $('input[name="kondisi_umum"][value="Sesak"]').prop("checked", true);
        }
        if (data.kondisi_umum.match(/Pucat/)) {
          $('input[name="kondisi_umum"][value="Pucat"]').prop("checked", true);
        }
        if (data.kondisi_umum.match(/Lemah/)) {
          $('input[name="kondisi_umum"][value="Lemah"]').prop("checked", true);
        }
        if (!data.kondisi_umum.match(/Baik&Tampak Sakit&Sesak&Pucat&Lemah/)) {
          $('input[name="kondisi_umum"][value="Lainnya"]').prop("checked", true);
          $('#kondisi_umum').val(data.kondisi_umum.replace(/Baik|Tampak Sakit|Sesak|Pucat|Lemah|,/g, ''));
          $("#kondisi_umum").show();
        }

        if (data.kebutuhan_khusus.match(/Tidak Ada.*/)) {
          $('input[name="kebutuhan_khusus"][value="Tidak Ada"]').prop("checked", true);
        }
        if (data.kebutuhan_khusus.match(/Alat Bantu Dengar/)) {
          $('input[name="kebutuhan_khusus"][value="Alat Bantu Dengar"]').prop("checked", true);
        }
        if (data.kebutuhan_khusus.match(/Kacamata/)) {
          $('input[name="kebutuhan_khusus"][value="Kacamata"]').prop("checked", true);
        }
        if (data.kebutuhan_khusus.match(/Tongkat/)) {
          $('input[name="kebutuhan_khusus"][value="Tongkat"]').prop("checked", true);
        }
        if (data.kebutuhan_khusus.match(/Gigi Palsu/)) {
          $('input[name="kebutuhan_khusus"][value="Gigi Palsu"]').prop("checked", true);
        }
        if (data.asesment_triase.match(/Merah/)) {
          $('input[name="asesment_triase"][value="Merah"]').prop("checked", true);
        }
        if (data.asesment_triase.match(/Kuning/)) {
          $('input[name="asesment_triase"][value="Kuning"]').prop("checked", true);
        }
        if (data.asesment_triase.match(/Hijau/)) {
          $('input[name="asesment_triase"][value="Hijau"]').prop("checked", true);
        }
        if (data.asesment_triase.match(/Hitam/)) {
          $('input[name="asesment_triase"][value="Hitam"]').prop("checked", true);
        }

        if (data.faktor_nyeri.match(/Tidak Ada/)) {
          $('input[name="faktor_nyeri"][value="Tidak Ada"]').prop("checked", true);
        }
        if (data.faktor_nyeri.match(/Cahaya/)) {
          $('input[name="faktor_nyeri"][value="Cahaya"]').prop("checked", true);
        }
        if (data.faktor_nyeri.match(/Gelap/)) {
          $('input[name="faktor_nyeri"][value="Gelap"]').prop("checked", true);
        }
        if (data.faktor_nyeri.match(/Gerakan/)) {
          $('input[name="faktor_nyeri"][value="Gerakan"]').prop("checked", true);
        }
        if (data.faktor_nyeri.match(/Berbaring/)) {
          $('input[name="faktor_nyeri"][value="Berbaring"]').prop("checked", true);
        }
        if (!data.faktor_nyeri.match(/Tidak Ada&Cahaya&Gelap&Gerakan&Berbaring/)) {
          $('input[name="faktor_nyeri"][value="Lainnya"]').prop("checked", true);
          $('#faktor_nyeri').val(data.faktor_nyeri.replace(/Tidak Ada|Cahaya|Gelap|Gerakan|Berbaring|,/g, ''));
          $("#faktor_nyeri").show();
        }

        if (data.kualitas_nyeri.match(/Tidak Ada/)) {
          $('input[name="kualitas_nyeri"][value="Tidak Ada"]').prop("checked", true);
        }
        if (data.kualitas_nyeri.match(/Tumpul/)) {
          $('input[name="kualitas_nyeri"][value="Tumpul"]').prop("checked", true);
        }
        if (data.kualitas_nyeri.match(/Tajam/)) {
          $('input[name="kualitas_nyeri"][value="Tajam"]').prop("checked", true);
        }
        if (data.kualitas_nyeri.match(/Ditusuk/)) {
          $('input[name="kualitas_nyeri"][value="Ditusuk"]').prop("checked", true);
        }
        if (data.kualitas_nyeri.match(/Kram/)) {
          $('input[name="kualitas_nyeri"][value="Kram"]').prop("checked", true);
        }
        if (data.kualitas_nyeri.match(/Terbakar/)) {
          $('input[name="kualitas_nyeri"][value="Terbakar"]').prop("checked", true);
        }
        if (data.kualitas_nyeri.match(/Berdenyut/)) {
          $('input[name="kualitas_nyeri"][value="Berdenyut"]').prop("checked", true);
        }

        if (data.faktor_peringan.match(/Tidak Ada/)) {
          $('input[name="faktor_peringan"][value="Tidak Ada"]').prop("checked", true);
        }
        if (data.faktor_peringan.match(/Kompress/)) {
          $('input[name="faktor_peringan"][value="Kompress"]').prop("checked", true);
        }
        if (data.faktor_peringan.match(/Nafas Dalam/)) {
          $('input[name="faktor_peringan"][value="Nafas Dalam"]').prop("checked", true);
        }
        if (data.faktor_peringan.match(/Istirahat/)) {
          $('input[name="faktor_peringan"][value="Istirahat"]').prop("checked", true);
        }
        if (!data.faktor_peringan.match(/Tidak Ada&Kompress&Nafas Dalam&Istirahat/)) {
          $('input[name="faktor_peringan"][value="Lainnya"]').prop("checked", true);
          $('#faktor_peringan').val(data.faktor_peringan.replace(/Tidak Ada|Kompress|Nafas Dalam|Istirahat|,/g, ''));
          $("#faktor_peringan").show();
        }

        if (data.efek_nyeri.match(/Tidak Ada/)) {
          $('input[name="efek_nyeri"][value="Tidak Ada"]').prop("checked", true);
        }
        if (data.efek_nyeri.match(/Mual.*/)) {
          $('input[name="efek_nyeri"][value="Mual / Muntah"]').prop("checked", true);
        }
        if (data.efek_nyeri.match(/Aktifitas Terganggu/)) {
          $('input[name="efek_nyeri"][value="Aktifitas Terganggu"]').prop("checked", true);
        }
        if (data.efek_nyeri.match(/Nafsu Makan Berkurang/)) {
          $('input[name="efek_nyeri"][value="Nafsu Makan Berkurang"]').prop("checked", true);
        }
        if (data.efek_nyeri.match(/Emosi/)) {
          $('input[name="efek_nyeri"][value="Emosi"]').prop("checked", true);
        }
        if (data.efek_nyeri.match(/Gangguan Tidur/)) {
          $('input[name="efek_nyeri"][value="Gangguan Tidur"]').prop("checked", true);
        }
        if (!data.efek_nyeri.match(/Tidak Ada&Mual.*&Aktifitas Terganggu&Nafsu Makan Berkurang&Emosi&Gangguan Tidur/)) {
          $('input[name="efek_nyeri"][value="Lainnya"]').prop("checked", true);
          $('#efek_nyeri').val(data.efek_nyeri.replace(/Tidak Ada|Mual.*|Aktifitas Terganggu|Nafsu Makan Berkurang|Emosi|Gangguan Tidur|,/g, ''));
          $("#efek_nyeri").show();
        }

        if (data.keluhan_bab.match(/Tidak Ada/)) {
          $('input[name="keluhan_bab"][value="Tidak Ada"]').prop("checked", true);
        }
        if (data.keluhan_bab.match(/Pendarahan/)) {
          $('input[name="keluhan_bab"][value="Pendarahan"]').prop("checked", true);
        }
        if (data.keluhan_bab.match(/Hemorroid/)) {
          $('input[name="keluhan_bab"][value="Hemorroid"]').prop("checked", true);
        }
        if (data.keluhan_bab.match(/Konstipasi/)) {
          $('input[name="keluhan_bab"][value="Konstipasi"]').prop("checked", true);
        }
        if (data.keluhan_bab.match(/Diare/)) {
          $('input[name="keluhan_bab"][value="Diare"]').prop("checked", true);
        }

        if (data.karakter_feces.match(/Padat/)) {
          $('input[name="karakter_feces"][value="Padat"]').prop("checked", true);
        }
        if (data.karakter_feces.match(/Lunak/)) {
          $('input[name="karakter_feces"][value="Lunak"]').prop("checked", true);
        }
        if (data.karakter_feces.match(/Cair/)) {
          $('input[name="karakter_feces"][value="Cair"]').prop("checked", true);
        }
...
<script type="text/javascript">
  ...
  function simpan() {
    ...
    // dataString = 'no_rm=' + no_rm + '&nama=' + nama + '&tgl_lahir=' + tgl_lahir + '&id_pelayanan=' + id_pelayanan + '&id_history=' + id_history + '&id=' + id +
  ...
  function cetak() {
    id = $('#id').val();
    window.location.href = "<?php echo base_url('Erm_igd_edit/print_ass_per_igd/') ?>" + id;
  }
</script>
<script>
