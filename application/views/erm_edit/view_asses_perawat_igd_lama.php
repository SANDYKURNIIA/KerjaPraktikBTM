  ...
  $(document).ready(function() {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        if (data.info_dpjp == "Tidak") {
          $('input[name="info_dpjp"][value="' + data.info_dpjp + '"]').prop("checked", true);
        } else {
          $('input[name="info_dpjp"][value="Ya"]').prop("checked", true);
          $('#info_dpjp').val(data.jam_info_dpjp);
          $('#info_dpjp').show();
        }
