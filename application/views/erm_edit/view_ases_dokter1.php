            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <span id="riwayat_error" class="text-danger"></span>
                  <div class="has-success">
                    <textarea class="form-control" name="" id="riwayat_sakit_fam" cols="30" rows="3" disabled></textarea>
                  </div>
                </div>
              </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_poli_edit/get_ass_dok",
      method: "POST",
      dataType: 'json',
      data: {
        id: id_history
      ...
      success: function(data) {
        ...
        if (data.alergi_obat == "Tidak Ada") {
          ...
          $('#alergi_obat').val(data.riwayat_alergi);
          $('#alergi_obat').show();
        }
        ...
        //   $('#ranap').val(data.tindak_lanjut.replace(/Rawat Inap, Jam transfer: /g, ''));
        ...
        //   $('input[name="psikologis"][value="Lainnya"]').prop("checked", true);
...
<script type="text/javascript">
  function simpan() {
    ...
    dataString = 'no_rm=' + no_rm + '&id_pelayanan=' + id_pelayanan + '&id_history=' + id_history +
      ...
      '&ekstremitas=' + ekstremitas + '&tindak_lanjut=' + tindak_lanjut + '&gambar=' + gambar + '&keterangan=' + keterangan +
      '&kondisi_pulang=' + kondisi_pulang + '&terapi=' + terapi + '&konsul=' + konsul + '&paham=' + paham +
      '&nama_lengkap=' + nama_lengkap + '&id=' + id;
    // alert(tindak_lanjut);

    $.ajax({
      url: "<?php echo base_url() ?>Asesmen_dokter/update_asses_dokter_igd",
      method: "POST",
      dataType: 'json',
      data: dataString,
      success: function(data) {
