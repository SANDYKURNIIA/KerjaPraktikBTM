...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_igd_edit/get_observasi",
      method: "POST",
      dataType: 'json',
      data: {
        id: id_history
      ...
      success: function(data) {
        ...
        $('input[name="gawat"][value="' + data.gawat + '"]').prop("checked", true);
        $('input[name="jenis_kasus"][value="' + data.jenis_kasus + '"]').prop("checked", true);
        $('input[name="ale_obat"][value="' + data.ale_obat + '"]').prop("checked", true);

        $('#id').val(data.id_form_observasi);
        $('#nama_supir').val(data.nama_supir);
        $('#nama_tm').val(data.nama_tm);
        $('#tgl').val(data.tgl);
        $('#berangkat').val(data.berangkat);
        $('#tujuan').val(data.tujuan);
        $('#jam_brgkt').val(data.jam_brgkt);
...
<script type="text/javascript">
  function simpan() {
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_igd/insert_observasi",
      method: "POST",
      dataType: 'json',
      data: dataString,
      success: function(data) {
  ...
  function simpan_tindakan() {
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_igd/insert_obat_observasi",
      method: "POST",
      dataType: 'json',
      data: dataString,
      success: function(data) {
  ...
  function hapus_tindakan(id) { //utk hapus diagnosa pasien
    swal({
      ...
      $().ready(function() {
        $.ajax({
          url: "<?php echo base_url() ?>Erm_igd/hapus_obat_observasi",
          method: "POST",
          dataType: 'json',
          data: {
            id: id,
  ...
  function pilih(id) {
    $('#id_form').val(id);
    $.ajax({
      url: "<?php echo base_url() ?>Erm_igd/get_obat_observasi",
      method: "POST",
      dataType: 'json',
      data: {
        id: id
  ...
  function edit() {
    ...
    $.ajax({
      url: "<?php echo base_url() ?>Erm_igd/edit_obat_observasi",
      method: "POST",
      dataType: 'json',
      data: dataString,
      success: function(data) {
  ...
  function cetak() {
    id = $('#id').val();
    window.location.href = "<?php echo base_url('Erm_igd_edit/print_observasi/') ?>" + id;
  }
</script>
<script>
  $(document).ready(function() {
