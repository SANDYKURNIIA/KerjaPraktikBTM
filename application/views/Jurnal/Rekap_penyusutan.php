...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="span span-success">REKAP PENYUSUTAN</span></h6>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="row mt-30">
                    <!-- <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <label class="mt-0 txt-dark">Tanggal Penyusutan: </label>
...
<script type="text/javascript">
    function cetak() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?= base_url() . 'Jurnal_onuse/cetak_penyusutan' ?>",
...
<script type="text/javascript">
    ...
    function tampilRangePo(mulai) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Jurnal_onuse/tampil_data_penyusutan'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                },
