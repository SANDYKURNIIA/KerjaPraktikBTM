...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="span span-success">JURNAL PEMBAYARAN UTANG</span></h6>
        </div>
...
<script type="text/javascript">
    function verifikasi(no_jurnal) {
        $.ajax({
            url: "<?php echo base_url() ?>Jurnal_utang_piutang/acc_jurnal_farmasi",
            method: "POST",
            dataType: 'json',
            data: {
                id_jurnal: no_jurnal,
            ...
            success: function(data) {
                if (data.status == "success") {
                    swal({
                        title: "good job!",
                        type: "success",
                        text: "Jurnal " + no_jurnal + " Berhasil Diverifikasi",
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Jurnal_utang_piutang/tampil_jurnal'); ?>',
                "type": 'POST',
