...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN JASA SERVICE</span></h6>
        </div>
...
<script type="text/javascript">
    ...
    function cetak() {
        ...
        if ((mulai != '' || akhir != '') && jenis_jurnal == '-') {
            location.href = "<?= base_url() . 'Jurnal_keuangan/export/' ?>" + mulai + '/' + akhir;
        } else if ((mulai != '' || akhir != '') && jenis_jurnal != '-') {
