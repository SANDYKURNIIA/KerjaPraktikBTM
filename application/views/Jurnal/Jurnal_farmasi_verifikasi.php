<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="span span-success">VERIFIKASI JURNAL <?= $judul ?></span></h6>
        </div>
...
<script type="text/javascript">
    function insertObatFaktur() {
        ...
        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Jurnal_farmasi/acc_jurnal_farmasi",
                method: "POST",
                dataType: 'json',
                data: {
                    id_jurnal: id_jurnal,
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Jurnal_farmasi/tampil_jurnal_farmasi_verifikasi'); ?>',
                "type": 'POST',
                "data": {
                    tipe: '<?= $tipe ?>'
                },
...
<script type="text/javascript">
    function setJurnal(no_jurnal, tgl, staff, jk, no_po, tipe) {

        $.ajax({
            type: 'POST',
            url: "<?= base_url() . 'Jurnal_farmasi/cetak_jurnal_farmasi' ?>",
            data: {
                no_jurnal: no_jurnal,
                tgl: tgl,
                staff: staff,
