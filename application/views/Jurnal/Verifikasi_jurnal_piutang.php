...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">VERIFIKASI JURNAL <?= $jenis ?></span></h6>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Jurnal_keuangan_nontunai/tampil_jurnal_piutang'); ?>',
                "type": 'POST',
                "data": {
                    jenis: '<?= $jenis ?>'
                },
    ...
    function verifikasi(no_jurnal) {
        swal({
            ...
            text: "Verifikasi Jurnal " + no_jurnal + "?",
            type: "warning",
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?= base_url() . 'Jurnal_keuangan/acc_jurnal_pendapatan' ?>",
                    data: {
                        no_jurnal: no_jurnal,
                    },
                    type: 'POST',
    ...
    function batal_jurnal(jenis, no_jurnal) {
        swal({
            title: "Apakah kamu yakin?",
            text: "Membatalkan no jurnal " + no_jurnal + "?",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#3cb878",
            confirmButtonText: "Yakin",
            ...
            $().ready(function() {
                $.ajax({
                    url: "<?php echo base_url() ?>Jurnal_keuangan_nontunai/batal_jurnal",
                    method: "POST",
                    dataType: 'json',
                    data: {
                        no_jurnal: no_jurnal,
