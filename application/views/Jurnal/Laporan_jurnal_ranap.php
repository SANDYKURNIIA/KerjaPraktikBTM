...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">JURNAL RAWAT INAP</span></h6>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Jurnal_keuangan/tampil_data_laporan_jurnal_ranap'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir, jenis_klaim) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Jurnal_keuangan/tampil_data_laporan_jurnal_ranap'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir,
        ...
        if (Date.parse(jurnal) < Date.parse(akhir)) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: "<?= base_url() . 'Jurnal_keuangan/setJurnal1' ?>",
                        data: {
                            mulai: mulai,
                            akhir: akhir,
