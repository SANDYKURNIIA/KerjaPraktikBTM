...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN SUMMARY JURNAL BANK</span></h6>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Jurnal_keuangan/tampil_summary_bank'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir, jenis_klaim) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Jurnal_keuangan/tampil_summary_bank'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir,
    ...
    function setJurnal(no_jurnal, tgl, staff, jk, id_fk) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?= base_url() . 'Jurnal_keuangan/cetak_jurnal_bank' ?>",
            data: {
                no_jurnal: no_jurnal,
                tgl: tgl,
                staff: staff,
