...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN REKAP JURNAL</span></h6>
        </div>
        ...
        <div class="row mt-30">
            <div class="col-md-12">
                ...
                <div class="col-md-2">
                    <label class="mt-0 txt-dark">Jenis Jurnal :</label>
                    ...
                    <select class="form-control select2" placeholder="Choose a Category" name="jenis_jurnal" id="jenis_jurnal">
                        ...
                        <option value="persediaan">BYMHD</option>
                        <option value="hutang">UTANG</option>
                        <option value="kas_bank_utang">BUKTI KAS/BANK PEMBAYARAN UTANG</option>
                        <option value="PYMHD">PYMHD</option>
...
<script type="text/javascript">
    ...
    function cetak() {
        ...
        if ((mulai != '' || akhir != '')&& (jenis_jurnal=='-'  || jenis_jurnal=='PYMHD' || jenis_jurnal=='PIUTANG') ) {
            location.href = "<?= base_url() . 'Jurnal_keuangan/export/' ?>"+mulai +'/'+akhir+'/'+jenis_jurnal;
        }else if ((mulai != '' || akhir != '')&& (jenis_jurnal=='hutang' || jenis_jurnal=='persediaan'|| jenis_jurnal=='kas_bank_utang' )) {
            location.href = "<?= base_url() . 'Jurnal_farmasi/export_jurnal/' ?>"+mulai +'/'+akhir+'/'+jenis_jurnal;
        } else {
