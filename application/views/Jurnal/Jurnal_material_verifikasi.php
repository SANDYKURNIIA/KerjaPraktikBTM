...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="span span-success">VERIFIKASI JURNAL MATERIAL</span></h6>
        </div>
...
<script type="text/javascript">
    function insertObatFaktur() {
        ...
        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Jurnal_Biaya_farmasi/verifikasi_jurnal",
                method: "POST",
                dataType: 'json',
                data: {
                    id_jurnal: id_jurnal,
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Jurnal_Biaya_farmasi/tampil_jurnal_verifikasi'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePo(mulai, akhir) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Jurnal_Biaya_farmasi/tampil_jurnal_verifikasi'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir
...
<script type="text/javascript">
    function setJurnal(no_jurnal, tgl, staff, jk, id_fk) {

        $.ajax({
            type: 'POST',
            url: "<?= base_url($url_cetak) ?>",
            data: {
                no_jurnal: no_jurnal,
                tgl: tgl,
                staff: staff,
