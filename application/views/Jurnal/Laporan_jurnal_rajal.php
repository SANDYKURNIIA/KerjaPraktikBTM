...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">JURNAL RAJAL TUNAI</span></h6>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Jurnal_keuangan/tampil_data_laporan_jurnal_rajal'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir, jenis_klaim) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Jurnal_keuangan/tampil_data_laporan_jurnal_rajal'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir,
    ...
    function setJurnal() {
        ...
        if (Date.parse(jurnal) < Date.parse(akhir)) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "<?= base_url() . 'Jurnal_keuangan/setJurnal' ?>",
                        data: {
                            mulai: mulai,
                            akhir: akhir,
                            jurnal:jurnal,
