<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="span span-success"><?= $judul1 ?> JURNAL <?= $judul ?></span></h6>
        </div>
...
<script type="text/javascript">
    function insertObatFaktur() {
        ...
        $().ready(function() {
            $.ajax({
                url: "<?php echo base_url() ?>Jurnal_kasbank/verifikasi_jurnal",
                method: "POST",
                dataType: 'json',
                data: {
                    id_jurnal: id_jurnal,
