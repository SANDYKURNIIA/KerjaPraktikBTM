...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN JURNAL BANK</span></h6>
        </div>
        ...
        <div class="row mt-30">
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" autocomplete="off" id="inTglJurnal" class="form-control">
                </div>
                <div class="col-md-3">
...
<script type="text/javascript">
    function setJurnal() {
        ...
        $.ajax({
            url: "<?= base_url() . 'Jurnal_keuangan/setJurnalBank' ?>",
            data: {
                req: fav,
                tgl:$('#inTglJurnal').val()
            },
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Jurnal_keuangan/tampil_data_laporan_jurnal_bank'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir, jenis_klaim) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Jurnal_keuangan/tampil_data_laporan_jurnal_bank'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir,
