        ...
        <div class="row mt-30">
            <div class="col-md-12">
                ...
                <div class="col-md-3 mt-20">
                    ...
                    <button class="btn btn-info btn-anim btn-sm1" onclick="cetak_pdf();"><i class="icon-rocket"></i><span class="btn-text">PDF</span>
                    <!-- <button class="btn btn-info btn-anim btn-sm1" onclick="export_excel();"><i class="icon-rocket"></i><span class="btn-text">PDF</span> -->
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function cetak_pdf() {
        ...
        dokter = $("#inDokter").val();
        if (jenis_jurnal == '-') {
            window.open('<?= base_url('Jasamedis/cetak_detail_pdf/'); ?>' + mulai + '/' + akhir + '/-', '_blank');
        } else {
            if(dokter =='-'){
                window.open('<?= base_url('Jasamedis/cetak_detail_pdf_dokter/'); ?>' + mulai + '/' + akhir + '/-', '_blank');
            }else{
            window.open('<?= base_url('Jasamedis/cetak_pasien_dokter/'); ?>' + mulai + '/' + akhir+ '/' + dokter + '/-', '_blank');
            }
        }
    }
    ...
    //     dokter = $("#inDokter").val();
    //     if (jenis_jurnal == '-') {
    //         window.open('<?= base_url('Jasamedis/cetak_detail_excel/'); ?>' + mulai + '/' + akhir, '_blank');
    //     } else {
    //         if(dokter =='-'){
    //             window.open('<?= base_url('Jasamedis/cetak_detail_excel_dokter/'); ?>' + mulai + '/' + akhir, '_blank');
    //         }else{
    //         window.open('<?= base_url('Jasamedis/cetak_pasien_dokter_excel/'); ?>' + mulai + '/' + akhir+ '/' + dokter, '_blank');
    //         }
    //     }
    // }
=======
