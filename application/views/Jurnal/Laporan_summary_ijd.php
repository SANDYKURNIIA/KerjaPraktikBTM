...
<div class="panel panel-default card-view">
    <div class="panel-heading">
        <div class="pull-left">
            <h6 class="panel-title txt-dark"><span class="label label-success font-weight-100">LAPORAN JURNAL IJD</span></h6>
        </div>
...
<script type="text/javascript">
    function setJurnal(no_jurnal, tgl, staff, jk, id_fk) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?= base_url() . 'Keuangan_IJD/cetak_jurnal_ijd' ?>",
            data: {
                no_jurnal: no_jurnal,
                tgl: tgl,
                staff: staff,
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datable').DataTable({
            ...
            "ajax": '<?php echo base_url('Keuangan_IJD/tampil_summary_ijd'); ?>',
            "deferRender": true,
            "processing": true,
            "order": [],
            "columnDefs": [{
    ...
    function tampilRangePermit(mulai, akhir, jenis_klaim) {
        ...
        $('#datable').DataTable({
            ...
            "ajax": {
                "url": '<?= base_url('Keuangan_IJD/tampil_summary_ijd'); ?>',
                "type": 'POST',
                "data": {
                    mulai: mulai,
                    akhir: akhir,
