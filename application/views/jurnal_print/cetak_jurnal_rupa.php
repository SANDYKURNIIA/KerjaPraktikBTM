...
<div class="panel panel-default card-view">
    ...
    <div class="panel-body">
        <strong>
            <h3>
                <center>JURNAL <?= $judul ?></center>
            </h3>
        </strong>
        <font>
            <center>Tanggal : <?= isset($jurnal['tanggal']) ? strtoupper(indo_date2($jurnal['tanggal'])) : ''; ?></center>
        </font>
        <br>
        <br>
        ...
        <table class="b-rtable" border="1" style="border-collapse: collapse; width: 100%; border: 1px solid black;page-break-inside:auto;">
            <thead>
                <tr class="b-rtable__row">
                    ...
                    <th class="b-rtable__cell -header" width="25%">DESKRIPSI</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                foreach ($data as $row) {
                    ...
                    <tr class="b-rtable__row -primary">
                        ...
                        <td align="center"><?php echo ($data[0]['jk'] != 10 && $data[0]['jk'] != 11) ? 0 : $row['cj']; ?></td>
                        <td align="right"><?php echo  number_format($row['debet'], 2, ',', '.'); ?></td>
                        <td align="right"><?php echo  number_format($row['kredit'], 2, ',', '.'); ?></td>
                        <td align="left"><?php if ($row['des_rek'] == $row['deskripsi']) {
                                                echo ucwords(strtolower($row['deskripsi']));
                                            } else {
                                                echo $row['des_rek'] . ' = ' . ucwords(strtolower($row['deskripsi']));
                                            } ?></td>
