...
<div class="panel panel-default card-view">
    ...
    <div class="panel-body">
        <strong>
            <h3>
                <center>JURNAL PENDAPATAN</center>
            </h3>
        </strong>
        <font>
            ...
            <tbody>
                ...
                foreach ($data as $row) {
                    ...
                    <tr class="b-rtable__row -primary">
                        ...
                        <td align="left"><?php echo ucwords(strtolower($row['deskripsi'])); ?></td>
        ...
        <table border="1" style="border-collapse: collapse; width: 100%; border: 1px solid white; margin-left: 50px;">
            ...
            <tr>
                ...
                <td height="100px"><?php $db_staff1 = $this->db->get_where("staff", ['nama' => $verif->staff_verifikasi])->row(); ?>
                    <img src="<?php echo base_url() . 'assets/ttd_qr/' . $db_staff1->qr_code; ?>" width="100px"></td>
            </tr>
            <tr>
                <td height="100px"><?= $staff ?></td>
                <td height="100px"><?= $verif->staff_verifikasi ?></td>
            </tr>
