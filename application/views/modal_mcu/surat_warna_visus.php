<div class="modal fade bs-example-modal-lg" id="modal_warna_visus" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
            ...
            <div class="modal-body">
                <div class="form-wrap">
                    ...
                    <div class="form-body">
                        ...
                        <hr width="95%">
                        <form id="formObat" method="post" action="<?php ECHO base_url() . 'Surat_mcu/cetak_buta_warna_visus' ?>">
                            <div id="tambah_obat">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" class="form-control" id="inDokter4" name="inDokter">
                                    <!-- <div class="col-md-6">
                                        <div class="form-group ">
                                            <label class="control-label col-md-3">UMUR</label>
                                            <div class="col-md-9 has-success">
                                                <input type="number" class="form-control" id="inUmur" name="inUmur">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label class="control-label col-md-3">STATUS BUTA WARNA</label>
                                            <div class="col-md-9">
                                                <div class="radio-button radio-button-primary col-md-6">
                                                    <input type="radio" name="sehat" value="BUTA WARNA" id="sehat1"> <label class="control-label" for="sehat1">YA</label>
                                                </div>
                                                <div class="radio-button radio-button-primary col-md-6">
                                                    <input type="radio" name="sehat" value="TIDAK BUTA WARNA" id="sehat2"> <label class="control-label" for="sehat2">TIDAK </label>
                                                </div>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label class="control-label col-md-3">HASIL PENGLIHATAN DEKAT</label>
                                            <div class="col-md-9">
                                            <div class="radio-button radio-button-primary col-md-5">
                                                    <input type="radio" name="dekat" value="NORMAL" id="dekat1"> <label class="control-label" for="dekat1">NORMAL</label>
                                                </div>
                                                <div class="radio-button radio-button-primary col-md-7">
                                                    <input type="radio" name="dekat" value="TIDAK NORMAL" id="dekat2"> <label class="control-label" for="dekat2">TIDAK NORMAL </label>
                                                </div>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label class="control-label col-md-3">HASIL PENGLIHATAN JAUH</label>
                                            <div class="col-md-9">
                                            <div class="radio-button radio-button-primary col-md-5">
                                                    <input type="radio" name="jauh" value="NORMAL" id="jauh1"> <label class="control-label" for="jauh1">NORMAL</label>
                                                </div>
                                                <div class="radio-button radio-button-primary col-md-7">
                                                    <input type="radio" name="jauh" value="TIDAK NORMAL" id="jauh2"> <label class="control-label" for="jauh2">TIDAK NORMAL </label>
                                                </div>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
