<div class="modal fade bs-example-modal-lg" id="modal_bebas_tato" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h5 class="modal-title" id="myLargeModalLabel"><i class="icon-user mr-10"></i> DATA SURAT KETERANGAN BEBAS TATO
                </h5>
            </div>
            <div class="modal-body">
                <div class="form-wrap">
                    ...
                    <div class="form-body">
                        ...
                        <hr width="95%">
                        <form id="formObat" method="post" action="<?php echo base_url() . 'Surat_mcu/cetak_bebas_tato' ?>">
                            <div id="tambah_obat">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" class="form-control" id="inDokter6" name="inDokter">
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label class="control-label col-md-3">TATO</label>
                                            <div class="col-md-9">
                                                <div class="radio-button radio-button-primary col-md-5">
                                                    <input type="radio" name="sehat" value="mempunyai tato" id="sehat1"> <label class="control-label" for="sehat1">PUNYA</label>
                                                </div>
                                                <div class="radio-button radio-button-primary col-md-7">
                                                    <input type="radio" name="sehat" value="tidak mempunyai tato" id="sehat2"> <label class="control-label" for="sehat2">TIDAK PUNYA</label>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label class="control-label col-md-3">PEMERIKSAAN LABOR</label>
                                            <div class="col-md-9 has-success">
                                            <textarea class="form-control" name="inPeriksa" id="inPeriksa" cols="30" rows="5"></textarea>
                                                <span class="help-block"></span>
                                            </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label class="control-label col-md-3">HASIL LABOR</label>
                                            <div class="col-md-9">
                                            <div class="radio-button radio-button-primary col-md-5">
                                                    <input type="radio" name="jauh" value="Dalam Batas Normal" id="jauh1"> <label class="control-label" for="sehat1">NORMAL</label>
                                                </div>
                                                <div class="radio-button radio-button-primary col-md-7">
                                                    <input type="radio" name="jauh" value="Tidak Normal" id="jauh2"> <label class="control-label" for="sehat2">TIDAK NORMAL </label>
                                                </div>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
