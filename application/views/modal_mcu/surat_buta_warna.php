<<<<<<< HEAD
<div class="modal fade bs-example-modal-lg" id="modal_buta_warna" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h5 class="modal-title" id="myLargeModalLabel"><i class="icon-user mr-10"></i> DATA SURAT KETERANGAN BUTA WARNA
                </h5>
            </div>
            <div class="modal-body">
                <div class="form-wrap">
                    ...
                    <div class="form-body">
                        ...
                        <hr width="95%">
                        <form id="formObat" method="post" action="<?php echo base_url() . 'Surat_mcu/cetak_buta_warna' ?>">
                            <div id="tambah_obat">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" class="form-control" id="inDokter3" name="inDokter">
                                    <div class="col-md-6">
