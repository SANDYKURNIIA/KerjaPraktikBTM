<div class="modal fade bs-example-modal-lg" id="modal_sehat_rohani" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
            ...
            <div class="modal-body">
                <div class="form-wrap">
                    ...
                    <div class="form-body">
                        ...
                        <hr width="95%">
                        <form id="formObat" method="post" action="<?php echo base_url('Surat_mcu/cetak_sehat_rohani')  ?>">
                            <div id="tambah_obat">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-9 has-success">
                                                <input type="text" class="form-control" id="inPerlu" name="inPerlu">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
